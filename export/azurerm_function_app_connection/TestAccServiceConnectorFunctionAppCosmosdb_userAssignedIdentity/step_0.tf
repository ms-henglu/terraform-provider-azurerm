...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-230922061924927907"
  location = "West Europe"
}

resource "azurerm_cosmosdb_account" "test" {
  name                = "acctestcosmosdb230922061924927907"
...
resource "azurerm_app_service_plan" "test" {
  name                = "acctestASP-230922061924927907"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_function_app" "test" {
  name                       = "acctest-230922061924927907-func"
  location                   = azurerm_resource_group.test.location
  resource_group_name        = azurerm_resource_group.test.name
...
resource "azurerm_function_app_connection" "test" {
  name               = "acctestserviceconnector230922061924927907"
