...
locals {
  number            = "240119024707425204"
  location          = "West Europe"
  domain_name_label = "acctestvm-jhtvg"
  random_string     = "jhtvg"
  admin_username    = "testadmin240119024707425204"
  admin_password    = "Password1234!240119024707425204"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240119024707425204"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240119024707425204"
  ...
  identifier {
    publisher = "AccTesPublisher240119024707425204"
    offer     = "AccTesOffer240119024707425204"
    sku       = "AccTesSku240119024707425204"
  }
}
