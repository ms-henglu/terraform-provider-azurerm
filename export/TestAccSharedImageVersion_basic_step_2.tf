...
locals {
  number            = "220107033655655018"
  location          = "West Europe"
  domain_name_label = "acctestvm-q3yx4"
  random_string     = "q3yx4"
  admin_username    = "testadmin220107033655655018"
  admin_password    = "Password1234!220107033655655018"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220107033655655018"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220107033655655018"
  ...
  identifier {
    publisher = "AccTesPublisher220107033655655018"
    offer     = "AccTesOffer220107033655655018"
    sku       = "AccTesSku220107033655655018"
  }
}
