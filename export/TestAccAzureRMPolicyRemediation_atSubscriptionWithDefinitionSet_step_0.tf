...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-wani7"
  policy_type  = "Custom"
  display_name = "testPolicySet-wani7"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-wani7"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-wani7"
