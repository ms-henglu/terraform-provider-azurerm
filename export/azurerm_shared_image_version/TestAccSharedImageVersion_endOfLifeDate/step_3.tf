...
locals {
  number            = "230721011329119464"
  location          = "West Europe"
  domain_name_label = "acctestvm-uyp7p"
  random_string     = "uyp7p"
  admin_username    = "testadmin230721011329119464"
  admin_password    = "Password1234!230721011329119464"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230721011329119464"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230721011329119464"
  ...
  identifier {
    publisher = "AccTesPublisher230721011329119464"
    offer     = "AccTesOffer230721011329119464"
    sku       = "AccTesSku230721011329119464"
  }
}
