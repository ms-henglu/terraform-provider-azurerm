...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-appconfig-220124121719480439"
  location = "West Europe"
}

resource "azurerm_app_configuration" "test" {
  name                = "testacc-appconf220124121719480439"
...
resource "azurerm_app_configuration_feature" "test" {
  ...
  name                   = "acctest-ackey-220124121719480439"
  label                  = "acctest-ackeylabel-220124121719480439"
  enabled                = true
