...
locals {
  number            = "221202035328132858"
  location          = "West Europe"
  domain_name_label = "acctestvm-c0oly"
  random_string     = "c0oly"
  admin_username    = "testadmin221202035328132858"
  admin_password    = "Password1234!221202035328132858"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221202035328132858"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221202035328132858"
  ...
  identifier {
    publisher = "AccTesPublisher221202035328132858"
    offer     = "AccTesOffer221202035328132858"
    sku       = "AccTesSku221202035328132858"
  }
}
