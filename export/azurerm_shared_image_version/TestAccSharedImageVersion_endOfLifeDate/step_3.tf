...
locals {
  number            = "240112224137952719"
  location          = "West Europe"
  domain_name_label = "acctestvm-31vqn"
  random_string     = "31vqn"
  admin_username    = "testadmin240112224137952719"
  admin_password    = "Password1234!240112224137952719"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240112224137952719"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240112224137952719"
  ...
  identifier {
    publisher = "AccTesPublisher240112224137952719"
    offer     = "AccTesOffer240112224137952719"
    sku       = "AccTesSku240112224137952719"
  }
}
