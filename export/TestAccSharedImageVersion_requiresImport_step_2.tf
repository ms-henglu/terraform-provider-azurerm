...
locals {
  number            = "220422011655554690"
  location          = "West Europe"
  domain_name_label = "acctestvm-1rimo"
  random_string     = "1rimo"
  admin_username    = "testadmin220422011655554690"
  admin_password    = "Password1234!220422011655554690"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220422011655554690"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220422011655554690"
  ...
  identifier {
    publisher = "AccTesPublisher220422011655554690"
    offer     = "AccTesOffer220422011655554690"
    sku       = "AccTesSku220422011655554690"
  }
}
