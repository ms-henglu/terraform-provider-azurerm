...
locals {
  number            = "240105063504072837"
  location          = "West Europe"
  domain_name_label = "acctestvm-ews7i"
  random_string     = "ews7i"
  admin_username    = "testadmin240105063504072837"
  admin_password    = "Password1234!240105063504072837"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105063504072837"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105063504072837"
  ...
  identifier {
    publisher = "AccTesPublisher240105063504072837"
    offer     = "AccTesOffer240105063504072837"
    sku       = "AccTesSku240105063504072837"
  }
}
