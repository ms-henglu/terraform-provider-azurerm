...
locals {
  number            = "221028171853892982"
  location          = "West Europe"
  domain_name_label = "acctestvm-y893m"
  random_string     = "y893m"
  admin_username    = "testadmin221028171853892982"
  admin_password    = "Password1234!221028171853892982"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221028171853892982"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221028171853892982"
  ...
  identifier {
    publisher = "AccTesPublisher221028171853892982"
    offer     = "AccTesOffer221028171853892982"
    sku       = "AccTesSku221028171853892982"
  }
}
