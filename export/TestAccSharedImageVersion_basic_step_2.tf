...
locals {
  number            = "220218070535201663"
  location          = "West Europe"
  domain_name_label = "acctestvm-qa972"
  random_string     = "qa972"
  admin_username    = "testadmin220218070535201663"
  admin_password    = "Password1234!220218070535201663"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220218070535201663"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220218070535201663"
  ...
  identifier {
    publisher = "AccTesPublisher220218070535201663"
    offer     = "AccTesOffer220218070535201663"
    sku       = "AccTesSku220218070535201663"
  }
}
