...
locals {
  number            = "221124181402011836"
  location          = "West Europe"
  domain_name_label = "acctestvm-fpvvo"
  random_string     = "fpvvo"
  admin_username    = "testadmin221124181402011836"
  admin_password    = "Password1234!221124181402011836"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221124181402011836"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221124181402011836"
  ...
  identifier {
    publisher = "AccTesPublisher221124181402011836"
    offer     = "AccTesOffer221124181402011836"
    sku       = "AccTesSku221124181402011836"
  }
}
