...
resource "azurerm_resource_group" "iothub" {
  name     = "acctest-iothub-240315123235191694"
  location = "eastus"
}

resource "azurerm_resource_group" "endpoint" {
  name     = "acctest-iothub-db-240315123235191694"
  location = "eastus"
}

resource "azurerm_cosmosdb_account" "test" {
  name                = "acctest-ca-240315123235191694"
...
resource "azurerm_cosmosdb_sql_database" "test" {
  name                = "acctest-240315123235191694"
