...
locals {
  number            = "230922060812877265"
  location          = "West Europe"
  domain_name_label = "acctestvm-4hjf3"
  random_string     = "4hjf3"
  admin_username    = "testadmin230922060812877265"
  admin_password    = "Password1234!230922060812877265"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230922060812877265"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230922060812877265"
  ...
  identifier {
    publisher = "AccTesPublisher230922060812877265"
    offer     = "AccTesOffer230922060812877265"
    sku       = "AccTesSku230922060812877265"
  }
}
