...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-230922054317708782"
  location = "West Europe"
}

resource "azurerm_resource_group" "test2" {
  name     = "acctestSecRG-230922054317708782"
  location = "West Europe"
}
...
resource "azurerm_cosmosdb_account" "test" {
  name                = "acctest-ca-230922054317708782"
...
resource "azurerm_cosmosdb_sql_database" "test" {
  name                = "acctestcosmosdbsqldb-230922054317708782"
  resource_group_name = azurerm_cosmosdb_account.test.resource_group_name
  account_name        = azurerm_cosmosdb_account.test.name
}

resource "azurerm_cosmosdb_sql_container" "test" {
  name                = "acctestcosmosdbsqlcon-230922054317708782"
  resource_group_name = azurerm_cosmosdb_account.test.resource_group_name
  account_name        = azurerm_cosmosdb_account.test.name
...
resource "azurerm_kusto_database" "test" {
  name                = "acctestkd-230922054317708782"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
