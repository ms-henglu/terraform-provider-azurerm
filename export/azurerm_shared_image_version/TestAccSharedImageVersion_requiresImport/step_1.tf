...
locals {
  number            = "230707010127174906"
  location          = "West Europe"
  domain_name_label = "acctestvm-n2cfj"
  random_string     = "n2cfj"
  admin_username    = "testadmin230707010127174906"
  admin_password    = "Password1234!230707010127174906"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230707010127174906"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230707010127174906"
  ...
  identifier {
    publisher = "AccTesPublisher230707010127174906"
    offer     = "AccTesOffer230707010127174906"
    sku       = "AccTesSku230707010127174906"
  }
}
