...
locals {
  number            = "240119021734532682"
  location          = "West Europe"
  domain_name_label = "acctestvm-h13nm"
  random_string     = "h13nm"
  admin_username    = "testadmin240119021734532682"
  admin_password    = "Password1234!240119021734532682"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240119021734532682"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240119021734532682"
  ...
  identifier {
    publisher = "AccTesPublisher240119021734532682"
    offer     = "AccTesOffer240119021734532682"
    sku       = "AccTesSku240119021734532682"
  }
}
