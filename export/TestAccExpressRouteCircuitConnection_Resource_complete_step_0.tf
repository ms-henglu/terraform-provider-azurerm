...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-ercircuitconn-220812015532203913"
  location = "West Europe"
}

resource "azurerm_express_route_port" "test" {
  name                = "acctest-erp-220812015532203913"
...
resource "azurerm_express_route_circuit" "test" {
  name                  = "acctest-erc-220812015532203913"
  location              = azurerm_resource_group.test.location
  resource_group_name   = azurerm_resource_group.test.name
...
resource "azurerm_express_route_port" "peer_test" {
  name                = "acctest-erp2-220812015532203913"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_express_route_circuit" "peer_test" {
  name                  = "acctest-erc2-220812015532203913"
  location              = azurerm_resource_group.test.location
  resource_group_name   = azurerm_resource_group.test.name
...
resource "azurerm_express_route_circuit_connection" "test" {
  name                = "acctest-ExpressRouteCircuitConn-220812015532203913"
