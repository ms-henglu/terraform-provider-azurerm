...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-240105063201418886"
  location = "West Europe"
}

resource "azurerm_key_vault" "test" {
  name                = "acct240105063201418886"
...
resource "azurerm_api_management" "test" {
  name                = "acctestAM-240105063201418886"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  publisher_name      = "pub1"
...
resource "azurerm_api_management_certificate" "test" {
  ...
  key_vault_secret_id = azurerm_key_vault_certificate.cert2.secret_id
}
