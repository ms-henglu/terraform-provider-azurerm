...
locals {
  number            = "220923011626953886"
  location          = "West Europe"
  domain_name_label = "acctestvm-97ilp"
  random_string     = "97ilp"
  admin_username    = "testadmin220923011626953886"
  admin_password    = "Password1234!220923011626953886"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220923011626953886"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220923011626953886"
  ...
  identifier {
    publisher = "AccTesPublisher220923011626953886"
    offer     = "AccTesOffer220923011626953886"
    sku       = "AccTesSku220923011626953886"
  }
}
