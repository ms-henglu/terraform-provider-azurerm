...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220909035103655082"
  location = "West Europe"
}

resource "azurerm_iothub" "test" {
  name                = "acctestiothub-220909035103655082"
...
resource "azurerm_stream_analytics_job" "test" {
  name                                     = "acctestjob-220909035103655082"
  resource_group_name                      = azurerm_resource_group.test.name
  location                                 = azurerm_resource_group.test.location
...
resource "azurerm_iothub" "updated" {
  name                = "acctestiot2-220909035103655082"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_stream_analytics_stream_input_iothub" "test" {
  name                         = "acctestinput-220909035103655082"
