...
func (c FindRestorableTimeRangesClient) RestorableTimeRangesFind(ctx context.Context, id BackupInstanceId, input AzureBackupFindRestorableTimeRangesRequest) (result RestorableTimeRangesFindResponse, err error) {
...
func (c FindRestorableTimeRangesClient) responderForRestorableTimeRangesFind(resp *http.Response) (result RestorableTimeRangesFindResponse, err error) {
