...
locals {
  number            = "221021033910593367"
  location          = "West Europe"
  domain_name_label = "acctestvm-qebaq"
  random_string     = "qebaq"
  admin_username    = "testadmin221021033910593367"
  admin_password    = "Password1234!221021033910593367"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221021033910593367"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221021033910593367"
  ...
  identifier {
    publisher = "AccTesPublisher221021033910593367"
    offer     = "AccTesOffer221021033910593367"
    sku       = "AccTesSku221021033910593367"
  }
}
