...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-231020041845725429"
  location = "West Europe"
}

resource "azurerm_cosmosdb_account" "test" {
  name                = "acctestcosmosdb231020041845725429"
...
resource "azurerm_app_service_plan" "test" {
  name                = "acctestASP-231020041845725429"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_function_app" "test" {
  name                       = "acctest-231020041845725429-func"
  location                   = azurerm_resource_group.test.location
  resource_group_name        = azurerm_resource_group.test.name
...
resource "azurerm_function_app_connection" "test" {
  name               = "acctestserviceconnector231020041845725429"
