...
locals {
  number            = "210924004029434065"
  location          = "West Europe"
  domain_name_label = "acctestvm-9yjq1"
  random_string     = "9yjq1"
  admin_username    = "testadmin210924004029434065"
  admin_password    = "Password1234!210924004029434065"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210924004029434065"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210924004029434065"
  ...
  identifier {
    publisher = "AccTesPublisher210924004029434065"
    offer     = "AccTesOffer210924004029434065"
    sku       = "AccTesSku210924004029434065"
  }
}
