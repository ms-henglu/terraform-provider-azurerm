...
locals {
  number            = "211210024414740983"
  location          = "West Europe"
  domain_name_label = "acctestvm-kubxs"
  random_string     = "kubxs"
  admin_username    = "testadmin211210024414740983"
  admin_password    = "Password1234!211210024414740983"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211210024414740983"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211210024414740983"
  ...
  identifier {
    publisher = "AccTesPublisher211210024414740983"
    offer     = "AccTesOffer211210024414740983"
    sku       = "AccTesSku211210024414740983"
  }
}
