...
locals {
  number            = "211015014431936728"
  location          = "West Europe"
  domain_name_label = "acctestvm-97pxq"
  random_string     = "97pxq"
  admin_username    = "testadmin211015014431936728"
  admin_password    = "Password1234!211015014431936728"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211015014431936728"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211015014431936728"
  ...
  identifier {
    publisher = "AccTesPublisher211015014431936728"
    offer     = "AccTesOffer211015014431936728"
    sku       = "AccTesSku211015014431936728"
  }
}
