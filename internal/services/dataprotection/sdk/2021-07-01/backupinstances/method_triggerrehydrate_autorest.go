...
type TriggerRehydrateResponse struct {
	Poller       polling.LongRunningPoller
	HttpResponse *http.Response
}

// TriggerRehydrate ...
func (c BackupInstancesClient) TriggerRehydrate(ctx context.Context, id BackupInstanceId, input AzureBackupRehydrationRequest) (result TriggerRehydrateResponse, err error) {
...
func (c BackupInstancesClient) senderForTriggerRehydrate(ctx context.Context, req *http.Request) (future TriggerRehydrateResponse, err error) {
