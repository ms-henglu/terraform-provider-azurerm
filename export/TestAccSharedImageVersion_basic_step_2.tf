...
locals {
  number            = "220811053013421491"
  location          = "West Europe"
  domain_name_label = "acctestvm-hw9m4"
  random_string     = "hw9m4"
  admin_username    = "testadmin220811053013421491"
  admin_password    = "Password1234!220811053013421491"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220811053013421491"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220811053013421491"
  ...
  identifier {
    publisher = "AccTesPublisher220811053013421491"
    offer     = "AccTesOffer220811053013421491"
    sku       = "AccTesSku220811053013421491"
  }
}
