...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-240315124039506448"
...
resource "azuread_application" "cluster_explorer" {
  ...
  identifier_uris = ["https://test-ckwvx.${data.azuread_domains.test.domains[0].domain_name}:19080/Explorer/index.html"]
  web {
...
resource "azurerm_service_fabric_cluster" "test" {
  name                = "acctest-240315124039506448"
