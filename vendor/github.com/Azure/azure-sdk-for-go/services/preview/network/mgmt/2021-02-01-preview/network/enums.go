...
// CommitType enumerates the values for commit type.
type CommitType string

const (
	// AdminPolicy ...
	AdminPolicy CommitType = "AdminPolicy"
	// Connectivity ...
	Connectivity CommitType = "Connectivity"
	// Routing ...
	Routing CommitType = "Routing"
	// UserPolicy ...
	UserPolicy CommitType = "UserPolicy"
)

// PossibleCommitTypeValues returns an array of possible values for the CommitType const type.
func PossibleCommitTypeValues() []CommitType {
	return []CommitType{AdminPolicy, Connectivity, Routing, UserPolicy}
}
...
// DeleteExistingNSGs enumerates the values for delete existing ns gs.
type DeleteExistingNSGs string

const (
	// False ...
	False DeleteExistingNSGs = "False"
	// True ...
	True DeleteExistingNSGs = "True"
)

// PossibleDeleteExistingNSGsValues returns an array of possible values for the DeleteExistingNSGs const type.
func PossibleDeleteExistingNSGsValues() []DeleteExistingNSGs {
	return []DeleteExistingNSGs{False, True}
}
...
func PossibleDeploymentTypeValues() []DeploymentType {
	return []DeploymentType{DeploymentTypeAdminPolicy, DeploymentTypeConnectivity, DeploymentTypeRouting, DeploymentTypeUserPolicy}
}
...
const (
	// KindConnectivityConfiguration ...
	KindConnectivityConfiguration Kind = "ConnectivityConfiguration"
	// KindEffectiveConfiguration ...
	KindEffectiveConfiguration Kind = "EffectiveConfiguration"
	// KindSecurityAdminRuleCollection ...
	KindSecurityAdminRuleCollection Kind = "SecurityAdminRuleCollection"
	// KindSecurityUserRuleCollection ...
	KindSecurityUserRuleCollection Kind = "SecurityUserRuleCollection"
)

// PossibleKindValues returns an array of possible values for the Kind const type.
func PossibleKindValues() []Kind {
	return []Kind{KindConnectivityConfiguration, KindEffectiveConfiguration, KindSecurityAdminRuleCollection, KindSecurityUserRuleCollection}
}

// KindBasicAdminBaseRule enumerates the values for kind basic admin base rule.
type KindBasicAdminBaseRule string

const (
	// KindAdminBaseRule ...
	KindAdminBaseRule KindBasicAdminBaseRule = "AdminBaseRule"
	// KindCustom ...
	KindCustom KindBasicAdminBaseRule = "Custom"
	// KindDefault ...
	KindDefault KindBasicAdminBaseRule = "Default"
)

// PossibleKindBasicAdminBaseRuleValues returns an array of possible values for the KindBasicAdminBaseRule const type.
func PossibleKindBasicAdminBaseRuleValues() []KindBasicAdminBaseRule {
	return []KindBasicAdminBaseRule{KindAdminBaseRule, KindCustom, KindDefault}
}
...
// KindBasicBaseUserRule enumerates the values for kind basic base user rule.
type KindBasicBaseUserRule string

const (
	// KindBasicBaseUserRuleKindBaseUserRule ...
	KindBasicBaseUserRuleKindBaseUserRule KindBasicBaseUserRule = "BaseUserRule"
	// KindBasicBaseUserRuleKindCustom ...
	KindBasicBaseUserRuleKindCustom KindBasicBaseUserRule = "Custom"
	// KindBasicBaseUserRuleKindDefault ...
	KindBasicBaseUserRuleKindDefault KindBasicBaseUserRule = "Default"
)

// PossibleKindBasicBaseUserRuleValues returns an array of possible values for the KindBasicBaseUserRule const type.
func PossibleKindBasicBaseUserRuleValues() []KindBasicBaseUserRule {
	return []KindBasicBaseUserRule{KindBasicBaseUserRuleKindBaseUserRule, KindBasicBaseUserRuleKindCustom, KindBasicBaseUserRuleKindDefault}
}

// KindBasicUserBaseRule enumerates the values for kind basic user base rule.
type KindBasicUserBaseRule string

const (
	// KindBasicUserBaseRuleKindCustom ...
	KindBasicUserBaseRuleKindCustom KindBasicUserBaseRule = "Custom"
	// KindBasicUserBaseRuleKindDefault ...
	KindBasicUserBaseRuleKindDefault KindBasicUserBaseRule = "Default"
	// KindBasicUserBaseRuleKindUserBaseRule ...
	KindBasicUserBaseRuleKindUserBaseRule KindBasicUserBaseRule = "UserBaseRule"
)

// PossibleKindBasicUserBaseRuleValues returns an array of possible values for the KindBasicUserBaseRule const type.
func PossibleKindBasicUserBaseRuleValues() []KindBasicUserBaseRule {
	return []KindBasicUserBaseRule{KindBasicUserBaseRuleKindCustom, KindBasicUserBaseRuleKindDefault, KindBasicUserBaseRuleKindUserBaseRule}
}
...
// MembershipType enumerates the values for membership type.
type MembershipType string

const (
	// MembershipTypeDynamic ...
	MembershipTypeDynamic MembershipType = "Dynamic"
	// MembershipTypeStatic ...
	MembershipTypeStatic MembershipType = "Static"
)

// PossibleMembershipTypeValues returns an array of possible values for the MembershipType const type.
func PossibleMembershipTypeValues() []MembershipType {
	return []MembershipType{MembershipTypeDynamic, MembershipTypeStatic}
}
...
func PossibleMemberTypeValues() []MemberType {
	return []MemberType{MemberTypeSubnet, MemberTypeVirtualNetwork}
}
...
// ScopeAccesses enumerates the values for scope accesses.
type ScopeAccesses string

const (
	// ScopeAccessesAdminPolicy ...
	ScopeAccessesAdminPolicy ScopeAccesses = "AdminPolicy"
	// ScopeAccessesConnectivity ...
	ScopeAccessesConnectivity ScopeAccesses = "Connectivity"
	// ScopeAccessesRouting ...
	ScopeAccessesRouting ScopeAccesses = "Routing"
	// ScopeAccessesUserPolicy ...
	ScopeAccessesUserPolicy ScopeAccesses = "UserPolicy"
)

// PossibleScopeAccessesValues returns an array of possible values for the ScopeAccesses const type.
func PossibleScopeAccessesValues() []ScopeAccesses {
	return []ScopeAccesses{ScopeAccessesAdminPolicy, ScopeAccessesConnectivity, ScopeAccessesRouting, ScopeAccessesUserPolicy}
}
...
// SecurityType enumerates the values for security type.
...
// PossibleSecurityTypeValues returns an array of possible values for the SecurityType const type.
func PossibleSecurityTypeValues() []SecurityType {
	return []SecurityType{SecurityTypeAdminPolicy, SecurityTypeUserPolicy}
}
