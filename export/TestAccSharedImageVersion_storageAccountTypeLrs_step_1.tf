...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211126031012790700"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211126031012790700"
  ...
  identifier {
    publisher = "AccTesPublisher211126031012790700"
    offer     = "AccTesOffer211126031012790700"
    sku       = "AccTesSku211126031012790700"
  }
}
