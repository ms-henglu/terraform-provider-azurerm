...
locals {
  number            = "220819165017102215"
  location          = "West Europe"
  domain_name_label = "acctestvm-2yfkp"
  random_string     = "2yfkp"
  admin_username    = "testadmin220819165017102215"
  admin_password    = "Password1234!220819165017102215"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220819165017102215"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220819165017102215"
  ...
  identifier {
    publisher = "AccTesPublisher220819165017102215"
    offer     = "AccTesOffer220819165017102215"
    sku       = "AccTesSku220819165017102215"
  }
}
...
resource "azurerm_shared_image_version" "test" {
  ...
  end_of_life_date    = "2022-08-20T02:50:17Z"
