...
locals {
  number            = "230324051802726302"
  location          = "West Europe"
  domain_name_label = "acctestvm-nml0o"
  random_string     = "nml0o"
  admin_username    = "testadmin230324051802726302"
  admin_password    = "Password1234!230324051802726302"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230324051802726302"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230324051802726302"
  ...
  identifier {
    publisher = "AccTesPublisher230324051802726302"
    offer     = "AccTesOffer230324051802726302"
    sku       = "AccTesSku230324051802726302"
  }
}
