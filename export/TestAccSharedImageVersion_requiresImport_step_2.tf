...
locals {
  number            = "220610022336701524"
  location          = "West Europe"
  domain_name_label = "acctestvm-b1yf7"
  random_string     = "b1yf7"
  admin_username    = "testadmin220610022336701524"
  admin_password    = "Password1234!220610022336701524"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220610022336701524"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220610022336701524"
  ...
  identifier {
    publisher = "AccTesPublisher220610022336701524"
    offer     = "AccTesOffer220610022336701524"
    sku       = "AccTesSku220610022336701524"
  }
}
