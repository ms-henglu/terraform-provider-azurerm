...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-backup-211015015021910654"
...
resource "azurerm_public_ip" "test" {
  ...
  domain_name_label   = "acctestip211015015021910654"
}
...
resource "azurerm_recovery_services_vault" "test" {
  name                = "acctest-211015015021910654"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Standard"
...
resource "azurerm_resource_group" "test2" {
  name     = "acctestRG-backup-211015015021910654-2"
  location = "West Europe"
}

resource "azurerm_recovery_services_vault" "test2" {
  name                = "acctest2-211015015021910654"
