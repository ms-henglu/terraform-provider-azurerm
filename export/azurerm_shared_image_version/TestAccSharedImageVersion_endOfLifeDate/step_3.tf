...
locals {
  number            = "230825024235259450"
  location          = "West Europe"
  domain_name_label = "acctestvm-0fefi"
  random_string     = "0fefi"
  admin_username    = "testadmin230825024235259450"
  admin_password    = "Password1234!230825024235259450"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230825024235259450"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230825024235259450"
  ...
  identifier {
    publisher = "AccTesPublisher230825024235259450"
    offer     = "AccTesOffer230825024235259450"
    sku       = "AccTesSku230825024235259450"
  }
}
