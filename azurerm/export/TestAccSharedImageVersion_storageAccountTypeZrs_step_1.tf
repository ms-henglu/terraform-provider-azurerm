...
locals {
  number            = "220627122505828756"
  location          = "West Europe"
  domain_name_label = "acctestvm-of8zw"
  random_string     = "of8zw"
  admin_username    = "testadmin220627122505828756"
  admin_password    = "Password1234!220627122505828756"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627122505828756"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627122505828756"
  ...
  identifier {
    publisher = "AccTesPublisher220627122505828756"
    offer     = "AccTesOffer220627122505828756"
    sku       = "AccTesSku220627122505828756"
  }
}
