...
resource "azurerm_resource_group" "test" {
  name     = "acctestrg-monitor-230721012052541191"
  location = "West Europe"
}

resource "azurerm_application_insights" "test" {
  name                = "acctestappinsights-230721012052541191"
...
resource "azurerm_monitor_action_group" "test" {
  name                = "acctestActionGroup-230721012052541191"
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_monitor_smart_detector_alert_rule" "test" {
  name                = "acctestSDAR-230721012052541191"
  resource_group_name = azurerm_resource_group.test.name
  severity            = "Sev0"
