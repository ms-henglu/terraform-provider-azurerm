...
locals {
  rg_name              = "acctest-nested-rg-230825025153633070"
  location             = "West Europe"
  vn_name              = "acctest-nested-vn-230825025153633070"
  ip_name              = "acctest-nested-ip-230825025153633070"
  vm_name              = "acctest-nested-vm-230825025153633070"
  nic_name             = "acctest-nested-nic-230825025153633070"
  disk_name            = "acctest-nested-disk-230825025153633070"
  keyvault_name        = "acctkv230825025153633070"
  nsg_name             = "acctest-nested-nsg-230825025153633070"
  recovery_vault_name  = "acctest-nested-recovery-vault-230825025153633070"
  recovery_site_name   = "acctest-nested-recovery-site-230825025153633070"
  admin_name           = "acctestadmin"
  cert_name            = "acctestcert"
  storage_account_name = "acctestsautdx9"
}
...
resource "azurerm_windows_virtual_machine" "host" {
  ...
  additional_unattend_content {
    setting = "AutoLogon"
    content = "<AutoLogon><Password><Value>@27^850#7%</Value></Password><Enabled>true</Enabled><LogonCount>1</LogonCount><Username>${local.admin_name}</Username></AutoLogon>"
  }
...
resource "azurerm_site_recovery_hyperv_replication_policy" "test" {
  recovery_vault_id                                  = azurerm_recovery_services_vault.test.id
  name                                               = "acctest-policy-230825025153633070"
