...
locals {
  number            = "220128082215744488"
  location          = "West Europe"
  domain_name_label = "acctestvm-tcu0y"
  random_string     = "tcu0y"
  admin_username    = "testadmin220128082215744488"
  admin_password    = "Password1234!220128082215744488"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220128082215744488"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220128082215744488"
  ...
  identifier {
    publisher = "AccTesPublisher220128082215744488"
    offer     = "AccTesOffer220128082215744488"
    sku       = "AccTesSku220128082215744488"
  }
}
