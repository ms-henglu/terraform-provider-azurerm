...
locals {
  number            = "220407230802471467"
  location          = "West Europe"
  domain_name_label = "acctestvm-q2ys2"
  random_string     = "q2ys2"
  admin_username    = "testadmin220407230802471467"
  admin_password    = "Password1234!220407230802471467"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220407230802471467"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220407230802471467"
  ...
  identifier {
    publisher = "AccTesPublisher220407230802471467"
    offer     = "AccTesOffer220407230802471467"
    sku       = "AccTesSku220407230802471467"
  }
}
