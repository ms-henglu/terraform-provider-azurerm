...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG1-sql-220107034537375448"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet1-220107034537375448"
...
resource "azurerm_subnet" "test" {
  name                 = "subnet1-220107034537375448"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_network_security_group" "test" {
  name                = "mi-security-group1-220107034537375448"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
}
...
resource "azurerm_route_table" "test" {
  name                          = "routetable1-220107034537375448"
  location                      = azurerm_resource_group.test.location
  resource_group_name           = azurerm_resource_group.test.name
...
resource "azurerm_sql_managed_instance" "test" {
  name                         = "acctestsqlserver220107034537375448"
  resource_group_name          = azurerm_resource_group.test.name
  location                     = azurerm_resource_group.test.location
...
resource "azurerm_resource_group" "secondary" {
  name     = "acctestRG2-sql-220107034537375448"
  location = "West US 2"
}

resource "azurerm_virtual_network" "secondary" {
  name                = "acctest-vnet2-220107034537375448"
...
resource "azurerm_subnet" "secondary" {
  name                 = "subnet2-220107034537375448"
  resource_group_name  = azurerm_resource_group.secondary.name
...
resource "azurerm_network_security_group" "secondary" {
  name                = "mi-security-group2-220107034537375448"
  location            = azurerm_resource_group.secondary.location
  resource_group_name = azurerm_resource_group.secondary.name
}
...
resource "azurerm_route_table" "secondary" {
  name                          = "routetable2-220107034537375448"
  location                      = azurerm_resource_group.secondary.location
  resource_group_name           = azurerm_resource_group.secondary.name
  disable_bgp_route_propagation = false
...
resource "azurerm_sql_managed_instance" "secondary" {
  name                         = "acctestsqlserver2220107034537375448"
  resource_group_name          = azurerm_resource_group.secondary.name
  location                     = azurerm_resource_group.secondary.location
  administrator_login          = "mradministrator"
  administrator_login_password = "thisIsDog11"
...
resource "azurerm_resource_group" "secondary_2" {
  name     = "acctestRG3-sql-220107034537375448"
  location = "West US 2"
}

resource "azurerm_virtual_network" "secondary_2" {
  name                = "acctest-vnet3-220107034537375448"
...
resource "azurerm_subnet" "secondary_2" {
  name                 = "subnet3-220107034537375448"
  resource_group_name  = azurerm_resource_group.secondary_2.name
...
resource "azurerm_network_security_group" "secondary_2" {
  name                = "mi-security-group3-220107034537375448"
  location            = azurerm_resource_group.secondary_2.location
  resource_group_name = azurerm_resource_group.secondary_2.name
}
...
resource "azurerm_route_table" "secondary_2" {
  name                          = "routetable3-220107034537375448"
  location                      = azurerm_resource_group.secondary_2.location
  resource_group_name           = azurerm_resource_group.secondary_2.name
  disable_bgp_route_propagation = false
...
resource "azurerm_sql_managed_instance" "secondary_2" {
  name                         = "acctestsqlserver3220107034537375448"
  resource_group_name          = azurerm_resource_group.secondary_2.name
  location                     = azurerm_resource_group.secondary_2.location
  administrator_login          = "mradministrator"
  administrator_login_password = "thisIsDog11"
