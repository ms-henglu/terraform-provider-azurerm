...
locals {
  number            = "220506015657138992"
  location          = "West Europe"
  domain_name_label = "acctestvm-ishw0"
  random_string     = "ishw0"
  admin_username    = "testadmin220506015657138992"
  admin_password    = "Password1234!220506015657138992"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220506015657138992"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220506015657138992"
  ...
  identifier {
    publisher = "AccTesPublisher220506015657138992"
    offer     = "AccTesOffer220506015657138992"
    sku       = "AccTesSku220506015657138992"
  }
}
