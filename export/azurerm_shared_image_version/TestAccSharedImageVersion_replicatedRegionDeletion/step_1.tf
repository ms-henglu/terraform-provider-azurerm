...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105063504074907"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105063504074907"
  ...
  identifier {
    publisher = "AccTesPublisher240105063504074907"
    offer     = "AccTesOffer240105063504074907"
    sku       = "AccTesSku240105063504074907"
  }
}
