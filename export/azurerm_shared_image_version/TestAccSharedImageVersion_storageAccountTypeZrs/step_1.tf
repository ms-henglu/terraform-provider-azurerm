...
locals {
  number            = "240315122550009638"
  location          = "West Europe"
  domain_name_label = "acctestvm-rwk9f"
  random_string     = "rwk9f"
  admin_username    = "testadmin240315122550009638"
  admin_password    = "Password1234!240315122550009638"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240315122550009638"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240315122550009638"
  ...
  identifier {
    publisher = "AccTesPublisher240315122550009638"
    offer     = "AccTesOffer240315122550009638"
    sku       = "AccTesSku240315122550009638"
  }
}
