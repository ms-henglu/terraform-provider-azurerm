...
locals {
  number            = "230915023108514100"
  location          = "West Europe"
  domain_name_label = "acctestvm-4ea1s"
  random_string     = "4ea1s"
  admin_username    = "testadmin230915023108514100"
  admin_password    = "Password1234!230915023108514100"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230915023108514100"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230915023108514100"
  ...
  identifier {
    publisher = "AccTesPublisher230915023108514100"
    offer     = "AccTesOffer230915023108514100"
    sku       = "AccTesSku230915023108514100"
  }
}
