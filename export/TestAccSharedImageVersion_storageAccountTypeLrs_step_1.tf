...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211001020609163303"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211001020609163303"
  ...
  identifier {
    publisher = "AccTesPublisher211001020609163303"
    offer     = "AccTesOffer211001020609163303"
    sku       = "AccTesSku211001020609163303"
  }
}
