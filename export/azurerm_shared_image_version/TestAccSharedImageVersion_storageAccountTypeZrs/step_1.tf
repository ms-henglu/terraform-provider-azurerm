...
locals {
  number            = "230120054357240754"
  location          = "West Europe"
  domain_name_label = "acctestvm-x21u4"
  random_string     = "x21u4"
  admin_username    = "testadmin230120054357240754"
  admin_password    = "Password1234!230120054357240754"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230120054357240754"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230120054357240754"
  ...
  identifier {
    publisher = "AccTesPublisher230120054357240754"
    offer     = "AccTesOffer230120054357240754"
    sku       = "AccTesSku230120054357240754"
  }
}
