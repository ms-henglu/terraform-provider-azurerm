...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627130916063391"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627130916063391"
  ...
  identifier {
    publisher = "AccTesPublisher220627130916063391"
    offer     = "AccTesOffer220627130916063391"
    sku       = "AccTesSku220627130916063391"
  }
}
