...
locals {
  number            = "221021033910590176"
  location          = "West Europe"
  domain_name_label = "acctestvm-xrzue"
  random_string     = "xrzue"
  admin_username    = "testadmin221021033910590176"
  admin_password    = "Password1234!221021033910590176"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221021033910590176"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221021033910590176"
  ...
  identifier {
    publisher = "AccTesPublisher221021033910590176"
    offer     = "AccTesOffer221021033910590176"
    sku       = "AccTesSku221021033910590176"
  }
}
