...
locals {
  number            = "220506015657130501"
  location          = "West Europe"
  domain_name_label = "acctestvm-mt8z6"
  random_string     = "mt8z6"
  admin_username    = "testadmin220506015657130501"
  admin_password    = "Password1234!220506015657130501"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220506015657130501"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220506015657130501"
  ...
  identifier {
    publisher = "AccTesPublisher220506015657130501"
    offer     = "AccTesOffer220506015657130501"
    sku       = "AccTesSku220506015657130501"
  }
}
