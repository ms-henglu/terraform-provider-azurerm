...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220128082215749168"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220128082215749168"
  ...
  identifier {
    publisher = "AccTesPublisher220128082215749168"
    offer     = "AccTesOffer220128082215749168"
    sku       = "AccTesSku220128082215749168"
  }
}
