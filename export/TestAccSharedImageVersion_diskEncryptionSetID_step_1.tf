...
locals {
  number            = "220726014613805263"
  location          = "West Europe"
  domain_name_label = "acctestvm-gdvfj"
  random_string     = "gdvfj"
  admin_username    = "testadmin220726014613805263"
  admin_password    = "Password1234!220726014613805263"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220726014613805263"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220726014613805263"
  ...
  identifier {
    publisher = "AccTesPublisher220726014613805263"
    offer     = "AccTesOffer220726014613805263"
    sku       = "AccTesSku220726014613805263"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220726014613805263"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
