...
locals {
  number            = "240112034043035652"
  location          = "West Europe"
  domain_name_label = "acctestvm-s6d03"
  random_string     = "s6d03"
  admin_username    = "testadmin240112034043035652"
  admin_password    = "Password1234!240112034043035652"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240112034043035652"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240112034043035652"
  ...
  identifier {
    publisher = "AccTesPublisher240112034043035652"
    offer     = "AccTesOffer240112034043035652"
    sku       = "AccTesSku240112034043035652"
  }
}
