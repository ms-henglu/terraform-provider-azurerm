...
locals {
  number            = "211001223759412593"
  location          = "West Europe"
  domain_name_label = "acctestvm-4iszc"
  random_string     = "4iszc"
  admin_username    = "testadmin211001223759412593"
  admin_password    = "Password1234!211001223759412593"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211001223759412593"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211001223759412593"
  ...
  identifier {
    publisher = "AccTesPublisher211001223759412593"
    offer     = "AccTesOffer211001223759412593"
    sku       = "AccTesSku211001223759412593"
  }
}
