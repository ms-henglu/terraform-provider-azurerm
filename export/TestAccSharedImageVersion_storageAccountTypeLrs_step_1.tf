...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825031517186303"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825031517186303"
  ...
  identifier {
    publisher = "AccTesPublisher210825031517186303"
    offer     = "AccTesOffer210825031517186303"
    sku       = "AccTesSku210825031517186303"
  }
}
