...
locals {
  number            = "230728025312832098"
  location          = "West Europe"
  domain_name_label = "acctestvm-2eemp"
  random_string     = "2eemp"
  admin_username    = "testadmin230728025312832098"
  admin_password    = "Password1234!230728025312832098"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230728025312832098"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230728025312832098"
  ...
  identifier {
    publisher = "AccTesPublisher230728025312832098"
    offer     = "AccTesOffer230728025312832098"
    sku       = "AccTesSku230728025312832098"
  }
}
