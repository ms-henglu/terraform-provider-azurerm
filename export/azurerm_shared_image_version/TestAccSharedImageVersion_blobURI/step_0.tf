...
locals {
  number            = "230428045412225947"
  location          = "West Europe"
  domain_name_label = "acctestvm-jf3sc"
  random_string     = "jf3sc"
  admin_username    = "testadmin230428045412225947"
  admin_password    = "Password1234!230428045412225947"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230428045412225947"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230428045412225947"
  ...
  identifier {
    publisher = "AccTesPublisher230428045412225947"
    offer     = "AccTesOffer230428045412225947"
    sku       = "AccTesSku230428045412225947"
  }
}
