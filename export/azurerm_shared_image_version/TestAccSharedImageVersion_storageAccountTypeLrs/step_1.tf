...
locals {
  number            = "230414020945145315"
  location          = "West Europe"
  domain_name_label = "acctestvm-bm2gk"
  random_string     = "bm2gk"
  admin_username    = "testadmin230414020945145315"
  admin_password    = "Password1234!230414020945145315"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230414020945145315"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230414020945145315"
  ...
  identifier {
    publisher = "AccTesPublisher230414020945145315"
    offer     = "AccTesOffer230414020945145315"
    sku       = "AccTesSku230414020945145315"
  }
}
