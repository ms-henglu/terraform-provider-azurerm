...
locals {
  number            = "240119021734536970"
  location          = "West Europe"
  domain_name_label = "acctestvm-nmfmo"
  random_string     = "nmfmo"
  admin_username    = "testadmin240119021734536970"
  admin_password    = "Password1234!240119021734536970"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240119021734536970"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240119021734536970"
  ...
  identifier {
    publisher = "AccTesPublisher240119021734536970"
    offer     = "AccTesOffer240119021734536970"
    sku       = "AccTesSku240119021734536970"
  }
}
