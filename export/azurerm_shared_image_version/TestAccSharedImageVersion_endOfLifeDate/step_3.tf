...
locals {
  number            = "230127045135671236"
  location          = "West Europe"
  domain_name_label = "acctestvm-ynjik"
  random_string     = "ynjik"
  admin_username    = "testadmin230127045135671236"
  admin_password    = "Password1234!230127045135671236"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230127045135671236"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230127045135671236"
  ...
  identifier {
    publisher = "AccTesPublisher230127045135671236"
    offer     = "AccTesOffer230127045135671236"
    sku       = "AccTesSku230127045135671236"
  }
}
