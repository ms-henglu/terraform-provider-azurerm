...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220326010253721485"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220326010253721485"
  ...
  identifier {
    publisher = "AccTesPublisher220326010253721485"
    offer     = "AccTesOffer220326010253721485"
    sku       = "AccTesSku220326010253721485"
  }
}
