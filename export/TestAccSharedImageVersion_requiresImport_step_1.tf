...
locals {
  number            = "220909034011278869"
  location          = "West Europe"
  domain_name_label = "acctestvm-jnctj"
  random_string     = "jnctj"
  admin_username    = "testadmin220909034011278869"
  admin_password    = "Password1234!220909034011278869"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220909034011278869"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220909034011278869"
  ...
  identifier {
    publisher = "AccTesPublisher220909034011278869"
    offer     = "AccTesOffer220909034011278869"
    sku       = "AccTesSku220909034011278869"
  }
}
