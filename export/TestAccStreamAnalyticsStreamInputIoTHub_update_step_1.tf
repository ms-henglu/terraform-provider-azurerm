...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-211022002541548279"
  location = "West Europe"
}

resource "azurerm_iothub" "test" {
  name                = "acctestiothub-211022002541548279"
...
resource "azurerm_stream_analytics_job" "test" {
  name                                     = "acctestjob-211022002541548279"
  resource_group_name                      = azurerm_resource_group.test.name
  location                                 = azurerm_resource_group.test.location
...
resource "azurerm_iothub" "updated" {
  name                = "acctestiot2-211022002541548279"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_stream_analytics_stream_input_iothub" "test" {
  name                         = "acctestinput-211022002541548279"
