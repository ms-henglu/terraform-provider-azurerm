...
locals {
  number            = "230728031950561112"
  location          = "West Europe"
  domain_name_label = "acctestvm-r7fzc"
  random_string     = "r7fzc"
  admin_username    = "testadmin230728031950561112"
  admin_password    = "Password1234!230728031950561112"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230728031950561112"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230728031950561112"
  ...
  identifier {
    publisher = "AccTesPublisher230728031950561112"
    offer     = "AccTesOffer230728031950561112"
    sku       = "AccTesSku230728031950561112"
  }
}
