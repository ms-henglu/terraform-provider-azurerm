...
locals {
  rg_name              = "acctest-nested-rg-230519075501495079"
  location             = "West Europe"
  vn_name              = "acctest-nested-vn-230519075501495079"
  ip_name              = "acctest-nested-ip-230519075501495079"
  vm_name              = "acctest-nested-vm-230519075501495079"
  nic_name             = "acctest-nested-nic-230519075501495079"
  disk_name            = "acctest-nested-disk-230519075501495079"
  keyvault_name        = "acctkv230519075501495079"
  nsg_name             = "acctest-nested-nsg-230519075501495079"
  recovery_vault_name  = "acctest-nested-recovery-vault-230519075501495079"
  recovery_site_name   = "acctest-nested-recovery-site-230519075501495079"
  admin_name           = "acctestadmin"
  cert_name            = "acctestcert"
  storage_account_name = "acctestsaopdsb"
}
...
resource "azurerm_windows_virtual_machine" "host" {
  ...
  additional_unattend_content {
    setting = "AutoLogon"
    content = "<AutoLogon><Password><Value>#4)^d(i(yR</Value></Password><Enabled>true</Enabled><LogonCount>1</LogonCount><Username>${local.admin_name}</Username></AutoLogon>"
  }
...
resource "azurerm_site_recovery_hyperv_replication_policy" "test" {
  recovery_vault_id                                  = azurerm_recovery_services_vault.test.id
  name                                               = "acctest-policy-230519075501495079"
