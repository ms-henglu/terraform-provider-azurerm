...
locals {
  number            = "230929064556876708"
  location          = "West Europe"
  domain_name_label = "acctestvm-2twmi"
  random_string     = "2twmi"
  admin_username    = "testadmin230929064556876708"
  admin_password    = "Password1234!230929064556876708"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230929064556876708"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230929064556876708"
  ...
  identifier {
    publisher = "AccTesPublisher230929064556876708"
    offer     = "AccTesOffer230929064556876708"
    sku       = "AccTesSku230929064556876708"
  }
}
