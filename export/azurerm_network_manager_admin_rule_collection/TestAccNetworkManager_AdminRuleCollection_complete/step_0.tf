...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-network-manager-230630033653878759"
...
resource "azurerm_network_manager" "test" {
  name                = "acctest-nm-230630033653878759"
