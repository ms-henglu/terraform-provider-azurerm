...
locals {
  number            = "221019060412964359"
  location          = "West Europe"
  domain_name_label = "acctestvm-4up8x"
  random_string     = "4up8x"
  admin_username    = "testadmin221019060412964359"
  admin_password    = "Password1234!221019060412964359"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221019060412964359"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221019060412964359"
  ...
  identifier {
    publisher = "AccTesPublisher221019060412964359"
    offer     = "AccTesOffer221019060412964359"
    sku       = "AccTesSku221019060412964359"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-221019060412964359"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
