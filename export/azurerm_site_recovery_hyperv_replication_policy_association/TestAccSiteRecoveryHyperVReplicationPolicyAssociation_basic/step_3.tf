...
locals {
  rg_name              = "acctest-nested-rg-230818024650068057"
  location             = "West Europe"
  vn_name              = "acctest-nested-vn-230818024650068057"
  ip_name              = "acctest-nested-ip-230818024650068057"
  vm_name              = "acctest-nested-vm-230818024650068057"
  nic_name             = "acctest-nested-nic-230818024650068057"
  disk_name            = "acctest-nested-disk-230818024650068057"
  keyvault_name        = "acctkv230818024650068057"
  nsg_name             = "acctest-nested-nsg-230818024650068057"
  recovery_vault_name  = "acctest-nested-recovery-vault-230818024650068057"
  recovery_site_name   = "acctest-nested-recovery-site-230818024650068057"
  admin_name           = "acctestadmin"
  cert_name            = "acctestcert"
  storage_account_name = "acctestsaqzmp7"
}
...
resource "azurerm_windows_virtual_machine" "host" {
  ...
  additional_unattend_content {
    setting = "AutoLogon"
    content = "<AutoLogon><Password><Value>3p)4oCGVq%</Value></Password><Enabled>true</Enabled><LogonCount>1</LogonCount><Username>${local.admin_name}</Username></AutoLogon>"
  }
...
resource "azurerm_site_recovery_hyperv_replication_policy" "test" {
  recovery_vault_id                                  = azurerm_recovery_services_vault.test.id
  name                                               = "acctest-policy-230818024650068057"
