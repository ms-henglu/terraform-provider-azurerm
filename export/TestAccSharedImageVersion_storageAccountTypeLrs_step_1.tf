...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220121044320001138"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220121044320001138"
  ...
  identifier {
    publisher = "AccTesPublisher220121044320001138"
    offer     = "AccTesOffer220121044320001138"
    sku       = "AccTesSku220121044320001138"
  }
}
