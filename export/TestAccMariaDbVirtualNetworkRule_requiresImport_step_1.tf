...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220124125341051151"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvnet220124125341051151"
...
resource "azurerm_subnet" "test" {
  name                 = "acctestsubnet220124125341051151"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_mariadb_server" "test" {
  name                         = "acctestmariadbsvr-220124125341051151"
  location                     = azurerm_resource_group.test.location
  resource_group_name          = azurerm_resource_group.test.name
...
resource "azurerm_mariadb_virtual_network_rule" "test" {
  name                = "acctestmariadbvnetrule220124125341051151"
  resource_group_name = azurerm_resource_group.test.name
