...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210924004029438704"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210924004029438704"
  ...
  identifier {
    publisher = "AccTesPublisher210924004029438704"
    offer     = "AccTesOffer210924004029438704"
    sku       = "AccTesSku210924004029438704"
  }
}
