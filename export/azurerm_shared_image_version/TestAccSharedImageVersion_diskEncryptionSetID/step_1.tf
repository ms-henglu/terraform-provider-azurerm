...
locals {
  number            = "240105063504064014"
  location          = "West Europe"
  domain_name_label = "acctestvm-gs8se"
  random_string     = "gs8se"
  admin_username    = "testadmin240105063504064014"
  admin_password    = "Password1234!240105063504064014"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105063504064014"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105063504064014"
  ...
  identifier {
    publisher = "AccTesPublisher240105063504064014"
    offer     = "AccTesOffer240105063504064014"
    sku       = "AccTesSku240105063504064014"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-240105063504064014"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
