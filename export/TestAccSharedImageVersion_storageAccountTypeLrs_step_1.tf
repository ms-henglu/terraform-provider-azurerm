...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220513180038358534"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220513180038358534"
  ...
  identifier {
    publisher = "AccTesPublisher220513180038358534"
    offer     = "AccTesOffer220513180038358534"
    sku       = "AccTesSku220513180038358534"
  }
}
