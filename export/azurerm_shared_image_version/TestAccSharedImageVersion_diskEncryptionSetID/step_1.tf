...
locals {
  number            = "230602030259354972"
  location          = "West Europe"
  domain_name_label = "acctestvm-uamyd"
  random_string     = "uamyd"
  admin_username    = "testadmin230602030259354972"
  admin_password    = "Password1234!230602030259354972"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230602030259354972"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230602030259354972"
  ...
  identifier {
    publisher = "AccTesPublisher230602030259354972"
    offer     = "AccTesOffer230602030259354972"
    sku       = "AccTesSku230602030259354972"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230602030259354972"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
