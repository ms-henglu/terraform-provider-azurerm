...
locals {
  number            = "220715004235782810"
  location          = "West Europe"
  domain_name_label = "acctestvm-ruzq6"
  random_string     = "ruzq6"
  admin_username    = "testadmin220715004235782810"
  admin_password    = "Password1234!220715004235782810"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220715004235782810"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220715004235782810"
  ...
  identifier {
    publisher = "AccTesPublisher220715004235782810"
    offer     = "AccTesOffer220715004235782810"
    sku       = "AccTesSku220715004235782810"
  }
}
