...
locals {
  number            = "220324163104846698"
  location          = "West Europe"
  domain_name_label = "acctestvm-6jtki"
  random_string     = "6jtki"
  admin_username    = "testadmin220324163104846698"
  admin_password    = "Password1234!220324163104846698"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220324163104846698"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220324163104846698"
  ...
  identifier {
    publisher = "AccTesPublisher220324163104846698"
    offer     = "AccTesOffer220324163104846698"
    sku       = "AccTesSku220324163104846698"
  }
}
