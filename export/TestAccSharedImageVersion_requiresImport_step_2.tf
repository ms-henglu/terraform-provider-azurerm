...
locals {
  number            = "220513023023745648"
  location          = "West Europe"
  domain_name_label = "acctestvm-fbpox"
  random_string     = "fbpox"
  admin_username    = "testadmin220513023023745648"
  admin_password    = "Password1234!220513023023745648"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220513023023745648"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220513023023745648"
  ...
  identifier {
    publisher = "AccTesPublisher220513023023745648"
    offer     = "AccTesOffer220513023023745648"
    sku       = "AccTesSku220513023023745648"
  }
}
