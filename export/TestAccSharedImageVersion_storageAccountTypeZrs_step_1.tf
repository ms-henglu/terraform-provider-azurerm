...
locals {
  number            = "220311042149584736"
  location          = "West Europe"
  domain_name_label = "acctestvm-9xbd8"
  random_string     = "9xbd8"
  admin_username    = "testadmin220311042149584736"
  admin_password    = "Password1234!220311042149584736"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220311042149584736"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220311042149584736"
  ...
  identifier {
    publisher = "AccTesPublisher220311042149584736"
    offer     = "AccTesOffer220311042149584736"
    sku       = "AccTesSku220311042149584736"
  }
}
