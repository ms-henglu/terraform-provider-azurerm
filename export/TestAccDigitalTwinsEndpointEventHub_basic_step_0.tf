...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-dtwin-210825042821983599"
  location = "West Europe"
}


resource "azurerm_digital_twins_instance" "test" {
  name                = "acctest-DT-210825042821983599"
...
resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhubnamespace-210825042821983599"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_eventhub" "test" {
  name                = "acctesteventhub-210825042821983599"
...
resource "azurerm_eventhub_authorization_rule" "test" {
  name                = "acctest-r210825042821983599"
  namespace_name      = azurerm_eventhub_namespace.test.name
...
resource "azurerm_digital_twins_endpoint_eventhub" "test" {
  name                                 = "acctest-EH-210825042821983599"
