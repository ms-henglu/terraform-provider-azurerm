...
locals {
  number            = "230106031234908406"
  location          = "West Europe"
  domain_name_label = "acctestvm-qtfzp"
  random_string     = "qtfzp"
  admin_username    = "testadmin230106031234908406"
  admin_password    = "Password1234!230106031234908406"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230106031234908406"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230106031234908406"
  ...
  identifier {
    publisher = "AccTesPublisher230106031234908406"
    offer     = "AccTesOffer230106031234908406"
    sku       = "AccTesSku230106031234908406"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230106031234908406"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
