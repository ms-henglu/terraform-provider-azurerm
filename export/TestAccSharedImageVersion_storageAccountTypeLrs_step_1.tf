...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220712042046048368"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220712042046048368"
  ...
  identifier {
    publisher = "AccTesPublisher220712042046048368"
    offer     = "AccTesOffer220712042046048368"
    sku       = "AccTesSku220712042046048368"
  }
}
