...
locals {
  number            = "240105063504074845"
  location          = "West Europe"
  domain_name_label = "acctestvm-88x3o"
  random_string     = "88x3o"
  admin_username    = "testadmin240105063504074845"
  admin_password    = "Password1234!240105063504074845"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105063504074845"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105063504074845"
  ...
  identifier {
    publisher = "AccTesPublisher240105063504074845"
    offer     = "AccTesOffer240105063504074845"
    sku       = "AccTesSku240105063504074845"
  }
}
