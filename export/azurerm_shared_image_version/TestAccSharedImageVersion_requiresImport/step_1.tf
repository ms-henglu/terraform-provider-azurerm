...
locals {
  number            = "221222034403204455"
  location          = "West Europe"
  domain_name_label = "acctestvm-fe1ax"
  random_string     = "fe1ax"
  admin_username    = "testadmin221222034403204455"
  admin_password    = "Password1234!221222034403204455"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221222034403204455"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221222034403204455"
  ...
  identifier {
    publisher = "AccTesPublisher221222034403204455"
    offer     = "AccTesOffer221222034403204455"
    sku       = "AccTesSku221222034403204455"
  }
}
