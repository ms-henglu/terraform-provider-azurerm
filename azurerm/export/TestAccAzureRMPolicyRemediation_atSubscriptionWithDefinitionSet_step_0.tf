...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-wjh2n"
  policy_type  = "Custom"
  display_name = "testPolicySet-wjh2n"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-wjh2n"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-wjh2n"
