...
locals {
  number            = "220819165017102104"
  location          = "West Europe"
  domain_name_label = "acctestvm-4hw1r"
  random_string     = "4hw1r"
  admin_username    = "testadmin220819165017102104"
  admin_password    = "Password1234!220819165017102104"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220819165017102104"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220819165017102104"
  ...
  identifier {
    publisher = "AccTesPublisher220819165017102104"
    offer     = "AccTesOffer220819165017102104"
    sku       = "AccTesSku220819165017102104"
  }
}
