...
locals {
  number            = "230609091011716590"
  location          = "West Europe"
  domain_name_label = "acctestvm-jqbwr"
  random_string     = "jqbwr"
  admin_username    = "testadmin230609091011716590"
  admin_password    = "Password1234!230609091011716590"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230609091011716590"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230609091011716590"
  ...
  identifier {
    publisher = "AccTesPublisher230609091011716590"
    offer     = "AccTesOffer230609091011716590"
    sku       = "AccTesSku230609091011716590"
  }
}
