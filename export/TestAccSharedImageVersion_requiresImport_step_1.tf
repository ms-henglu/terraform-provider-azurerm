...
locals {
  number            = "220826002453905646"
  location          = "West Europe"
  domain_name_label = "acctestvm-j6g8p"
  random_string     = "j6g8p"
  admin_username    = "testadmin220826002453905646"
  admin_password    = "Password1234!220826002453905646"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220826002453905646"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220826002453905646"
  ...
  identifier {
    publisher = "AccTesPublisher220826002453905646"
    offer     = "AccTesOffer220826002453905646"
    sku       = "AccTesSku220826002453905646"
  }
}
