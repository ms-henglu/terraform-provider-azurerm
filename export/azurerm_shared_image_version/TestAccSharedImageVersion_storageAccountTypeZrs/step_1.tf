...
locals {
  number            = "230630032848833309"
  location          = "West Europe"
  domain_name_label = "acctestvm-46azq"
  random_string     = "46azq"
  admin_username    = "testadmin230630032848833309"
  admin_password    = "Password1234!230630032848833309"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230630032848833309"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230630032848833309"
  ...
  identifier {
    publisher = "AccTesPublisher230630032848833309"
    offer     = "AccTesOffer230630032848833309"
    sku       = "AccTesSku230630032848833309"
  }
}
