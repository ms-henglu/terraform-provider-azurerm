...
locals {
  number            = "211001020609178642"
  location          = "West Europe"
  domain_name_label = "acctestvm-n2y27"
  random_string     = "n2y27"
  admin_username    = "testadmin211001020609178642"
  admin_password    = "Password1234!211001020609178642"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211001020609178642"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211001020609178642"
  ...
  identifier {
    publisher = "AccTesPublisher211001020609178642"
    offer     = "AccTesOffer211001020609178642"
    sku       = "AccTesSku211001020609178642"
  }
}
