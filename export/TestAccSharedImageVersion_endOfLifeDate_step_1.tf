...
locals {
  number            = "220726001659728896"
  location          = "West Europe"
  domain_name_label = "acctestvm-vv4rc"
  random_string     = "vv4rc"
  admin_username    = "testadmin220726001659728896"
  admin_password    = "Password1234!220726001659728896"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220726001659728896"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220726001659728896"
  ...
  identifier {
    publisher = "AccTesPublisher220726001659728896"
    offer     = "AccTesOffer220726001659728896"
    sku       = "AccTesSku220726001659728896"
  }
}
...
resource "azurerm_shared_image_version" "test" {
  ...
  end_of_life_date    = "2022-07-26T10:16:59Z"
