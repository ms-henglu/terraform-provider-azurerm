...
locals {
  number            = "221124181402019750"
  location          = "West Europe"
  domain_name_label = "acctestvm-ty820"
  random_string     = "ty820"
  admin_username    = "testadmin221124181402019750"
  admin_password    = "Password1234!221124181402019750"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221124181402019750"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221124181402019750"
  ...
  identifier {
    publisher = "AccTesPublisher221124181402019750"
    offer     = "AccTesOffer221124181402019750"
    sku       = "AccTesSku221124181402019750"
  }
}
