...
locals {
  number            = "230810143140388253"
  location          = "West Europe"
  domain_name_label = "acctestvm-vgtwe"
  random_string     = "vgtwe"
  admin_username    = "testadmin230810143140388253"
  admin_password    = "Password1234!230810143140388253"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230810143140388253"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230810143140388253"
  ...
  identifier {
    publisher = "AccTesPublisher230810143140388253"
    offer     = "AccTesOffer230810143140388253"
    sku       = "AccTesSku230810143140388253"
  }
}
