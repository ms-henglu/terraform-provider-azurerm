...
locals {
  number            = "220225034148139546"
  location          = "West Europe"
  domain_name_label = "acctestvm-3nq3k"
  random_string     = "3nq3k"
  admin_username    = "testadmin220225034148139546"
  admin_password    = "Password1234!220225034148139546"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220225034148139546"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220225034148139546"
  ...
  identifier {
    publisher = "AccTesPublisher220225034148139546"
    offer     = "AccTesOffer220225034148139546"
    sku       = "AccTesSku220225034148139546"
  }
}
