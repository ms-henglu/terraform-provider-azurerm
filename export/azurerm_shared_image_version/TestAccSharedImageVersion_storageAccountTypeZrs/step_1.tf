...
locals {
  number            = "221021030948781408"
  location          = "West Europe"
  domain_name_label = "acctestvm-9qdyz"
  random_string     = "9qdyz"
  admin_username    = "testadmin221021030948781408"
  admin_password    = "Password1234!221021030948781408"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221021030948781408"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221021030948781408"
  ...
  identifier {
    publisher = "AccTesPublisher221021030948781408"
    offer     = "AccTesOffer221021030948781408"
    sku       = "AccTesSku221021030948781408"
  }
}
