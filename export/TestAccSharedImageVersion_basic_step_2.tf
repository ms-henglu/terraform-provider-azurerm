...
locals {
  number            = "220610022336709473"
  location          = "West Europe"
  domain_name_label = "acctestvm-304eq"
  random_string     = "304eq"
  admin_username    = "testadmin220610022336709473"
  admin_password    = "Password1234!220610022336709473"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220610022336709473"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220610022336709473"
  ...
  identifier {
    publisher = "AccTesPublisher220610022336709473"
    offer     = "AccTesOffer220610022336709473"
    sku       = "AccTesSku220610022336709473"
  }
}
