...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220506005527651467"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220506005527651467"
  ...
  identifier {
    publisher = "AccTesPublisher220506005527651467"
    offer     = "AccTesOffer220506005527651467"
    sku       = "AccTesSku220506005527651467"
  }
}
