...
locals {
  number            = "220408051032002149"
  location          = "West Europe"
  domain_name_label = "acctestvm-fytzs"
  random_string     = "fytzs"
  admin_username    = "testadmin220408051032002149"
  admin_password    = "Password1234!220408051032002149"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220408051032002149"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220408051032002149"
  ...
  identifier {
    publisher = "AccTesPublisher220408051032002149"
    offer     = "AccTesOffer220408051032002149"
    sku       = "AccTesSku220408051032002149"
  }
}
