...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220722051724577556"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220722051724577556"
  ...
  identifier {
    publisher = "AccTesPublisher220722051724577556"
    offer     = "AccTesOffer220722051724577556"
    sku       = "AccTesSku220722051724577556"
  }
}
