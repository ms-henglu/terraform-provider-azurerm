...
locals {
  number            = "221221204056163396"
  location          = "West Europe"
  domain_name_label = "acctestvm-jad4j"
  random_string     = "jad4j"
  admin_username    = "testadmin221221204056163396"
  admin_password    = "Password1234!221221204056163396"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221221204056163396"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221221204056163396"
  ...
  identifier {
    publisher = "AccTesPublisher221221204056163396"
    offer     = "AccTesOffer221221204056163396"
    sku       = "AccTesSku221221204056163396"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-221221204056163396"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
