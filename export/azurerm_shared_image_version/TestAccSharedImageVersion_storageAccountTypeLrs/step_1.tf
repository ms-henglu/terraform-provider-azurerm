...
locals {
  number            = "230519074408708044"
  location          = "West Europe"
  domain_name_label = "acctestvm-vhzmi"
  random_string     = "vhzmi"
  admin_username    = "testadmin230519074408708044"
  admin_password    = "Password1234!230519074408708044"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230519074408708044"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230519074408708044"
  ...
  identifier {
    publisher = "AccTesPublisher230519074408708044"
    offer     = "AccTesOffer230519074408708044"
    sku       = "AccTesSku230519074408708044"
  }
}
