...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825042656060795"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825042656060795"
  ...
  identifier {
    publisher = "AccTesPublisher210825042656060795"
    offer     = "AccTesOffer210825042656060795"
    sku       = "AccTesSku210825042656060795"
  }
}
