...
locals {
  number            = "211008044203072822"
  location          = "West Europe"
  domain_name_label = "acctestvm-j3ig9"
  random_string     = "j3ig9"
  admin_username    = "testadmin211008044203072822"
  admin_password    = "Password1234!211008044203072822"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211008044203072822"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211008044203072822"
  ...
  identifier {
    publisher = "AccTesPublisher211008044203072822"
    offer     = "AccTesOffer211008044203072822"
    sku       = "AccTesSku211008044203072822"
  }
}
