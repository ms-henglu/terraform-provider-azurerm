...
locals {
  number            = "230313020903884566"
  location          = "West Europe"
  domain_name_label = "acctestvm-e10qg"
  random_string     = "e10qg"
  admin_username    = "testadmin230313020903884566"
  admin_password    = "Password1234!230313020903884566"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230313020903884566"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230313020903884566"
  ...
  identifier {
    publisher = "AccTesPublisher230313020903884566"
    offer     = "AccTesOffer230313020903884566"
    sku       = "AccTesSku230313020903884566"
  }
}
