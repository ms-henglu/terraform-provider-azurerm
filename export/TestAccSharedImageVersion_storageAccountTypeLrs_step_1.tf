...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220811053013426136"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220811053013426136"
  ...
  identifier {
    publisher = "AccTesPublisher220811053013426136"
    offer     = "AccTesOffer220811053013426136"
    sku       = "AccTesSku220811053013426136"
  }
}
