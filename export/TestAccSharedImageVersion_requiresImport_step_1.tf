...
locals {
  number            = "211126031012792730"
  location          = "West Europe"
  domain_name_label = "acctestvm-cskb0"
  random_string     = "cskb0"
  admin_username    = "testadmin211126031012792730"
  admin_password    = "Password1234!211126031012792730"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211126031012792730"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211126031012792730"
  ...
  identifier {
    publisher = "AccTesPublisher211126031012792730"
    offer     = "AccTesOffer211126031012792730"
    sku       = "AccTesSku211126031012792730"
  }
}
