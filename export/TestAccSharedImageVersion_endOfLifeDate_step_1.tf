...
locals {
  number            = "221019054023430673"
  location          = "West Europe"
  domain_name_label = "acctestvm-s89cu"
  random_string     = "s89cu"
  admin_username    = "testadmin221019054023430673"
  admin_password    = "Password1234!221019054023430673"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221019054023430673"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221019054023430673"
  ...
  identifier {
    publisher = "AccTesPublisher221019054023430673"
    offer     = "AccTesOffer221019054023430673"
    sku       = "AccTesSku221019054023430673"
  }
}
...
resource "azurerm_shared_image_version" "test" {
  ...
  end_of_life_date    = "2022-10-19T15:40:23Z"
