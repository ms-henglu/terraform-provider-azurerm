...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220520053718278151"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220520053718278151"
  ...
  identifier {
    publisher = "AccTesPublisher220520053718278151"
    offer     = "AccTesOffer220520053718278151"
    sku       = "AccTesSku220520053718278151"
  }
}
