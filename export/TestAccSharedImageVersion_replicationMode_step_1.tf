...
locals {
  number            = "220909034011273332"
  location          = "West Europe"
  domain_name_label = "acctestvm-b7b2g"
  random_string     = "b7b2g"
  admin_username    = "testadmin220909034011273332"
  admin_password    = "Password1234!220909034011273332"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220909034011273332"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220909034011273332"
  ...
  identifier {
    publisher = "AccTesPublisher220909034011273332"
    offer     = "AccTesOffer220909034011273332"
    sku       = "AccTesSku220909034011273332"
  }
}
