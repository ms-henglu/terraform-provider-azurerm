...
locals {
  number            = "230227032410658033"
  location          = "West Europe"
  domain_name_label = "acctestvm-vrd6j"
  random_string     = "vrd6j"
  admin_username    = "testadmin230227032410658033"
  admin_password    = "Password1234!230227032410658033"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230227032410658033"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230227032410658033"
  ...
  identifier {
    publisher = "AccTesPublisher230227032410658033"
    offer     = "AccTesOffer230227032410658033"
    sku       = "AccTesSku230227032410658033"
  }
}
