...
locals {
  number            = "211013071641593128"
  location          = "West Europe"
  domain_name_label = "acctestvm-o6kvu"
  random_string     = "o6kvu"
  admin_username    = "testadmin211013071641593128"
  admin_password    = "Password1234!211013071641593128"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211013071641593128"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211013071641593128"
  ...
  identifier {
    publisher = "AccTesPublisher211013071641593128"
    offer     = "AccTesOffer211013071641593128"
    sku       = "AccTesSku211013071641593128"
  }
}
