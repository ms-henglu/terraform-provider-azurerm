...
locals {
  number            = "230825024235242708"
  location          = "West Europe"
  domain_name_label = "acctestvm-g079s"
  random_string     = "g079s"
  admin_username    = "testadmin230825024235242708"
  admin_password    = "Password1234!230825024235242708"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230825024235242708"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230825024235242708"
  ...
  identifier {
    publisher = "AccTesPublisher230825024235242708"
    offer     = "AccTesOffer230825024235242708"
    sku       = "AccTesSku230825024235242708"
  }
}
