...
resource "azurerm_resource_group" "iothub" {
  name     = "acctest-iothub-240311032307927500"
  location = "eastus"
}

resource "azurerm_resource_group" "endpoint" {
  name     = "acctest-iothub-db-240311032307927500"
  location = "eastus"
}

resource "azurerm_cosmosdb_account" "test" {
  name                = "acctest-ca-240311032307927500"
...
resource "azurerm_cosmosdb_sql_database" "test" {
  name                = "acctest-240311032307927500"
