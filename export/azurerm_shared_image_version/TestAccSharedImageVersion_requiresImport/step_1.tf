...
locals {
  number            = "230203063036576814"
  location          = "West Europe"
  domain_name_label = "acctestvm-v937z"
  random_string     = "v937z"
  admin_username    = "testadmin230203063036576814"
  admin_password    = "Password1234!230203063036576814"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230203063036576814"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230203063036576814"
  ...
  identifier {
    publisher = "AccTesPublisher230203063036576814"
    offer     = "AccTesOffer230203063036576814"
    sku       = "AccTesSku230203063036576814"
  }
}
