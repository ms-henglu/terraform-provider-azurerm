...
func (client ManagerCommitsClient) Post(ctx context.Context, parameters ManagerCommit, resourceGroupName string, networkManagerName string) (result autorest.Response, err error) {
...
func (client ManagerCommitsClient) PostResponder(resp *http.Response) (result autorest.Response, err error) {
