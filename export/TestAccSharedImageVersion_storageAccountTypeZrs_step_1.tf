...
locals {
  number            = "220812014802179935"
  location          = "West Europe"
  domain_name_label = "acctestvm-8dlg0"
  random_string     = "8dlg0"
  admin_username    = "testadmin220812014802179935"
  admin_password    = "Password1234!220812014802179935"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220812014802179935"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220812014802179935"
  ...
  identifier {
    publisher = "AccTesPublisher220812014802179935"
    offer     = "AccTesOffer220812014802179935"
    sku       = "AccTesSku220812014802179935"
  }
}
