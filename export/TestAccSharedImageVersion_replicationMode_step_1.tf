...
locals {
  number            = "220712042046043632"
  location          = "West Europe"
  domain_name_label = "acctestvm-dk2rr"
  random_string     = "dk2rr"
  admin_username    = "testadmin220712042046043632"
  admin_password    = "Password1234!220712042046043632"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220712042046043632"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220712042046043632"
  ...
  identifier {
    publisher = "AccTesPublisher220712042046043632"
    offer     = "AccTesOffer220712042046043632"
    sku       = "AccTesSku220712042046043632"
  }
}
