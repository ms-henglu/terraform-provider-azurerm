...
locals {
  number            = "220520053718275457"
  location          = "West Europe"
  domain_name_label = "acctestvm-633co"
  random_string     = "633co"
  admin_username    = "testadmin220520053718275457"
  admin_password    = "Password1234!220520053718275457"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220520053718275457"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220520053718275457"
  ...
  identifier {
    publisher = "AccTesPublisher220520053718275457"
    offer     = "AccTesOffer220520053718275457"
    sku       = "AccTesSku220520053718275457"
  }
}
