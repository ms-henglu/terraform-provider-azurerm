...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-psql-220627130126647043"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-VNET-220627130126647043"
...
resource "azurerm_subnet" "test" {
  name                 = "acctest-SN-220627130126647043"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_postgresql_server" "test" {
  name                         = "acctest-psql-server-220627130126647043"
  location                     = azurerm_resource_group.test.location
  resource_group_name          = azurerm_resource_group.test.name
...
resource "azurerm_postgresql_virtual_network_rule" "test" {
  name                = "acctest-PSQL-VNET-rule-220627130126647043"
  resource_group_name = azurerm_resource_group.test.name
