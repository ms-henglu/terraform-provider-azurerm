...
locals {
  number            = "230316221218743644"
  location          = "West Europe"
  domain_name_label = "acctestvm-gu8y1"
  random_string     = "gu8y1"
  admin_username    = "testadmin230316221218743644"
  admin_password    = "Password1234!230316221218743644"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230316221218743644"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230316221218743644"
  ...
  identifier {
    publisher = "AccTesPublisher230316221218743644"
    offer     = "AccTesOffer230316221218743644"
    sku       = "AccTesSku230316221218743644"
  }
}
