...
locals {
  number            = "221222034403201998"
  location          = "West Europe"
  domain_name_label = "acctestvm-m2vci"
  random_string     = "m2vci"
  admin_username    = "testadmin221222034403201998"
  admin_password    = "Password1234!221222034403201998"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221222034403201998"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221222034403201998"
  ...
  identifier {
    publisher = "AccTesPublisher221222034403201998"
    offer     = "AccTesOffer221222034403201998"
    sku       = "AccTesSku221222034403201998"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-221222034403201998"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
