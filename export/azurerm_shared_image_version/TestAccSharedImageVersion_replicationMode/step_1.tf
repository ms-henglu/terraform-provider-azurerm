...
locals {
  number            = "230414020945141328"
  location          = "West Europe"
  domain_name_label = "acctestvm-mvp1h"
  random_string     = "mvp1h"
  admin_username    = "testadmin230414020945141328"
  admin_password    = "Password1234!230414020945141328"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230414020945141328"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230414020945141328"
  ...
  identifier {
    publisher = "AccTesPublisher230414020945141328"
    offer     = "AccTesOffer230414020945141328"
    sku       = "AccTesSku230414020945141328"
  }
}
