...
locals {
  number            = "221028171853894550"
  location          = "West Europe"
  domain_name_label = "acctestvm-ma1tn"
  random_string     = "ma1tn"
  admin_username    = "testadmin221028171853894550"
  admin_password    = "Password1234!221028171853894550"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221028171853894550"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221028171853894550"
  ...
  identifier {
    publisher = "AccTesPublisher221028171853894550"
    offer     = "AccTesOffer221028171853894550"
    sku       = "AccTesSku221028171853894550"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-221028171853894550"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
