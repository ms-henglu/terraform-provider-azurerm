...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-plss-211210035108860439"
  location = "West Europe"
}

resource "azurerm_monitor_private_link_scope" "test" {
  name                = "acctest-pls-211210035108860439"
  resource_group_name = azurerm_resource_group.test.name
}

resource "azurerm_application_insights" "test" {
  name                = "acctest-appinsights-211210035108860439"
...
resource "azurerm_monitor_private_link_scoped_service" "test" {
  name                = "acctest-plss-211210035108860439"
  resource_group_name = azurerm_resource_group.test.name
