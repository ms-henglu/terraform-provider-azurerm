...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-mssql-230818024434512432"
  location = "West Europe"
}

resource "azurerm_storage_account" "test" {
  name                     = "unlikely23exst2acctt2lvb"
...
resource "azurerm_mssql_virtual_machine_group" "test" {
  ...
  wsfc_domain_profile {
    ...
    cluster_bootstrap_account_name = "bootstrapacct2lvb"
    cluster_operator_account_name  = "opacct2lvb"
    sql_service_account_name       = "sqlsrvacct2lvb"
