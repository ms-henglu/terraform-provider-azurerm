...
locals {
  number            = "220630210603395630"
  location          = "West Europe"
  domain_name_label = "acctestvm-mx8ln"
  random_string     = "mx8ln"
  admin_username    = "testadmin220630210603395630"
  admin_password    = "Password1234!220630210603395630"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220630210603395630"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220630210603395630"
  ...
  identifier {
    publisher = "AccTesPublisher220630210603395630"
    offer     = "AccTesOffer220630210603395630"
    sku       = "AccTesSku220630210603395630"
  }
}
