...
locals {
  number            = "230804025626266974"
  location          = "West Europe"
  domain_name_label = "acctestvm-ghk6v"
  random_string     = "ghk6v"
  admin_username    = "testadmin230804025626266974"
  admin_password    = "Password1234!230804025626266974"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230804025626266974"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230804025626266974"
  ...
  identifier {
    publisher = "AccTesPublisher230804025626266974"
    offer     = "AccTesOffer230804025626266974"
    sku       = "AccTesSku230804025626266974"
  }
}
