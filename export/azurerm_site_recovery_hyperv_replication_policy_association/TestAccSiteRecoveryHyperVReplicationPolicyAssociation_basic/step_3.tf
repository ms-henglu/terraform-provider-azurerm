...
locals {
  rg_name              = "acctest-nested-rg-230407023959748508"
  location             = "West Europe"
  vn_name              = "acctest-nested-vn-230407023959748508"
  ip_name              = "acctest-nested-ip-230407023959748508"
  vm_name              = "acctest-nested-vm-230407023959748508"
  nic_name             = "acctest-nested-nic-230407023959748508"
  disk_name            = "acctest-nested-disk-230407023959748508"
  keyvault_name        = "acctkv230407023959748508"
  nsg_name             = "acctest-nested-nsg-230407023959748508"
  recovery_vault_name  = "acctest-nested-recovery-vault-230407023959748508"
  recovery_site_name   = "acctest-nested-recovery-site-230407023959748508"
  admin_name           = "acctestadmin"
  cert_name            = "acctestcert"
  storage_account_name = "acctestsa130ca"
}
...
resource "azurerm_windows_virtual_machine" "host" {
  ...
  additional_unattend_content {
    setting = "AutoLogon"
    content = "<AutoLogon><Password><Value>w7%k475^%^</Value></Password><Enabled>true</Enabled><LogonCount>1</LogonCount><Username>${local.admin_name}</Username></AutoLogon>"
  }
...
resource "azurerm_site_recovery_hyperv_replication_policy" "test" {
  recovery_vault_id                                  = azurerm_recovery_services_vault.test.id
  name                                               = "acctest-policy-230407023959748508"
