...
locals {
  number            = "211210024414741386"
  location          = "West Europe"
  domain_name_label = "acctestvm-p4abg"
  random_string     = "p4abg"
  admin_username    = "testadmin211210024414741386"
  admin_password    = "Password1234!211210024414741386"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211210024414741386"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211210024414741386"
  ...
  identifier {
    publisher = "AccTesPublisher211210024414741386"
    offer     = "AccTesOffer211210024414741386"
    sku       = "AccTesSku211210024414741386"
  }
}
