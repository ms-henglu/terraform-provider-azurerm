...
locals {
  number            = "220715014258875837"
  location          = "West Europe"
  domain_name_label = "acctestvm-lqjx6"
  random_string     = "lqjx6"
  admin_username    = "testadmin220715014258875837"
  admin_password    = "Password1234!220715014258875837"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220715014258875837"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220715014258875837"
  ...
  identifier {
    publisher = "AccTesPublisher220715014258875837"
    offer     = "AccTesOffer220715014258875837"
    sku       = "AccTesSku220715014258875837"
  }
}
