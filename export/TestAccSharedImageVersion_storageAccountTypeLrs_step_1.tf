...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221019054023432653"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221019054023432653"
  ...
  identifier {
    publisher = "AccTesPublisher221019054023432653"
    offer     = "AccTesOffer221019054023432653"
    sku       = "AccTesSku221019054023432653"
  }
}
