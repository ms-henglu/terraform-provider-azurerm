...
locals {
  number            = "230804025626255734"
  location          = "West Europe"
  domain_name_label = "acctestvm-twlzd"
  random_string     = "twlzd"
  admin_username    = "testadmin230804025626255734"
  admin_password    = "Password1234!230804025626255734"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230804025626255734"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230804025626255734"
  ...
  identifier {
    publisher = "AccTesPublisher230804025626255734"
    offer     = "AccTesOffer230804025626255734"
    sku       = "AccTesSku230804025626255734"
  }
}
