...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-210825041248507071"
  location = "West Europe"
}

resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhub-210825041248507071"
  location            = "West Europe"
...
resource "azurerm_eventhub_authorization_rule" "test" {
  name                = "acctest-eventhub-auth-rule-210825041248507071"
  namespace_name      = azurerm_eventhub_namespace.test.name
...
resource "azurerm_security_center_automation" "test" {
  name                = "acctestautomation-210825041248507071"
  location            = "West Europe"
  resource_group_name = azurerm_resource_group.test.name
