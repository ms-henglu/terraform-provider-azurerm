...
locals {
  number            = "220909034011277221"
  location          = "West Europe"
  domain_name_label = "acctestvm-zomsv"
  random_string     = "zomsv"
  admin_username    = "testadmin220909034011277221"
  admin_password    = "Password1234!220909034011277221"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220909034011277221"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220909034011277221"
  ...
  identifier {
    publisher = "AccTesPublisher220909034011277221"
    offer     = "AccTesOffer220909034011277221"
    sku       = "AccTesSku220909034011277221"
  }
}
...
resource "azurerm_shared_image_version" "test" {
  ...
  end_of_life_date    = "2022-09-09T13:40:11Z"
