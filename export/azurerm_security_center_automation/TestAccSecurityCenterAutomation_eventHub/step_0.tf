...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-230407024045112300"
  location = "West Europe"
}

resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhub-230407024045112300"
  location            = "West Europe"
...
resource "azurerm_eventhub_authorization_rule" "test" {
  name                = "acctest-eventhub-auth-rule-230407024045112300"
  namespace_name      = azurerm_eventhub_namespace.test.name
...
resource "azurerm_security_center_automation" "test" {
  name                = "acctestautomation-230407024045112300"
  location            = "West Europe"
  resource_group_name = azurerm_resource_group.test.name
