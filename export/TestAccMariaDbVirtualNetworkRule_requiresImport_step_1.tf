...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220715004645320952"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvnet220715004645320952"
...
resource "azurerm_subnet" "test" {
  name                 = "acctestsubnet220715004645320952"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_mariadb_server" "test" {
  name                         = "acctestmariadbsvr-220715004645320952"
  location                     = azurerm_resource_group.test.location
  resource_group_name          = azurerm_resource_group.test.name
...
resource "azurerm_mariadb_virtual_network_rule" "test" {
  name                = "acctestmariadbvnetrule220715004645320952"
  resource_group_name = azurerm_resource_group.test.name
