...
locals {
  number            = "220818234946133022"
  location          = "West Europe"
  domain_name_label = "acctestvm-mnuyd"
  random_string     = "mnuyd"
  admin_username    = "testadmin220818234946133022"
  admin_password    = "Password1234!220818234946133022"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220818234946133022"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220818234946133022"
  ...
  identifier {
    publisher = "AccTesPublisher220818234946133022"
    offer     = "AccTesOffer220818234946133022"
    sku       = "AccTesSku220818234946133022"
  }
}
