...
locals {
  number            = "211021234811792166"
  location          = "West Europe"
  domain_name_label = "acctestvm-hijgn"
  random_string     = "hijgn"
  admin_username    = "testadmin211021234811792166"
  admin_password    = "Password1234!211021234811792166"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211021234811792166"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211021234811792166"
  ...
  identifier {
    publisher = "AccTesPublisher211021234811792166"
    offer     = "AccTesOffer211021234811792166"
    sku       = "AccTesSku211021234811792166"
  }
}
