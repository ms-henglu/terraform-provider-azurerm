...
locals {
  number            = "230414020945146730"
  location          = "West Europe"
  domain_name_label = "acctestvm-m0wzt"
  random_string     = "m0wzt"
  admin_username    = "testadmin230414020945146730"
  admin_password    = "Password1234!230414020945146730"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230414020945146730"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230414020945146730"
  ...
  identifier {
    publisher = "AccTesPublisher230414020945146730"
    offer     = "AccTesOffer230414020945146730"
    sku       = "AccTesSku230414020945146730"
  }
}
