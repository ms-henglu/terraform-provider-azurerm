...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-230922060636414091"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctest-230922060636414091"
...
resource "azurerm_log_analytics_workspace" "test" {
  name                = "acctestLAW-230922060636414091"
  location            = "west europe"
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "PerGB2018"
...
resource "azurerm_automation_software_update_configuration" "test" {
  ...
  name                  = "acctest-suc-230922060636414091"
  ...
  schedule {
    ...
    start_time         = "2023-09-22T07:07:00Z"
    expiry_time        = "2023-09-22T08:07:00Z"
    is_enabled         = true
    interval           = 2
    frequency          = "Hour"
    time_zone          = "Etc/UTC"
