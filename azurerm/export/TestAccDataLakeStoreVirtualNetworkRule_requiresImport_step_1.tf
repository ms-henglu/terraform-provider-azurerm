...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220627134437915293"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvnet220627134437915293"
...
resource "azurerm_subnet" "test" {
  name                 = "acctestsubnet220627134437915293"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_data_lake_store" "test" {
  name                = "acctestadls06271344379"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_data_lake_store_virtual_network_rule" "test" {
  name                = "acctestadlsvnetrule220627134437915293"
  resource_group_name = azurerm_resource_group.test.name
