...
locals {
  number            = "230613071532229940"
  location          = "West Europe"
  domain_name_label = "acctestvm-gdy1i"
  random_string     = "gdy1i"
  admin_username    = "testadmin230613071532229940"
  admin_password    = "Password1234!230613071532229940"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230613071532229940"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230613071532229940"
  ...
  identifier {
    publisher = "AccTesPublisher230613071532229940"
    offer     = "AccTesOffer230613071532229940"
    sku       = "AccTesSku230613071532229940"
  }
}
