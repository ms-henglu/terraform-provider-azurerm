...
locals {
  number            = "230421021839857380"
  location          = "West Europe"
  domain_name_label = "acctestvm-ywdup"
  random_string     = "ywdup"
  admin_username    = "testadmin230421021839857380"
  admin_password    = "Password1234!230421021839857380"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230421021839857380"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230421021839857380"
  ...
  identifier {
    publisher = "AccTesPublisher230421021839857380"
    offer     = "AccTesOffer230421021839857380"
    sku       = "AccTesSku230421021839857380"
  }
}
