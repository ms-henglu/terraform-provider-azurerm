...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG1-sql-230922061955861915"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet1-230922061955861915"
...
resource "azurerm_subnet" "test" {
  name                 = "subnet1-230922061955861915"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_network_security_group" "test" {
  name                = "mi-security-group1-230922061955861915"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
}
...
resource "azurerm_route_table" "test" {
  name                          = "routetable1-230922061955861915"
  location                      = azurerm_resource_group.test.location
  resource_group_name           = azurerm_resource_group.test.name
...
resource "azurerm_sql_managed_instance" "test" {
  name                         = "acctestsqlserver230922061955861915"
  resource_group_name          = azurerm_resource_group.test.name
  location                     = azurerm_resource_group.test.location
...
resource "azurerm_resource_group" "secondary" {
  name     = "acctestRG2-sql-230922061955861915"
  location = "West US 2"
}

resource "azurerm_virtual_network" "secondary" {
  name                = "acctest-vnet2-230922061955861915"
...
resource "azurerm_subnet" "secondary" {
  name                 = "subnet2-230922061955861915"
  resource_group_name  = azurerm_resource_group.secondary.name
...
resource "azurerm_network_security_group" "secondary" {
  name                = "mi-security-group2-230922061955861915"
  location            = azurerm_resource_group.secondary.location
  resource_group_name = azurerm_resource_group.secondary.name
}
...
resource "azurerm_route_table" "secondary" {
  name                          = "routetable2-230922061955861915"
  location                      = azurerm_resource_group.secondary.location
  resource_group_name           = azurerm_resource_group.secondary.name
  disable_bgp_route_propagation = false
...
resource "azurerm_sql_managed_instance" "secondary" {
  name                         = "acctestsqlserver2230922061955861915"
  resource_group_name          = azurerm_resource_group.secondary.name
  location                     = azurerm_resource_group.secondary.location
  administrator_login          = "mradministrator"
  administrator_login_password = "thisIsDog11"
...
resource "azurerm_public_ip" "test" {
  name                = "acctest-pip-230922061955861915"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network_gateway" "test" {
  name                = "acctest-vnetgway-230922061955861915"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network_gateway_connection" "test" {
  name                = "acctest-gwc-230922061955861915"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_public_ip" "secondary" {
  name                = "acctest-pip2-230922061955861915"
  location            = azurerm_resource_group.secondary.location
  resource_group_name = azurerm_resource_group.secondary.name
  allocation_method   = "Dynamic"
}
...
resource "azurerm_virtual_network_gateway" "secondary" {
  name                = "acctest-vnetgway2-230922061955861915"
  location            = azurerm_resource_group.secondary.location
  resource_group_name = azurerm_resource_group.secondary.name
...
resource "azurerm_virtual_network_gateway_connection" "secondary" {
  name                = "acctest-gwc2-230922061955861915"
  location            = azurerm_resource_group.secondary.location
  resource_group_name = azurerm_resource_group.secondary.name
...
resource "azurerm_sql_managed_instance_failover_group" "test" {
  name                        = "acctest-fog-230922061955861915"
  resource_group_name         = azurerm_resource_group.test.name
