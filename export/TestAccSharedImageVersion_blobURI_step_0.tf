...
locals {
  number            = "220826005646578102"
  location          = "West Europe"
  domain_name_label = "acctestvm-lxchq"
  random_string     = "lxchq"
  admin_username    = "testadmin220826005646578102"
  admin_password    = "Password1234!220826005646578102"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220826005646578102"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220826005646578102"
  ...
  identifier {
    publisher = "AccTesPublisher220826005646578102"
    offer     = "AccTesOffer220826005646578102"
    sku       = "AccTesSku220826005646578102"
  }
}
