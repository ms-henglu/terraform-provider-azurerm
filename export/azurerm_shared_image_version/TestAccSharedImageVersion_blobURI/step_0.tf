...
locals {
  number            = "221104005221351974"
  location          = "West Europe"
  domain_name_label = "acctestvm-w3r6v"
  random_string     = "w3r6v"
  admin_username    = "testadmin221104005221351974"
  admin_password    = "Password1234!221104005221351974"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221104005221351974"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221104005221351974"
  ...
  identifier {
    publisher = "AccTesPublisher221104005221351974"
    offer     = "AccTesOffer221104005221351974"
    sku       = "AccTesSku221104005221351974"
  }
}
