...
locals {
  number            = "220715014258876630"
  location          = "West Europe"
  domain_name_label = "acctestvm-cxwi6"
  random_string     = "cxwi6"
  admin_username    = "testadmin220715014258876630"
  admin_password    = "Password1234!220715014258876630"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220715014258876630"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220715014258876630"
  ...
  identifier {
    publisher = "AccTesPublisher220715014258876630"
    offer     = "AccTesOffer220715014258876630"
    sku       = "AccTesSku220715014258876630"
  }
}
