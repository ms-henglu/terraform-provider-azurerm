...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-i1teh"
  policy_type  = "Custom"
  display_name = "testPolicySet-i1teh"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-i1teh"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-i1teh"
