...
locals {
  number            = "240119024707422274"
  location          = "West Europe"
  domain_name_label = "acctestvm-ybfh0"
  random_string     = "ybfh0"
  admin_username    = "testadmin240119024707422274"
  admin_password    = "Password1234!240119024707422274"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240119024707422274"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240119024707422274"
  ...
  identifier {
    publisher = "AccTesPublisher240119024707422274"
    offer     = "AccTesOffer240119024707422274"
    sku       = "AccTesSku240119024707422274"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-240119024707422274"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
