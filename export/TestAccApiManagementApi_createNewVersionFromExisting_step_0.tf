...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220513175900641627"
  location = "West Europe"
}

resource "azurerm_api_management" "test" {
  name                = "acctestAM-220513175900641627"
...
resource "azurerm_api_management_api" "test" {
  name                = "acctestapi-220513175900641627"
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_api_management_api_version_set" "test" {
  name                = "acctestAMAVS-220513175900641627"
  resource_group_name = azurerm_resource_group.test.name
  api_management_name = azurerm_api_management.test.name
...
resource "azurerm_api_management_api" "version" {
  name                = "acctestVersion-220513175900641627"
  resource_group_name = azurerm_resource_group.test.name
  api_management_name = azurerm_api_management.test.name
