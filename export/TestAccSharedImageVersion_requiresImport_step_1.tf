...
locals {
  number            = "220722051724587211"
  location          = "West Europe"
  domain_name_label = "acctestvm-83079"
  random_string     = "83079"
  admin_username    = "testadmin220722051724587211"
  admin_password    = "Password1234!220722051724587211"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220722051724587211"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220722051724587211"
  ...
  identifier {
    publisher = "AccTesPublisher220722051724587211"
    offer     = "AccTesOffer220722051724587211"
    sku       = "AccTesSku220722051724587211"
  }
}
