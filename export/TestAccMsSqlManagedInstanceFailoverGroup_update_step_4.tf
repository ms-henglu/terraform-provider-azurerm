...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG1-sql-220520054334786435"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet1-220520054334786435"
...
resource "azurerm_subnet" "test" {
  name                 = "subnet1-220520054334786435"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_network_security_group" "test" {
  name                = "mi-security-group1-220520054334786435"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
}
...
resource "azurerm_route_table" "test" {
  name                          = "routetable1-220520054334786435"
  location                      = azurerm_resource_group.test.location
  resource_group_name           = azurerm_resource_group.test.name
...
resource "azurerm_mssql_managed_instance" "test" {
  name                = "acctestsqlserver220520054334786435"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_resource_group" "secondary" {
  name     = "acctestRG2-sql-220520054334786435"
  location = "West US 2"
}

resource "azurerm_virtual_network" "secondary" {
  name                = "acctest-vnet2-220520054334786435"
...
resource "azurerm_subnet" "secondary" {
  name                 = "subnet2-220520054334786435"
  resource_group_name  = azurerm_resource_group.secondary.name
...
resource "azurerm_network_security_group" "secondary" {
  name                = "mi-security-group2-220520054334786435"
  location            = azurerm_resource_group.secondary.location
  resource_group_name = azurerm_resource_group.secondary.name
}
...
resource "azurerm_route_table" "secondary" {
  name                          = "routetable2-220520054334786435"
  location                      = azurerm_resource_group.secondary.location
  resource_group_name           = azurerm_resource_group.secondary.name
  disable_bgp_route_propagation = false
...
resource "azurerm_mssql_managed_instance" "secondary" {
  name                = "acctestsqlserver2220520054334786435"
  resource_group_name = azurerm_resource_group.secondary.name
  location            = azurerm_resource_group.secondary.location
...
resource "azurerm_public_ip" "test" {
  name                = "acctest-pip-220520054334786435"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network_gateway" "test" {
  name                = "acctest-vnetgway-220520054334786435"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network_gateway_connection" "test" {
  name                = "acctest-gwc-220520054334786435"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_public_ip" "secondary" {
  name                = "acctest-pip2-220520054334786435"
  location            = azurerm_resource_group.secondary.location
  resource_group_name = azurerm_resource_group.secondary.name
  allocation_method   = "Dynamic"
}
...
resource "azurerm_virtual_network_gateway" "secondary" {
  name                = "acctest-vnetgway2-220520054334786435"
  location            = azurerm_resource_group.secondary.location
  resource_group_name = azurerm_resource_group.secondary.name
...
resource "azurerm_virtual_network_gateway_connection" "secondary" {
  name                = "acctest-gwc2-220520054334786435"
  location            = azurerm_resource_group.secondary.location
  resource_group_name = azurerm_resource_group.secondary.name
...
resource "azurerm_mssql_managed_instance_failover_group" "test" {
  name                        = "acctest-fog-220520054334786435"
  resource_group_name         = azurerm_resource_group.test.name
  location                    = "West Europe"
