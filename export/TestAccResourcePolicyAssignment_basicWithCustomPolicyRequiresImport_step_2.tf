...
resource "azurerm_resource_group" "test" {
  name     = "acctest220107034307839960"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-220107034307839960"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestpol-220107034307839960"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestpol-220107034307839960"
...
resource "azurerm_resource_policy_assignment" "test" {
  name                 = "acctestpa-220107034307839960"
