...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211001053545929719"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211001053545929719"
  ...
  identifier {
    publisher = "AccTesPublisher211001053545929719"
    offer     = "AccTesOffer211001053545929719"
    sku       = "AccTesSku211001053545929719"
  }
}
