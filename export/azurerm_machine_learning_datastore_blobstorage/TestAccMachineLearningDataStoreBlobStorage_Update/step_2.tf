...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-ml-231016034220156528"
  location = "West Europe"
}

resource "azurerm_application_insights" "test" {
  name                = "acctestai-231016034220156528"
...
resource "azurerm_machine_learning_workspace" "test" {
  name                    = "acctest-MLW-231016034220156528"
  location                = azurerm_resource_group.test.location
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_storage_container" "test" {
  name                  = "acctestcontainer231016034220156528"
...
resource "azurerm_machine_learning_datastore_blobstorage" "test" {
  name                    = "accdatastore231016034220156528"
