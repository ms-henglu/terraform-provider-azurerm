...
locals {
  number            = "230526084758998305"
  location          = "West Europe"
  domain_name_label = "acctestvm-7t2eg"
  random_string     = "7t2eg"
  admin_username    = "testadmin230526084758998305"
  admin_password    = "Password1234!230526084758998305"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230526084758998305"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230526084758998305"
  ...
  identifier {
    publisher = "AccTesPublisher230526084758998305"
    offer     = "AccTesOffer230526084758998305"
    sku       = "AccTesSku230526084758998305"
  }
}
