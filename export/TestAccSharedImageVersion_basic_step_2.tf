...
locals {
  number            = "220407230802461107"
  location          = "West Europe"
  domain_name_label = "acctestvm-q8blx"
  random_string     = "q8blx"
  admin_username    = "testadmin220407230802461107"
  admin_password    = "Password1234!220407230802461107"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220407230802461107"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220407230802461107"
  ...
  identifier {
    publisher = "AccTesPublisher220407230802461107"
    offer     = "AccTesOffer220407230802461107"
    sku       = "AccTesSku220407230802461107"
  }
}
