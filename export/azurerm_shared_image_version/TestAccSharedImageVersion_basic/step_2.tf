...
locals {
  number            = "221124181402017489"
  location          = "West Europe"
  domain_name_label = "acctestvm-26u9m"
  random_string     = "26u9m"
  admin_username    = "testadmin221124181402017489"
  admin_password    = "Password1234!221124181402017489"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221124181402017489"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221124181402017489"
  ...
  identifier {
    publisher = "AccTesPublisher221124181402017489"
    offer     = "AccTesOffer221124181402017489"
    sku       = "AccTesSku221124181402017489"
  }
}
