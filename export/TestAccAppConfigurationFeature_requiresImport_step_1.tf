...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-appconfig-220812014606774563"
...
resource "azurerm_app_configuration" "test" {
  name                = "testacc-appconf220812014606774563"
...
resource "azurerm_app_configuration_feature" "test" {
  ...
  name                   = "acctest-ackey-220812014606774563"
  label                  = "acctest-ackeylabel-220812014606774563"
  enabled                = true
