...
locals {
  number            = "230313020903882575"
  location          = "West Europe"
  domain_name_label = "acctestvm-nk7if"
  random_string     = "nk7if"
  admin_username    = "testadmin230313020903882575"
  admin_password    = "Password1234!230313020903882575"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230313020903882575"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230313020903882575"
  ...
  identifier {
    publisher = "AccTesPublisher230313020903882575"
    offer     = "AccTesOffer230313020903882575"
    sku       = "AccTesSku230313020903882575"
  }
}
