...
locals {
  number            = "230421021839856676"
  location          = "West Europe"
  domain_name_label = "acctestvm-sw0b8"
  random_string     = "sw0b8"
  admin_username    = "testadmin230421021839856676"
  admin_password    = "Password1234!230421021839856676"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230421021839856676"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230421021839856676"
  ...
  identifier {
    publisher = "AccTesPublisher230421021839856676"
    offer     = "AccTesOffer230421021839856676"
    sku       = "AccTesSku230421021839856676"
  }
}
