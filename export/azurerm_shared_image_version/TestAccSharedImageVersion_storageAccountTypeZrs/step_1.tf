...
locals {
  number            = "230929064556875201"
  location          = "West Europe"
  domain_name_label = "acctestvm-ykh30"
  random_string     = "ykh30"
  admin_username    = "testadmin230929064556875201"
  admin_password    = "Password1234!230929064556875201"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230929064556875201"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230929064556875201"
  ...
  identifier {
    publisher = "AccTesPublisher230929064556875201"
    offer     = "AccTesOffer230929064556875201"
    sku       = "AccTesSku230929064556875201"
  }
}
