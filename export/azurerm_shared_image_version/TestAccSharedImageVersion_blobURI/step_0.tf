...
locals {
  number            = "230313020903888369"
  location          = "West Europe"
  domain_name_label = "acctestvm-3g4bn"
  random_string     = "3g4bn"
  admin_username    = "testadmin230313020903888369"
  admin_password    = "Password1234!230313020903888369"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230313020903888369"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230313020903888369"
  ...
  identifier {
    publisher = "AccTesPublisher230313020903888369"
    offer     = "AccTesOffer230313020903888369"
    sku       = "AccTesSku230313020903888369"
  }
}
