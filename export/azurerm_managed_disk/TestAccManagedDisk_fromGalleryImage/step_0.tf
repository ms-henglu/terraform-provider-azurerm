...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-240315122549966288"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestnw-240315122549966288"
...
resource "azurerm_network_interface" "test" {
  name                = "acctestnic-240315122549966288"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "test" {
  name                = "acctestVM-240315122549966288"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  size                = "Standard_F2"
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240315122549966288"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240315122549966288"
  ...
  identifier {
    publisher = "AccTesPublisher240315122549966288"
    offer     = "AccTesOffer240315122549966288"
    sku       = "AccTesSku240315122549966288"
  }
}
...
resource "azurerm_managed_disk" "test" {
  name                       = "acctestd-240315122549966288"
  location                   = azurerm_resource_group.test.location
  resource_group_name        = azurerm_resource_group.test.name
  os_type                    = "Linux"
