...
locals {
  number            = "230707003540142974"
  location          = "West Europe"
  domain_name_label = "acctestvm-zbt3v"
  random_string     = "zbt3v"
  admin_username    = "testadmin230707003540142974"
  admin_password    = "Password1234!230707003540142974"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230707003540142974"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230707003540142974"
  ...
  identifier {
    publisher = "AccTesPublisher230707003540142974"
    offer     = "AccTesOffer230707003540142974"
    sku       = "AccTesSku230707003540142974"
  }
}
