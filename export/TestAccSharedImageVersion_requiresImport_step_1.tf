...
locals {
  number            = "220415030257369939"
  location          = "West Europe"
  domain_name_label = "acctestvm-urem0"
  random_string     = "urem0"
  admin_username    = "testadmin220415030257369939"
  admin_password    = "Password1234!220415030257369939"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220415030257369939"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220415030257369939"
  ...
  identifier {
    publisher = "AccTesPublisher220415030257369939"
    offer     = "AccTesOffer220415030257369939"
    sku       = "AccTesSku220415030257369939"
  }
}
