...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-plss-240112034757526632"
  location = "West Europe"
}

resource "azurerm_monitor_private_link_scope" "test" {
  name                = "acctest-pls-240112034757526632"
  resource_group_name = azurerm_resource_group.test.name
}

resource "azurerm_application_insights" "test" {
  name                = "acctest-appinsights-240112034757526632"
...
resource "azurerm_monitor_private_link_scoped_service" "test" {
  name                = "acctest-plss-240112034757526632"
  resource_group_name = azurerm_resource_group.test.name
