...
func TestAccSpringCloudNewRelicApplicationPerformanceMonitoringPerformanceMonitoring_basic(t *testing.T) {
...
func TestAccSpringCloudNewRelicApplicationPerformanceMonitoringPerformanceMonitoring_requiresImport(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_spring_cloud_new_relic_application_performance_monitoring", "test")
	r := SpringCloudNewRelicApplicationPerformanceMonitoringResource{}
	data.ResourceTest(t, r, []acceptance.TestStep{
		{
...
func TestAccSpringCloudNewRelicApplicationPerformanceMonitoringPerformanceMonitoring_complete(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_spring_cloud_new_relic_application_performance_monitoring", "test")
	r := SpringCloudNewRelicApplicationPerformanceMonitoringResource{}
	data.ResourceTest(t, r, []acceptance.TestStep{
		{
...
func TestAccSpringCloudNewRelicApplicationPerformanceMonitoringPerformanceMonitoring_update(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_spring_cloud_new_relic_application_performance_monitoring", "test")
	r := SpringCloudNewRelicApplicationPerformanceMonitoringResource{}
	data.ResourceTest(t, r, []acceptance.TestStep{
		{
