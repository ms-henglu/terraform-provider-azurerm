...
locals {
  number            = "230929064556777281"
  location          = "West Europe"
  domain_name_label = "acctestvm-p0797"
  random_string     = "p0797"
  admin_username    = "testadmin230929064556777281"
  admin_password    = "Password1234!230929064556777281"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230929064556777281"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
