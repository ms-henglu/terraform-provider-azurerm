...
locals {
  number            = "221124181402019948"
  location          = "West Europe"
  domain_name_label = "acctestvm-ayknq"
  random_string     = "ayknq"
  admin_username    = "testadmin221124181402019948"
  admin_password    = "Password1234!221124181402019948"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221124181402019948"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221124181402019948"
  ...
  identifier {
    publisher = "AccTesPublisher221124181402019948"
    offer     = "AccTesOffer221124181402019948"
    sku       = "AccTesSku221124181402019948"
  }
}
