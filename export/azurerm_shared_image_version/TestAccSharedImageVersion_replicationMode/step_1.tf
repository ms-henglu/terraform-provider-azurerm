...
locals {
  number            = "230721011329115050"
  location          = "West Europe"
  domain_name_label = "acctestvm-k8bwu"
  random_string     = "k8bwu"
  admin_username    = "testadmin230721011329115050"
  admin_password    = "Password1234!230721011329115050"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230721011329115050"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230721011329115050"
  ...
  identifier {
    publisher = "AccTesPublisher230721011329115050"
    offer     = "AccTesOffer230721011329115050"
    sku       = "AccTesSku230721011329115050"
  }
}
