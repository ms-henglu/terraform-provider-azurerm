...
locals {
  number            = "231020040746254225"
  location          = "West Europe"
  domain_name_label = "acctestvm-zi7m9"
  random_string     = "zi7m9"
  admin_username    = "testadmin231020040746254225"
  admin_password    = "Password1234!231020040746254225"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231020040746254225"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231020040746254225"
  ...
  identifier {
    publisher = "AccTesPublisher231020040746254225"
    offer     = "AccTesOffer231020040746254225"
    sku       = "AccTesSku231020040746254225"
  }
}
