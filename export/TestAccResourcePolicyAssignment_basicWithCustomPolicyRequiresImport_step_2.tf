...
resource "azurerm_resource_group" "test" {
  name     = "acctest220422012209871046"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-220422012209871046"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestpol-220422012209871046"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestpol-220422012209871046"
...
resource "azurerm_resource_policy_assignment" "test" {
  name                 = "acctestpa-220422012209871046"
