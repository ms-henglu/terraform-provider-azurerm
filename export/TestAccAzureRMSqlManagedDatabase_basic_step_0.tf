...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-sql-210910021919266529"
  location = "West Europe"
}

resource "azurerm_network_security_group" "test" {
  name                = "mi-security-group-210910021919266529"
...
resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet-210910021919266529"
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_subnet" "test" {
  name                 = "subnet-210910021919266529"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_route_table" "test" {
  name                          = "routetable-210910021919266529"
  location                      = azurerm_resource_group.test.location
  resource_group_name           = azurerm_resource_group.test.name
...
resource "azurerm_sql_managed_instance" "test" {
  name                         = "acctestsqlserver210910021919266529"
  resource_group_name          = azurerm_resource_group.test.name
  location                     = azurerm_resource_group.test.location
...
resource "azurerm_sql_managed_database" "test" {
  ...
  name                    = "acctest-210910021919266529"
  location                = azurerm_resource_group.test.location
}
