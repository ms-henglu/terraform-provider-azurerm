...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-230127044928804018"
  location = "West Europe"
}

resource "azurerm_api_management" "test" {
  name                = "acctestAM-230127044928804018"
...
resource "azurerm_api_management_api" "test" {
  name                = "acctestapi-230127044928804018"
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_api_management_api_version_set" "test" {
  name                = "acctestAMAVS-230127044928804018"
  resource_group_name = azurerm_resource_group.test.name
  api_management_name = azurerm_api_management.test.name
...
resource "azurerm_api_management_api" "version" {
  name                = "acctestVersion-230127044928804018"
  resource_group_name = azurerm_resource_group.test.name
  api_management_name = azurerm_api_management.test.name
