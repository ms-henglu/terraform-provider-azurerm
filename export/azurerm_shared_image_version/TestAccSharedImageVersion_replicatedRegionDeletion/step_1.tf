...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240311031615611459"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240311031615611459"
  ...
  identifier {
    publisher = "AccTesPublisher240311031615611459"
    offer     = "AccTesOffer240311031615611459"
    sku       = "AccTesSku240311031615611459"
  }
}
