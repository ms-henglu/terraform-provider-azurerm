...
locals {
  number            = "230227175227910665"
  location          = "West Europe"
  domain_name_label = "acctestvm-0omc8"
  random_string     = "0omc8"
  admin_username    = "testadmin230227175227910665"
  admin_password    = "Password1234!230227175227910665"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230227175227910665"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230227175227910665"
  ...
  identifier {
    publisher = "AccTesPublisher230227175227910665"
    offer     = "AccTesOffer230227175227910665"
    sku       = "AccTesSku230227175227910665"
  }
}
