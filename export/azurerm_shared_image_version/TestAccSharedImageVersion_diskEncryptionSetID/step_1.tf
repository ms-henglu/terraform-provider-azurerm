...
locals {
  number            = "230227032410656664"
  location          = "West Europe"
  domain_name_label = "acctestvm-7p4ne"
  random_string     = "7p4ne"
  admin_username    = "testadmin230227032410656664"
  admin_password    = "Password1234!230227032410656664"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230227032410656664"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230227032410656664"
  ...
  identifier {
    publisher = "AccTesPublisher230227032410656664"
    offer     = "AccTesOffer230227032410656664"
    sku       = "AccTesSku230227032410656664"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230227032410656664"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
