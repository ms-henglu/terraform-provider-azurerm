...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-cognitive-220204055747911937"
  location = "West US 2"
}
...
resource "azurerm_cognitive_account" "test" {
  name                  = "acctest-cogacc-220204055747911937"
  location              = azurerm_resource_group.test.location
  resource_group_name   = azurerm_resource_group.test.name
  kind                  = "Face"
  sku_name              = "E0"
  custom_subdomain_name = "acctest-cogacc-220204055747911937"
  identity {
