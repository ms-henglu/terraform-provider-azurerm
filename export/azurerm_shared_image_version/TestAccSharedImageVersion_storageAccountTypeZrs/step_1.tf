...
locals {
  number            = "221028171853891241"
  location          = "West Europe"
  domain_name_label = "acctestvm-a8k4e"
  random_string     = "a8k4e"
  admin_username    = "testadmin221028171853891241"
  admin_password    = "Password1234!221028171853891241"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221028171853891241"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221028171853891241"
  ...
  identifier {
    publisher = "AccTesPublisher221028171853891241"
    offer     = "AccTesOffer221028171853891241"
    sku       = "AccTesSku221028171853891241"
  }
}
