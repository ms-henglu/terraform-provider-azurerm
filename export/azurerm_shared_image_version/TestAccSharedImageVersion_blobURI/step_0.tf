...
locals {
  number            = "221028171853896786"
  location          = "West Europe"
  domain_name_label = "acctestvm-ljwek"
  random_string     = "ljwek"
  admin_username    = "testadmin221028171853896786"
  admin_password    = "Password1234!221028171853896786"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221028171853896786"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221028171853896786"
  ...
  identifier {
    publisher = "AccTesPublisher221028171853896786"
    offer     = "AccTesOffer221028171853896786"
    sku       = "AccTesSku221028171853896786"
  }
}
