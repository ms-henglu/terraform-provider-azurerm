...
locals {
  number            = "220826002453898731"
  location          = "West Europe"
  domain_name_label = "acctestvm-7rlsz"
  random_string     = "7rlsz"
  admin_username    = "testadmin220826002453898731"
  admin_password    = "Password1234!220826002453898731"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220826002453898731"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220826002453898731"
  ...
  identifier {
    publisher = "AccTesPublisher220826002453898731"
    offer     = "AccTesOffer220826002453898731"
    sku       = "AccTesSku220826002453898731"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220826002453898731"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
