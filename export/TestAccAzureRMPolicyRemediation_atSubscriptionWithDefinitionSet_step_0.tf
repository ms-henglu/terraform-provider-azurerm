...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-arwyx"
  policy_type  = "Custom"
  display_name = "testPolicySet-arwyx"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-arwyx"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-arwyx"
