...
// JobsGet ...
func (c AzureBackupJobClient) JobsGet(ctx context.Context, id BackupJobId) (result JobsGetResponse, err error) {
...
func (c AzureBackupJobClient) responderForJobsGet(resp *http.Response) (result JobsGetResponse, err error) {
