...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-230728025819300263"
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestvirtnet230728025819300263"
...
resource "azurerm_subnet" "test" {
  name                 = "acctestsubnet230728025819300263"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_public_ip" "test" {
  name                = "acctestpip230728025819300263"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_nat_gateway" "test" {
  name                    = "acctestnat230728025819300263"
  location                = azurerm_resource_group.test.location
  resource_group_name     = azurerm_resource_group.test.name
  sku_name                = "Standard"
...
resource "azurerm_hdinsight_hbase_cluster" "test" {
  ...
  name                = "acctesthdi-230728025819300263"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  cluster_version     = "4.0"
  tier                = "Standard"
...
resource "azurerm_network_security_group" "test" {
  name                = "acctestnsg-230728025819300263"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
