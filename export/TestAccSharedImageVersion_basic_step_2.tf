...
locals {
  number            = "220204092752861778"
  location          = "West Europe"
  domain_name_label = "acctestvm-xi8wj"
  random_string     = "xi8wj"
  admin_username    = "testadmin220204092752861778"
  admin_password    = "Password1234!220204092752861778"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220204092752861778"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220204092752861778"
  ...
  identifier {
    publisher = "AccTesPublisher220204092752861778"
    offer     = "AccTesOffer220204092752861778"
    sku       = "AccTesSku220204092752861778"
  }
}
