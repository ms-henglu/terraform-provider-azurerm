...
locals {
  number            = "220722035002638674"
  location          = "West Europe"
  domain_name_label = "acctestvm-zollp"
  random_string     = "zollp"
  admin_username    = "testadmin220722035002638674"
  admin_password    = "Password1234!220722035002638674"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220722035002638674"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220722035002638674"
  ...
  identifier {
    publisher = "AccTesPublisher220722035002638674"
    offer     = "AccTesOffer220722035002638674"
    sku       = "AccTesSku220722035002638674"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220722035002638674"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
