...
locals {
  number            = "211022001757132610"
  location          = "West Europe"
  domain_name_label = "acctestvm-y8d0y"
  random_string     = "y8d0y"
  admin_username    = "testadmin211022001757132610"
  admin_password    = "Password1234!211022001757132610"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211022001757132610"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211022001757132610"
  ...
  identifier {
    publisher = "AccTesPublisher211022001757132610"
    offer     = "AccTesOffer211022001757132610"
    sku       = "AccTesSku211022001757132610"
  }
}
