...
locals {
  number            = "220107033655667463"
  location          = "West Europe"
  domain_name_label = "acctestvm-lrx7r"
  random_string     = "lrx7r"
  admin_username    = "testadmin220107033655667463"
  admin_password    = "Password1234!220107033655667463"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220107033655667463"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220107033655667463"
  ...
  identifier {
    publisher = "AccTesPublisher220107033655667463"
    offer     = "AccTesOffer220107033655667463"
    sku       = "AccTesSku220107033655667463"
  }
}
