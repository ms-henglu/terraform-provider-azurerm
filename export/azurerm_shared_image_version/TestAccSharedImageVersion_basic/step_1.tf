...
locals {
  number            = "230519074408707879"
  location          = "West Europe"
  domain_name_label = "acctestvm-4posb"
  random_string     = "4posb"
  admin_username    = "testadmin230519074408707879"
  admin_password    = "Password1234!230519074408707879"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230519074408707879"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230519074408707879"
  ...
  identifier {
    publisher = "AccTesPublisher230519074408707879"
    offer     = "AccTesOffer230519074408707879"
    sku       = "AccTesSku230519074408707879"
  }
}
