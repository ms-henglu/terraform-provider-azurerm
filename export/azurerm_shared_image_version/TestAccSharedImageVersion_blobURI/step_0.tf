...
locals {
  number            = "231013043133450978"
  location          = "West Europe"
  domain_name_label = "acctestvm-oc1i7"
  random_string     = "oc1i7"
  admin_username    = "testadmin231013043133450978"
  admin_password    = "Password1234!231013043133450978"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231013043133450978"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231013043133450978"
  ...
  identifier {
    publisher = "AccTesPublisher231013043133450978"
    offer     = "AccTesOffer231013043133450978"
    sku       = "AccTesSku231013043133450978"
  }
}
