...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-qvmzi"
  policy_type  = "Custom"
  display_name = "testPolicySet-qvmzi"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-qvmzi"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-qvmzi"
