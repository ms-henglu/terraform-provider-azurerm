...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-acr-221202035358361053"
  location = "West Europe"
}

resource "azurerm_container_registry" "test" {
  name                  = "testacccr221202035358361053"
...
resource "azurerm_container_registry_scope_map" "test" {
  ...
  actions = [
    ...
    "gateway/testacccrc221202035358361053/config/read",
    "gateway/testacccrc221202035358361053/config/write",
    "gateway/testacccrc221202035358361053/message/read",
    "gateway/testacccrc221202035358361053/message/write",
  ]
}

resource "azurerm_container_registry_token" "test" {
  name                    = "testacccrtoken221202035358361053"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
...
resource "azurerm_container_registry_scope_map" "client" {
  name                    = "testacccrclient221202035358361053"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
  actions = [
    "repositories/hello-world/content/delete",
...
resource "azurerm_container_registry_token" "client" {
  name                    = "testacccrtokenclient221202035358361053"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
...
resource "azurerm_container_connected_registry" "test" {
  name                  = "testacccrc221202035358361053"
