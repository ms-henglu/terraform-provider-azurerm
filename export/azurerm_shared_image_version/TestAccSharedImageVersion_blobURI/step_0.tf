...
locals {
  number            = "230519074408705407"
  location          = "West Europe"
  domain_name_label = "acctestvm-v1e0s"
  random_string     = "v1e0s"
  admin_username    = "testadmin230519074408705407"
  admin_password    = "Password1234!230519074408705407"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230519074408705407"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230519074408705407"
  ...
  identifier {
    publisher = "AccTesPublisher230519074408705407"
    offer     = "AccTesOffer230519074408705407"
    sku       = "AccTesSku230519074408705407"
  }
}
