...
locals {
  number            = "210924004029437260"
  location          = "West Europe"
  domain_name_label = "acctestvm-pcfg4"
  random_string     = "pcfg4"
  admin_username    = "testadmin210924004029437260"
  admin_password    = "Password1234!210924004029437260"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210924004029437260"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210924004029437260"
  ...
  identifier {
    publisher = "AccTesPublisher210924004029437260"
    offer     = "AccTesOffer210924004029437260"
    sku       = "AccTesSku210924004029437260"
  }
}
