...
locals {
  number            = "230526084758992806"
  location          = "West Europe"
  domain_name_label = "acctestvm-maqg9"
  random_string     = "maqg9"
  admin_username    = "testadmin230526084758992806"
  admin_password    = "Password1234!230526084758992806"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230526084758992806"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230526084758992806"
  ...
  identifier {
    publisher = "AccTesPublisher230526084758992806"
    offer     = "AccTesOffer230526084758992806"
    sku       = "AccTesSku230526084758992806"
  }
}
