...
resource "azurerm_policy_definition" "test" {
  name         = "acctestpol-220225034916559951"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestpol-220225034916559951"
...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220225034916559951"
  location = "West Europe"
}

resource "azurerm_log_analytics_workspace" "test" {
  name                = "acctestLAW-220225034916559951"
...
resource "azurerm_policy_assignment" "test" {
  name                 = "acctestpa-220225034916559951"
  scope                = azurerm_resource_group.test.id
  policy_definition_id = azurerm_policy_definition.test.id
  description          = "Policy Assignment created via an Acceptance Test"
  display_name         = "Acceptance Test Run 220225034916559951"
...
resource "azurerm_resource_group_template_deployment" "test" {
  name                = "acctestrgtd-220225034916559951"
  resource_group_name = azurerm_resource_group.test.name
...
{
  "description": {
   "value": "description-220225034916559951"
  },
  "displayName": {
    "value": "name--220225034916559951"
  },
  "exemptionCategory": {
    "value": "Waiver"
  },
