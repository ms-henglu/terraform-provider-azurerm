...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211001223759405315"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211001223759405315"
  ...
  identifier {
    publisher = "AccTesPublisher211001223759405315"
    offer     = "AccTesOffer211001223759405315"
    sku       = "AccTesSku211001223759405315"
  }
}
