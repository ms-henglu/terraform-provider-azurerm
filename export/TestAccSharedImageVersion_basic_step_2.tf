...
locals {
  number            = "211203013551381037"
  location          = "West Europe"
  domain_name_label = "acctestvm-e2amb"
  random_string     = "e2amb"
  admin_username    = "testadmin211203013551381037"
  admin_password    = "Password1234!211203013551381037"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211203013551381037"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211203013551381037"
  ...
  identifier {
    publisher = "AccTesPublisher211203013551381037"
    offer     = "AccTesOffer211203013551381037"
    sku       = "AccTesSku211203013551381037"
  }
}
