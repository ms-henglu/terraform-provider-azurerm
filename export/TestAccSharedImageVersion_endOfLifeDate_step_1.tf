...
locals {
  number            = "220811053013422109"
  location          = "West Europe"
  domain_name_label = "acctestvm-jpe9w"
  random_string     = "jpe9w"
  admin_username    = "testadmin220811053013422109"
  admin_password    = "Password1234!220811053013422109"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220811053013422109"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220811053013422109"
  ...
  identifier {
    publisher = "AccTesPublisher220811053013422109"
    offer     = "AccTesOffer220811053013422109"
    sku       = "AccTesSku220811053013422109"
  }
}
