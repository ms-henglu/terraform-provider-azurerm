...
locals {
  number            = "230324051802722759"
  location          = "West Europe"
  domain_name_label = "acctestvm-7v7il"
  random_string     = "7v7il"
  admin_username    = "testadmin230324051802722759"
  admin_password    = "Password1234!230324051802722759"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230324051802722759"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230324051802722759"
  ...
  identifier {
    publisher = "AccTesPublisher230324051802722759"
    offer     = "AccTesOffer230324051802722759"
    sku       = "AccTesSku230324051802722759"
  }
}
