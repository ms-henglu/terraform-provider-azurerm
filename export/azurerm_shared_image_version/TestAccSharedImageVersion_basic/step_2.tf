...
locals {
  number            = "230728025312831444"
  location          = "West Europe"
  domain_name_label = "acctestvm-y79ka"
  random_string     = "y79ka"
  admin_username    = "testadmin230728025312831444"
  admin_password    = "Password1234!230728025312831444"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230728025312831444"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230728025312831444"
  ...
  identifier {
    publisher = "AccTesPublisher230728025312831444"
    offer     = "AccTesOffer230728025312831444"
    sku       = "AccTesSku230728025312831444"
  }
}
