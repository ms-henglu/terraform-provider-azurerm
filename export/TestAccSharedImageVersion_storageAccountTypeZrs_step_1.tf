...
locals {
  number            = "220603021818523328"
  location          = "West Europe"
  domain_name_label = "acctestvm-knnms"
  random_string     = "knnms"
  admin_username    = "testadmin220603021818523328"
  admin_password    = "Password1234!220603021818523328"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220603021818523328"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220603021818523328"
  ...
  identifier {
    publisher = "AccTesPublisher220603021818523328"
    offer     = "AccTesOffer220603021818523328"
    sku       = "AccTesSku220603021818523328"
  }
}
