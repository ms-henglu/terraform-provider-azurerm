...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210917031451905922"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210917031451905922"
  ...
  identifier {
    publisher = "AccTesPublisher210917031451905922"
    offer     = "AccTesOffer210917031451905922"
    sku       = "AccTesSku210917031451905922"
  }
}
