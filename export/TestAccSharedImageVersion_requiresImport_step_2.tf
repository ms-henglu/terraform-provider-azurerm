...
locals {
  number            = "220819165017109468"
  location          = "West Europe"
  domain_name_label = "acctestvm-2xae0"
  random_string     = "2xae0"
  admin_username    = "testadmin220819165017109468"
  admin_password    = "Password1234!220819165017109468"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220819165017109468"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220819165017109468"
  ...
  identifier {
    publisher = "AccTesPublisher220819165017109468"
    offer     = "AccTesOffer220819165017109468"
    sku       = "AccTesSku220819165017109468"
  }
}
