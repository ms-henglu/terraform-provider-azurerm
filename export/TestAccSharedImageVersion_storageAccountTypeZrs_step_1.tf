...
locals {
  number            = "220923011626953958"
  location          = "West Europe"
  domain_name_label = "acctestvm-jjxqf"
  random_string     = "jjxqf"
  admin_username    = "testadmin220923011626953958"
  admin_password    = "Password1234!220923011626953958"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220923011626953958"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220923011626953958"
  ...
  identifier {
    publisher = "AccTesPublisher220923011626953958"
    offer     = "AccTesOffer220923011626953958"
    sku       = "AccTesSku220923011626953958"
  }
}
