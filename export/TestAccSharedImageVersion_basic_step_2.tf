...
locals {
  number            = "220905045548220438"
  location          = "West Europe"
  domain_name_label = "acctestvm-vhwp1"
  random_string     = "vhwp1"
  admin_username    = "testadmin220905045548220438"
  admin_password    = "Password1234!220905045548220438"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220905045548220438"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220905045548220438"
  ...
  identifier {
    publisher = "AccTesPublisher220905045548220438"
    offer     = "AccTesOffer220905045548220438"
    sku       = "AccTesSku220905045548220438"
  }
}
