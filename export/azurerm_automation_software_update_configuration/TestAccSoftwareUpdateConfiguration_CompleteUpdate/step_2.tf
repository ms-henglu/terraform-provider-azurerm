...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-231016033425306274"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctest-231016033425306274"
...
resource "azurerm_log_analytics_workspace" "test" {
  name                = "acctestLAW-231016033425306274"
  location            = "west europe"
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "PerGB2018"
...
resource "azurerm_automation_software_update_configuration" "test" {
  ...
  name                  = "acctest-suc-231016033425306274"
  ...
  schedule {
    ...
    start_time         = "2023-10-16T04:34:00Z"
    expiry_time        = "2023-10-16T05:34:00Z"
    is_enabled         = true
    interval           = 2
    frequency          = "Hour"
    time_zone          = "Etc/UTC"
