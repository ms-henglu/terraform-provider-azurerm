...
locals {
  number            = "220211130332033575"
  location          = "West Europe"
  domain_name_label = "acctestvm-2l3sc"
  random_string     = "2l3sc"
  admin_username    = "testadmin220211130332033575"
  admin_password    = "Password1234!220211130332033575"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220211130332033575"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220211130332033575"
  ...
  identifier {
    publisher = "AccTesPublisher220211130332033575"
    offer     = "AccTesOffer220211130332033575"
    sku       = "AccTesSku220211130332033575"
  }
}
