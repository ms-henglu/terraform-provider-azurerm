...
locals {
  number            = "220218070535204429"
  location          = "West Europe"
  domain_name_label = "acctestvm-jztz3"
  random_string     = "jztz3"
  admin_username    = "testadmin220218070535204429"
  admin_password    = "Password1234!220218070535204429"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220218070535204429"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220218070535204429"
  ...
  identifier {
    publisher = "AccTesPublisher220218070535204429"
    offer     = "AccTesOffer220218070535204429"
    sku       = "AccTesSku220218070535204429"
  }
}
