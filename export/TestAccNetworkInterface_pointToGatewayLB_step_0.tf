...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220218071107044473"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-220218071107044473"
...
resource "azurerm_virtual_network" "gateway" {
  name                = "acctestvnet-gw-220218071107044473"
...
resource "azurerm_subnet" "gateway" {
  name                 = "acctestsubnet-gw-220218071107044473"
...
resource "azurerm_lb" "gateway" {
  name                = "acctestlb-220218071107044473"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Gateway"
...
resource "azurerm_lb_backend_address_pool" "gateway" {
  name            = "acctestbap-220218071107044473"
...
resource "azurerm_public_ip" "test" {
  name                = "acctestpip-220218071107044473"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Standard"
...
resource "azurerm_network_interface" "test" {
  name                = "acctestnic-220218071107044473"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
