...
locals {
  number            = "210917031451906356"
  location          = "West Europe"
  domain_name_label = "acctestvm-uuyff"
  random_string     = "uuyff"
  admin_username    = "testadmin210917031451906356"
  admin_password    = "Password1234!210917031451906356"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210917031451906356"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210917031451906356"
  ...
  identifier {
    publisher = "AccTesPublisher210917031451906356"
    offer     = "AccTesOffer210917031451906356"
    sku       = "AccTesSku210917031451906356"
  }
}
