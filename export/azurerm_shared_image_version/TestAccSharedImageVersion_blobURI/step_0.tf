...
locals {
  number            = "230707010127173423"
  location          = "West Europe"
  domain_name_label = "acctestvm-7l726"
  random_string     = "7l726"
  admin_username    = "testadmin230707010127173423"
  admin_password    = "Password1234!230707010127173423"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230707010127173423"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230707010127173423"
  ...
  identifier {
    publisher = "AccTesPublisher230707010127173423"
    offer     = "AccTesOffer230707010127173423"
    sku       = "AccTesSku230707010127173423"
  }
}
