...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-iothub-220204060147927633"
  location = "West Europe"
}

resource "azurerm_storage_account" "test" {
  name                     = "acc220204060147927633"
...
resource "azurerm_servicebus_namespace" "test" {
  name                = "acctest-220204060147927633"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Standard"
}
...
resource "azurerm_servicebus_topic" "test" {
  name                = "acctestservicebustopic-220204060147927633"
  namespace_name      = azurerm_servicebus_namespace.test.name
  resource_group_name = azurerm_resource_group.test.name
}
...
resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhubnamespace-220204060147927633"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Basic"
}
...
resource "azurerm_eventhub" "test" {
  name                = "acctesteventhub-220204060147927633"
...
resource "azurerm_user_assigned_identity" "test" {
  name                = "acctestuai-220204060147927633"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}
...
resource "azurerm_iothub" "test" {
  name                = "acctestIoTHub-220204060147927633"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
