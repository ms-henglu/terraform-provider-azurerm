...
locals {
  number            = "230728025312843530"
  location          = "West Europe"
  domain_name_label = "acctestvm-91bob"
  random_string     = "91bob"
  admin_username    = "testadmin230728025312843530"
  admin_password    = "Password1234!230728025312843530"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230728025312843530"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230728025312843530"
  ...
  identifier {
    publisher = "AccTesPublisher230728025312843530"
    offer     = "AccTesOffer230728025312843530"
    sku       = "AccTesSku230728025312843530"
  }
}
