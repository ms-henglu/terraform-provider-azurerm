...
locals {
  number            = "220729032452201228"
  location          = "West Europe"
  domain_name_label = "acctestvm-ey7rp"
  random_string     = "ey7rp"
  admin_username    = "testadmin220729032452201228"
  admin_password    = "Password1234!220729032452201228"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220729032452201228"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220729032452201228"
  ...
  identifier {
    publisher = "AccTesPublisher220729032452201228"
    offer     = "AccTesOffer220729032452201228"
    sku       = "AccTesSku220729032452201228"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220729032452201228"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
