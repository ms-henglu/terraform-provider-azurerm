...
locals {
  number            = "230721014716582183"
  location          = "West Europe"
  domain_name_label = "acctestvm-xf8zx"
  random_string     = "xf8zx"
  admin_username    = "testadmin230721014716582183"
  admin_password    = "Password1234!230721014716582183"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230721014716582183"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230721014716582183"
  ...
  identifier {
    publisher = "AccTesPublisher230721014716582183"
    offer     = "AccTesOffer230721014716582183"
    sku       = "AccTesSku230721014716582183"
  }
}
