...
locals {
  number            = "230922053821483157"
  location          = "West Europe"
  domain_name_label = "acctestvm-b9ctn"
  random_string     = "b9ctn"
  admin_username    = "testadmin230922053821483157"
  admin_password    = "Password1234!230922053821483157"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230922053821483157"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230922053821483157"
  ...
  identifier {
    publisher = "AccTesPublisher230922053821483157"
    offer     = "AccTesOffer230922053821483157"
    sku       = "AccTesSku230922053821483157"
  }
}
