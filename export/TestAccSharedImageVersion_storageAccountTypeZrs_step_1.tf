...
locals {
  number            = "211015014431938247"
  location          = "West Europe"
  domain_name_label = "acctestvm-y2990"
  random_string     = "y2990"
  admin_username    = "testadmin211015014431938247"
  admin_password    = "Password1234!211015014431938247"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211015014431938247"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211015014431938247"
  ...
  identifier {
    publisher = "AccTesPublisher211015014431938247"
    offer     = "AccTesOffer211015014431938247"
    sku       = "AccTesSku211015014431938247"
  }
}
