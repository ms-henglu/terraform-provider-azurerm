...
locals {
  rg_name              = "acctest-nested-rg-240119025700980449"
  location             = "West Europe"
  vn_name              = "acctest-nested-vn-240119025700980449"
  ip_name              = "acctest-nested-ip-240119025700980449"
  vm_name              = "acctest-nested-vm-240119025700980449"
  nic_name             = "acctest-nested-nic-240119025700980449"
  disk_name            = "acctest-nested-disk-240119025700980449"
  keyvault_name        = "acctkv240119025700980449"
  nsg_name             = "acctest-nested-nsg-240119025700980449"
  recovery_vault_name  = "acctest-nested-recovery-vault-240119025700980449"
  recovery_site_name   = "acctest-nested-recovery-site-240119025700980449"
  admin_name           = "acctestadmin"
  cert_name            = "acctestcert"
  storage_account_name = "acctestsa7tg39"
}
...
resource "azurerm_windows_virtual_machine" "host" {
  ...
  additional_unattend_content {
    setting = "AutoLogon"
    content = "<AutoLogon><Password><Value>!Y6#)nw13!</Value></Password><Enabled>true</Enabled><LogonCount>1</LogonCount><Username>${local.admin_name}</Username></AutoLogon>"
  }
...
resource "azurerm_site_recovery_hyperv_replication_policy" "test" {
  recovery_vault_id                                  = azurerm_recovery_services_vault.test.id
  name                                               = "acctest-policy-240119025700980449"
