...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-221021034242714069"
  location = "West Europe"
}

resource "azurerm_virtual_network" "backend-vn-R1" {
  name                = "acctestvn-221021034242714069-R1"
...
resource "azurerm_virtual_network" "backend-vn-R2" {
  name                = "acctestvn-221021034242714069-R2"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_public_ip" "backend-ip-R1" {
  name                = "acctestpip-221021034242714069-R1"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_public_ip" "backend-ip-R1-1" {
  name                = "acctestpip-221021034242714069-R1-1"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  allocation_method   = "Static"
  sku                 = "Standard"
...
resource "azurerm_public_ip" "backend-ip-R2" {
  name                = "acctestpip-221021034242714069-R2"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  allocation_method   = "Static"
  sku                 = "Standard"
...
resource "azurerm_public_ip" "backend-ip-cr" {
  name                = "acctestpip-221021034242714069-cr"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  allocation_method   = "Static"
  sku                 = "Standard"
...
resource "azurerm_lb" "backend-lb-R1" {
  name                = "acctestlb-221021034242714069-R1"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Standard"
...
resource "azurerm_lb" "backend-lb-R2" {
  name                = "acctestlb-221021034242714069-R2"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Standard"
...
resource "azurerm_lb" "backend-lb-cr" {
  name                = "acctestlb-221021034242714069-cr"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Standard"
  sku_tier            = "Global"
