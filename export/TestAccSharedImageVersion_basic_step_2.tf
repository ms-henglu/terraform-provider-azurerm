...
locals {
  number            = "220712042046041527"
  location          = "West Europe"
  domain_name_label = "acctestvm-sg2tw"
  random_string     = "sg2tw"
  admin_username    = "testadmin220712042046041527"
  admin_password    = "Password1234!220712042046041527"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220712042046041527"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220712042046041527"
  ...
  identifier {
    publisher = "AccTesPublisher220712042046041527"
    offer     = "AccTesOffer220712042046041527"
    sku       = "AccTesSku220712042046041527"
  }
}
