...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-211008044914775375"
  location = "West Europe"
}

resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhub-211008044914775375"
  location            = "West Europe"
...
resource "azurerm_eventhub_authorization_rule" "test" {
  name                = "acctest-eventhub-auth-rule-211008044914775375"
  namespace_name      = azurerm_eventhub_namespace.test.name
...
resource "azurerm_security_center_automation" "test" {
  name                = "acctestautomation-211008044914775375"
  location            = "West Europe"
  resource_group_name = azurerm_resource_group.test.name
