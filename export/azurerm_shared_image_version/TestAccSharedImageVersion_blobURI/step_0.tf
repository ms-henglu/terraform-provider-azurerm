...
locals {
  number            = "230728025312831477"
  location          = "West Europe"
  domain_name_label = "acctestvm-igx4r"
  random_string     = "igx4r"
  admin_username    = "testadmin230728025312831477"
  admin_password    = "Password1234!230728025312831477"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230728025312831477"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230728025312831477"
  ...
  identifier {
    publisher = "AccTesPublisher230728025312831477"
    offer     = "AccTesOffer230728025312831477"
    sku       = "AccTesSku230728025312831477"
  }
}
