...
locals {
  number            = "220610022336707973"
  location          = "West Europe"
  domain_name_label = "acctestvm-nwhxe"
  random_string     = "nwhxe"
  admin_username    = "testadmin220610022336707973"
  admin_password    = "Password1234!220610022336707973"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220610022336707973"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220610022336707973"
  ...
  identifier {
    publisher = "AccTesPublisher220610022336707973"
    offer     = "AccTesOffer220610022336707973"
    sku       = "AccTesSku220610022336707973"
  }
}
