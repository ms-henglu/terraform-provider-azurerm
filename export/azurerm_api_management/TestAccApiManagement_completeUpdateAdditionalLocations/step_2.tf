...
resource "azurerm_resource_group" "test1" {
  name     = "acctestRG-api1-230512010138317773"
  location = "West Europe"
}

resource "azurerm_resource_group" "test2" {
  name     = "acctestRG-api2-230512010138317773"
  location = "West US 2"
}

resource "azurerm_resource_group" "test3" {
  name     = "acctestRG-api3-230512010138317773"
  location = "East US 2"
}

resource "azurerm_api_management" "test" {
  name                      = "acctestAM-230512010138317773"
  publisher_name            = "pub1"
  ...
  hostname_configuration {
    proxy {
      host_name                    = "acctestAM-230512010138317773.azure-api.net"
