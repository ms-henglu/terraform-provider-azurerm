...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG1-sql-230630034008554952"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet1-230630034008554952"
...
resource "azurerm_subnet" "test" {
  name                 = "subnet1-230630034008554952"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_route_table" "test" {
  name                          = "routetable1-230630034008554952"
  location                      = azurerm_resource_group.test.location
  resource_group_name           = azurerm_resource_group.test.name
...
resource "azurerm_sql_managed_instance" "test" {
  name                         = "acctestsqlserver230630034008554952"
  resource_group_name          = azurerm_resource_group.test.name
  location                     = azurerm_resource_group.test.location
...
resource "azurerm_sql_managed_database" "test" {
  ...
  name                    = "acctest-230630034008554952"
  location                = azurerm_resource_group.test.location
}
