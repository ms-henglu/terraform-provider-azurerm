...
locals {
  number            = "220326010253729727"
  location          = "West Europe"
  domain_name_label = "acctestvm-z7c3t"
  random_string     = "z7c3t"
  admin_username    = "testadmin220326010253729727"
  admin_password    = "Password1234!220326010253729727"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220326010253729727"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220326010253729727"
  ...
  identifier {
    publisher = "AccTesPublisher220326010253729727"
    offer     = "AccTesOffer220326010253729727"
    sku       = "AccTesSku220326010253729727"
  }
}
