...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-230106031046493509"
...
resource "azurerm_aadb2c_directory" "test" {
  ...
  display_name            = "acctest230106031046493509"
  domain_name             = "acctest230106031046493509.onmicrosoft.com"
...
resource "azurerm_resource_group" "duplicate" {
  name     = "acctestRG-duplicate-230106031046493509"
  location = "West US 2"
}
...
resource "azurerm_aadb2c_directory" "duplicate" {
  ...
  display_name            = "acctest-duplicate-230106031046493509"
