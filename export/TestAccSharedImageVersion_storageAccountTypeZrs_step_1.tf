...
locals {
  number            = "220916011219831051"
  location          = "West Europe"
  domain_name_label = "acctestvm-zc62b"
  random_string     = "zc62b"
  admin_username    = "testadmin220916011219831051"
  admin_password    = "Password1234!220916011219831051"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220916011219831051"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220916011219831051"
  ...
  identifier {
    publisher = "AccTesPublisher220916011219831051"
    offer     = "AccTesOffer220916011219831051"
    sku       = "AccTesSku220916011219831051"
  }
}
