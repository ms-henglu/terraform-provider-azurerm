...
locals {
  number            = "230922060812878880"
  location          = "West Europe"
  domain_name_label = "acctestvm-o09xn"
  random_string     = "o09xn"
  admin_username    = "testadmin230922060812878880"
  admin_password    = "Password1234!230922060812878880"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230922060812878880"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230922060812878880"
  ...
  identifier {
    publisher = "AccTesPublisher230922060812878880"
    offer     = "AccTesOffer230922060812878880"
    sku       = "AccTesSku230922060812878880"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230922060812878880"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
