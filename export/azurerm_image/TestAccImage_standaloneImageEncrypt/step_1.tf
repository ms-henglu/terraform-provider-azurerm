...
locals {
  number            = "230728031950452894"
  location          = "West Europe"
  domain_name_label = "acctestvm-8cxhj"
  random_string     = "8cxhj"
  admin_username    = "testadmin230728031950452894"
  admin_password    = "Password1234!230728031950452894"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230728031950452894"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
