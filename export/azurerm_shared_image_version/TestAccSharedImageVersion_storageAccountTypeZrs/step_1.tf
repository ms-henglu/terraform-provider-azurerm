...
locals {
  number            = "230609091011710915"
  location          = "West Europe"
  domain_name_label = "acctestvm-tcxyr"
  random_string     = "tcxyr"
  admin_username    = "testadmin230609091011710915"
  admin_password    = "Password1234!230609091011710915"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230609091011710915"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230609091011710915"
  ...
  identifier {
    publisher = "AccTesPublisher230609091011710915"
    offer     = "AccTesOffer230609091011710915"
    sku       = "AccTesSku230609091011710915"
  }
}
