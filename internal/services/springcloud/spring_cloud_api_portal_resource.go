...
func resourceSpringCloudAPIPortalCreateUpdate(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	apiPortalResource := appplatform.APIPortalResource{
		Properties: &appplatform.APIPortalProperties{
			...
			SourceUrls:    utils.ExpandStringSlice(d.Get("source_urls").(*pluginsdk.Set).List()),
			SsoProperties: expandAPIPortalSsoProperties(d.Get("sso_properties").([]interface{})),
		},
		Sku: &appplatform.Sku{
...
func resourceSpringCloudAPIPortalRead(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	if props := resp.Properties; props != nil {
		...
		d.Set("source_urls", utils.FlattenStringSlice(props.SourceUrls))
		if err := d.Set("sso_properties", flattenAPIPortalSsoProperties(props.SsoProperties)); err != nil {
...
func flattenAPIPortalSsoProperties(input *appplatform.SsoProperties) []interface{} {
	if input == nil {
