...
locals {
  number            = "230602030259359444"
  location          = "West Europe"
  domain_name_label = "acctestvm-zmzxw"
  random_string     = "zmzxw"
  admin_username    = "testadmin230602030259359444"
  admin_password    = "Password1234!230602030259359444"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230602030259359444"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230602030259359444"
  ...
  identifier {
    publisher = "AccTesPublisher230602030259359444"
    offer     = "AccTesOffer230602030259359444"
    sku       = "AccTesSku230602030259359444"
  }
}
