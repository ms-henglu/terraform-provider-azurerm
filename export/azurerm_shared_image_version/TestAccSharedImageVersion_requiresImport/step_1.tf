...
locals {
  number            = "240311031615611092"
  location          = "West Europe"
  domain_name_label = "acctestvm-amnyd"
  random_string     = "amnyd"
  admin_username    = "testadmin240311031615611092"
  admin_password    = "Password1234!240311031615611092"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240311031615611092"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240311031615611092"
  ...
  identifier {
    publisher = "AccTesPublisher240311031615611092"
    offer     = "AccTesOffer240311031615611092"
    sku       = "AccTesSku240311031615611092"
  }
}
