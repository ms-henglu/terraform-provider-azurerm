...
locals {
  number            = "230707003540145174"
  location          = "West Europe"
  domain_name_label = "acctestvm-x1orb"
  random_string     = "x1orb"
  admin_username    = "testadmin230707003540145174"
  admin_password    = "Password1234!230707003540145174"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230707003540145174"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230707003540145174"
  ...
  identifier {
    publisher = "AccTesPublisher230707003540145174"
    offer     = "AccTesOffer230707003540145174"
    sku       = "AccTesSku230707003540145174"
  }
}
