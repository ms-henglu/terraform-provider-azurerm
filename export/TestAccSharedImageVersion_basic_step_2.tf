...
locals {
  number            = "210826023203599987"
  location          = "West Europe"
  domain_name_label = "acctestvm-crjr6"
  random_string     = "crjr6"
  admin_username    = "testadmin210826023203599987"
  admin_password    = "Password1234!210826023203599987"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210826023203599987"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210826023203599987"
  ...
  identifier {
    publisher = "AccTesPublisher210826023203599987"
    offer     = "AccTesOffer210826023203599987"
    sku       = "AccTesSku210826023203599987"
  }
}
