...
locals {
  number            = "211105035652870304"
  location          = "West Europe"
  domain_name_label = "acctestvm-0yi73"
  random_string     = "0yi73"
  admin_username    = "testadmin211105035652870304"
  admin_password    = "Password1234!211105035652870304"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211105035652870304"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211105035652870304"
  ...
  identifier {
    publisher = "AccTesPublisher211105035652870304"
    offer     = "AccTesOffer211105035652870304"
    sku       = "AccTesSku211105035652870304"
  }
}
