...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210910021215851972"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210910021215851972"
  ...
  identifier {
    publisher = "AccTesPublisher210910021215851972"
    offer     = "AccTesOffer210910021215851972"
    sku       = "AccTesSku210910021215851972"
  }
}
