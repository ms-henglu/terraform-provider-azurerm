...
resource "azurerm_resource_group" "test1" {
  name     = "acctestRG-api1-221111013031388793"
  location = "West Europe"
}

resource "azurerm_resource_group" "test2" {
  name     = "acctestRG-api2-221111013031388793"
  location = "West US 2"
}

resource "azurerm_resource_group" "test3" {
  name     = "acctestRG-api3-221111013031388793"
  location = "East US 2"
}

resource "azurerm_api_management" "test" {
  name                      = "acctestAM-221111013031388793"
  publisher_name            = "pub1"
  ...
  hostname_configuration {
    proxy {
      host_name                    = "acctestAM-221111013031388793.azure-api.net"
