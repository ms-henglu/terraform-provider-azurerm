...
locals {
  number            = "230728025312847144"
  location          = "West Europe"
  domain_name_label = "acctestvm-0hji4"
  random_string     = "0hji4"
  admin_username    = "testadmin230728025312847144"
  admin_password    = "Password1234!230728025312847144"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230728025312847144"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230728025312847144"
  ...
  identifier {
    publisher = "AccTesPublisher230728025312847144"
    offer     = "AccTesOffer230728025312847144"
    sku       = "AccTesSku230728025312847144"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230728025312847144"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
