...
locals {
  number            = "231020040746250137"
  location          = "West Europe"
  domain_name_label = "acctestvm-audxj"
  random_string     = "audxj"
  admin_username    = "testadmin231020040746250137"
  admin_password    = "Password1234!231020040746250137"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231020040746250137"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231020040746250137"
  ...
  identifier {
    publisher = "AccTesPublisher231020040746250137"
    offer     = "AccTesOffer231020040746250137"
    sku       = "AccTesSku231020040746250137"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-231020040746250137"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
