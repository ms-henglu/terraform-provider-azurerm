...
locals {
  number            = "230505050044913928"
  location          = "West Europe"
  domain_name_label = "acctestvm-yma1q"
  random_string     = "yma1q"
  admin_username    = "testadmin230505050044913928"
  admin_password    = "Password1234!230505050044913928"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230505050044913928"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230505050044913928"
  ...
  identifier {
    publisher = "AccTesPublisher230505050044913928"
    offer     = "AccTesOffer230505050044913928"
    sku       = "AccTesSku230505050044913928"
  }
}
