...
locals {
  number            = "220324180045323910"
  location          = "West Europe"
  domain_name_label = "acctestvm-af6yy"
  random_string     = "af6yy"
  admin_username    = "testadmin220324180045323910"
  admin_password    = "Password1234!220324180045323910"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220324180045323910"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220324180045323910"
  ...
  identifier {
    publisher = "AccTesPublisher220324180045323910"
    offer     = "AccTesOffer220324180045323910"
    sku       = "AccTesSku220324180045323910"
  }
}
