...
locals {
  number            = "230526084758995413"
  location          = "West Europe"
  domain_name_label = "acctestvm-uyols"
  random_string     = "uyols"
  admin_username    = "testadmin230526084758995413"
  admin_password    = "Password1234!230526084758995413"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230526084758995413"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230526084758995413"
  ...
  identifier {
    publisher = "AccTesPublisher230526084758995413"
    offer     = "AccTesOffer230526084758995413"
    sku       = "AccTesSku230526084758995413"
  }
}
