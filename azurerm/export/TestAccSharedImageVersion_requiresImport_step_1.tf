...
locals {
  number            = "220627131710509475"
  location          = "West Europe"
  domain_name_label = "acctestvm-if20h"
  random_string     = "if20h"
  admin_username    = "testadmin220627131710509475"
  admin_password    = "Password1234!220627131710509475"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627131710509475"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627131710509475"
  ...
  identifier {
    publisher = "AccTesPublisher220627131710509475"
    offer     = "AccTesOffer220627131710509475"
    sku       = "AccTesSku220627131710509475"
  }
}
