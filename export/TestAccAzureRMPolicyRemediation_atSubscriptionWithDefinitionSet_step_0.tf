...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-0nkox"
  policy_type  = "Custom"
  display_name = "testPolicySet-0nkox"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-0nkox"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-0nkox"
