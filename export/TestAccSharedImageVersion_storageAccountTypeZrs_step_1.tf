...
locals {
  number            = "220715004235780649"
  location          = "West Europe"
  domain_name_label = "acctestvm-sgp0b"
  random_string     = "sgp0b"
  admin_username    = "testadmin220715004235780649"
  admin_password    = "Password1234!220715004235780649"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220715004235780649"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220715004235780649"
  ...
  identifier {
    publisher = "AccTesPublisher220715004235780649"
    offer     = "AccTesOffer220715004235780649"
    sku       = "AccTesSku220715004235780649"
  }
}
