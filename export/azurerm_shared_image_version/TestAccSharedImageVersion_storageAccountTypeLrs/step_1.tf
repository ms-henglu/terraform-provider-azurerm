...
locals {
  number            = "230810143140374963"
  location          = "West Europe"
  domain_name_label = "acctestvm-a481g"
  random_string     = "a481g"
  admin_username    = "testadmin230810143140374963"
  admin_password    = "Password1234!230810143140374963"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230810143140374963"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230810143140374963"
  ...
  identifier {
    publisher = "AccTesPublisher230810143140374963"
    offer     = "AccTesOffer230810143140374963"
    sku       = "AccTesSku230810143140374963"
  }
}
