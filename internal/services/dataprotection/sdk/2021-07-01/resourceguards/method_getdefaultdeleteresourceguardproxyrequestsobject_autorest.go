...
type GetDefaultDeleteResourceGuardProxyRequestsObjectResponse struct {
	HttpResponse *http.Response
	Model        *DppBaseResource
}

// GetDefaultDeleteResourceGuardProxyRequestsObject ...
func (c ResourceGuardsClient) GetDefaultDeleteResourceGuardProxyRequestsObject(ctx context.Context, id DeleteResourceGuardProxyRequestId) (result GetDefaultDeleteResourceGuardProxyRequestsObjectResponse, err error) {
...
func (c ResourceGuardsClient) responderForGetDefaultDeleteResourceGuardProxyRequestsObject(resp *http.Response) (result GetDefaultDeleteResourceGuardProxyRequestsObjectResponse, err error) {
