...
resource "azurerm_resource_group" "test" {
  name     = "acctest220211044044004591"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-220211044044004591"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestpol-220211044044004591"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestpol-220211044044004591"
...
resource "azurerm_resource_policy_assignment" "test" {
  name                 = "acctestpa-220211044044004591"
