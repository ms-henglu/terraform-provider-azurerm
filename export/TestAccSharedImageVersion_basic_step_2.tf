...
locals {
  number            = "211015014023154451"
  location          = "West Europe"
  domain_name_label = "acctestvm-bqvc2"
  random_string     = "bqvc2"
  admin_username    = "testadmin211015014023154451"
  admin_password    = "Password1234!211015014023154451"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211015014023154451"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211015014023154451"
  ...
  identifier {
    publisher = "AccTesPublisher211015014023154451"
    offer     = "AccTesOffer211015014023154451"
    sku       = "AccTesSku211015014023154451"
  }
}
