...
locals {
  number            = "211105035652878441"
  location          = "West Europe"
  domain_name_label = "acctestvm-ms0i8"
  random_string     = "ms0i8"
  admin_username    = "testadmin211105035652878441"
  admin_password    = "Password1234!211105035652878441"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211105035652878441"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211105035652878441"
  ...
  identifier {
    publisher = "AccTesPublisher211105035652878441"
    offer     = "AccTesOffer211105035652878441"
    sku       = "AccTesSku211105035652878441"
  }
}
