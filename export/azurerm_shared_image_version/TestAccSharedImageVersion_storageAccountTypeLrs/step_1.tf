...
locals {
  number            = "230120054357245496"
  location          = "West Europe"
  domain_name_label = "acctestvm-qi1ec"
  random_string     = "qi1ec"
  admin_username    = "testadmin230120054357245496"
  admin_password    = "Password1234!230120054357245496"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230120054357245496"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230120054357245496"
  ...
  identifier {
    publisher = "AccTesPublisher230120054357245496"
    offer     = "AccTesOffer230120054357245496"
    sku       = "AccTesSku230120054357245496"
  }
}
