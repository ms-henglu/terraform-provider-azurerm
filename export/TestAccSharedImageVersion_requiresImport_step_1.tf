...
locals {
  number            = "220916011219831552"
  location          = "West Europe"
  domain_name_label = "acctestvm-9xw31"
  random_string     = "9xw31"
  admin_username    = "testadmin220916011219831552"
  admin_password    = "Password1234!220916011219831552"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220916011219831552"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220916011219831552"
  ...
  identifier {
    publisher = "AccTesPublisher220916011219831552"
    offer     = "AccTesOffer220916011219831552"
    sku       = "AccTesSku220916011219831552"
  }
}
