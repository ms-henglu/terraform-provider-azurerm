...
locals {
  number            = "230526084758998922"
  location          = "West Europe"
  domain_name_label = "acctestvm-bfeej"
  random_string     = "bfeej"
  admin_username    = "testadmin230526084758998922"
  admin_password    = "Password1234!230526084758998922"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230526084758998922"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230526084758998922"
  ...
  identifier {
    publisher = "AccTesPublisher230526084758998922"
    offer     = "AccTesOffer230526084758998922"
    sku       = "AccTesSku230526084758998922"
  }
}
