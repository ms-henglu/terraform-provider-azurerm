...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-o72mf"
  policy_type  = "Custom"
  display_name = "testPolicySet-o72mf"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-o72mf"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-o72mf"
