...
locals {
  number            = "220324180045329940"
  location          = "West Europe"
  domain_name_label = "acctestvm-c1kmz"
  random_string     = "c1kmz"
  admin_username    = "testadmin220324180045329940"
  admin_password    = "Password1234!220324180045329940"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220324180045329940"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220324180045329940"
  ...
  identifier {
    publisher = "AccTesPublisher220324180045329940"
    offer     = "AccTesOffer220324180045329940"
    sku       = "AccTesSku220324180045329940"
  }
}
