...
locals {
  number            = "220211043347730462"
  location          = "West Europe"
  domain_name_label = "acctestvm-or2r3"
  random_string     = "or2r3"
  admin_username    = "testadmin220211043347730462"
  admin_password    = "Password1234!220211043347730462"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220211043347730462"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220211043347730462"
  ...
  identifier {
    publisher = "AccTesPublisher220211043347730462"
    offer     = "AccTesOffer220211043347730462"
    sku       = "AccTesSku220211043347730462"
  }
}
