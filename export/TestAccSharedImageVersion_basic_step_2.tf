...
locals {
  number            = "220211130332037777"
  location          = "West Europe"
  domain_name_label = "acctestvm-bcrnw"
  random_string     = "bcrnw"
  admin_username    = "testadmin220211130332037777"
  admin_password    = "Password1234!220211130332037777"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220211130332037777"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220211130332037777"
  ...
  identifier {
    publisher = "AccTesPublisher220211130332037777"
    offer     = "AccTesOffer220211130332037777"
    sku       = "AccTesSku220211130332037777"
  }
}
