...
locals {
  number            = "220627125722841484"
  location          = "West Europe"
  domain_name_label = "acctestvm-hmr83"
  random_string     = "hmr83"
  admin_username    = "testadmin220627125722841484"
  admin_password    = "Password1234!220627125722841484"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627125722841484"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627125722841484"
  ...
  identifier {
    publisher = "AccTesPublisher220627125722841484"
    offer     = "AccTesOffer220627125722841484"
    sku       = "AccTesSku220627125722841484"
  }
}
