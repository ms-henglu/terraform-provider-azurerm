...
locals {
  number            = "230106031234903190"
  location          = "West Europe"
  domain_name_label = "acctestvm-vei3w"
  random_string     = "vei3w"
  admin_username    = "testadmin230106031234903190"
  admin_password    = "Password1234!230106031234903190"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230106031234903190"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230106031234903190"
  ...
  identifier {
    publisher = "AccTesPublisher230106031234903190"
    offer     = "AccTesOffer230106031234903190"
    sku       = "AccTesSku230106031234903190"
  }
}
