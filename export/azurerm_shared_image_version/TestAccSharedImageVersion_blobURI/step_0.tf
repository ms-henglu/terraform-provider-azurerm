...
locals {
  number            = "221111020149334720"
  location          = "West Europe"
  domain_name_label = "acctestvm-qijiz"
  random_string     = "qijiz"
  admin_username    = "testadmin221111020149334720"
  admin_password    = "Password1234!221111020149334720"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221111020149334720"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221111020149334720"
  ...
  identifier {
    publisher = "AccTesPublisher221111020149334720"
    offer     = "AccTesOffer221111020149334720"
    sku       = "AccTesSku221111020149334720"
  }
}
