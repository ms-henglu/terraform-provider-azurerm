...
locals {
  number            = "221021030948789799"
  location          = "West Europe"
  domain_name_label = "acctestvm-tcrq2"
  random_string     = "tcrq2"
  admin_username    = "testadmin221021030948789799"
  admin_password    = "Password1234!221021030948789799"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221021030948789799"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221021030948789799"
  ...
  identifier {
    publisher = "AccTesPublisher221021030948789799"
    offer     = "AccTesOffer221021030948789799"
    sku       = "AccTesSku221021030948789799"
  }
}
