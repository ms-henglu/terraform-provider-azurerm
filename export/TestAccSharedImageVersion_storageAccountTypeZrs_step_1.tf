...
locals {
  number            = "210826023203591687"
  location          = "West Europe"
  domain_name_label = "acctestvm-rqt46"
  random_string     = "rqt46"
  admin_username    = "testadmin210826023203591687"
  admin_password    = "Password1234!210826023203591687"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210826023203591687"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210826023203591687"
  ...
  identifier {
    publisher = "AccTesPublisher210826023203591687"
    offer     = "AccTesOffer210826023203591687"
    sku       = "AccTesSku210826023203591687"
  }
}
