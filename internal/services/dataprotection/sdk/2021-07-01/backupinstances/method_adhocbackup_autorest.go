...
type AdhocBackupResponse struct {
	Poller       polling.LongRunningPoller
	HttpResponse *http.Response
}

// AdhocBackup ...
func (c BackupInstancesClient) AdhocBackup(ctx context.Context, id BackupInstanceId, input TriggerBackupRequest) (result AdhocBackupResponse, err error) {
...
func (c BackupInstancesClient) senderForAdhocBackup(ctx context.Context, req *http.Request) (future AdhocBackupResponse, err error) {
