...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-211029015641815820"
  location = "West Europe"
}

resource "azurerm_storage_account" "gen2test" {
  name                     = "accgen2testg73kn"
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestvirtnet211029015641815820"
...
resource "azurerm_subnet" "test" {
  name                 = "acctestsubnet211029015641815820"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_public_ip" "test" {
  name                = "acctestpip211029015641815820"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_nat_gateway" "test" {
  name                    = "acctestnat211029015641815820"
  location                = azurerm_resource_group.test.location
  resource_group_name     = azurerm_resource_group.test.name
  sku_name                = "Standard"
...
resource "azurerm_hdinsight_interactive_query_cluster" "test" {
  ...
  name                = "acctesthdi-211029015641815820"
  resource_group_name = "${azurerm_resource_group.test.name}"
  location            = "${azurerm_resource_group.test.location}"
  cluster_version     = "4.0"
  tier                = "Standard"
...
resource "azurerm_network_security_group" "test" {
  name                = "acctestnsg-211029015641815820"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
