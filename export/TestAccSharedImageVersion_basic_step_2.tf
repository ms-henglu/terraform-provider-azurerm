...
locals {
  number            = "211210024414742115"
  location          = "West Europe"
  domain_name_label = "acctestvm-jdxls"
  random_string     = "jdxls"
  admin_username    = "testadmin211210024414742115"
  admin_password    = "Password1234!211210024414742115"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211210024414742115"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211210024414742115"
  ...
  identifier {
    publisher = "AccTesPublisher211210024414742115"
    offer     = "AccTesOffer211210024414742115"
    sku       = "AccTesSku211210024414742115"
  }
}
