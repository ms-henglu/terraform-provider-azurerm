...
locals {
  number            = "221104005221355513"
  location          = "West Europe"
  domain_name_label = "acctestvm-mpbsy"
  random_string     = "mpbsy"
  admin_username    = "testadmin221104005221355513"
  admin_password    = "Password1234!221104005221355513"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221104005221355513"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221104005221355513"
  ...
  identifier {
    publisher = "AccTesPublisher221104005221355513"
    offer     = "AccTesOffer221104005221355513"
    sku       = "AccTesSku221104005221355513"
  }
}
