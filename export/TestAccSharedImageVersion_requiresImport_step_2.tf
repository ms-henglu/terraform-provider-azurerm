...
locals {
  number            = "220527033935752381"
  location          = "West Europe"
  domain_name_label = "acctestvm-lqeet"
  random_string     = "lqeet"
  admin_username    = "testadmin220527033935752381"
  admin_password    = "Password1234!220527033935752381"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220527033935752381"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220527033935752381"
  ...
  identifier {
    publisher = "AccTesPublisher220527033935752381"
    offer     = "AccTesOffer220527033935752381"
    sku       = "AccTesSku220527033935752381"
  }
}
