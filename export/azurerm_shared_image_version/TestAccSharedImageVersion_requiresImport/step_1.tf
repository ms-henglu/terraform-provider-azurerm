...
locals {
  number            = "231013043133455063"
  location          = "West Europe"
  domain_name_label = "acctestvm-d4u7y"
  random_string     = "d4u7y"
  admin_username    = "testadmin231013043133455063"
  admin_password    = "Password1234!231013043133455063"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231013043133455063"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231013043133455063"
  ...
  identifier {
    publisher = "AccTesPublisher231013043133455063"
    offer     = "AccTesOffer231013043133455063"
    sku       = "AccTesSku231013043133455063"
  }
}
