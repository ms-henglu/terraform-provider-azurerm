...
locals {
  number            = "240112034043049890"
  location          = "West Europe"
  domain_name_label = "acctestvm-cn0gf"
  random_string     = "cn0gf"
  admin_username    = "testadmin240112034043049890"
  admin_password    = "Password1234!240112034043049890"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240112034043049890"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240112034043049890"
  ...
  identifier {
    publisher = "AccTesPublisher240112034043049890"
    offer     = "AccTesOffer240112034043049890"
    sku       = "AccTesSku240112034043049890"
  }
}
