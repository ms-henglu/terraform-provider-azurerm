...
func TestNetworkAdminRuleIDFormatter(t *testing.T) {
	...
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Network/networkManagers/networkManager1/securityAdminConfigurations/securityConfiguration1/ruleCollections/ruleCollection1/rules/rule1"
	if actual != expected {
...
func TestNetworkAdminRuleID(t *testing.T) {
	testData := []struct {
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Network/networkManagers/networkManager1/securityAdminConfigurations/securityConfiguration1/ruleCollections/ruleCollection1/rules/",
			Error: true,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Network/networkManagers/networkManager1/securityAdminConfigurations/securityConfiguration1/ruleCollections/ruleCollection1/rules/rule1",
			Expected: &NetworkAdminRuleId{
