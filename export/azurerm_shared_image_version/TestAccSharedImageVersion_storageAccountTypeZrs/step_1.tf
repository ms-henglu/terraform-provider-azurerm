...
locals {
  number            = "221202035328131127"
  location          = "West Europe"
  domain_name_label = "acctestvm-i71c7"
  random_string     = "i71c7"
  admin_username    = "testadmin221202035328131127"
  admin_password    = "Password1234!221202035328131127"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221202035328131127"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221202035328131127"
  ...
  identifier {
    publisher = "AccTesPublisher221202035328131127"
    offer     = "AccTesOffer221202035328131127"
    sku       = "AccTesSku221202035328131127"
  }
}
