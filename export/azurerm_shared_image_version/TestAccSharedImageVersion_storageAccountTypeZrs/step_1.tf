...
locals {
  number            = "231013043133451223"
  location          = "West Europe"
  domain_name_label = "acctestvm-779av"
  random_string     = "779av"
  admin_username    = "testadmin231013043133451223"
  admin_password    = "Password1234!231013043133451223"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231013043133451223"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231013043133451223"
  ...
  identifier {
    publisher = "AccTesPublisher231013043133451223"
    offer     = "AccTesOffer231013043133451223"
    sku       = "AccTesSku231013043133451223"
  }
}
