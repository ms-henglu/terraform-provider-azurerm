...
locals {
  number            = "230120051707940646"
  location          = "West Europe"
  domain_name_label = "acctestvm-tgtlo"
  random_string     = "tgtlo"
  admin_username    = "testadmin230120051707940646"
  admin_password    = "Password1234!230120051707940646"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230120051707940646"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230120051707940646"
  ...
  identifier {
    publisher = "AccTesPublisher230120051707940646"
    offer     = "AccTesOffer230120051707940646"
    sku       = "AccTesSku230120051707940646"
  }
}
