...
locals {
  number            = "230120054357245554"
  location          = "West Europe"
  domain_name_label = "acctestvm-aki0d"
  random_string     = "aki0d"
  admin_username    = "testadmin230120054357245554"
  admin_password    = "Password1234!230120054357245554"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230120054357245554"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230120054357245554"
  ...
  identifier {
    publisher = "AccTesPublisher230120054357245554"
    offer     = "AccTesOffer230120054357245554"
    sku       = "AccTesSku230120054357245554"
  }
}
