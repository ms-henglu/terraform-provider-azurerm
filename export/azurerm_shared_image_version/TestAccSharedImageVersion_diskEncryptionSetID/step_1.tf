...
locals {
  number            = "221111013238948898"
  location          = "West Europe"
  domain_name_label = "acctestvm-sdo4t"
  random_string     = "sdo4t"
  admin_username    = "testadmin221111013238948898"
  admin_password    = "Password1234!221111013238948898"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221111013238948898"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221111013238948898"
  ...
  identifier {
    publisher = "AccTesPublisher221111013238948898"
    offer     = "AccTesOffer221111013238948898"
    sku       = "AccTesSku221111013238948898"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-221111013238948898"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
