...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-211001021211369153"
  location = "West Europe"
}

resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhub-211001021211369153"
  location            = "West Europe"
...
resource "azurerm_eventhub_authorization_rule" "test" {
  name                = "acctest-eventhub-auth-rule-211001021211369153"
  namespace_name      = azurerm_eventhub_namespace.test.name
...
resource "azurerm_security_center_automation" "test" {
  name                = "acctestautomation-211001021211369153"
  location            = "West Europe"
  resource_group_name = azurerm_resource_group.test.name
