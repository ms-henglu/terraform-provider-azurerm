...
locals {
  number            = "231218071435561485"
  location          = "West Europe"
  domain_name_label = "acctestvm-g93wj"
  random_string     = "g93wj"
  admin_username    = "testadmin231218071435561485"
  admin_password    = "Password1234!231218071435561485"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231218071435561485"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231218071435561485"
  ...
  identifier {
    publisher = "AccTesPublisher231218071435561485"
    offer     = "AccTesOffer231218071435561485"
    sku       = "AccTesSku231218071435561485"
  }
}
