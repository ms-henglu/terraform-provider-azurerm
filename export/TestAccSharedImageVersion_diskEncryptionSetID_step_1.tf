...
locals {
  number            = "220812014802179675"
  location          = "West Europe"
  domain_name_label = "acctestvm-xnw91"
  random_string     = "xnw91"
  admin_username    = "testadmin220812014802179675"
  admin_password    = "Password1234!220812014802179675"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220812014802179675"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220812014802179675"
  ...
  identifier {
    publisher = "AccTesPublisher220812014802179675"
    offer     = "AccTesOffer220812014802179675"
    sku       = "AccTesSku220812014802179675"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220812014802179675"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
