...
locals {
  number            = "230113180850408940"
  location          = "West Europe"
  domain_name_label = "acctestvm-xt96j"
  random_string     = "xt96j"
  admin_username    = "testadmin230113180850408940"
  admin_password    = "Password1234!230113180850408940"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230113180850408940"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230113180850408940"
  ...
  identifier {
    publisher = "AccTesPublisher230113180850408940"
    offer     = "AccTesOffer230113180850408940"
    sku       = "AccTesSku230113180850408940"
  }
}
