...
locals {
  number            = "220623233411087440"
  location          = "West Europe"
  domain_name_label = "acctestvm-7ivsq"
  random_string     = "7ivsq"
  admin_username    = "testadmin220623233411087440"
  admin_password    = "Password1234!220623233411087440"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220623233411087440"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220623233411087440"
  ...
  identifier {
    publisher = "AccTesPublisher220623233411087440"
    offer     = "AccTesOffer220623233411087440"
    sku       = "AccTesSku220623233411087440"
  }
}
