...
locals {
  number            = "240315122550005764"
  location          = "West Europe"
  domain_name_label = "acctestvm-i80tu"
  random_string     = "i80tu"
  admin_username    = "testadmin240315122550005764"
  admin_password    = "Password1234!240315122550005764"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240315122550005764"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240315122550005764"
  ...
  identifier {
    publisher = "AccTesPublisher240315122550005764"
    offer     = "AccTesOffer240315122550005764"
    sku       = "AccTesSku240315122550005764"
  }
}
