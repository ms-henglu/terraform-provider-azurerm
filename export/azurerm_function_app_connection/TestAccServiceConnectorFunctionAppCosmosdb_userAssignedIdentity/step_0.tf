...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-231013044237026631"
  location = "West Europe"
}

resource "azurerm_cosmosdb_account" "test" {
  name                = "acctestcosmosdb231013044237026631"
...
resource "azurerm_app_service_plan" "test" {
  name                = "acctestASP-231013044237026631"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_function_app" "test" {
  name                       = "acctest-231013044237026631-func"
  location                   = azurerm_resource_group.test.location
  resource_group_name        = azurerm_resource_group.test.name
...
resource "azurerm_function_app_connection" "test" {
  name               = "acctestserviceconnector231013044237026631"
