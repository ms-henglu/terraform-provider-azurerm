...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-cognitive-211001053527062343"
  location = "West US 2"
}
...
resource "azurerm_cognitive_account" "test" {
  name                  = "acctest-cogacc-211001053527062343"
  location              = azurerm_resource_group.test.location
  resource_group_name   = azurerm_resource_group.test.name
  kind                  = "Face"
  sku_name              = "E0"
  custom_subdomain_name = "acctest-cogacc-211001053527062343"
  identity {
