...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-230707004458848783"
  location = "West Europe"
}

resource "azurerm_public_ip" "test" {
  name                = "acctest230707004458848783"
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestvirtnet230707004458848783"
...
resource "azurerm_nginx_deployment" "test" {
  name                     = "acctest-230707004458848783"
  resource_group_name      = azurerm_resource_group.test.name
...
resource "azurerm_key_vault_certificate" "test2" {
  name         = "acctestcert2230707004458848783"
  key_vault_id = azurerm_key_vault.test.id
