...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-frontdoor-230721015144610876"
...
resource "azurerm_frontdoor_firewall_policy" "test" {
  name                = "acctestwafp230721015144610876"
  resource_group_name = azurerm_resource_group.test.name
  mode                = "Prevention"
}

resource "azurerm_frontdoor" "test" {
  name                = "acctest-FD-230721015144610876"
  resource_group_name = azurerm_resource_group.test.name
  ...
  frontend_endpoint {
    ...
    host_name                               = "acctest-FD-230721015144610876.azurefd.net"
