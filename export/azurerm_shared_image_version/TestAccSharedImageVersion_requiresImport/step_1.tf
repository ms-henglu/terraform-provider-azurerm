...
locals {
  number            = "230526084759005675"
  location          = "West Europe"
  domain_name_label = "acctestvm-zgebf"
  random_string     = "zgebf"
  admin_username    = "testadmin230526084759005675"
  admin_password    = "Password1234!230526084759005675"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230526084759005675"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230526084759005675"
  ...
  identifier {
    publisher = "AccTesPublisher230526084759005675"
    offer     = "AccTesOffer230526084759005675"
    sku       = "AccTesSku230526084759005675"
  }
}
