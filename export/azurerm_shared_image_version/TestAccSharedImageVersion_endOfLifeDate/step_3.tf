...
locals {
  number            = "230915023108513954"
  location          = "West Europe"
  domain_name_label = "acctestvm-l9lnf"
  random_string     = "l9lnf"
  admin_username    = "testadmin230915023108513954"
  admin_password    = "Password1234!230915023108513954"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230915023108513954"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230915023108513954"
  ...
  identifier {
    publisher = "AccTesPublisher230915023108513954"
    offer     = "AccTesOffer230915023108513954"
    sku       = "AccTesSku230915023108513954"
  }
}
