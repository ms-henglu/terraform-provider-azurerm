...
locals {
  number            = "230106034233474872"
  location          = "West Europe"
  domain_name_label = "acctestvm-8v92i"
  random_string     = "8v92i"
  admin_username    = "testadmin230106034233474872"
  admin_password    = "Password1234!230106034233474872"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230106034233474872"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230106034233474872"
  ...
  identifier {
    publisher = "AccTesPublisher230106034233474872"
    offer     = "AccTesOffer230106034233474872"
    sku       = "AccTesSku230106034233474872"
  }
}
