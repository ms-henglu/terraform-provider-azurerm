...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-230915024316105801"
  location = "West Europe"
}

resource "azurerm_sql_server" "test" {
  name                         = "acctestserver-bxxbb"
...
resource "azurerm_stream_analytics_output_mssql" "test" {
  name                      = "acctestoutput-230915024316105801"
  ...
  max_batch_count  = 10001.000000
  max_writer_count = 0.000000
}
