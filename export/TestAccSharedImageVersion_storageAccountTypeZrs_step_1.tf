...
locals {
  number            = "220408051032009465"
  location          = "West Europe"
  domain_name_label = "acctestvm-opv6o"
  random_string     = "opv6o"
  admin_username    = "testadmin220408051032009465"
  admin_password    = "Password1234!220408051032009465"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220408051032009465"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220408051032009465"
  ...
  identifier {
    publisher = "AccTesPublisher220408051032009465"
    offer     = "AccTesOffer220408051032009465"
    sku       = "AccTesSku220408051032009465"
  }
}
