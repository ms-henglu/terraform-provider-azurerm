...
resource "azurerm_policy_definition" "test" {
  name         = "acctestpol-211217035803389914"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestpol-211217035803389914"
...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-211217035803389914"
  location = "West Europe"
}

resource "azurerm_log_analytics_workspace" "test" {
  name                = "acctestLAW-211217035803389914"
...
resource "azurerm_policy_assignment" "test" {
  name                 = "acctestpa-211217035803389914"
  scope                = azurerm_resource_group.test.id
  policy_definition_id = azurerm_policy_definition.test.id
  description          = "Policy Assignment created via an Acceptance Test"
  display_name         = "Acceptance Test Run 211217035803389914"
...
resource "azurerm_resource_group_template_deployment" "test" {
  name                = "acctestrgtd-211217035803389914"
  resource_group_name = azurerm_resource_group.test.name
...
{
  "description": {
   "value": "description-211217035803389914"
  },
  "displayName": {
    "value": "name--211217035803389914"
  },
  "exemptionCategory": {
    "value": "Waiver"
  },
