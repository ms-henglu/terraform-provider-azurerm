...
locals {
  number            = "221216013235533382"
  location          = "West Europe"
  domain_name_label = "acctestvm-rjjel"
  random_string     = "rjjel"
  admin_username    = "testadmin221216013235533382"
  admin_password    = "Password1234!221216013235533382"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221216013235533382"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221216013235533382"
  ...
  identifier {
    publisher = "AccTesPublisher221216013235533382"
    offer     = "AccTesOffer221216013235533382"
    sku       = "AccTesSku221216013235533382"
  }
}
