...
locals {
  number            = "230519074408706298"
  location          = "West Europe"
  domain_name_label = "acctestvm-n1zru"
  random_string     = "n1zru"
  admin_username    = "testadmin230519074408706298"
  admin_password    = "Password1234!230519074408706298"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230519074408706298"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230519074408706298"
  ...
  identifier {
    publisher = "AccTesPublisher230519074408706298"
    offer     = "AccTesOffer230519074408706298"
    sku       = "AccTesSku230519074408706298"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230519074408706298"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
