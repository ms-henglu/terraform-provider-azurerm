...
locals {
  number            = "230227032410650388"
  location          = "West Europe"
  domain_name_label = "acctestvm-d1o83"
  random_string     = "d1o83"
  admin_username    = "testadmin230227032410650388"
  admin_password    = "Password1234!230227032410650388"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230227032410650388"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230227032410650388"
  ...
  identifier {
    publisher = "AccTesPublisher230227032410650388"
    offer     = "AccTesOffer230227032410650388"
    sku       = "AccTesSku230227032410650388"
  }
}
