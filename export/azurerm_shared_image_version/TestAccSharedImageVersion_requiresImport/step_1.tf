...
locals {
  number            = "230609091011711684"
  location          = "West Europe"
  domain_name_label = "acctestvm-0ne1o"
  random_string     = "0ne1o"
  admin_username    = "testadmin230609091011711684"
  admin_password    = "Password1234!230609091011711684"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230609091011711684"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230609091011711684"
  ...
  identifier {
    publisher = "AccTesPublisher230609091011711684"
    offer     = "AccTesOffer230609091011711684"
    sku       = "AccTesSku230609091011711684"
  }
}
