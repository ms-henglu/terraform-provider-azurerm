...
locals {
  number            = "220211043347738000"
  location          = "West Europe"
  domain_name_label = "acctestvm-ewgiy"
  random_string     = "ewgiy"
  admin_username    = "testadmin220211043347738000"
  admin_password    = "Password1234!220211043347738000"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220211043347738000"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220211043347738000"
  ...
  identifier {
    publisher = "AccTesPublisher220211043347738000"
    offer     = "AccTesOffer220211043347738000"
    sku       = "AccTesSku220211043347738000"
  }
}
