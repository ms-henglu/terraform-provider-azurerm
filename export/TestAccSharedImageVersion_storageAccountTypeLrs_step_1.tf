...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220114014015954748"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220114014015954748"
  ...
  identifier {
    publisher = "AccTesPublisher220114014015954748"
    offer     = "AccTesOffer220114014015954748"
    sku       = "AccTesSku220114014015954748"
  }
}
