...
locals {
  rg_name              = "acctest-nested-rg-230707004617532929"
  location             = "West Europe"
  vn_name              = "acctest-nested-vn-230707004617532929"
  ip_name              = "acctest-nested-ip-230707004617532929"
  vm_name              = "acctest-nested-vm-230707004617532929"
  nic_name             = "acctest-nested-nic-230707004617532929"
  disk_name            = "acctest-nested-disk-230707004617532929"
  keyvault_name        = "acctkv230707004617532929"
  nsg_name             = "acctest-nested-nsg-230707004617532929"
  recovery_vault_name  = "acctest-nested-recovery-vault-230707004617532929"
  recovery_site_name   = "acctest-nested-recovery-site-230707004617532929"
  admin_name           = "acctestadmin"
  cert_name            = "acctestcert"
  storage_account_name = "acctestsaz2kiv"
}
...
resource "azurerm_windows_virtual_machine" "host" {
  ...
  additional_unattend_content {
    setting = "AutoLogon"
    content = "<AutoLogon><Password><Value>J#)!s8#)1c</Value></Password><Enabled>true</Enabled><LogonCount>1</LogonCount><Username>${local.admin_name}</Username></AutoLogon>"
  }
...
resource "azurerm_site_recovery_hyperv_replication_policy" "test" {
  recovery_vault_id                                  = azurerm_recovery_services_vault.test.id
  name                                               = "acctest-policy-230707004617532929"
