...
locals {
  number            = "221202035328134019"
  location          = "West Europe"
  domain_name_label = "acctestvm-jmaz1"
  random_string     = "jmaz1"
  admin_username    = "testadmin221202035328134019"
  admin_password    = "Password1234!221202035328134019"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221202035328134019"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221202035328134019"
  ...
  identifier {
    publisher = "AccTesPublisher221202035328134019"
    offer     = "AccTesOffer221202035328134019"
    sku       = "AccTesSku221202035328134019"
  }
}
