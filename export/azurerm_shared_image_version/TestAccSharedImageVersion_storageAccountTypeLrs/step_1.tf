...
locals {
  number            = "230203063036574871"
  location          = "West Europe"
  domain_name_label = "acctestvm-u8pr4"
  random_string     = "u8pr4"
  admin_username    = "testadmin230203063036574871"
  admin_password    = "Password1234!230203063036574871"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230203063036574871"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230203063036574871"
  ...
  identifier {
    publisher = "AccTesPublisher230203063036574871"
    offer     = "AccTesOffer230203063036574871"
    sku       = "AccTesSku230203063036574871"
  }
}
