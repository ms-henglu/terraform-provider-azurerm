...
locals {
  number            = "240119024707424861"
  location          = "West Europe"
  domain_name_label = "acctestvm-vyewo"
  random_string     = "vyewo"
  admin_username    = "testadmin240119024707424861"
  admin_password    = "Password1234!240119024707424861"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240119024707424861"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240119024707424861"
  ...
  identifier {
    publisher = "AccTesPublisher240119024707424861"
    offer     = "AccTesOffer240119024707424861"
    sku       = "AccTesSku240119024707424861"
  }
}
