...
locals {
  number            = "230602030259357710"
  location          = "West Europe"
  domain_name_label = "acctestvm-cmg6f"
  random_string     = "cmg6f"
  admin_username    = "testadmin230602030259357710"
  admin_password    = "Password1234!230602030259357710"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230602030259357710"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230602030259357710"
  ...
  identifier {
    publisher = "AccTesPublisher230602030259357710"
    offer     = "AccTesOffer230602030259357710"
    sku       = "AccTesSku230602030259357710"
  }
}
