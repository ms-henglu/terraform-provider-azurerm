...
locals {
  number            = "240105063504067439"
  location          = "West Europe"
  domain_name_label = "acctestvm-6ypph"
  random_string     = "6ypph"
  admin_username    = "testadmin240105063504067439"
  admin_password    = "Password1234!240105063504067439"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105063504067439"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105063504067439"
  ...
  identifier {
    publisher = "AccTesPublisher240105063504067439"
    offer     = "AccTesOffer240105063504067439"
    sku       = "AccTesSku240105063504067439"
  }
}
