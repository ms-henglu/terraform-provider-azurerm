...
locals {
  number            = "230120054357248627"
  location          = "West Europe"
  domain_name_label = "acctestvm-cdgm1"
  random_string     = "cdgm1"
  admin_username    = "testadmin230120054357248627"
  admin_password    = "Password1234!230120054357248627"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230120054357248627"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230120054357248627"
  ...
  identifier {
    publisher = "AccTesPublisher230120054357248627"
    offer     = "AccTesOffer230120054357248627"
    sku       = "AccTesSku230120054357248627"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230120054357248627"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
