...
locals {
  number            = "220204055814366512"
  location          = "West Europe"
  domain_name_label = "acctestvm-977tx"
  random_string     = "977tx"
  admin_username    = "testadmin220204055814366512"
  admin_password    = "Password1234!220204055814366512"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220204055814366512"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220204055814366512"
  ...
  identifier {
    publisher = "AccTesPublisher220204055814366512"
    offer     = "AccTesOffer220204055814366512"
    sku       = "AccTesSku220204055814366512"
  }
}
