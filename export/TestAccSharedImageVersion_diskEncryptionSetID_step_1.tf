...
locals {
  number            = "220715004235782971"
  location          = "West Europe"
  domain_name_label = "acctestvm-91ogy"
  random_string     = "91ogy"
  admin_username    = "testadmin220715004235782971"
  admin_password    = "Password1234!220715004235782971"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220715004235782971"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220715004235782971"
  ...
  identifier {
    publisher = "AccTesPublisher220715004235782971"
    offer     = "AccTesOffer220715004235782971"
    sku       = "AccTesSku220715004235782971"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220715004235782971"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
