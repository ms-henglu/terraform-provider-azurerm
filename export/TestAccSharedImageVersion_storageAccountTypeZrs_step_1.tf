...
locals {
  number            = "220121044320009650"
  location          = "West Europe"
  domain_name_label = "acctestvm-qfd2b"
  random_string     = "qfd2b"
  admin_username    = "testadmin220121044320009650"
  admin_password    = "Password1234!220121044320009650"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220121044320009650"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220121044320009650"
  ...
  identifier {
    publisher = "AccTesPublisher220121044320009650"
    offer     = "AccTesOffer220121044320009650"
    sku       = "AccTesSku220121044320009650"
  }
}
