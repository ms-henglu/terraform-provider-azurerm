...
locals {
  number            = "230505050044923073"
  location          = "West Europe"
  domain_name_label = "acctestvm-elz4y"
  random_string     = "elz4y"
  admin_username    = "testadmin230505050044923073"
  admin_password    = "Password1234!230505050044923073"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230505050044923073"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230505050044923073"
  ...
  identifier {
    publisher = "AccTesPublisher230505050044923073"
    offer     = "AccTesOffer230505050044923073"
    sku       = "AccTesSku230505050044923073"
  }
}
