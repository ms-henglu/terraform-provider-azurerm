...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-ml-230613072145478137"
...
resource "azurerm_application_insights" "test" {
  name                = "acctestai-230613072145478137"
...
resource "azurerm_machine_learning_workspace" "test" {
  name                    = "acctest-MLW2306130721454781"
  location                = azurerm_resource_group.test.location
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_private_endpoint" "test" {
  name                = "test-pe-230613072145478137"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  subnet_id           = azurerm_subnet.test.id

  private_service_connection {
    name                           = "test-mlworkspace-230613072145478137"
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestvirtnet230613072145478137"
...
resource "azurerm_subnet" "test" {
  name                 = "acctestsubnet230613072145478137"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_network_security_group" "test" {
  name                = "test-nsg-230613072145478137"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  security_rule {
    name                       = "test123"
