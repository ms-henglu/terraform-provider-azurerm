...
locals {
  number            = "220128082215749296"
  location          = "West Europe"
  domain_name_label = "acctestvm-j3xss"
  random_string     = "j3xss"
  admin_username    = "testadmin220128082215749296"
  admin_password    = "Password1234!220128082215749296"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220128082215749296"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220128082215749296"
  ...
  identifier {
    publisher = "AccTesPublisher220128082215749296"
    offer     = "AccTesOffer220128082215749296"
    sku       = "AccTesSku220128082215749296"
  }
}
