...
locals {
  number            = "230324051802728286"
  location          = "West Europe"
  domain_name_label = "acctestvm-iu9ql"
  random_string     = "iu9ql"
  admin_username    = "testadmin230324051802728286"
  admin_password    = "Password1234!230324051802728286"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230324051802728286"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230324051802728286"
  ...
  identifier {
    publisher = "AccTesPublisher230324051802728286"
    offer     = "AccTesOffer230324051802728286"
    sku       = "AccTesSku230324051802728286"
  }
}
