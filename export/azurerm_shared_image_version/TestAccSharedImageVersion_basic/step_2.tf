...
locals {
  number            = "221202035328132423"
  location          = "West Europe"
  domain_name_label = "acctestvm-c8jrz"
  random_string     = "c8jrz"
  admin_username    = "testadmin221202035328132423"
  admin_password    = "Password1234!221202035328132423"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221202035328132423"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221202035328132423"
  ...
  identifier {
    publisher = "AccTesPublisher221202035328132423"
    offer     = "AccTesOffer221202035328132423"
    sku       = "AccTesSku221202035328132423"
  }
}
