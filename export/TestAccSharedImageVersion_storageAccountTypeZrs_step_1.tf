...
locals {
  number            = "220627123942224931"
  location          = "West Europe"
  domain_name_label = "acctestvm-9wu26"
  random_string     = "9wu26"
  admin_username    = "testadmin220627123942224931"
  admin_password    = "Password1234!220627123942224931"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627123942224931"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627123942224931"
  ...
  identifier {
    publisher = "AccTesPublisher220627123942224931"
    offer     = "AccTesOffer220627123942224931"
    sku       = "AccTesSku220627123942224931"
  }
}
