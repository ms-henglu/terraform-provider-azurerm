...
locals {
  number            = "220204055814363176"
  location          = "West Europe"
  domain_name_label = "acctestvm-m1vg2"
  random_string     = "m1vg2"
  admin_username    = "testadmin220204055814363176"
  admin_password    = "Password1234!220204055814363176"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220204055814363176"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220204055814363176"
  ...
  identifier {
    publisher = "AccTesPublisher220204055814363176"
    offer     = "AccTesOffer220204055814363176"
    sku       = "AccTesSku220204055814363176"
  }
}
