...
type GetResourcesInResourceGroupResponse struct {
	HttpResponse *http.Response
	Model        *[]ResourceGuardResource

	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (GetResourcesInResourceGroupResponse, error)
}
...
func (r GetResourcesInResourceGroupResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r GetResourcesInResourceGroupResponse) LoadMore(ctx context.Context) (resp GetResourcesInResourceGroupResponse, err error) {
	if !r.HasMore() {
...
func (c ResourceGuardsClient) GetResourcesInResourceGroup(ctx context.Context, id commonids.ResourceGroupId) (resp GetResourcesInResourceGroupResponse, err error) {
...
func (c ResourceGuardsClient) GetResourcesInResourceGroupComplete(ctx context.Context, id commonids.ResourceGroupId) (GetResourcesInResourceGroupCompleteResult, error) {
	return c.GetResourcesInResourceGroupCompleteMatchingPredicate(ctx, id, ResourceGuardResourcePredicate{})
}

// GetResourcesInResourceGroupCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c ResourceGuardsClient) GetResourcesInResourceGroupCompleteMatchingPredicate(ctx context.Context, id commonids.ResourceGroupId, predicate ResourceGuardResourcePredicate) (resp GetResourcesInResourceGroupCompleteResult, err error) {
...
func (c ResourceGuardsClient) responderForGetResourcesInResourceGroup(resp *http.Response) (result GetResourcesInResourceGroupResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result GetResourcesInResourceGroupResponse, err error) {
