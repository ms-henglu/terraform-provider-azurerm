...
locals {
  number            = "210825025624759505"
  location          = "West Europe"
  domain_name_label = "acctestvm-mic62"
  random_string     = "mic62"
  admin_username    = "testadmin210825025624759505"
  admin_password    = "Password1234!210825025624759505"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825025624759505"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825025624759505"
  ...
  identifier {
    publisher = "AccTesPublisher210825025624759505"
    offer     = "AccTesOffer210825025624759505"
    sku       = "AccTesSku210825025624759505"
  }
}
