...
locals {
  number            = "210928055247517334"
  location          = "West Europe"
  domain_name_label = "acctestvm-0rvfq"
  random_string     = "0rvfq"
  admin_username    = "testadmin210928055247517334"
  admin_password    = "Password1234!210928055247517334"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210928055247517334"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210928055247517334"
  ...
  identifier {
    publisher = "AccTesPublisher210928055247517334"
    offer     = "AccTesOffer210928055247517334"
    sku       = "AccTesSku210928055247517334"
  }
}
