...
locals {
  number            = "210906022054100531"
  location          = "West Europe"
  domain_name_label = "acctestvm-twlz7"
  random_string     = "twlz7"
  admin_username    = "testadmin210906022054100531"
  admin_password    = "Password1234!210906022054100531"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210906022054100531"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210906022054100531"
  ...
  identifier {
    publisher = "AccTesPublisher210906022054100531"
    offer     = "AccTesOffer210906022054100531"
    sku       = "AccTesSku210906022054100531"
  }
}
