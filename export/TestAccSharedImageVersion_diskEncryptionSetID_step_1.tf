...
locals {
  number            = "220722051724572999"
  location          = "West Europe"
  domain_name_label = "acctestvm-89cgj"
  random_string     = "89cgj"
  admin_username    = "testadmin220722051724572999"
  admin_password    = "Password1234!220722051724572999"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220722051724572999"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220722051724572999"
  ...
  identifier {
    publisher = "AccTesPublisher220722051724572999"
    offer     = "AccTesOffer220722051724572999"
    sku       = "AccTesSku220722051724572999"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220722051724572999"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
