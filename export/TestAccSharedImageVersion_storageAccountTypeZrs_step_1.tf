...
locals {
  number            = "220630223513053871"
  location          = "West Europe"
  domain_name_label = "acctestvm-ny2vn"
  random_string     = "ny2vn"
  admin_username    = "testadmin220630223513053871"
  admin_password    = "Password1234!220630223513053871"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220630223513053871"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220630223513053871"
  ...
  identifier {
    publisher = "AccTesPublisher220630223513053871"
    offer     = "AccTesOffer220630223513053871"
    sku       = "AccTesSku220630223513053871"
  }
}
