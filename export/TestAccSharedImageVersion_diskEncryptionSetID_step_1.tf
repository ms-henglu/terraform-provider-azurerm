...
locals {
  number            = "220905045548229580"
  location          = "West Europe"
  domain_name_label = "acctestvm-v46ix"
  random_string     = "v46ix"
  admin_username    = "testadmin220905045548229580"
  admin_password    = "Password1234!220905045548229580"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220905045548229580"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220905045548229580"
  ...
  identifier {
    publisher = "AccTesPublisher220905045548229580"
    offer     = "AccTesOffer220905045548229580"
    sku       = "AccTesSku220905045548229580"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220905045548229580"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
