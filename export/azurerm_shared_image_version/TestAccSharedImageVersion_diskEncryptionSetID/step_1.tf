...
locals {
  number            = "221028164721121338"
  location          = "West Europe"
  domain_name_label = "acctestvm-twu4l"
  random_string     = "twu4l"
  admin_username    = "testadmin221028164721121338"
  admin_password    = "Password1234!221028164721121338"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221028164721121338"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221028164721121338"
  ...
  identifier {
    publisher = "AccTesPublisher221028164721121338"
    offer     = "AccTesOffer221028164721121338"
    sku       = "AccTesSku221028164721121338"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-221028164721121338"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
