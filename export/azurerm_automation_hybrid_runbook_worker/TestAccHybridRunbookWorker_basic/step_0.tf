...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-230721011209801570"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctestAA-230721011209801570"
...
resource "azurerm_automation_credential" "test" {
  name                    = "acctest-230721011209801570"
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestnw-230721011209801570"
...
resource "azurerm_network_interface" "test" {
  name                = "acctni-230721011209801570"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "test" {
  name                = "acctestVM-230721011209801570"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_automation_hybrid_runbook_worker" "test" {
  ...
  worker_id               = "559d1787-7af4-4a09-b391-4c7e89294f0f"
