...
func TestAccSpringCloudAPIPortalCustomDomain_complete(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_spring_cloud_api_portal_custom_domain", "test")
	r := SpringCloudAPIPortalCustomDomainResource{}
	data.ResourceTest(t, r, []resource.TestStep{
		{
...
func TestAccSpringCloudAPIPortalCustomDomain_update(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_spring_cloud_api_portal_custom_domain", "test")
	r := SpringCloudAPIPortalCustomDomainResource{}
	data.ResourceTest(t, r, []resource.TestStep{
		{
...
func (r SpringCloudAPIPortalCustomDomainResource) complete(data acceptance.TestData) string {
	template := r.template(data)
	return fmt.Sprintf(`
%s
