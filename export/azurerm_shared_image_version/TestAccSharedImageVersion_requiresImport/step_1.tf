...
locals {
  number            = "221124181402013307"
  location          = "West Europe"
  domain_name_label = "acctestvm-hja9h"
  random_string     = "hja9h"
  admin_username    = "testadmin221124181402013307"
  admin_password    = "Password1234!221124181402013307"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221124181402013307"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221124181402013307"
  ...
  identifier {
    publisher = "AccTesPublisher221124181402013307"
    offer     = "AccTesOffer221124181402013307"
    sku       = "AccTesSku221124181402013307"
  }
}
