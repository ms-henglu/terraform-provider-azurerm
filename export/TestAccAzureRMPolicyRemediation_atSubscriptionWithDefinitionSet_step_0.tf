...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-6296x"
  policy_type  = "Custom"
  display_name = "testPolicySet-6296x"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-6296x"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-6296x"
