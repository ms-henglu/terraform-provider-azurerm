...
locals {
  number            = "230227175227914334"
  location          = "West Europe"
  domain_name_label = "acctestvm-2u6x2"
  random_string     = "2u6x2"
  admin_username    = "testadmin230227175227914334"
  admin_password    = "Password1234!230227175227914334"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230227175227914334"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230227175227914334"
  ...
  identifier {
    publisher = "AccTesPublisher230227175227914334"
    offer     = "AccTesOffer230227175227914334"
    sku       = "AccTesSku230227175227914334"
  }
}
