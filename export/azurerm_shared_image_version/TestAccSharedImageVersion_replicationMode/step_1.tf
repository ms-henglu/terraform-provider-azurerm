...
locals {
  number            = "230721014716581978"
  location          = "West Europe"
  domain_name_label = "acctestvm-9n8hr"
  random_string     = "9n8hr"
  admin_username    = "testadmin230721014716581978"
  admin_password    = "Password1234!230721014716581978"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230721014716581978"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230721014716581978"
  ...
  identifier {
    publisher = "AccTesPublisher230721014716581978"
    offer     = "AccTesOffer230721014716581978"
    sku       = "AccTesSku230721014716581978"
  }
}
