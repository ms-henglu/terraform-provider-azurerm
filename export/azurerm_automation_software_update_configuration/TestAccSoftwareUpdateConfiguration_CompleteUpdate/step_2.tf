...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-240119021605008495"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctest-240119021605008495"
...
resource "azurerm_log_analytics_workspace" "test" {
  name                = "acctestLAW-240119021605008495"
  location            = "west europe"
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "PerGB2018"
...
resource "azurerm_automation_software_update_configuration" "test" {
  ...
  name                  = "acctest-suc-240119021605008495"
  ...
  schedule {
    ...
    start_time         = "2024-01-19T03:16:00Z"
    expiry_time        = "2024-01-19T04:16:00Z"
    is_enabled         = true
    interval           = 2
    frequency          = "Hour"
    time_zone          = "Etc/UTC"
