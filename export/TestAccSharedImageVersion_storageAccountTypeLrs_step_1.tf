...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210906022054105817"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210906022054105817"
  ...
  identifier {
    publisher = "AccTesPublisher210906022054105817"
    offer     = "AccTesOffer210906022054105817"
    sku       = "AccTesSku210906022054105817"
  }
}
