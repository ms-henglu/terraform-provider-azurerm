...
locals {
  number            = "230810143140374626"
  location          = "West Europe"
  domain_name_label = "acctestvm-7buhw"
  random_string     = "7buhw"
  admin_username    = "testadmin230810143140374626"
  admin_password    = "Password1234!230810143140374626"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230810143140374626"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230810143140374626"
  ...
  identifier {
    publisher = "AccTesPublisher230810143140374626"
    offer     = "AccTesOffer230810143140374626"
    sku       = "AccTesSku230810143140374626"
  }
}
