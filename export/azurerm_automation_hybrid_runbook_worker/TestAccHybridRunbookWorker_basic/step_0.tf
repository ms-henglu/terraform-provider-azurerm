...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-240119021604998680"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctestAA-240119021604998680"
...
resource "azurerm_automation_credential" "test" {
  name                    = "acctest-240119021604998680"
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestnw-240119021604998680"
...
resource "azurerm_network_interface" "test" {
  name                = "acctni-240119021604998680"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "test" {
  name                = "acctestVM-240119021604998680"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_automation_hybrid_runbook_worker" "test" {
  ...
  worker_id               = "8d224d67-5c57-4536-8fc1-a963026650f1"
