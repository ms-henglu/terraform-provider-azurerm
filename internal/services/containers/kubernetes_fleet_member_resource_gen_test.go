...
resource "azurerm_kubernetes_fleet_member" "test" {
  cluster_resource_id = azurerm_kubernetes_cluster.test.id
...
resource "azurerm_kubernetes_fleet_member" "import" {
  cluster_resource_id = azurerm_kubernetes_fleet_member.test.cluster_resource_id
  fleet_id            = azurerm_kubernetes_fleet_member.test.fleet_id
