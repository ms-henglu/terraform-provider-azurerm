...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211008044203076354"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211008044203076354"
  ...
  identifier {
    publisher = "AccTesPublisher211008044203076354"
    offer     = "AccTesOffer211008044203076354"
    sku       = "AccTesSku211008044203076354"
  }
}
