...
locals {
  number            = "221216013235533980"
  location          = "West Europe"
  domain_name_label = "acctestvm-x62pn"
  random_string     = "x62pn"
  admin_username    = "testadmin221216013235533980"
  admin_password    = "Password1234!221216013235533980"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221216013235533980"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221216013235533980"
  ...
  identifier {
    publisher = "AccTesPublisher221216013235533980"
    offer     = "AccTesOffer221216013235533980"
    sku       = "AccTesSku221216013235533980"
  }
}
