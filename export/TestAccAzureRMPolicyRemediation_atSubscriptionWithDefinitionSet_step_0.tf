...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-ggqoz"
  policy_type  = "Custom"
  display_name = "testPolicySet-ggqoz"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-ggqoz"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-ggqoz"
