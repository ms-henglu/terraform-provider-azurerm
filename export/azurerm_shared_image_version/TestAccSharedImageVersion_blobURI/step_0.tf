...
locals {
  number            = "230818023718890460"
  location          = "West Europe"
  domain_name_label = "acctestvm-8wmuh"
  random_string     = "8wmuh"
  admin_username    = "testadmin230818023718890460"
  admin_password    = "Password1234!230818023718890460"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230818023718890460"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230818023718890460"
  ...
  identifier {
    publisher = "AccTesPublisher230818023718890460"
    offer     = "AccTesOffer230818023718890460"
    sku       = "AccTesSku230818023718890460"
  }
}
