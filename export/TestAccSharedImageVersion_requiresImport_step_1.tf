...
locals {
  number            = "220627123942223145"
  location          = "West Europe"
  domain_name_label = "acctestvm-j3pee"
  random_string     = "j3pee"
  admin_username    = "testadmin220627123942223145"
  admin_password    = "Password1234!220627123942223145"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627123942223145"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627123942223145"
  ...
  identifier {
    publisher = "AccTesPublisher220627123942223145"
    offer     = "AccTesOffer220627123942223145"
    sku       = "AccTesSku220627123942223145"
  }
}
