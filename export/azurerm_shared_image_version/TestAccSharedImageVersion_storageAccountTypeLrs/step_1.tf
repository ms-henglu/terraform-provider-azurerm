...
locals {
  number            = "230120051707945398"
  location          = "West Europe"
  domain_name_label = "acctestvm-9kgpq"
  random_string     = "9kgpq"
  admin_username    = "testadmin230120051707945398"
  admin_password    = "Password1234!230120051707945398"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230120051707945398"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230120051707945398"
  ...
  identifier {
    publisher = "AccTesPublisher230120051707945398"
    offer     = "AccTesOffer230120051707945398"
    sku       = "AccTesSku230120051707945398"
  }
}
