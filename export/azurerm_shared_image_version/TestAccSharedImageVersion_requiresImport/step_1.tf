...
locals {
  number            = "230106034233479063"
  location          = "West Europe"
  domain_name_label = "acctestvm-lz8to"
  random_string     = "lz8to"
  admin_username    = "testadmin230106034233479063"
  admin_password    = "Password1234!230106034233479063"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230106034233479063"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230106034233479063"
  ...
  identifier {
    publisher = "AccTesPublisher230106034233479063"
    offer     = "AccTesOffer230106034233479063"
    sku       = "AccTesSku230106034233479063"
  }
}
