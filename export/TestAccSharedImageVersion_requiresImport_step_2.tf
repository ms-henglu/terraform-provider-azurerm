...
locals {
  number            = "220712042046049234"
  location          = "West Europe"
  domain_name_label = "acctestvm-6fg2d"
  random_string     = "6fg2d"
  admin_username    = "testadmin220712042046049234"
  admin_password    = "Password1234!220712042046049234"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220712042046049234"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220712042046049234"
  ...
  identifier {
    publisher = "AccTesPublisher220712042046049234"
    offer     = "AccTesOffer220712042046049234"
    sku       = "AccTesSku220712042046049234"
  }
}
