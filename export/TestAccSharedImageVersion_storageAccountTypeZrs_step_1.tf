...
locals {
  number            = "220909034011271003"
  location          = "West Europe"
  domain_name_label = "acctestvm-3qkpw"
  random_string     = "3qkpw"
  admin_username    = "testadmin220909034011271003"
  admin_password    = "Password1234!220909034011271003"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220909034011271003"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220909034011271003"
  ...
  identifier {
    publisher = "AccTesPublisher220909034011271003"
    offer     = "AccTesOffer220909034011271003"
    sku       = "AccTesSku220909034011271003"
  }
}
