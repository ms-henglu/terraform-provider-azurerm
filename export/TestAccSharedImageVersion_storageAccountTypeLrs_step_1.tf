...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220324160038485958"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220324160038485958"
  ...
  identifier {
    publisher = "AccTesPublisher220324160038485958"
    offer     = "AccTesOffer220324160038485958"
    sku       = "AccTesSku220324160038485958"
  }
}
