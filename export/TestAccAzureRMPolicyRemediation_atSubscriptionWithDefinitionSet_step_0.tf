...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-tn9sm"
  policy_type  = "Custom"
  display_name = "testPolicySet-tn9sm"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-tn9sm"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-tn9sm"
