...
locals {
  number            = "240105063504063674"
  location          = "West Europe"
  domain_name_label = "acctestvm-j92a6"
  random_string     = "j92a6"
  admin_username    = "testadmin240105063504063674"
  admin_password    = "Password1234!240105063504063674"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105063504063674"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105063504063674"
  ...
  identifier {
    publisher = "AccTesPublisher240105063504063674"
    offer     = "AccTesOffer240105063504063674"
    sku       = "AccTesSku240105063504063674"
  }
}
