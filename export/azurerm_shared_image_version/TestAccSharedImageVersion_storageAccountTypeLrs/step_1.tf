...
locals {
  number            = "221028171853893453"
  location          = "West Europe"
  domain_name_label = "acctestvm-fwm17"
  random_string     = "fwm17"
  admin_username    = "testadmin221028171853893453"
  admin_password    = "Password1234!221028171853893453"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221028171853893453"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221028171853893453"
  ...
  identifier {
    publisher = "AccTesPublisher221028171853893453"
    offer     = "AccTesOffer221028171853893453"
    sku       = "AccTesSku221028171853893453"
  }
}
