...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-yveqj"
  policy_type  = "Custom"
  display_name = "testPolicySet-yveqj"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-yveqj"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-yveqj"
