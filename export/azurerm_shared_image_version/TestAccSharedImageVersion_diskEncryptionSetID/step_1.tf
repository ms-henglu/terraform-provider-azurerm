...
locals {
  number            = "230630032848830071"
  location          = "West Europe"
  domain_name_label = "acctestvm-nqdud"
  random_string     = "nqdud"
  admin_username    = "testadmin230630032848830071"
  admin_password    = "Password1234!230630032848830071"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230630032848830071"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230630032848830071"
  ...
  identifier {
    publisher = "AccTesPublisher230630032848830071"
    offer     = "AccTesOffer230630032848830071"
    sku       = "AccTesSku230630032848830071"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230630032848830071"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
