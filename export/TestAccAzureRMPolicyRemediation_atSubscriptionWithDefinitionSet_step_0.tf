...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-h3aaa"
  policy_type  = "Custom"
  display_name = "testPolicySet-h3aaa"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-h3aaa"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-h3aaa"
