...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-webpubsub-240112225256309319"
...
resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet-240112225256309319"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  address_space       = ["10.5.0.0/16"]
}
resource "azurerm_subnet" "test" {
  name                                           = "acctest-subnet-240112225256309319"
  resource_group_name                            = azurerm_resource_group.test.name
...
resource "azurerm_private_endpoint" "test" {
  name                = "acctest-pe-240112225256309319"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_virtual_network" "test2" {
  name                = "acctest-vnet2-240112225256309319"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  address_space       = ["10.5.0.0/16"]
}
...
resource "azurerm_subnet" "test2" {
  name                 = "acctest-subnet2-240112225256309319"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_private_endpoint" "test2" {
  name                = "acctest-pe2-240112225256309319"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
