...
locals {
  number            = "230728025312838336"
  location          = "West Europe"
  domain_name_label = "acctestvm-amggl"
  random_string     = "amggl"
  admin_username    = "testadmin230728025312838336"
  admin_password    = "Password1234!230728025312838336"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230728025312838336"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230728025312838336"
  ...
  identifier {
    publisher = "AccTesPublisher230728025312838336"
    offer     = "AccTesOffer230728025312838336"
    sku       = "AccTesSku230728025312838336"
  }
}
