...
locals {
  number            = "240315122550004313"
  location          = "West Europe"
  domain_name_label = "acctestvm-32svv"
  random_string     = "32svv"
  admin_username    = "testadmin240315122550004313"
  admin_password    = "Password1234!240315122550004313"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240315122550004313"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240315122550004313"
  ...
  identifier {
    publisher = "AccTesPublisher240315122550004313"
    offer     = "AccTesOffer240315122550004313"
    sku       = "AccTesSku240315122550004313"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-240315122550004313"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
