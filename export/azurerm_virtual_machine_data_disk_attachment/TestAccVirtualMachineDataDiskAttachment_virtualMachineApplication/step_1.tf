...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-240311031615620163"
  location = "West Europe"
}

resource "azurerm_shared_image_gallery" "test" {
  name                = "ACCTESTGAL240311031615620163"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_gallery_application" "test" {
  name              = "acc-app240311031615620163"
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-240311031615620163"
...
resource "azurerm_public_ip" "test" {
  name                = "acctestpip240311031615620163"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_network_interface" "test" {
  name                = "acctestni240311031615620163"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "test" {
  name                  = "acctestvm240311031615620163"
  location              = azurerm_resource_group.test.location
  resource_group_name   = azurerm_resource_group.test.name
...
resource "azurerm_managed_disk" "test" {
  name                 = "acctest240311031615620163"
  location             = azurerm_resource_group.test.location
  resource_group_name  = azurerm_resource_group.test.name
  storage_account_type = "Standard_LRS"
  create_option        = "Empty"
