...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-230512003341157907"
  location = "West Europe"
}

resource "azurerm_api_management" "test" {
  name                = "acctestAM-230512003341157907"
...
resource "azurerm_api_management_api" "test" {
  name                = "acctestapi-230512003341157907"
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_api_management_api_version_set" "test" {
  name                = "acctestAMAVS-230512003341157907"
  resource_group_name = azurerm_resource_group.test.name
  api_management_name = azurerm_api_management.test.name
...
resource "azurerm_api_management_api" "version" {
  name                = "acctestVersion-230512003341157907"
  resource_group_name = azurerm_resource_group.test.name
  api_management_name = azurerm_api_management.test.name
