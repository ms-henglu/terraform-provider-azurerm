...
locals {
  number            = "220722035002633824"
  location          = "West Europe"
  domain_name_label = "acctestvm-arwvq"
  random_string     = "arwvq"
  admin_username    = "testadmin220722035002633824"
  admin_password    = "Password1234!220722035002633824"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220722035002633824"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220722035002633824"
  ...
  identifier {
    publisher = "AccTesPublisher220722035002633824"
    offer     = "AccTesOffer220722035002633824"
    sku       = "AccTesSku220722035002633824"
  }
}
