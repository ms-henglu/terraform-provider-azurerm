...
locals {
  number            = "230127045135676613"
  location          = "West Europe"
  domain_name_label = "acctestvm-zgtjw"
  random_string     = "zgtjw"
  admin_username    = "testadmin230127045135676613"
  admin_password    = "Password1234!230127045135676613"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230127045135676613"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230127045135676613"
  ...
  identifier {
    publisher = "AccTesPublisher230127045135676613"
    offer     = "AccTesOffer230127045135676613"
    sku       = "AccTesSku230127045135676613"
  }
}
