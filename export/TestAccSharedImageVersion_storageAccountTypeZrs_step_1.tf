...
locals {
  number            = "220603004640120890"
  location          = "West Europe"
  domain_name_label = "acctestvm-ua7wa"
  random_string     = "ua7wa"
  admin_username    = "testadmin220603004640120890"
  admin_password    = "Password1234!220603004640120890"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220603004640120890"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220603004640120890"
  ...
  identifier {
    publisher = "AccTesPublisher220603004640120890"
    offer     = "AccTesOffer220603004640120890"
    sku       = "AccTesSku220603004640120890"
  }
}
