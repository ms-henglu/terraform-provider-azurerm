...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-network-manager-240315123704042590"
...
resource "azurerm_network_manager" "test" {
  name                = "acctest-nm-240315123704042590"
...
resource "azurerm_network_manager_network_group" "test" {
  name               = "acctest-nmng-240315123704042590"
  network_manager_id = azurerm_network_manager.test.id
}

resource "azurerm_virtual_network" "test" {
  name                    = "acctest-vnet-240315123704042590"
  location                = azurerm_resource_group.test.location
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_network_manager_connectivity_configuration" "test" {
  name                  = "acctest-nmcc-240315123704042590"
  network_manager_id    = azurerm_network_manager.test.id
...
resource "azurerm_network_manager_security_admin_configuration" "test" {
  name               = "acctest-nmsac-240315123704042590"
  network_manager_id = azurerm_network_manager.test.id
}

resource "azurerm_network_manager_admin_rule_collection" "test" {
  name                            = "acctest-nmarc-240315123704042590"
...
resource "azurerm_network_manager_admin_rule" "test" {
  name                     = "acctest-nmar-240315123704042590"
