...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-acr-220627124005870230"
  location = "West Europe"
}

resource "azurerm_container_registry" "test" {
  name                  = "testacccr220627124005870230"
...
resource "azurerm_container_registry_scope_map" "test" {
  ...
  actions = [
    ...
    "gateway/testacccrc220627124005870230/config/read",
    "gateway/testacccrc220627124005870230/config/write",
    "gateway/testacccrc220627124005870230/message/read",
    "gateway/testacccrc220627124005870230/message/write",
  ]
}

resource "azurerm_container_registry_token" "test" {
  name                    = "testacccrtoken220627124005870230"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
...
resource "azurerm_container_registry_scope_map" "client" {
  name                    = "testacccrclient220627124005870230"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
  actions = [
    "repositories/hello-world/content/delete",
...
resource "azurerm_container_registry_token" "client" {
  name                    = "testacccrtokenclient220627124005870230"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
...
resource "azurerm_container_connected_registry" "test" {
  name                  = "testacccrc220627124005870230"
