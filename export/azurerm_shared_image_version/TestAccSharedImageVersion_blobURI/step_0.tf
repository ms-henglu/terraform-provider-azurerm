...
locals {
  number            = "230203063036574614"
  location          = "West Europe"
  domain_name_label = "acctestvm-rz44g"
  random_string     = "rz44g"
  admin_username    = "testadmin230203063036574614"
  admin_password    = "Password1234!230203063036574614"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230203063036574614"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230203063036574614"
  ...
  identifier {
    publisher = "AccTesPublisher230203063036574614"
    offer     = "AccTesOffer230203063036574614"
    sku       = "AccTesSku230203063036574614"
  }
}
