...
locals {
  number            = "210825044607833507"
  location          = "West Europe"
  domain_name_label = "acctestvm-ys37p"
  random_string     = "ys37p"
  admin_username    = "testadmin210825044607833507"
  admin_password    = "Password1234!210825044607833507"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825044607833507"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825044607833507"
  ...
  identifier {
    publisher = "AccTesPublisher210825044607833507"
    offer     = "AccTesOffer210825044607833507"
    sku       = "AccTesSku210825044607833507"
  }
}
