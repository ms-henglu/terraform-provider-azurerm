...
locals {
  number            = "230113180850401066"
  location          = "West Europe"
  domain_name_label = "acctestvm-1pklz"
  random_string     = "1pklz"
  admin_username    = "testadmin230113180850401066"
  admin_password    = "Password1234!230113180850401066"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230113180850401066"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230113180850401066"
  ...
  identifier {
    publisher = "AccTesPublisher230113180850401066"
    offer     = "AccTesOffer230113180850401066"
    sku       = "AccTesSku230113180850401066"
  }
}
