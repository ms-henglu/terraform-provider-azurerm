...
locals {
  number            = "220812014802171717"
  location          = "West Europe"
  domain_name_label = "acctestvm-c9o4l"
  random_string     = "c9o4l"
  admin_username    = "testadmin220812014802171717"
  admin_password    = "Password1234!220812014802171717"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220812014802171717"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220812014802171717"
  ...
  identifier {
    publisher = "AccTesPublisher220812014802171717"
    offer     = "AccTesOffer220812014802171717"
    sku       = "AccTesSku220812014802171717"
  }
}
