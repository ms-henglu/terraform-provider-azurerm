...
locals {
  number            = "211210034450664601"
  location          = "West Europe"
  domain_name_label = "acctestvm-ydljd"
  random_string     = "ydljd"
  admin_username    = "testadmin211210034450664601"
  admin_password    = "Password1234!211210034450664601"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211210034450664601"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211210034450664601"
  ...
  identifier {
    publisher = "AccTesPublisher211210034450664601"
    offer     = "AccTesOffer211210034450664601"
    sku       = "AccTesSku211210034450664601"
  }
}
