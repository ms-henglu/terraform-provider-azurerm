...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-ifbcm"
  policy_type  = "Custom"
  display_name = "testPolicySet-ifbcm"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-ifbcm"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-ifbcm"
