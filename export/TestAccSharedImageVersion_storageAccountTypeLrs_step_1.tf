...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211013071641596633"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211013071641596633"
  ...
  identifier {
    publisher = "AccTesPublisher211013071641596633"
    offer     = "AccTesOffer211013071641596633"
    sku       = "AccTesSku211013071641596633"
  }
}
