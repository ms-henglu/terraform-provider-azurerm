...
locals {
  number            = "220324180045321237"
  location          = "West Europe"
  domain_name_label = "acctestvm-obr7a"
  random_string     = "obr7a"
  admin_username    = "testadmin220324180045321237"
  admin_password    = "Password1234!220324180045321237"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220324180045321237"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220324180045321237"
  ...
  identifier {
    publisher = "AccTesPublisher220324180045321237"
    offer     = "AccTesOffer220324180045321237"
    sku       = "AccTesSku220324180045321237"
  }
}
