...
locals {
  number            = "230707010127172664"
  location          = "West Europe"
  domain_name_label = "acctestvm-pirgh"
  random_string     = "pirgh"
  admin_username    = "testadmin230707010127172664"
  admin_password    = "Password1234!230707010127172664"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230707010127172664"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230707010127172664"
  ...
  identifier {
    publisher = "AccTesPublisher230707010127172664"
    offer     = "AccTesOffer230707010127172664"
    sku       = "AccTesSku230707010127172664"
  }
}
