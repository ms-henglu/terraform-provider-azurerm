...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-vdesktop-230707010308708684"
  location = "West US 2"
}

resource "azurerm_virtual_desktop_workspace" "test" {
  name                = "acctestWS23070784"
