...
locals {
  number            = "220630223513058024"
  location          = "West Europe"
  domain_name_label = "acctestvm-dq9jk"
  random_string     = "dq9jk"
  admin_username    = "testadmin220630223513058024"
  admin_password    = "Password1234!220630223513058024"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220630223513058024"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220630223513058024"
  ...
  identifier {
    publisher = "AccTesPublisher220630223513058024"
    offer     = "AccTesOffer220630223513058024"
    sku       = "AccTesSku220630223513058024"
  }
}
