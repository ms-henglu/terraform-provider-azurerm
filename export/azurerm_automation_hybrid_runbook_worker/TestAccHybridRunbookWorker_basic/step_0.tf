...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-230127045017532168"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctestAA-230127045017532168"
...
resource "azurerm_automation_credential" "test" {
  name                    = "acctest-230127045017532168"
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestnw-230127045017532168"
...
resource "azurerm_network_interface" "test" {
  name                = "acctni-230127045017532168"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "test" {
  name                = "acctestVM-230127045017532168"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_automation_hybrid_runbook_worker" "test" {
  ...
  worker_id               = "40afe8b2-517c-4b87-bf23-9cc1161b275c"
