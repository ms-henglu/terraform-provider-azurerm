...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-iff06"
  policy_type  = "Custom"
  display_name = "testPolicySet-iff06"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-iff06"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-iff06"
