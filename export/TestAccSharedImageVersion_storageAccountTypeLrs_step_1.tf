...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210924010808666691"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210924010808666691"
  ...
  identifier {
    publisher = "AccTesPublisher210924010808666691"
    offer     = "AccTesOffer210924010808666691"
    sku       = "AccTesSku210924010808666691"
  }
}
