...
locals {
  number            = "231016033604025028"
  location          = "West Europe"
  domain_name_label = "acctestvm-io7md"
  random_string     = "io7md"
  admin_username    = "testadmin231016033604025028"
  admin_password    = "Password1234!231016033604025028"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231016033604025028"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231016033604025028"
  ...
  identifier {
    publisher = "AccTesPublisher231016033604025028"
    offer     = "AccTesOffer231016033604025028"
    sku       = "AccTesSku231016033604025028"
  }
}
