...
locals {
  number            = "220715004235785388"
  location          = "West Europe"
  domain_name_label = "acctestvm-oinmv"
  random_string     = "oinmv"
  admin_username    = "testadmin220715004235785388"
  admin_password    = "Password1234!220715004235785388"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220715004235785388"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220715004235785388"
  ...
  identifier {
    publisher = "AccTesPublisher220715004235785388"
    offer     = "AccTesOffer220715004235785388"
    sku       = "AccTesSku220715004235785388"
  }
}
...
resource "azurerm_shared_image_version" "test" {
  ...
  end_of_life_date    = "2022-07-15T10:42:35Z"
