...
locals {
  number            = "220923011626956048"
  location          = "West Europe"
  domain_name_label = "acctestvm-v3geg"
  random_string     = "v3geg"
  admin_username    = "testadmin220923011626956048"
  admin_password    = "Password1234!220923011626956048"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220923011626956048"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220923011626956048"
  ...
  identifier {
    publisher = "AccTesPublisher220923011626956048"
    offer     = "AccTesOffer220923011626956048"
    sku       = "AccTesSku220923011626956048"
  }
}
