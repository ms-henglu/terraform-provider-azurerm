...
locals {
  number            = "221222034403207468"
  location          = "West Europe"
  domain_name_label = "acctestvm-namxt"
  random_string     = "namxt"
  admin_username    = "testadmin221222034403207468"
  admin_password    = "Password1234!221222034403207468"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221222034403207468"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221222034403207468"
  ...
  identifier {
    publisher = "AccTesPublisher221222034403207468"
    offer     = "AccTesOffer221222034403207468"
    sku       = "AccTesSku221222034403207468"
  }
}
