...
locals {
  number            = "211203013551381024"
  location          = "West Europe"
  domain_name_label = "acctestvm-3irrd"
  random_string     = "3irrd"
  admin_username    = "testadmin211203013551381024"
  admin_password    = "Password1234!211203013551381024"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211203013551381024"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211203013551381024"
  ...
  identifier {
    publisher = "AccTesPublisher211203013551381024"
    offer     = "AccTesOffer211203013551381024"
    sku       = "AccTesSku211203013551381024"
  }
}
