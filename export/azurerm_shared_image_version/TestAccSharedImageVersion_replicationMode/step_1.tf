...
locals {
  number            = "230825024235256293"
  location          = "West Europe"
  domain_name_label = "acctestvm-yddh9"
  random_string     = "yddh9"
  admin_username    = "testadmin230825024235256293"
  admin_password    = "Password1234!230825024235256293"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230825024235256293"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230825024235256293"
  ...
  identifier {
    publisher = "AccTesPublisher230825024235256293"
    offer     = "AccTesOffer230825024235256293"
    sku       = "AccTesSku230825024235256293"
  }
}
