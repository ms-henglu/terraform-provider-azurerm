...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220124125441651741"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet-220124125441651741"
...
resource "azurerm_subnet" "test" {
  name                                          = "subnet-220124125441651741"
  resource_group_name                           = azurerm_resource_group.test.name
...
resource "azurerm_public_ip" "test" {
  name                = "acctest-pubip-220124125441651741"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_public_ip" "teststd" {
  name                = "acctest-PubIpStd-220124125441651741"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_web_application_firewall_policy" "testfwp" {
  name                = "acctest-fwp-220124125441651741"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_web_application_firewall_policy" "testfwp_listener" {
  name                = "acctest-fwp-listener-220124125441651741"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_application_gateway" "test" {
  name                = "acctestag-220124125441651741"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
