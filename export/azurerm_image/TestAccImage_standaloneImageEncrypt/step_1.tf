...
locals {
  number            = "240105063503975100"
  location          = "West Europe"
  domain_name_label = "acctestvm-2quvt"
  random_string     = "2quvt"
  admin_username    = "testadmin240105063503975100"
  admin_password    = "Password1234!240105063503975100"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-240105063503975100"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
