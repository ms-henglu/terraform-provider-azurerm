...
locals {
  number            = "210924010808669559"
  location          = "West Europe"
  domain_name_label = "acctestvm-jq2n0"
  random_string     = "jq2n0"
  admin_username    = "testadmin210924010808669559"
  admin_password    = "Password1234!210924010808669559"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210924010808669559"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210924010808669559"
  ...
  identifier {
    publisher = "AccTesPublisher210924010808669559"
    offer     = "AccTesOffer210924010808669559"
    sku       = "AccTesSku210924010808669559"
  }
}
