...
locals {
  number            = "230106034233475937"
  location          = "West Europe"
  domain_name_label = "acctestvm-luywb"
  random_string     = "luywb"
  admin_username    = "testadmin230106034233475937"
  admin_password    = "Password1234!230106034233475937"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230106034233475937"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230106034233475937"
  ...
  identifier {
    publisher = "AccTesPublisher230106034233475937"
    offer     = "AccTesOffer230106034233475937"
    sku       = "AccTesSku230106034233475937"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230106034233475937"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
