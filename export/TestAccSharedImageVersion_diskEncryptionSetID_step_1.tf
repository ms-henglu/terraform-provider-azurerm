...
locals {
  number            = "220715014258877686"
  location          = "West Europe"
  domain_name_label = "acctestvm-oufob"
  random_string     = "oufob"
  admin_username    = "testadmin220715014258877686"
  admin_password    = "Password1234!220715014258877686"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220715014258877686"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220715014258877686"
  ...
  identifier {
    publisher = "AccTesPublisher220715014258877686"
    offer     = "AccTesOffer220715014258877686"
    sku       = "AccTesSku220715014258877686"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220715014258877686"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
