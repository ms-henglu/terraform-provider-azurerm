...
locals {
  number            = "221021030948782833"
  location          = "West Europe"
  domain_name_label = "acctestvm-3j71u"
  random_string     = "3j71u"
  admin_username    = "testadmin221021030948782833"
  admin_password    = "Password1234!221021030948782833"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221021030948782833"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221021030948782833"
  ...
  identifier {
    publisher = "AccTesPublisher221021030948782833"
    offer     = "AccTesOffer221021030948782833"
    sku       = "AccTesSku221021030948782833"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-221021030948782833"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
