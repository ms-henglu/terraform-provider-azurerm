...
locals {
  number            = "220124121851414254"
  location          = "West Europe"
  domain_name_label = "acctestvm-dx6ap"
  random_string     = "dx6ap"
  admin_username    = "testadmin220124121851414254"
  admin_password    = "Password1234!220124121851414254"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220124121851414254"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220124121851414254"
  ...
  identifier {
    publisher = "AccTesPublisher220124121851414254"
    offer     = "AccTesOffer220124121851414254"
    sku       = "AccTesSku220124121851414254"
  }
}
