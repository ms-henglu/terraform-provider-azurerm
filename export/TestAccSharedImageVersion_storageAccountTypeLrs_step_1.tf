...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220826002453893755"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220826002453893755"
  ...
  identifier {
    publisher = "AccTesPublisher220826002453893755"
    offer     = "AccTesOffer220826002453893755"
    sku       = "AccTesSku220826002453893755"
  }
}
