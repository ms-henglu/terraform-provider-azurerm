...
locals {
  number            = "210906022054102208"
  location          = "West Europe"
  domain_name_label = "acctestvm-y8kt3"
  random_string     = "y8kt3"
  admin_username    = "testadmin210906022054102208"
  admin_password    = "Password1234!210906022054102208"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210906022054102208"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210906022054102208"
  ...
  identifier {
    publisher = "AccTesPublisher210906022054102208"
    offer     = "AccTesOffer210906022054102208"
    sku       = "AccTesSku210906022054102208"
  }
}
