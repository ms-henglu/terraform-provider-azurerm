...
locals {
  number            = "240112224137834218"
  location          = "West Europe"
  domain_name_label = "acctestvm-jiwui"
  random_string     = "jiwui"
  admin_username    = "testadmin240112224137834218"
  admin_password    = "Password1234!240112224137834218"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-240112224137834218"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
