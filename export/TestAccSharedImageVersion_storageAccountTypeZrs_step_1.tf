...
locals {
  number            = "211001053545928695"
  location          = "West Europe"
  domain_name_label = "acctestvm-2cdgo"
  random_string     = "2cdgo"
  admin_username    = "testadmin211001053545928695"
  admin_password    = "Password1234!211001053545928695"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211001053545928695"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211001053545928695"
  ...
  identifier {
    publisher = "AccTesPublisher211001053545928695"
    offer     = "AccTesOffer211001053545928695"
    sku       = "AccTesSku211001053545928695"
  }
}
