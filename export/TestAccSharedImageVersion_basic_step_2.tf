...
locals {
  number            = "220422024923909779"
  location          = "West Europe"
  domain_name_label = "acctestvm-3t0zk"
  random_string     = "3t0zk"
  admin_username    = "testadmin220422024923909779"
  admin_password    = "Password1234!220422024923909779"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220422024923909779"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220422024923909779"
  ...
  identifier {
    publisher = "AccTesPublisher220422024923909779"
    offer     = "AccTesOffer220422024923909779"
    sku       = "AccTesSku220422024923909779"
  }
}
