...
locals {
  number            = "221019054023439271"
  location          = "West Europe"
  domain_name_label = "acctestvm-42umz"
  random_string     = "42umz"
  admin_username    = "testadmin221019054023439271"
  admin_password    = "Password1234!221019054023439271"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221019054023439271"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221019054023439271"
  ...
  identifier {
    publisher = "AccTesPublisher221019054023439271"
    offer     = "AccTesOffer221019054023439271"
    sku       = "AccTesSku221019054023439271"
  }
}
