...
locals {
  number            = "230707003540148608"
  location          = "West Europe"
  domain_name_label = "acctestvm-wjv80"
  random_string     = "wjv80"
  admin_username    = "testadmin230707003540148608"
  admin_password    = "Password1234!230707003540148608"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230707003540148608"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230707003540148608"
  ...
  identifier {
    publisher = "AccTesPublisher230707003540148608"
    offer     = "AccTesOffer230707003540148608"
    sku       = "AccTesSku230707003540148608"
  }
}
