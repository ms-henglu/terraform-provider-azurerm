...
locals {
  number            = "221221204056154580"
  location          = "West Europe"
  domain_name_label = "acctestvm-x492v"
  random_string     = "x492v"
  admin_username    = "testadmin221221204056154580"
  admin_password    = "Password1234!221221204056154580"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221221204056154580"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221221204056154580"
  ...
  identifier {
    publisher = "AccTesPublisher221221204056154580"
    offer     = "AccTesOffer221221204056154580"
    sku       = "AccTesSku221221204056154580"
  }
}
