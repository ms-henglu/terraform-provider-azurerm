...
locals {
  number            = "230106031234901858"
  location          = "West Europe"
  domain_name_label = "acctestvm-fz4wf"
  random_string     = "fz4wf"
  admin_username    = "testadmin230106031234901858"
  admin_password    = "Password1234!230106031234901858"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230106031234901858"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230106031234901858"
  ...
  identifier {
    publisher = "AccTesPublisher230106031234901858"
    offer     = "AccTesOffer230106031234901858"
    sku       = "AccTesSku230106031234901858"
  }
}
