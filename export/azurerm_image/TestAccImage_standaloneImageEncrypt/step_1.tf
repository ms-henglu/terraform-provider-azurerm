...
locals {
  number            = "230825024235158989"
  location          = "West Europe"
  domain_name_label = "acctestvm-vv81a"
  random_string     = "vv81a"
  admin_username    = "testadmin230825024235158989"
  admin_password    = "Password1234!230825024235158989"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230825024235158989"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
