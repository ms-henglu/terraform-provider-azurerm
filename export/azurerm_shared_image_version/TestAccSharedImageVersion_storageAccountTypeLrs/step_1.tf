...
locals {
  number            = "221111013238937172"
  location          = "West Europe"
  domain_name_label = "acctestvm-sw27s"
  random_string     = "sw27s"
  admin_username    = "testadmin221111013238937172"
  admin_password    = "Password1234!221111013238937172"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221111013238937172"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221111013238937172"
  ...
  identifier {
    publisher = "AccTesPublisher221111013238937172"
    offer     = "AccTesOffer221111013238937172"
    sku       = "AccTesSku221111013238937172"
  }
}
