...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-230613071404911780"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctestAA-230613071404911780"
...
resource "azurerm_automation_credential" "test" {
  name                    = "acctest-230613071404911780"
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestnw-230613071404911780"
...
resource "azurerm_network_interface" "test" {
  name                = "acctni-230613071404911780"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "test" {
  name                = "acctestVM-230613071404911780"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_automation_hybrid_runbook_worker" "test" {
  ...
  worker_id               = "0beb4244-1206-4a18-906e-8bcfc8caa6b9"
