...
locals {
  number            = "230707003540150419"
  location          = "West Europe"
  domain_name_label = "acctestvm-7ivcu"
  random_string     = "7ivcu"
  admin_username    = "testadmin230707003540150419"
  admin_password    = "Password1234!230707003540150419"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230707003540150419"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230707003540150419"
  ...
  identifier {
    publisher = "AccTesPublisher230707003540150419"
    offer     = "AccTesOffer230707003540150419"
    sku       = "AccTesSku230707003540150419"
  }
}
