...
locals {
  number            = "220726014613807643"
  location          = "West Europe"
  domain_name_label = "acctestvm-09e2j"
  random_string     = "09e2j"
  admin_username    = "testadmin220726014613807643"
  admin_password    = "Password1234!220726014613807643"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220726014613807643"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220726014613807643"
  ...
  identifier {
    publisher = "AccTesPublisher220726014613807643"
    offer     = "AccTesOffer220726014613807643"
    sku       = "AccTesSku220726014613807643"
  }
}
