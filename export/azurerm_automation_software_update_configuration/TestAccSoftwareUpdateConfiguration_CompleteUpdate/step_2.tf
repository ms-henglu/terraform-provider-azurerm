...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-230721011209814792"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctest-230721011209814792"
...
resource "azurerm_log_analytics_workspace" "test" {
  name                = "acctestLAW-230721011209814792"
  location            = "west europe"
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "PerGB2018"
...
resource "azurerm_automation_software_update_configuration" "test" {
  ...
  name                  = "acctest-suc-230721011209814792"
  ...
  schedule {
    ...
    start_time         = "2023-07-21T02:12:00Z"
    expiry_time        = "2023-07-21T03:12:00Z"
    is_enabled         = true
    interval           = 2
    frequency          = "Hour"
    time_zone          = "Etc/UTC"
