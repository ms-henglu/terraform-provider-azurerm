...
locals {
  number            = "230929064556877229"
  location          = "West Europe"
  domain_name_label = "acctestvm-n13g1"
  random_string     = "n13g1"
  admin_username    = "testadmin230929064556877229"
  admin_password    = "Password1234!230929064556877229"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230929064556877229"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230929064556877229"
  ...
  identifier {
    publisher = "AccTesPublisher230929064556877229"
    offer     = "AccTesOffer230929064556877229"
    sku       = "AccTesSku230929064556877229"
  }
}
