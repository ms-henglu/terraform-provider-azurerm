...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-21m4r"
  policy_type  = "Custom"
  display_name = "testPolicySet-21m4r"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-21m4r"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-21m4r"
