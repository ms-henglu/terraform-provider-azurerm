...
// Delete ...
func (c BackupPoliciesClient) Delete(ctx context.Context, id BackupPoliciesId) (result DeleteResponse, err error) {
...
func (c BackupPoliciesClient) responderForDelete(resp *http.Response) (result DeleteResponse, err error) {
