...
locals {
  number            = "230804025626266300"
  location          = "West Europe"
  domain_name_label = "acctestvm-rtfbm"
  random_string     = "rtfbm"
  admin_username    = "testadmin230804025626266300"
  admin_password    = "Password1234!230804025626266300"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230804025626266300"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230804025626266300"
  ...
  identifier {
    publisher = "AccTesPublisher230804025626266300"
    offer     = "AccTesOffer230804025626266300"
    sku       = "AccTesSku230804025626266300"
  }
}
