...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-221111014248503571"
...
resource "azuread_application" "cluster_explorer" {
  ...
  identifier_uris = ["https://test-r1pej.${data.azuread_domains.test.domains[0].domain_name}:19080/Explorer/index.html"]
  web {
...
resource "azurerm_service_fabric_cluster" "test" {
  name                = "acctest-221111014248503571"
