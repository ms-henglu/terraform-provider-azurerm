...
resource "azurerm_resource_group" "test" {
  name     = "acctest220916011841513417"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-220916011841513417"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestpol-220916011841513417"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestpol-220916011841513417"
...
resource "azurerm_resource_policy_assignment" "test" {
  name                 = "acctestpa-220916011841513417"
