...
locals {
  number            = "211105035652862875"
  location          = "West Europe"
  domain_name_label = "acctestvm-kg7zh"
  random_string     = "kg7zh"
  admin_username    = "testadmin211105035652862875"
  admin_password    = "Password1234!211105035652862875"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211105035652862875"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211105035652862875"
  ...
  identifier {
    publisher = "AccTesPublisher211105035652862875"
    offer     = "AccTesOffer211105035652862875"
    sku       = "AccTesSku211105035652862875"
  }
}
