...
locals {
  number            = "240119024707422851"
  location          = "West Europe"
  domain_name_label = "acctestvm-y2hd4"
  random_string     = "y2hd4"
  admin_username    = "testadmin240119024707422851"
  admin_password    = "Password1234!240119024707422851"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240119024707422851"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240119024707422851"
  ...
  identifier {
    publisher = "AccTesPublisher240119024707422851"
    offer     = "AccTesOffer240119024707422851"
    sku       = "AccTesSku240119024707422851"
  }
}
