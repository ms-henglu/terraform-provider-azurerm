...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-lab-240105060953820036"
  location = "West Europe"
}


resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105060953820036"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105060953820036"
  ...
  identifier {
    publisher = "AccTesPublisher240105060953820036"
    offer     = "AccTesOffer240105060953820036"
    sku       = "AccTesSku240105060953820036"
  }
}
...
resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet-240105060953820036"
...
resource "azurerm_subnet" "test" {
  name                 = "acctest-sn-240105060953820036"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_network_interface" "test" {
  name                = "acctestnic-240105060953820036"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "test" {
  name                = "acctestVM-linux-240105060953820036"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  size                = "Standard_F2"
...
resource "azurerm_lab_service_plan" "test" {
  name                = "acctest-lslp-240105060953820036"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_lab_service_lab" "test" {
  name                = "acctest-lab-240105060953820036"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  title               = "Test Title"
