...
resource "azurerm_resource_group" "test" {
  name     = "acctest220422025607201681"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-220422025607201681"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestpol-220422025607201681"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestpol-220422025607201681"
...
resource "azurerm_resource_policy_assignment" "test" {
  name                 = "acctestpa-220422025607201681"
