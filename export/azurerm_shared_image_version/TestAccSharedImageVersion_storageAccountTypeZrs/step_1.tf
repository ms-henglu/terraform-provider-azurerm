...
locals {
  number            = "230428045412223009"
  location          = "West Europe"
  domain_name_label = "acctestvm-tsp81"
  random_string     = "tsp81"
  admin_username    = "testadmin230428045412223009"
  admin_password    = "Password1234!230428045412223009"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230428045412223009"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230428045412223009"
  ...
  identifier {
    publisher = "AccTesPublisher230428045412223009"
    offer     = "AccTesOffer230428045412223009"
    sku       = "AccTesSku230428045412223009"
  }
}
