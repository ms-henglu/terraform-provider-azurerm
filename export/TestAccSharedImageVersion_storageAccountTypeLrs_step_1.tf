...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220429075220067769"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220429075220067769"
  ...
  identifier {
    publisher = "AccTesPublisher220429075220067769"
    offer     = "AccTesOffer220429075220067769"
    sku       = "AccTesSku220429075220067769"
  }
}
