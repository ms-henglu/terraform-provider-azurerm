...
resource "azurerm_policy_definition" "test" {
  name         = "acctestpol-220623223741025260"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestpol-220623223741025260"
...
resource "azurerm_policy_set_definition" "test" {
  name         = "acctestPolSet-220623223741025260"
  policy_type  = "Custom"
  display_name = "acctestPolSet-display-220623223741025260"
