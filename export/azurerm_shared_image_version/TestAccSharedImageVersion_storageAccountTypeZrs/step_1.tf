...
locals {
  number            = "221111013238944396"
  location          = "West Europe"
  domain_name_label = "acctestvm-glbda"
  random_string     = "glbda"
  admin_username    = "testadmin221111013238944396"
  admin_password    = "Password1234!221111013238944396"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221111013238944396"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221111013238944396"
  ...
  identifier {
    publisher = "AccTesPublisher221111013238944396"
    offer     = "AccTesOffer221111013238944396"
    sku       = "AccTesSku221111013238944396"
  }
}
