...
locals {
  number            = "230113180850401409"
  location          = "West Europe"
  domain_name_label = "acctestvm-u63sv"
  random_string     = "u63sv"
  admin_username    = "testadmin230113180850401409"
  admin_password    = "Password1234!230113180850401409"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230113180850401409"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230113180850401409"
  ...
  identifier {
    publisher = "AccTesPublisher230113180850401409"
    offer     = "AccTesOffer230113180850401409"
    sku       = "AccTesSku230113180850401409"
  }
}
