...
locals {
  number            = "220726001659729673"
  location          = "West Europe"
  domain_name_label = "acctestvm-jo0hl"
  random_string     = "jo0hl"
  admin_username    = "testadmin220726001659729673"
  admin_password    = "Password1234!220726001659729673"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220726001659729673"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220726001659729673"
  ...
  identifier {
    publisher = "AccTesPublisher220726001659729673"
    offer     = "AccTesOffer220726001659729673"
    sku       = "AccTesSku220726001659729673"
  }
}
