...
locals {
  number            = "221117230632442697"
  location          = "West Europe"
  domain_name_label = "acctestvm-ws9qq"
  random_string     = "ws9qq"
  admin_username    = "testadmin221117230632442697"
  admin_password    = "Password1234!221117230632442697"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221117230632442697"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221117230632442697"
  ...
  identifier {
    publisher = "AccTesPublisher221117230632442697"
    offer     = "AccTesOffer221117230632442697"
    sku       = "AccTesSku221117230632442697"
  }
}
