...
locals {
  number            = "210924004029449876"
  location          = "West Europe"
  domain_name_label = "acctestvm-ma308"
  random_string     = "ma308"
  admin_username    = "testadmin210924004029449876"
  admin_password    = "Password1234!210924004029449876"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210924004029449876"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210924004029449876"
  ...
  identifier {
    publisher = "AccTesPublisher210924004029449876"
    offer     = "AccTesOffer210924004029449876"
    sku       = "AccTesSku210924004029449876"
  }
}
