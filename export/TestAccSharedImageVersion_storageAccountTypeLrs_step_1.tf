...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210928075302204342"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210928075302204342"
  ...
  identifier {
    publisher = "AccTesPublisher210928075302204342"
    offer     = "AccTesOffer210928075302204342"
    sku       = "AccTesSku210928075302204342"
  }
}
