...
locals {
  number            = "231218071435460021"
  location          = "West Europe"
  domain_name_label = "acctestvm-wtxmq"
  random_string     = "wtxmq"
  admin_username    = "testadmin231218071435460021"
  admin_password    = "Password1234!231218071435460021"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-231218071435460021"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
