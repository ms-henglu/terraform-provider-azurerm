...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-k616m"
  policy_type  = "Custom"
  display_name = "testPolicySet-k616m"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-k616m"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-k616m"
