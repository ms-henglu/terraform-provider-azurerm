...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220324180045320965"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220324180045320965"
  ...
  identifier {
    publisher = "AccTesPublisher220324180045320965"
    offer     = "AccTesOffer220324180045320965"
    sku       = "AccTesSku220324180045320965"
  }
}
