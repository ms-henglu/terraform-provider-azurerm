...
resource "azurerm_resource_group" "test1" {
  name     = "acctestRG-api1-231218071134504442"
  location = "West Europe"
}

resource "azurerm_resource_group" "test2" {
  name     = "acctestRG-api2-231218071134504442"
  location = "West US 2"
}

resource "azurerm_resource_group" "test3" {
  name     = "acctestRG-api3-231218071134504442"
  location = "East US 2"
}

resource "azurerm_api_management" "test" {
  name                      = "acctestAM-231218071134504442"
  publisher_name            = "pub1"
  ...
  hostname_configuration {
    proxy {
      host_name                    = "acctestAM-231218071134504442.azure-api.net"
