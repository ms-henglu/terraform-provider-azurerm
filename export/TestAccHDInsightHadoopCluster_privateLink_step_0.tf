...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220211130653167823"
  location = "West Europe"
}

resource "azurerm_storage_account" "gen2test" {
  name                     = "accgen2testuoud8"
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestvirtnet220211130653167823"
...
resource "azurerm_subnet" "test" {
  name                 = "acctestsubnet220211130653167823"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_public_ip" "test" {
  name                = "acctestpip220211130653167823"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_nat_gateway" "test" {
  name                    = "acctestnat220211130653167823"
  location                = azurerm_resource_group.test.location
  resource_group_name     = azurerm_resource_group.test.name
  sku_name                = "Standard"
...
resource "azurerm_hdinsight_hadoop_cluster" "test" {
  ...
  name                = "acctesthdi-220211130653167823"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  cluster_version     = "4.0"
  tier                = "Standard"
...
resource "azurerm_network_security_group" "test" {
  name                = "acctestnsg-220211130653167823"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
