...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-spring-240105064639578777"
  location = "West Europe"
}

resource "azurerm_spring_cloud_service" "test" {
  name                = "acctest-sc-240105064639578777"
...
resource "azurerm_spring_cloud_app" "test" {
  name                = "acctest-sca-240105064639578777"
...
resource "azurerm_application_insights" "test" {
  name                = "acctest-ai-240105064639578777"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_spring_cloud_application_insights_application_performance_monitoring" "test" {
  name                    = "acctest-apm-240105064639578777"
