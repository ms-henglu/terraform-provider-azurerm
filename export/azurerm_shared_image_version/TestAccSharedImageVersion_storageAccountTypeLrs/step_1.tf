...
locals {
  number            = "231016033604025498"
  location          = "West Europe"
  domain_name_label = "acctestvm-0a0qm"
  random_string     = "0a0qm"
  admin_username    = "testadmin231016033604025498"
  admin_password    = "Password1234!231016033604025498"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231016033604025498"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231016033604025498"
  ...
  identifier {
    publisher = "AccTesPublisher231016033604025498"
    offer     = "AccTesOffer231016033604025498"
    sku       = "AccTesSku231016033604025498"
  }
}
