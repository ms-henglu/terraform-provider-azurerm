...
locals {
  number            = "210830083803913239"
  location          = "West Europe"
  domain_name_label = "acctestvm-ia6hf"
  random_string     = "ia6hf"
  admin_username    = "testadmin210830083803913239"
  admin_password    = "Password1234!210830083803913239"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210830083803913239"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210830083803913239"
  ...
  identifier {
    publisher = "AccTesPublisher210830083803913239"
    offer     = "AccTesOffer210830083803913239"
    sku       = "AccTesSku210830083803913239"
  }
}
