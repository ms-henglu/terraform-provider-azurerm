...
locals {
  number            = "220107063800655553"
  location          = "West Europe"
  domain_name_label = "acctestvm-m86z8"
  random_string     = "m86z8"
  admin_username    = "testadmin220107063800655553"
  admin_password    = "Password1234!220107063800655553"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220107063800655553"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220107063800655553"
  ...
  identifier {
    publisher = "AccTesPublisher220107063800655553"
    offer     = "AccTesOffer220107063800655553"
    sku       = "AccTesSku220107063800655553"
  }
}
