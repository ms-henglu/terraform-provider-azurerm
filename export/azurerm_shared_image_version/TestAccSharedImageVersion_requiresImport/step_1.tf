...
locals {
  number            = "230721011329113503"
  location          = "West Europe"
  domain_name_label = "acctestvm-4wf88"
  random_string     = "4wf88"
  admin_username    = "testadmin230721011329113503"
  admin_password    = "Password1234!230721011329113503"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230721011329113503"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230721011329113503"
  ...
  identifier {
    publisher = "AccTesPublisher230721011329113503"
    offer     = "AccTesOffer230721011329113503"
    sku       = "AccTesSku230721011329113503"
  }
}
