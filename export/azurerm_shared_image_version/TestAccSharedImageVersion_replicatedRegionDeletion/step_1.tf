...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231016033604026384"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231016033604026384"
  ...
  identifier {
    publisher = "AccTesPublisher231016033604026384"
    offer     = "AccTesOffer231016033604026384"
    sku       = "AccTesSku231016033604026384"
  }
}
