...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220812015850214900"
  location = "West Europe"
}

resource "azurerm_iothub" "test" {
  name                = "acctestiothub-220812015850214900"
...
resource "azurerm_stream_analytics_job" "test" {
  name                                     = "acctestjob-220812015850214900"
  resource_group_name                      = azurerm_resource_group.test.name
  location                                 = azurerm_resource_group.test.location
...
resource "azurerm_iothub" "updated" {
  name                = "acctestiot2-220812015850214900"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_stream_analytics_stream_input_iothub" "test" {
  name                         = "acctestinput-220812015850214900"
