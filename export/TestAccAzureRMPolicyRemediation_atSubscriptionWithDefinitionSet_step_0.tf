...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-4bnmm"
  policy_type  = "Custom"
  display_name = "testPolicySet-4bnmm"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-4bnmm"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-4bnmm"
