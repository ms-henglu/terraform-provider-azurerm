...
locals {
  number            = "230113180850400681"
  location          = "West Europe"
  domain_name_label = "acctestvm-af4es"
  random_string     = "af4es"
  admin_username    = "testadmin230113180850400681"
  admin_password    = "Password1234!230113180850400681"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230113180850400681"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230113180850400681"
  ...
  identifier {
    publisher = "AccTesPublisher230113180850400681"
    offer     = "AccTesOffer230113180850400681"
    sku       = "AccTesSku230113180850400681"
  }
}
