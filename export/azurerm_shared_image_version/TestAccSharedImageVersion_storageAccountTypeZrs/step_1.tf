...
locals {
  number            = "221028164721129452"
  location          = "West Europe"
  domain_name_label = "acctestvm-akluo"
  random_string     = "akluo"
  admin_username    = "testadmin221028164721129452"
  admin_password    = "Password1234!221028164721129452"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221028164721129452"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221028164721129452"
  ...
  identifier {
    publisher = "AccTesPublisher221028164721129452"
    offer     = "AccTesOffer221028164721129452"
    sku       = "AccTesSku221028164721129452"
  }
}
