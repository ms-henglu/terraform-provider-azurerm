...
locals {
  number            = "240105060444557237"
  location          = "West Europe"
  domain_name_label = "acctestvm-gyoj3"
  random_string     = "gyoj3"
  admin_username    = "testadmin240105060444557237"
  admin_password    = "Password1234!240105060444557237"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105060444557237"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105060444557237"
  ...
  identifier {
    publisher = "AccTesPublisher240105060444557237"
    offer     = "AccTesOffer240105060444557237"
    sku       = "AccTesSku240105060444557237"
  }
}
