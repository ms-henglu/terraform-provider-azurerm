...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG1-sql-221021031518810797"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet1-221021031518810797"
...
resource "azurerm_subnet" "test" {
  name                 = "subnet1-221021031518810797"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_network_security_group" "test" {
  name                = "mi-security-group1-221021031518810797"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
}
...
resource "azurerm_route_table" "test" {
  name                          = "routetable1-221021031518810797"
  location                      = azurerm_resource_group.test.location
  resource_group_name           = azurerm_resource_group.test.name
...
resource "azurerm_mssql_managed_instance" "test" {
  name                = "acctestsqlserver221021031518810797"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_resource_group" "secondary" {
  name     = "acctestRG2-sql-221021031518810797"
  location = "West US 2"
}

resource "azurerm_virtual_network" "secondary" {
  name                = "acctest-vnet2-221021031518810797"
...
resource "azurerm_subnet" "secondary" {
  name                 = "subnet2-221021031518810797"
  resource_group_name  = azurerm_resource_group.secondary.name
...
resource "azurerm_network_security_group" "secondary" {
  name                = "mi-security-group2-221021031518810797"
  location            = azurerm_resource_group.secondary.location
  resource_group_name = azurerm_resource_group.secondary.name
}
...
resource "azurerm_route_table" "secondary" {
  name                          = "routetable2-221021031518810797"
  location                      = azurerm_resource_group.secondary.location
  resource_group_name           = azurerm_resource_group.secondary.name
  disable_bgp_route_propagation = false
...
resource "azurerm_mssql_managed_instance" "secondary" {
  name                = "acctestsqlserver2221021031518810797"
  resource_group_name = azurerm_resource_group.secondary.name
  location            = azurerm_resource_group.secondary.location
