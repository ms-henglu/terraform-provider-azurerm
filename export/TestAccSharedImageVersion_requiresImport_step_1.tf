...
locals {
  number            = "211112020355813501"
  location          = "West Europe"
  domain_name_label = "acctestvm-1isec"
  random_string     = "1isec"
  admin_username    = "testadmin211112020355813501"
  admin_password    = "Password1234!211112020355813501"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211112020355813501"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211112020355813501"
  ...
  identifier {
    publisher = "AccTesPublisher211112020355813501"
    offer     = "AccTesOffer211112020355813501"
    sku       = "AccTesSku211112020355813501"
  }
}
