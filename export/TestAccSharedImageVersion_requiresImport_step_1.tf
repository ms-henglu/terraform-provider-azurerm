...
locals {
  number            = "220311042149586224"
  location          = "West Europe"
  domain_name_label = "acctestvm-poimo"
  random_string     = "poimo"
  admin_username    = "testadmin220311042149586224"
  admin_password    = "Password1234!220311042149586224"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220311042149586224"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220311042149586224"
  ...
  identifier {
    publisher = "AccTesPublisher220311042149586224"
    offer     = "AccTesOffer220311042149586224"
    sku       = "AccTesSku220311042149586224"
  }
}
