...
locals {
  number            = "230120051707942424"
  location          = "West Europe"
  domain_name_label = "acctestvm-nyqvz"
  random_string     = "nyqvz"
  admin_username    = "testadmin230120051707942424"
  admin_password    = "Password1234!230120051707942424"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230120051707942424"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230120051707942424"
  ...
  identifier {
    publisher = "AccTesPublisher230120051707942424"
    offer     = "AccTesOffer230120051707942424"
    sku       = "AccTesSku230120051707942424"
  }
}
