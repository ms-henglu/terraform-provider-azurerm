...
func TestAccSpringCloudGatewayCustomDomain_complete(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_spring_cloud_gateway_custom_domain", "test")
	r := SpringCloudGatewayCustomDomainResource{}
	data.ResourceTest(t, r, []resource.TestStep{
		{
...
func TestAccSpringCloudGatewayCustomDomain_update(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_spring_cloud_gateway_custom_domain", "test")
	r := SpringCloudGatewayCustomDomainResource{}
	data.ResourceTest(t, r, []resource.TestStep{
		{
...
func (r SpringCloudGatewayCustomDomainResource) complete(data acceptance.TestData) string {
	template := r.template(data)
	return fmt.Sprintf(`
%s
