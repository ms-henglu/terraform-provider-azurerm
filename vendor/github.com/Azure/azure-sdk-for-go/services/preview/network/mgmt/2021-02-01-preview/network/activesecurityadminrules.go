...
func (client ActiveSecurityAdminRulesClient) List(ctx context.Context, resourceGroupName string, networkManagerName string, parameters interface{}) (result ActiveSecurityAdminRulesListResult, err error) {
...
func (client ActiveSecurityAdminRulesClient) ListPreparer(ctx context.Context, resourceGroupName string, networkManagerName string, parameters interface{}) (*http.Request, error) {
