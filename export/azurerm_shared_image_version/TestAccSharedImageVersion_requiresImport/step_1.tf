...
locals {
  number            = "230825024235255394"
  location          = "West Europe"
  domain_name_label = "acctestvm-hpuey"
  random_string     = "hpuey"
  admin_username    = "testadmin230825024235255394"
  admin_password    = "Password1234!230825024235255394"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230825024235255394"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230825024235255394"
  ...
  identifier {
    publisher = "AccTesPublisher230825024235255394"
    offer     = "AccTesOffer230825024235255394"
    sku       = "AccTesSku230825024235255394"
  }
}
