...
locals {
  number            = "221117230632449867"
  location          = "West Europe"
  domain_name_label = "acctestvm-guury"
  random_string     = "guury"
  admin_username    = "testadmin221117230632449867"
  admin_password    = "Password1234!221117230632449867"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221117230632449867"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221117230632449867"
  ...
  identifier {
    publisher = "AccTesPublisher221117230632449867"
    offer     = "AccTesOffer221117230632449867"
    sku       = "AccTesSku221117230632449867"
  }
}
