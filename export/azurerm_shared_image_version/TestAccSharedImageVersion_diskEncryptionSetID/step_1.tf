...
locals {
  number            = "230721014716584541"
  location          = "West Europe"
  domain_name_label = "acctestvm-huf72"
  random_string     = "huf72"
  admin_username    = "testadmin230721014716584541"
  admin_password    = "Password1234!230721014716584541"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230721014716584541"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230721014716584541"
  ...
  identifier {
    publisher = "AccTesPublisher230721014716584541"
    offer     = "AccTesOffer230721014716584541"
    sku       = "AccTesSku230721014716584541"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230721014716584541"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
