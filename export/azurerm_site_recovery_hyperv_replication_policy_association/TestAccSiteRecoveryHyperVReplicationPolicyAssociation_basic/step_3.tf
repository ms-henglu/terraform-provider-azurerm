...
locals {
  rg_name              = "acctest-nested-rg-230804030554435655"
  location             = "West Europe"
  vn_name              = "acctest-nested-vn-230804030554435655"
  ip_name              = "acctest-nested-ip-230804030554435655"
  vm_name              = "acctest-nested-vm-230804030554435655"
  nic_name             = "acctest-nested-nic-230804030554435655"
  disk_name            = "acctest-nested-disk-230804030554435655"
  keyvault_name        = "acctkv230804030554435655"
  nsg_name             = "acctest-nested-nsg-230804030554435655"
  recovery_vault_name  = "acctest-nested-recovery-vault-230804030554435655"
  recovery_site_name   = "acctest-nested-recovery-site-230804030554435655"
  admin_name           = "acctestadmin"
  cert_name            = "acctestcert"
  storage_account_name = "acctestsal722g"
}
...
resource "azurerm_windows_virtual_machine" "host" {
  ...
  additional_unattend_content {
    setting = "AutoLogon"
    content = "<AutoLogon><Password><Value>725R2$9(^)</Value></Password><Enabled>true</Enabled><LogonCount>1</LogonCount><Username>${local.admin_name}</Username></AutoLogon>"
  }
...
resource "azurerm_site_recovery_hyperv_replication_policy" "test" {
  recovery_vault_id                                  = azurerm_recovery_services_vault.test.id
  name                                               = "acctest-policy-230804030554435655"
