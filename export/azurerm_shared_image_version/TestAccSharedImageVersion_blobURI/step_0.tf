...
locals {
  number            = "240315122550007728"
  location          = "West Europe"
  domain_name_label = "acctestvm-imykb"
  random_string     = "imykb"
  admin_username    = "testadmin240315122550007728"
  admin_password    = "Password1234!240315122550007728"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240315122550007728"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240315122550007728"
  ...
  identifier {
    publisher = "AccTesPublisher240315122550007728"
    offer     = "AccTesOffer240315122550007728"
    sku       = "AccTesSku240315122550007728"
  }
}
