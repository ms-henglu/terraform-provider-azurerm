...
locals {
  number            = "221216013235531395"
  location          = "West Europe"
  domain_name_label = "acctestvm-7sf64"
  random_string     = "7sf64"
  admin_username    = "testadmin221216013235531395"
  admin_password    = "Password1234!221216013235531395"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221216013235531395"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221216013235531395"
  ...
  identifier {
    publisher = "AccTesPublisher221216013235531395"
    offer     = "AccTesOffer221216013235531395"
    sku       = "AccTesSku221216013235531395"
  }
}
