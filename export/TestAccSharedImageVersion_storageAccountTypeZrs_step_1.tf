...
locals {
  number            = "211029015345460839"
  location          = "West Europe"
  domain_name_label = "acctestvm-1epyu"
  random_string     = "1epyu"
  admin_username    = "testadmin211029015345460839"
  admin_password    = "Password1234!211029015345460839"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211029015345460839"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211029015345460839"
  ...
  identifier {
    publisher = "AccTesPublisher211029015345460839"
    offer     = "AccTesOffer211029015345460839"
    sku       = "AccTesSku211029015345460839"
  }
}
