...
locals {
  number            = "220520053718276767"
  location          = "West Europe"
  domain_name_label = "acctestvm-ksvzb"
  random_string     = "ksvzb"
  admin_username    = "testadmin220520053718276767"
  admin_password    = "Password1234!220520053718276767"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220520053718276767"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220520053718276767"
  ...
  identifier {
    publisher = "AccTesPublisher220520053718276767"
    offer     = "AccTesOffer220520053718276767"
    sku       = "AccTesSku220520053718276767"
  }
}
