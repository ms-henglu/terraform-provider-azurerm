...
locals {
  number            = "230707010127174314"
  location          = "West Europe"
  domain_name_label = "acctestvm-hkogr"
  random_string     = "hkogr"
  admin_username    = "testadmin230707010127174314"
  admin_password    = "Password1234!230707010127174314"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230707010127174314"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230707010127174314"
  ...
  identifier {
    publisher = "AccTesPublisher230707010127174314"
    offer     = "AccTesOffer230707010127174314"
    sku       = "AccTesSku230707010127174314"
  }
}
