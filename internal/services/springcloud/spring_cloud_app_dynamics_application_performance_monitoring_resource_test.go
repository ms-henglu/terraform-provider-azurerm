...
func TestAccSpringCloudAppDynamicsApplicationPerformanceMonitoringPerformanceMonitoring_basic(t *testing.T) {
...
func TestAccSpringCloudAppDynamicsApplicationPerformanceMonitoringPerformanceMonitoring_requiresImport(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_spring_cloud_app_dynamics_application_performance_monitoring", "test")
	r := SpringCloudAppDynamicsApplicationPerformanceMonitoringResource{}
	data.ResourceTest(t, r, []acceptance.TestStep{
		{
...
func TestAccSpringCloudAppDynamicsApplicationPerformanceMonitoringPerformanceMonitoring_complete(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_spring_cloud_app_dynamics_application_performance_monitoring", "test")
	r := SpringCloudAppDynamicsApplicationPerformanceMonitoringResource{}
	data.ResourceTest(t, r, []acceptance.TestStep{
		{
...
func TestAccSpringCloudAppDynamicsApplicationPerformanceMonitoringPerformanceMonitoring_update(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_spring_cloud_app_dynamics_application_performance_monitoring", "test")
	r := SpringCloudAppDynamicsApplicationPerformanceMonitoringResource{}
	data.ResourceTest(t, r, []acceptance.TestStep{
		{
