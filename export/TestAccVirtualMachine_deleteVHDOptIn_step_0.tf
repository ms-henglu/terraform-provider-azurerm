...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-210917031451920029"
  location = "West Europe"
}

resource "azurerm_resource_group" "test-sa" {
  name     = "acctestRG-sa-210917031451920029"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctvn-210917031451920029"
...
resource "azurerm_subnet" "test" {
  name                 = "acctsub-210917031451920029"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_network_interface" "test" {
  name                = "acctni-210917031451920029"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_virtual_machine" "test" {
  name                  = "acctvm-210917031451920029"
  location              = azurerm_resource_group.test.location
  resource_group_name   = azurerm_resource_group.test.name
  ...
  os_profile {
    computer_name  = "hn210917031451920029"
