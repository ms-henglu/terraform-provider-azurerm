...
locals {
  number            = "220819165017102889"
  location          = "West Europe"
  domain_name_label = "acctestvm-skmqm"
  random_string     = "skmqm"
  admin_username    = "testadmin220819165017102889"
  admin_password    = "Password1234!220819165017102889"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220819165017102889"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220819165017102889"
  ...
  identifier {
    publisher = "AccTesPublisher220819165017102889"
    offer     = "AccTesOffer220819165017102889"
    sku       = "AccTesSku220819165017102889"
  }
}
