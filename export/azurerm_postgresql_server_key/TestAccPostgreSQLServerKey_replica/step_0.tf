...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-221216014019873221"
...
resource "azurerm_postgresql_server" "test" {
  name                = "acctest-postgre-server-221216014019873221"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_resource_group" "replica" {
  name     = "acctestRG-psql-221216014019873221-replica"
  location = "West Europe"
}

resource "azurerm_postgresql_server" "replica" {
  name                = "acctest-postgre-replica-221216014019873221"
