...
locals {
  number            = "211203161152211235"
  location          = "West Europe"
  domain_name_label = "acctestvm-fgbdk"
  random_string     = "fgbdk"
  admin_username    = "testadmin211203161152211235"
  admin_password    = "Password1234!211203161152211235"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211203161152211235"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211203161152211235"
  ...
  identifier {
    publisher = "AccTesPublisher211203161152211235"
    offer     = "AccTesOffer211203161152211235"
    sku       = "AccTesSku211203161152211235"
  }
}
