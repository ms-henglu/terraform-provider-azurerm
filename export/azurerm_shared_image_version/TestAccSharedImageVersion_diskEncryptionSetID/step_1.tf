...
locals {
  number            = "230512003629463103"
  location          = "West Europe"
  domain_name_label = "acctestvm-vajx1"
  random_string     = "vajx1"
  admin_username    = "testadmin230512003629463103"
  admin_password    = "Password1234!230512003629463103"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230512003629463103"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230512003629463103"
  ...
  identifier {
    publisher = "AccTesPublisher230512003629463103"
    offer     = "AccTesOffer230512003629463103"
    sku       = "AccTesSku230512003629463103"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230512003629463103"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
