...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-9hm7h"
  policy_type  = "Custom"
  display_name = "testPolicySet-9hm7h"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-9hm7h"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-9hm7h"
