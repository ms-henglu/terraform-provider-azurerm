...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-211105040208647864"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctvn-211105040208647864"
...
resource "azurerm_virtual_machine_scale_set" "test" {
  name                = "acctvmss-211105040208647864"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  ...
  os_profile {
    computer_name_prefix = "testvm-211105040208647864"
  ...
  network_profile {
    name    = "TestNetworkProfile-211105040208647864"
    primary = true
...
resource "azurerm_monitor_autoscale_setting" "test" {
  name                = "acctestautoscale-211105040208647864"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
