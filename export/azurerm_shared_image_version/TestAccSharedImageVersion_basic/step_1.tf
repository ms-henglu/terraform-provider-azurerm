...
locals {
  number            = "230707003540149496"
  location          = "West Europe"
  domain_name_label = "acctestvm-c9mer"
  random_string     = "c9mer"
  admin_username    = "testadmin230707003540149496"
  admin_password    = "Password1234!230707003540149496"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230707003540149496"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230707003540149496"
  ...
  identifier {
    publisher = "AccTesPublisher230707003540149496"
    offer     = "AccTesOffer230707003540149496"
    sku       = "AccTesSku230707003540149496"
  }
}
