...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-diskpool-220623223336465729"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet-220623223336465729"
...
resource "azurerm_subnet" "test" {
  name                 = "acctest-subnet-220623223336465729"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_managed_disk" "test" {
  name                 = "acctest-diskpool-220623223336465729"
  resource_group_name  = azurerm_resource_group.test.name
  location             = azurerm_resource_group.test.location
  create_option        = "Empty"
...
resource "azurerm_managed_disk" "second" {
  name                 = "acctest-diskspool-220623223336465729-2"
  resource_group_name  = azurerm_resource_group.test.name
  location             = azurerm_resource_group.test.location
  create_option        = "Empty"
  storage_account_type = "Premium_LRS"
