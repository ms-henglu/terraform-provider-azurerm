...
func TestAccDNSResolverOutboundEndpoint_basic(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_dns_resolver_outbound_endpoint", "test")
...
func (r DNSResolverOutboundEndpointResource) Exists(ctx context.Context, clients *clients.Client, state *pluginsdk.InstanceState) (*bool, error) {
	...
	client := clients.DNSResolver.OutboundEndpointsClient
...
resource "azurerm_dns_resolver_outbound_endpoint" "test" {
  name            = "acctest-droe-%d"
...
resource "azurerm_dns_resolver_outbound_endpoint" "import" {
  name            = azurerm_dns_resolver_outbound_endpoint.test.name
  dns_resolver_id = azurerm_dns_resolver_outbound_endpoint.test.dns_resolver_id
  location        = azurerm_dns_resolver_outbound_endpoint.test.location
  subnet_id       = azurerm_dns_resolver_outbound_endpoint.test.subnet_id
}
`, config)
}
