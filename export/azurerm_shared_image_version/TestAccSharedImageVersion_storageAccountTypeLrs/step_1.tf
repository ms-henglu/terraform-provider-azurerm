...
locals {
  number            = "230707010127178584"
  location          = "West Europe"
  domain_name_label = "acctestvm-1kai4"
  random_string     = "1kai4"
  admin_username    = "testadmin230707010127178584"
  admin_password    = "Password1234!230707010127178584"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230707010127178584"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230707010127178584"
  ...
  identifier {
    publisher = "AccTesPublisher230707010127178584"
    offer     = "AccTesOffer230707010127178584"
    sku       = "AccTesSku230707010127178584"
  }
}
