...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-DataCollectionRule-230106031722205544"
...
resource "azurerm_log_analytics_workspace" "test1" {
  name                = "acctest-law-230106031722205544"
...
resource "azurerm_log_analytics_workspace" "test2" {
  name                = "acctest-law2-230106031722205544"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
}
...
resource "azurerm_monitor_data_collection_rule" "test" {
  name                = "acctestmdcr-230106031722205544"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
