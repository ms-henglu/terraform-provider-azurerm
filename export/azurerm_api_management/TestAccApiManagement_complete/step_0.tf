...
resource "azurerm_resource_group" "test1" {
  name     = "acctestRG-api1-240112223839728015"
  location = "West Europe"
}

resource "azurerm_resource_group" "test2" {
  name     = "acctestRG-api2-240112223839728015"
  location = "West US 2"
}

resource "azurerm_resource_group" "test3" {
  name     = "acctestRG-api3-240112223839728015"
  location = "East US 2"
}

resource "azurerm_api_management" "test" {
  name                      = "acctestAM-240112223839728015"
  publisher_name            = "pub1"
  ...
  hostname_configuration {
    proxy {
      host_name                    = "acctestAM-240112223839728015.azure-api.net"
