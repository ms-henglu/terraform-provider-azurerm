...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220128082652104326"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvnet220128082652104326"
...
resource "azurerm_subnet" "test" {
  name                 = "acctestsubnet220128082652104326"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_mariadb_server" "test" {
  name                         = "acctestmariadbsvr-220128082652104326"
  location                     = azurerm_resource_group.test.location
  resource_group_name          = azurerm_resource_group.test.name
...
resource "azurerm_mariadb_virtual_network_rule" "test" {
  name                = "acctestmariadbvnetrule220128082652104326"
  resource_group_name = azurerm_resource_group.test.name
