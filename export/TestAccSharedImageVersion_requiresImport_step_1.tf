...
locals {
  number            = "211119050629412039"
  location          = "West Europe"
  domain_name_label = "acctestvm-9crix"
  random_string     = "9crix"
  admin_username    = "testadmin211119050629412039"
  admin_password    = "Password1234!211119050629412039"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211119050629412039"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211119050629412039"
  ...
  identifier {
    publisher = "AccTesPublisher211119050629412039"
    offer     = "AccTesOffer211119050629412039"
    sku       = "AccTesSku211119050629412039"
  }
}
