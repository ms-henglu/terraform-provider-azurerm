...
locals {
  number            = "220326010253720797"
  location          = "West Europe"
  domain_name_label = "acctestvm-b12as"
  random_string     = "b12as"
  admin_username    = "testadmin220326010253720797"
  admin_password    = "Password1234!220326010253720797"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220326010253720797"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220326010253720797"
  ...
  identifier {
    publisher = "AccTesPublisher220326010253720797"
    offer     = "AccTesOffer220326010253720797"
    sku       = "AccTesSku220326010253720797"
  }
}
