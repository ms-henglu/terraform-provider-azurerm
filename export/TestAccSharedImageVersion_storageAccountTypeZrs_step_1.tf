...
locals {
  number            = "220204092752860889"
  location          = "West Europe"
  domain_name_label = "acctestvm-fzgv9"
  random_string     = "fzgv9"
  admin_username    = "testadmin220204092752860889"
  admin_password    = "Password1234!220204092752860889"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220204092752860889"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220204092752860889"
  ...
  identifier {
    publisher = "AccTesPublisher220204092752860889"
    offer     = "AccTesOffer220204092752860889"
    sku       = "AccTesSku220204092752860889"
  }
}
