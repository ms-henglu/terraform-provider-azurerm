...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220826003237413675"
  location = "West Europe"
}

resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhub-220826003237413675"
  location            = "West Europe"
...
resource "azurerm_eventhub_authorization_rule" "test" {
  name                = "acctest-eventhub-auth-rule-220826003237413675"
  namespace_name      = azurerm_eventhub_namespace.test.name
...
resource "azurerm_security_center_automation" "test" {
  name                = "acctestautomation-220826003237413675"
  location            = "West Europe"
  resource_group_name = azurerm_resource_group.test.name
