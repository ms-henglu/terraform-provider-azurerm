...
locals {
  number            = "210825044610908695"
  location          = "West Europe"
  domain_name_label = "acctestvm-qzawi"
  random_string     = "qzawi"
  admin_username    = "testadmin210825044610908695"
  admin_password    = "Password1234!210825044610908695"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825044610908695"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825044610908695"
  ...
  identifier {
    publisher = "AccTesPublisher210825044610908695"
    offer     = "AccTesOffer210825044610908695"
    sku       = "AccTesSku210825044610908695"
  }
}
