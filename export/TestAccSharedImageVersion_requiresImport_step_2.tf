...
locals {
  number            = "211105025753275363"
  location          = "West Europe"
  domain_name_label = "acctestvm-qv31r"
  random_string     = "qv31r"
  admin_username    = "testadmin211105025753275363"
  admin_password    = "Password1234!211105025753275363"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211105025753275363"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211105025753275363"
  ...
  identifier {
    publisher = "AccTesPublisher211105025753275363"
    offer     = "AccTesOffer211105025753275363"
    sku       = "AccTesSku211105025753275363"
  }
}
