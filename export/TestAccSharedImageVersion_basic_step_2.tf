...
locals {
  number            = "220826005646574173"
  location          = "West Europe"
  domain_name_label = "acctestvm-6333m"
  random_string     = "6333m"
  admin_username    = "testadmin220826005646574173"
  admin_password    = "Password1234!220826005646574173"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220826005646574173"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220826005646574173"
  ...
  identifier {
    publisher = "AccTesPublisher220826005646574173"
    offer     = "AccTesOffer220826005646574173"
    sku       = "AccTesSku220826005646574173"
  }
}
