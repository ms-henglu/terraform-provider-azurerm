...
locals {
  number            = "220715014258879867"
  location          = "West Europe"
  domain_name_label = "acctestvm-rv1td"
  random_string     = "rv1td"
  admin_username    = "testadmin220715014258879867"
  admin_password    = "Password1234!220715014258879867"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220715014258879867"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220715014258879867"
  ...
  identifier {
    publisher = "AccTesPublisher220715014258879867"
    offer     = "AccTesOffer220715014258879867"
    sku       = "AccTesSku220715014258879867"
  }
}
...
resource "azurerm_shared_image_version" "test" {
  ...
  end_of_life_date    = "2022-07-15T11:42:58Z"
