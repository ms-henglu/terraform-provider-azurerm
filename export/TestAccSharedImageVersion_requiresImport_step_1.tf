...
locals {
  number            = "211029015345460456"
  location          = "West Europe"
  domain_name_label = "acctestvm-t19ad"
  random_string     = "t19ad"
  admin_username    = "testadmin211029015345460456"
  admin_password    = "Password1234!211029015345460456"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211029015345460456"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211029015345460456"
  ...
  identifier {
    publisher = "AccTesPublisher211029015345460456"
    offer     = "AccTesOffer211029015345460456"
    sku       = "AccTesSku211029015345460456"
  }
}
