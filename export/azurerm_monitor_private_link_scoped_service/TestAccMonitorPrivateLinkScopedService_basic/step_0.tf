...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-plss-230616075122909963"
  location = "West Europe"
}

resource "azurerm_monitor_private_link_scope" "test" {
  name                = "acctest-pls-230616075122909963"
  resource_group_name = azurerm_resource_group.test.name
}

resource "azurerm_application_insights" "test" {
  name                = "acctest-appinsights-230616075122909963"
...
resource "azurerm_monitor_private_link_scoped_service" "test" {
  name                = "acctest-plss-230616075122909963"
  resource_group_name = azurerm_resource_group.test.name
