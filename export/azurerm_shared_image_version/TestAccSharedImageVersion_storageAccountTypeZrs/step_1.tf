...
locals {
  number            = "230922053821488980"
  location          = "West Europe"
  domain_name_label = "acctestvm-nu22p"
  random_string     = "nu22p"
  admin_username    = "testadmin230922053821488980"
  admin_password    = "Password1234!230922053821488980"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230922053821488980"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230922053821488980"
  ...
  identifier {
    publisher = "AccTesPublisher230922053821488980"
    offer     = "AccTesOffer230922053821488980"
    sku       = "AccTesSku230922053821488980"
  }
}
