...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-ml-240105064115128053"
...
resource "azurerm_application_insights" "test" {
  name                = "acctestai-240105064115128053"
...
resource "azurerm_machine_learning_workspace" "test" {
  name                    = "acc-MLW240105064115128053"
  location                = azurerm_resource_group.test.location
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_private_endpoint" "test" {
  name                = "test-pe-240105064115128053"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  subnet_id           = azurerm_subnet.test.id

  private_service_connection {
    name                           = "test-mlworkspace-240105064115128053"
...
resource "azurerm_virtual_network" "test" {
  name                = "accvnet240105064115128053"
...
resource "azurerm_subnet" "test" {
  name                 = "accsubnet240105064115128053"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_network_security_group" "test" {
  name                = "test-nsg-240105064115128053"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  security_rule {
    name                       = "test123"
