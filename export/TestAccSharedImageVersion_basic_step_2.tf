...
locals {
  number            = "211001223759408121"
  location          = "West Europe"
  domain_name_label = "acctestvm-47sly"
  random_string     = "47sly"
  admin_username    = "testadmin211001223759408121"
  admin_password    = "Password1234!211001223759408121"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211001223759408121"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211001223759408121"
  ...
  identifier {
    publisher = "AccTesPublisher211001223759408121"
    offer     = "AccTesOffer211001223759408121"
    sku       = "AccTesSku211001223759408121"
  }
}
