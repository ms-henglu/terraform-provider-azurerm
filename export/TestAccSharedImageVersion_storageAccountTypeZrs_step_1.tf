...
locals {
  number            = "220819165017107445"
  location          = "West Europe"
  domain_name_label = "acctestvm-r8o0q"
  random_string     = "r8o0q"
  admin_username    = "testadmin220819165017107445"
  admin_password    = "Password1234!220819165017107445"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220819165017107445"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220819165017107445"
  ...
  identifier {
    publisher = "AccTesPublisher220819165017107445"
    offer     = "AccTesOffer220819165017107445"
    sku       = "AccTesSku220819165017107445"
  }
}
