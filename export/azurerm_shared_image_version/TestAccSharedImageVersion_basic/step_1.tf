...
locals {
  number            = "221222034403199891"
  location          = "West Europe"
  domain_name_label = "acctestvm-f1ozu"
  random_string     = "f1ozu"
  admin_username    = "testadmin221222034403199891"
  admin_password    = "Password1234!221222034403199891"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221222034403199891"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221222034403199891"
  ...
  identifier {
    publisher = "AccTesPublisher221222034403199891"
    offer     = "AccTesOffer221222034403199891"
    sku       = "AccTesSku221222034403199891"
  }
}
