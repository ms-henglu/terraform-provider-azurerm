...
locals {
  number            = "220630210603390721"
  location          = "West Europe"
  domain_name_label = "acctestvm-xhn4p"
  random_string     = "xhn4p"
  admin_username    = "testadmin220630210603390721"
  admin_password    = "Password1234!220630210603390721"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220630210603390721"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220630210603390721"
  ...
  identifier {
    publisher = "AccTesPublisher220630210603390721"
    offer     = "AccTesOffer220630210603390721"
    sku       = "AccTesSku220630210603390721"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220630210603390721"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
