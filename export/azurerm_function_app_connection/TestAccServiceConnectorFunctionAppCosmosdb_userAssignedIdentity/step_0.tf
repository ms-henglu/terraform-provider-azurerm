...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-240112035136882939"
  location = "West Europe"
}

resource "azurerm_cosmosdb_account" "test" {
  name                = "acctestcosmosdb240112035136882939"
...
resource "azurerm_app_service_plan" "test" {
  name                = "acctestASP-240112035136882939"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_function_app" "test" {
  name                       = "acctest-240112035136882939-func"
  location                   = azurerm_resource_group.test.location
  resource_group_name        = azurerm_resource_group.test.name
...
resource "azurerm_function_app_connection" "test" {
  name               = "acctestserviceconnector240112035136882939"
