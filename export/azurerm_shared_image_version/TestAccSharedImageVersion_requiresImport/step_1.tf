...
locals {
  number            = "221028164721123857"
  location          = "West Europe"
  domain_name_label = "acctestvm-8snrm"
  random_string     = "8snrm"
  admin_username    = "testadmin221028164721123857"
  admin_password    = "Password1234!221028164721123857"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221028164721123857"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221028164721123857"
  ...
  identifier {
    publisher = "AccTesPublisher221028164721123857"
    offer     = "AccTesOffer221028164721123857"
    sku       = "AccTesSku221028164721123857"
  }
}
