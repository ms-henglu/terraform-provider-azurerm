...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-nf726"
  policy_type  = "Custom"
  display_name = "testPolicySet-nf726"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-nf726"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-nf726"
