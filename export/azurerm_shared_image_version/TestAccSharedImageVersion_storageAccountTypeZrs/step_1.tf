...
locals {
  number            = "230915023108515637"
  location          = "West Europe"
  domain_name_label = "acctestvm-3lf20"
  random_string     = "3lf20"
  admin_username    = "testadmin230915023108515637"
  admin_password    = "Password1234!230915023108515637"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230915023108515637"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230915023108515637"
  ...
  identifier {
    publisher = "AccTesPublisher230915023108515637"
    offer     = "AccTesOffer230915023108515637"
    sku       = "AccTesSku230915023108515637"
  }
}
