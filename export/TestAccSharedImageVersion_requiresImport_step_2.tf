...
locals {
  number            = "220121044320004606"
  location          = "West Europe"
  domain_name_label = "acctestvm-3ixfv"
  random_string     = "3ixfv"
  admin_username    = "testadmin220121044320004606"
  admin_password    = "Password1234!220121044320004606"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220121044320004606"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220121044320004606"
  ...
  identifier {
    publisher = "AccTesPublisher220121044320004606"
    offer     = "AccTesOffer220121044320004606"
    sku       = "AccTesSku220121044320004606"
  }
}
