...
locals {
  number            = "230227175227916603"
  location          = "West Europe"
  domain_name_label = "acctestvm-cv9jk"
  random_string     = "cv9jk"
  admin_username    = "testadmin230227175227916603"
  admin_password    = "Password1234!230227175227916603"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230227175227916603"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230227175227916603"
  ...
  identifier {
    publisher = "AccTesPublisher230227175227916603"
    offer     = "AccTesOffer230227175227916603"
    sku       = "AccTesSku230227175227916603"
  }
}
