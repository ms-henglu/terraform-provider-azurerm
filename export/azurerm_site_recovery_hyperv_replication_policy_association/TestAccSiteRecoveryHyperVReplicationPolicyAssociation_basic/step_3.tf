...
locals {
  rg_name              = "acctest-nested-rg-230428050409634199"
  location             = "West Europe"
  vn_name              = "acctest-nested-vn-230428050409634199"
  ip_name              = "acctest-nested-ip-230428050409634199"
  vm_name              = "acctest-nested-vm-230428050409634199"
  nic_name             = "acctest-nested-nic-230428050409634199"
  disk_name            = "acctest-nested-disk-230428050409634199"
  keyvault_name        = "acctkv230428050409634199"
  nsg_name             = "acctest-nested-nsg-230428050409634199"
  recovery_vault_name  = "acctest-nested-recovery-vault-230428050409634199"
  recovery_site_name   = "acctest-nested-recovery-site-230428050409634199"
  admin_name           = "acctestadmin"
  cert_name            = "acctestcert"
  storage_account_name = "acctestsats4sl"
}
...
resource "azurerm_windows_virtual_machine" "host" {
  ...
  additional_unattend_content {
    setting = "AutoLogon"
    content = "<AutoLogon><Password><Value>L54p^V58hf</Value></Password><Enabled>true</Enabled><LogonCount>1</LogonCount><Username>${local.admin_name}</Username></AutoLogon>"
  }
...
resource "azurerm_site_recovery_hyperv_replication_policy" "test" {
  recovery_vault_id                                  = azurerm_recovery_services_vault.test.id
  name                                               = "acctest-policy-230428050409634199"
