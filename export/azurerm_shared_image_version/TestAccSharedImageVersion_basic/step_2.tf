...
locals {
  number            = "230106031234903198"
  location          = "West Europe"
  domain_name_label = "acctestvm-ad13u"
  random_string     = "ad13u"
  admin_username    = "testadmin230106031234903198"
  admin_password    = "Password1234!230106031234903198"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230106031234903198"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230106031234903198"
  ...
  identifier {
    publisher = "AccTesPublisher230106031234903198"
    offer     = "AccTesOffer230106031234903198"
    sku       = "AccTesSku230106031234903198"
  }
}
