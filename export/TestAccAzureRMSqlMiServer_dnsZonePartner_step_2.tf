...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-sql-211203014519008805"
  location = "West Europe"
}

resource "azurerm_network_security_group" "test" {
  name                = "mi-security-group-211203014519008805"
...
resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet-211203014519008805"
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_subnet" "test" {
  name                 = "subnet-211203014519008805"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_route_table" "test" {
  name                          = "routetable-211203014519008805"
  location                      = azurerm_resource_group.test.location
  resource_group_name           = azurerm_resource_group.test.name
...
resource "azurerm_sql_managed_instance" "test" {
  name                         = "acctestsqlserver211203014519008805"
  resource_group_name          = azurerm_resource_group.test.name
  location                     = azurerm_resource_group.test.location
...
resource "azurerm_resource_group" "test1" {
  name     = "acctestRG2-sql-211203014519008805"
  location = "West US 2"
}

resource "azurerm_virtual_network" "test1" {
  name                = "acctest-vnet2-211203014519008805"
...
resource "azurerm_subnet" "test1" {
  name                 = "subnet2-211203014519008805"
  resource_group_name  = azurerm_resource_group.test1.name
...
resource "azurerm_network_security_group" "test1" {
  name                = "mi-security-group2-211203014519008805"
  location            = azurerm_resource_group.test1.location
  resource_group_name = azurerm_resource_group.test1.name
}

resource "azurerm_network_security_rule" "allow_management_inbound1" {
  name                        = "allow_management_inbound"
  priority                    = 106
  direction                   = "Inbound"
  access                      = "Allow"
...
resource "azurerm_network_security_rule" "allow_misubnet_inbound1" {
  name                        = "allow_misubnet_inbound"
  priority                    = 200
  direction                   = "Inbound"
  access                      = "Allow"
...
resource "azurerm_network_security_rule" "allow_health_probe_inbound1" {
  name                        = "allow_health_probe_inbound"
  priority                    = 300
  direction                   = "Inbound"
  access                      = "Allow"
...
resource "azurerm_network_security_rule" "allow_tds_inbound1" {
  name                        = "allow_tds_inbound"
  priority                    = 1000
  direction                   = "Inbound"
  access                      = "Allow"
...
resource "azurerm_network_security_rule" "deny_all_inbound1" {
  name                        = "deny_all_inbound"
  priority                    = 4096
  direction                   = "Inbound"
  access                      = "Deny"
...
resource "azurerm_network_security_rule" "allow_management_outbound1" {
  name                        = "allow_management_outbound"
  priority                    = 102
  direction                   = "Outbound"
  access                      = "Allow"
...
resource "azurerm_network_security_rule" "allow_misubnet_outbound1" {
  name                        = "allow_misubnet_outbound"
  priority                    = 200
  direction                   = "Outbound"
  access                      = "Allow"
...
resource "azurerm_network_security_rule" "deny_all_outbound1" {
  name                        = "deny_all_outbound"
  priority                    = 4096
  direction                   = "Outbound"
  access                      = "Deny"
...
resource "azurerm_subnet_route_table_association" "test1" {
  subnet_id      = azurerm_subnet.test1.id
  route_table_id = azurerm_route_table.test1.id
}


resource "azurerm_sql_managed_instance" "test1" {
  name                         = "acctestsqlserver2211203014519008805"
  resource_group_name          = azurerm_resource_group.test1.name
  location                     = azurerm_resource_group.test1.location
  administrator_login          = "mradministrator"
  administrator_login_password = "thisIsDog11"
