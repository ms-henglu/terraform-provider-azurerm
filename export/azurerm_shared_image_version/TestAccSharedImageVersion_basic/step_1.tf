...
locals {
  number            = "230616074443135783"
  location          = "West Europe"
  domain_name_label = "acctestvm-2b8ce"
  random_string     = "2b8ce"
  admin_username    = "testadmin230616074443135783"
  admin_password    = "Password1234!230616074443135783"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230616074443135783"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230616074443135783"
  ...
  identifier {
    publisher = "AccTesPublisher230616074443135783"
    offer     = "AccTesOffer230616074443135783"
    sku       = "AccTesSku230616074443135783"
  }
}
