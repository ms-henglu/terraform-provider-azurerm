...
locals {
  number            = "220527033935753364"
  location          = "West Europe"
  domain_name_label = "acctestvm-q3j81"
  random_string     = "q3j81"
  admin_username    = "testadmin220527033935753364"
  admin_password    = "Password1234!220527033935753364"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220527033935753364"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220527033935753364"
  ...
  identifier {
    publisher = "AccTesPublisher220527033935753364"
    offer     = "AccTesOffer220527033935753364"
    sku       = "AccTesSku220527033935753364"
  }
}
