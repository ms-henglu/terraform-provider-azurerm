...
locals {
  number            = "230818023718895365"
  location          = "West Europe"
  domain_name_label = "acctestvm-nblpd"
  random_string     = "nblpd"
  admin_username    = "testadmin230818023718895365"
  admin_password    = "Password1234!230818023718895365"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230818023718895365"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230818023718895365"
  ...
  identifier {
    publisher = "AccTesPublisher230818023718895365"
    offer     = "AccTesOffer230818023718895365"
    sku       = "AccTesSku230818023718895365"
  }
}
