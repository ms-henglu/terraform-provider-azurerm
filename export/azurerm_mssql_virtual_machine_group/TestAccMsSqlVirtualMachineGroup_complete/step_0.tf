...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-mssql-230929065324044250"
  location = "West Europe"
}

resource "azurerm_storage_account" "test" {
  name                     = "unlikely23exst2acct9qxl4"
...
resource "azurerm_mssql_virtual_machine_group" "test" {
  ...
  wsfc_domain_profile {
    ...
    cluster_bootstrap_account_name = "bootstrapacc9qxl4"
    cluster_operator_account_name  = "opacc9qxl4"
    sql_service_account_name       = "sqlsrvacc9qxl4"
