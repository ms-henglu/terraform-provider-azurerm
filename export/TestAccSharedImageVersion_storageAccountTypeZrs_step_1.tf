...
locals {
  number            = "210928055247513102"
  location          = "West Europe"
  domain_name_label = "acctestvm-kjvvw"
  random_string     = "kjvvw"
  admin_username    = "testadmin210928055247513102"
  admin_password    = "Password1234!210928055247513102"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210928055247513102"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210928055247513102"
  ...
  identifier {
    publisher = "AccTesPublisher210928055247513102"
    offer     = "AccTesOffer210928055247513102"
    sku       = "AccTesSku210928055247513102"
  }
}
