...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-iothub-230613072019997098"
  location = "West Europe"
}

resource "azurerm_storage_account" "test" {
  name                     = "acc230613072019997098"
...
resource "azurerm_servicebus_namespace" "test" {
  name                = "acctest-230613072019997098"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Standard"
}
...
resource "azurerm_servicebus_topic" "test" {
  name         = "acctestservicebustopic-230613072019997098"
  namespace_id = azurerm_servicebus_namespace.test.id
}
...
resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhubnamespace-230613072019997098"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Basic"
}
...
resource "azurerm_eventhub" "test" {
  name                = "acctesteventhub-230613072019997098"
...
resource "azurerm_user_assigned_identity" "test" {
  name                = "acctestuai-230613072019997098"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}
...
resource "azurerm_iothub" "test" {
  name                = "acctestIoTHub-230613072019997098"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
