...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-plss-221021031511342307"
  location = "West Europe"
}

resource "azurerm_monitor_private_link_scope" "test" {
  name                = "acctest-pls-221021031511342307"
  resource_group_name = azurerm_resource_group.test.name
}

resource "azurerm_application_insights" "test" {
  name                = "acctest-appinsights-221021031511342307"
...
resource "azurerm_monitor_private_link_scoped_service" "test" {
  name                = "acctest-plss-221021031511342307"
  resource_group_name = azurerm_resource_group.test.name
