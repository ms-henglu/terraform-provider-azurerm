...
locals {
  number            = "221117230632439486"
  location          = "West Europe"
  domain_name_label = "acctestvm-i1tqc"
  random_string     = "i1tqc"
  admin_username    = "testadmin221117230632439486"
  admin_password    = "Password1234!221117230632439486"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221117230632439486"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221117230632439486"
  ...
  identifier {
    publisher = "AccTesPublisher221117230632439486"
    offer     = "AccTesOffer221117230632439486"
    sku       = "AccTesSku221117230632439486"
  }
}
