...
locals {
  number            = "220729032452208498"
  location          = "West Europe"
  domain_name_label = "acctestvm-wqko9"
  random_string     = "wqko9"
  admin_username    = "testadmin220729032452208498"
  admin_password    = "Password1234!220729032452208498"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220729032452208498"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220729032452208498"
  ...
  identifier {
    publisher = "AccTesPublisher220729032452208498"
    offer     = "AccTesOffer220729032452208498"
    sku       = "AccTesSku220729032452208498"
  }
}
