...
locals {
  number            = "221221204056153299"
  location          = "West Europe"
  domain_name_label = "acctestvm-f02bt"
  random_string     = "f02bt"
  admin_username    = "testadmin221221204056153299"
  admin_password    = "Password1234!221221204056153299"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221221204056153299"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221221204056153299"
  ...
  identifier {
    publisher = "AccTesPublisher221221204056153299"
    offer     = "AccTesOffer221221204056153299"
    sku       = "AccTesSku221221204056153299"
  }
}
