...
locals {
  number            = "230922060812872076"
  location          = "West Europe"
  domain_name_label = "acctestvm-l7s1p"
  random_string     = "l7s1p"
  admin_username    = "testadmin230922060812872076"
  admin_password    = "Password1234!230922060812872076"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230922060812872076"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230922060812872076"
  ...
  identifier {
    publisher = "AccTesPublisher230922060812872076"
    offer     = "AccTesOffer230922060812872076"
    sku       = "AccTesSku230922060812872076"
  }
}
