...
locals {
  number            = "240311031615619043"
  location          = "West Europe"
  domain_name_label = "acctestvm-qsny1"
  random_string     = "qsny1"
  admin_username    = "testadmin240311031615619043"
  admin_password    = "Password1234!240311031615619043"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240311031615619043"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240311031615619043"
  ...
  identifier {
    publisher = "AccTesPublisher240311031615619043"
    offer     = "AccTesOffer240311031615619043"
    sku       = "AccTesSku240311031615619043"
  }
}
