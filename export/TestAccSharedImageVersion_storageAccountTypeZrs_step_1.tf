...
locals {
  number            = "211210034450660944"
  location          = "West Europe"
  domain_name_label = "acctestvm-hcuon"
  random_string     = "hcuon"
  admin_username    = "testadmin211210034450660944"
  admin_password    = "Password1234!211210034450660944"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211210034450660944"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211210034450660944"
  ...
  identifier {
    publisher = "AccTesPublisher211210034450660944"
    offer     = "AccTesOffer211210034450660944"
    sku       = "AccTesSku211210034450660944"
  }
}
