...
locals {
  number            = "230106031234901654"
  location          = "West Europe"
  domain_name_label = "acctestvm-x6j08"
  random_string     = "x6j08"
  admin_username    = "testadmin230106031234901654"
  admin_password    = "Password1234!230106031234901654"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230106031234901654"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230106031234901654"
  ...
  identifier {
    publisher = "AccTesPublisher230106031234901654"
    offer     = "AccTesOffer230106031234901654"
    sku       = "AccTesSku230106031234901654"
  }
}
