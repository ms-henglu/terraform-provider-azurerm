...
locals {
  number            = "210825044607835241"
  location          = "West Europe"
  domain_name_label = "acctestvm-xf8jn"
  random_string     = "xf8jn"
  admin_username    = "testadmin210825044607835241"
  admin_password    = "Password1234!210825044607835241"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825044607835241"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825044607835241"
  ...
  identifier {
    publisher = "AccTesPublisher210825044607835241"
    offer     = "AccTesOffer210825044607835241"
    sku       = "AccTesSku210825044607835241"
  }
}
