...
locals {
  number            = "230407023100163388"
  location          = "West Europe"
  domain_name_label = "acctestvm-gwxjj"
  random_string     = "gwxjj"
  admin_username    = "testadmin230407023100163388"
  admin_password    = "Password1234!230407023100163388"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230407023100163388"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230407023100163388"
  ...
  identifier {
    publisher = "AccTesPublisher230407023100163388"
    offer     = "AccTesOffer230407023100163388"
    sku       = "AccTesSku230407023100163388"
  }
}
