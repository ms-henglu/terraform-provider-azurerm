...
locals {
  number            = "230414020945142018"
  location          = "West Europe"
  domain_name_label = "acctestvm-j383r"
  random_string     = "j383r"
  admin_username    = "testadmin230414020945142018"
  admin_password    = "Password1234!230414020945142018"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230414020945142018"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230414020945142018"
  ...
  identifier {
    publisher = "AccTesPublisher230414020945142018"
    offer     = "AccTesOffer230414020945142018"
    sku       = "AccTesSku230414020945142018"
  }
}
