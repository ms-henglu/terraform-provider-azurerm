...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-230512004217883626"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-230512004217883626"
...
resource "azurerm_subnet" "test" {
  name                 = "acctestsn-230512004217883626"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_storage_container" "test" {
  name                  = "acctestsc-230512004217883626"
  storage_account_name  = azurerm_storage_account.test.name
  container_access_type = "private"
}

resource "azurerm_public_ip" "test" {
  name                = "acctestpip-230512004217883626"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_lb" "test" {
  name                = "acctestlb-230512004217883626"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_lb_backend_address_pool" "test" {
  name            = "acctestbap-230512004217883626"
  loadbalancer_id = azurerm_lb.test.id
}

resource "azurerm_virtual_machine_scale_set" "test" {
  name                = "acctestvmss-230512004217883626"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
