...
locals {
  rg_name              = "acctest-nested-rg-230922054753906884"
  location             = "West Europe"
  vn_name              = "acctest-nested-vn-230922054753906884"
  ip_name              = "acctest-nested-ip-230922054753906884"
  vm_name              = "acctest-nested-vm-230922054753906884"
  nic_name             = "acctest-nested-nic-230922054753906884"
  disk_name            = "acctest-nested-disk-230922054753906884"
  keyvault_name        = "acctkv230922054753906884"
  nsg_name             = "acctest-nested-nsg-230922054753906884"
  recovery_vault_name  = "acctest-nested-recovery-vault-230922054753906884"
  recovery_site_name   = "acctest-nested-recovery-site-230922054753906884"
  admin_name           = "acctestadmin"
  cert_name            = "acctestcert"
  storage_account_name = "acctestsacs2vf"
}
...
resource "azurerm_windows_virtual_machine" "host" {
  ...
  additional_unattend_content {
    setting = "AutoLogon"
    content = "<AutoLogon><Password><Value>TS2Q8)%72B</Value></Password><Enabled>true</Enabled><LogonCount>1</LogonCount><Username>${local.admin_name}</Username></AutoLogon>"
  }
...
resource "azurerm_site_recovery_hyperv_replication_policy" "test" {
  recovery_vault_id                                  = azurerm_recovery_services_vault.test.id
  name                                               = "acctest-policy-230922054753906884"
