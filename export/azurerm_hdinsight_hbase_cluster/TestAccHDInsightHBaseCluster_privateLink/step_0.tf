...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-230428045831402524"
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestvirtnet230428045831402524"
...
resource "azurerm_subnet" "test" {
  name                 = "acctestsubnet230428045831402524"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_public_ip" "test" {
  name                = "acctestpip230428045831402524"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_nat_gateway" "test" {
  name                    = "acctestnat230428045831402524"
  location                = azurerm_resource_group.test.location
  resource_group_name     = azurerm_resource_group.test.name
  sku_name                = "Standard"
...
resource "azurerm_hdinsight_hbase_cluster" "test" {
  ...
  name                = "acctesthdi-230428045831402524"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  cluster_version     = "4.0"
  tier                = "Standard"
...
resource "azurerm_network_security_group" "test" {
  name                = "acctestnsg-230428045831402524"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
