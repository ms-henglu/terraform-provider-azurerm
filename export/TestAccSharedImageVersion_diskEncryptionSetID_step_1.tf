...
locals {
  number            = "220923011626951330"
  location          = "West Europe"
  domain_name_label = "acctestvm-941rb"
  random_string     = "941rb"
  admin_username    = "testadmin220923011626951330"
  admin_password    = "Password1234!220923011626951330"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220923011626951330"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220923011626951330"
  ...
  identifier {
    publisher = "AccTesPublisher220923011626951330"
    offer     = "AccTesOffer220923011626951330"
    sku       = "AccTesSku220923011626951330"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220923011626951330"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
