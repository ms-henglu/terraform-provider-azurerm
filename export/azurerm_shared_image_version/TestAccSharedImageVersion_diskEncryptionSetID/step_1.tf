...
locals {
  number            = "230203063036578167"
  location          = "West Europe"
  domain_name_label = "acctestvm-v1pvv"
  random_string     = "v1pvv"
  admin_username    = "testadmin230203063036578167"
  admin_password    = "Password1234!230203063036578167"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230203063036578167"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230203063036578167"
  ...
  identifier {
    publisher = "AccTesPublisher230203063036578167"
    offer     = "AccTesOffer230203063036578167"
    sku       = "AccTesSku230203063036578167"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230203063036578167"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
