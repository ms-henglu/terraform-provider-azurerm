...
locals {
  number            = "220610092433251091"
  location          = "West Europe"
  domain_name_label = "acctestvm-ij2ju"
  random_string     = "ij2ju"
  admin_username    = "testadmin220610092433251091"
  admin_password    = "Password1234!220610092433251091"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220610092433251091"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220610092433251091"
  ...
  identifier {
    publisher = "AccTesPublisher220610092433251091"
    offer     = "AccTesOffer220610092433251091"
    sku       = "AccTesSku220610092433251091"
  }
}
