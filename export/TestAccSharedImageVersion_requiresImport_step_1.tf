...
locals {
  number            = "220218070535205146"
  location          = "West Europe"
  domain_name_label = "acctestvm-xfrcc"
  random_string     = "xfrcc"
  admin_username    = "testadmin220218070535205146"
  admin_password    = "Password1234!220218070535205146"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220218070535205146"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220218070535205146"
  ...
  identifier {
    publisher = "AccTesPublisher220218070535205146"
    offer     = "AccTesOffer220218070535205146"
    sku       = "AccTesSku220218070535205146"
  }
}
