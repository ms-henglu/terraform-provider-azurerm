...
resource "azurerm_monitor_activity_log_alert" "test" {
  name                = "acctestActivityLogAlert-220506020220751170"
  resource_group_name = azurerm_resource_group.test.name
  enabled             = true
