...
locals {
  rg_name              = "acctest-nested-rg-230613072507273525"
  location             = "West Europe"
  vn_name              = "acctest-nested-vn-230613072507273525"
  ip_name              = "acctest-nested-ip-230613072507273525"
  vm_name              = "acctest-nested-vm-230613072507273525"
  nic_name             = "acctest-nested-nic-230613072507273525"
  disk_name            = "acctest-nested-disk-230613072507273525"
  keyvault_name        = "acctkv230613072507273525"
  nsg_name             = "acctest-nested-nsg-230613072507273525"
  recovery_vault_name  = "acctest-nested-recovery-vault-230613072507273525"
  recovery_site_name   = "acctest-nested-recovery-site-230613072507273525"
  admin_name           = "acctestadmin"
  cert_name            = "acctestcert"
  storage_account_name = "acctestsaxdtst"
}
...
resource "azurerm_windows_virtual_machine" "host" {
  ...
  additional_unattend_content {
    setting = "AutoLogon"
    content = "<AutoLogon><Password><Value>o$8zI%!(W2</Value></Password><Enabled>true</Enabled><LogonCount>1</LogonCount><Username>${local.admin_name}</Username></AutoLogon>"
  }
...
resource "azurerm_site_recovery_hyperv_replication_policy" "test" {
  recovery_vault_id                                  = azurerm_recovery_services_vault.test.id
  name                                               = "acctest-policy-230613072507273525"
