...
locals {
  number            = "220715014258877328"
  location          = "West Europe"
  domain_name_label = "acctestvm-xz6pc"
  random_string     = "xz6pc"
  admin_username    = "testadmin220715014258877328"
  admin_password    = "Password1234!220715014258877328"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220715014258877328"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220715014258877328"
  ...
  identifier {
    publisher = "AccTesPublisher220715014258877328"
    offer     = "AccTesOffer220715014258877328"
    sku       = "AccTesSku220715014258877328"
  }
}
