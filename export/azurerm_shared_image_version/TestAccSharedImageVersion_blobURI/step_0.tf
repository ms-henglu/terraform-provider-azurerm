...
locals {
  number            = "230922053821482695"
  location          = "West Europe"
  domain_name_label = "acctestvm-9cpjd"
  random_string     = "9cpjd"
  admin_username    = "testadmin230922053821482695"
  admin_password    = "Password1234!230922053821482695"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230922053821482695"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230922053821482695"
  ...
  identifier {
    publisher = "AccTesPublisher230922053821482695"
    offer     = "AccTesOffer230922053821482695"
    sku       = "AccTesSku230922053821482695"
  }
}
