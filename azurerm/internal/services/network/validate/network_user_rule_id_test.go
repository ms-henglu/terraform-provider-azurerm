...
func TestNetworkUserRuleID(t *testing.T) {
	cases := []struct {
		Input string
		Valid bool
	}{
		...
		{
			// missing value for UserRuleName
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Network/networkManagers/networkManager1/securityConfigurations/securityConfiguration1/userRules/",
			Valid: false,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Network/networkManagers/networkManager1/securityConfigurations/securityConfiguration1/userRules/userRule1",
			Valid: true,
		},
	...
	for _, tc := range cases {
		...
		_, errors := NetworkUserRuleID(tc.Input, "test")
		valid := len(errors) == 0
