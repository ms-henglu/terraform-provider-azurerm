...
locals {
  number            = "210825042656062858"
  location          = "West Europe"
  domain_name_label = "acctestvm-xys3o"
  random_string     = "xys3o"
  admin_username    = "testadmin210825042656062858"
  admin_password    = "Password1234!210825042656062858"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825042656062858"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825042656062858"
  ...
  identifier {
    publisher = "AccTesPublisher210825042656062858"
    offer     = "AccTesOffer210825042656062858"
    sku       = "AccTesSku210825042656062858"
  }
}
