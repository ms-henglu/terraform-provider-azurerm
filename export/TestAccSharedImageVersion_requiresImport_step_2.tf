...
locals {
  number            = "220513180038359796"
  location          = "West Europe"
  domain_name_label = "acctestvm-6dsva"
  random_string     = "6dsva"
  admin_username    = "testadmin220513180038359796"
  admin_password    = "Password1234!220513180038359796"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220513180038359796"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220513180038359796"
  ...
  identifier {
    publisher = "AccTesPublisher220513180038359796"
    offer     = "AccTesOffer220513180038359796"
    sku       = "AccTesSku220513180038359796"
  }
}
