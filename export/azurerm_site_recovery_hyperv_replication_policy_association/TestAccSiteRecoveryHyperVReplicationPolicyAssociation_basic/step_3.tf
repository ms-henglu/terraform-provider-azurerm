...
locals {
  rg_name              = "acctest-nested-rg-230728032933326338"
  location             = "West Europe"
  vn_name              = "acctest-nested-vn-230728032933326338"
  ip_name              = "acctest-nested-ip-230728032933326338"
  vm_name              = "acctest-nested-vm-230728032933326338"
  nic_name             = "acctest-nested-nic-230728032933326338"
  disk_name            = "acctest-nested-disk-230728032933326338"
  keyvault_name        = "acctkv230728032933326338"
  nsg_name             = "acctest-nested-nsg-230728032933326338"
  recovery_vault_name  = "acctest-nested-recovery-vault-230728032933326338"
  recovery_site_name   = "acctest-nested-recovery-site-230728032933326338"
  admin_name           = "acctestadmin"
  cert_name            = "acctestcert"
  storage_account_name = "acctestsar0vaz"
}
...
resource "azurerm_windows_virtual_machine" "host" {
  ...
  additional_unattend_content {
    setting = "AutoLogon"
    content = "<AutoLogon><Password><Value>e154w(0b^4</Value></Password><Enabled>true</Enabled><LogonCount>1</LogonCount><Username>${local.admin_name}</Username></AutoLogon>"
  }
...
resource "azurerm_site_recovery_hyperv_replication_policy" "test" {
  recovery_vault_id                                  = azurerm_recovery_services_vault.test.id
  name                                               = "acctest-policy-230728032933326338"
