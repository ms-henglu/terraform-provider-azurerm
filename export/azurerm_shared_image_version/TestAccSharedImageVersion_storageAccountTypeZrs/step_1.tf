...
locals {
  number            = "230120051707942431"
  location          = "West Europe"
  domain_name_label = "acctestvm-l3kte"
  random_string     = "l3kte"
  admin_username    = "testadmin230120051707942431"
  admin_password    = "Password1234!230120051707942431"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230120051707942431"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230120051707942431"
  ...
  identifier {
    publisher = "AccTesPublisher230120051707942431"
    offer     = "AccTesOffer230120051707942431"
    sku       = "AccTesSku230120051707942431"
  }
}
