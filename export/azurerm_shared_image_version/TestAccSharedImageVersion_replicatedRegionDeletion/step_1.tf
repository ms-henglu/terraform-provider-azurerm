...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231218071435571392"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231218071435571392"
  ...
  identifier {
    publisher = "AccTesPublisher231218071435571392"
    offer     = "AccTesOffer231218071435571392"
    sku       = "AccTesSku231218071435571392"
  }
}
