...
locals {
  number            = "230915023108512135"
  location          = "West Europe"
  domain_name_label = "acctestvm-wuob7"
  random_string     = "wuob7"
  admin_username    = "testadmin230915023108512135"
  admin_password    = "Password1234!230915023108512135"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230915023108512135"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230915023108512135"
  ...
  identifier {
    publisher = "AccTesPublisher230915023108512135"
    offer     = "AccTesOffer230915023108512135"
    sku       = "AccTesSku230915023108512135"
  }
}
