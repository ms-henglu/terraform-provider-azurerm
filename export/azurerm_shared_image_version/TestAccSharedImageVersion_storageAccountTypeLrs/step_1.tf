...
locals {
  number            = "230929064556875910"
  location          = "West Europe"
  domain_name_label = "acctestvm-gle27"
  random_string     = "gle27"
  admin_username    = "testadmin230929064556875910"
  admin_password    = "Password1234!230929064556875910"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230929064556875910"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230929064556875910"
  ...
  identifier {
    publisher = "AccTesPublisher230929064556875910"
    offer     = "AccTesOffer230929064556875910"
    sku       = "AccTesSku230929064556875910"
  }
}
