...
locals {
  number            = "220520040450450920"
  location          = "West Europe"
  domain_name_label = "acctestvm-2y81p"
  random_string     = "2y81p"
  admin_username    = "testadmin220520040450450920"
  admin_password    = "Password1234!220520040450450920"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220520040450450920"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220520040450450920"
  ...
  identifier {
    publisher = "AccTesPublisher220520040450450920"
    offer     = "AccTesOffer220520040450450920"
    sku       = "AccTesSku220520040450450920"
  }
}
