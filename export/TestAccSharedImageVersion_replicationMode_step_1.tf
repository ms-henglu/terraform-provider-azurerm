...
locals {
  number            = "220905045548220010"
  location          = "West Europe"
  domain_name_label = "acctestvm-vyfyk"
  random_string     = "vyfyk"
  admin_username    = "testadmin220905045548220010"
  admin_password    = "Password1234!220905045548220010"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220905045548220010"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220905045548220010"
  ...
  identifier {
    publisher = "AccTesPublisher220905045548220010"
    offer     = "AccTesOffer220905045548220010"
    sku       = "AccTesSku220905045548220010"
  }
}
