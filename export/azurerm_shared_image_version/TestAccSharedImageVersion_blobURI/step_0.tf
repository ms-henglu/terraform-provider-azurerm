...
locals {
  number            = "230127045135672797"
  location          = "West Europe"
  domain_name_label = "acctestvm-ijucm"
  random_string     = "ijucm"
  admin_username    = "testadmin230127045135672797"
  admin_password    = "Password1234!230127045135672797"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230127045135672797"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230127045135672797"
  ...
  identifier {
    publisher = "AccTesPublisher230127045135672797"
    offer     = "AccTesOffer230127045135672797"
    sku       = "AccTesSku230127045135672797"
  }
}
