...
locals {
  number            = "220627131710500902"
  location          = "West Europe"
  domain_name_label = "acctestvm-epgmo"
  random_string     = "epgmo"
  admin_username    = "testadmin220627131710500902"
  admin_password    = "Password1234!220627131710500902"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627131710500902"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627131710500902"
  ...
  identifier {
    publisher = "AccTesPublisher220627131710500902"
    offer     = "AccTesOffer220627131710500902"
    sku       = "AccTesSku220627131710500902"
  }
}
