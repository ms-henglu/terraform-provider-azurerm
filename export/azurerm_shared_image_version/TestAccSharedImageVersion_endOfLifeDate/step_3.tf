...
locals {
  number            = "221222034403203908"
  location          = "West Europe"
  domain_name_label = "acctestvm-rayqq"
  random_string     = "rayqq"
  admin_username    = "testadmin221222034403203908"
  admin_password    = "Password1234!221222034403203908"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221222034403203908"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221222034403203908"
  ...
  identifier {
    publisher = "AccTesPublisher221222034403203908"
    offer     = "AccTesOffer221222034403203908"
    sku       = "AccTesSku221222034403203908"
  }
}
