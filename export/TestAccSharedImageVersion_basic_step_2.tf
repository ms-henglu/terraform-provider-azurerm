...
locals {
  number            = "220630210603391148"
  location          = "West Europe"
  domain_name_label = "acctestvm-otpk7"
  random_string     = "otpk7"
  admin_username    = "testadmin220630210603391148"
  admin_password    = "Password1234!220630210603391148"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220630210603391148"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220630210603391148"
  ...
  identifier {
    publisher = "AccTesPublisher220630210603391148"
    offer     = "AccTesOffer220630210603391148"
    sku       = "AccTesSku220630210603391148"
  }
}
