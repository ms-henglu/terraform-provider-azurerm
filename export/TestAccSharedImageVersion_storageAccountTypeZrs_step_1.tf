...
locals {
  number            = "220726001659726497"
  location          = "West Europe"
  domain_name_label = "acctestvm-6nv33"
  random_string     = "6nv33"
  admin_username    = "testadmin220726001659726497"
  admin_password    = "Password1234!220726001659726497"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220726001659726497"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220726001659726497"
  ...
  identifier {
    publisher = "AccTesPublisher220726001659726497"
    offer     = "AccTesOffer220726001659726497"
    sku       = "AccTesSku220726001659726497"
  }
}
