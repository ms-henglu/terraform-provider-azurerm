...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220916011219839463"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220916011219839463"
  ...
  identifier {
    publisher = "AccTesPublisher220916011219839463"
    offer     = "AccTesOffer220916011219839463"
    sku       = "AccTesSku220916011219839463"
  }
}
