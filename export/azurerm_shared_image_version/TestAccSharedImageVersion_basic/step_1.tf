...
locals {
  number            = "230526084758992512"
  location          = "West Europe"
  domain_name_label = "acctestvm-gu9f9"
  random_string     = "gu9f9"
  admin_username    = "testadmin230526084758992512"
  admin_password    = "Password1234!230526084758992512"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230526084758992512"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230526084758992512"
  ...
  identifier {
    publisher = "AccTesPublisher230526084758992512"
    offer     = "AccTesOffer230526084758992512"
    sku       = "AccTesSku230526084758992512"
  }
}
