...
locals {
  number            = "230106031234903269"
  location          = "West Europe"
  domain_name_label = "acctestvm-qkea6"
  random_string     = "qkea6"
  admin_username    = "testadmin230106031234903269"
  admin_password    = "Password1234!230106031234903269"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230106031234903269"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230106031234903269"
  ...
  identifier {
    publisher = "AccTesPublisher230106031234903269"
    offer     = "AccTesOffer230106031234903269"
    sku       = "AccTesSku230106031234903269"
  }
}
