...
locals {
  number            = "221104005221352265"
  location          = "West Europe"
  domain_name_label = "acctestvm-nbchs"
  random_string     = "nbchs"
  admin_username    = "testadmin221104005221352265"
  admin_password    = "Password1234!221104005221352265"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221104005221352265"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221104005221352265"
  ...
  identifier {
    publisher = "AccTesPublisher221104005221352265"
    offer     = "AccTesOffer221104005221352265"
    sku       = "AccTesSku221104005221352265"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-221104005221352265"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
