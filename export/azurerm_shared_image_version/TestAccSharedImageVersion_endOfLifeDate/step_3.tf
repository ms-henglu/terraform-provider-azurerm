...
locals {
  number            = "230505050044913983"
  location          = "West Europe"
  domain_name_label = "acctestvm-ftwy9"
  random_string     = "ftwy9"
  admin_username    = "testadmin230505050044913983"
  admin_password    = "Password1234!230505050044913983"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230505050044913983"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230505050044913983"
  ...
  identifier {
    publisher = "AccTesPublisher230505050044913983"
    offer     = "AccTesOffer230505050044913983"
    sku       = "AccTesSku230505050044913983"
  }
}
