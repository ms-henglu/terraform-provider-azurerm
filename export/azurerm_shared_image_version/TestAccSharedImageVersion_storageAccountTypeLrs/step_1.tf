...
locals {
  number            = "230428045412228222"
  location          = "West Europe"
  domain_name_label = "acctestvm-9dk91"
  random_string     = "9dk91"
  admin_username    = "testadmin230428045412228222"
  admin_password    = "Password1234!230428045412228222"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230428045412228222"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230428045412228222"
  ...
  identifier {
    publisher = "AccTesPublisher230428045412228222"
    offer     = "AccTesOffer230428045412228222"
    sku       = "AccTesSku230428045412228222"
  }
}
