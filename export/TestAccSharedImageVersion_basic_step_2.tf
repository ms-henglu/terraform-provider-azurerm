...
locals {
  number            = "220610092433258618"
  location          = "West Europe"
  domain_name_label = "acctestvm-st3sv"
  random_string     = "st3sv"
  admin_username    = "testadmin220610092433258618"
  admin_password    = "Password1234!220610092433258618"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220610092433258618"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220610092433258618"
  ...
  identifier {
    publisher = "AccTesPublisher220610092433258618"
    offer     = "AccTesOffer220610092433258618"
    sku       = "AccTesSku220610092433258618"
  }
}
