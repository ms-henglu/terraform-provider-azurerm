...
locals {
  number            = "221021033910593869"
  location          = "West Europe"
  domain_name_label = "acctestvm-40t4o"
  random_string     = "40t4o"
  admin_username    = "testadmin221021033910593869"
  admin_password    = "Password1234!221021033910593869"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221021033910593869"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221021033910593869"
  ...
  identifier {
    publisher = "AccTesPublisher221021033910593869"
    offer     = "AccTesOffer221021033910593869"
    sku       = "AccTesSku221021033910593869"
  }
}
