...
locals {
  number            = "221124181402016377"
  location          = "West Europe"
  domain_name_label = "acctestvm-8s9zh"
  random_string     = "8s9zh"
  admin_username    = "testadmin221124181402016377"
  admin_password    = "Password1234!221124181402016377"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221124181402016377"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221124181402016377"
  ...
  identifier {
    publisher = "AccTesPublisher221124181402016377"
    offer     = "AccTesOffer221124181402016377"
    sku       = "AccTesSku221124181402016377"
  }
}
