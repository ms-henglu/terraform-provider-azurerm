...
locals {
  number            = "230609091011718920"
  location          = "West Europe"
  domain_name_label = "acctestvm-ojj4p"
  random_string     = "ojj4p"
  admin_username    = "testadmin230609091011718920"
  admin_password    = "Password1234!230609091011718920"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230609091011718920"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230609091011718920"
  ...
  identifier {
    publisher = "AccTesPublisher230609091011718920"
    offer     = "AccTesOffer230609091011718920"
    sku       = "AccTesSku230609091011718920"
  }
}
