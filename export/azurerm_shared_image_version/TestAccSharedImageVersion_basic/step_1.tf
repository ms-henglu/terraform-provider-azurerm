...
locals {
  number            = "230728031950550362"
  location          = "West Europe"
  domain_name_label = "acctestvm-icke6"
  random_string     = "icke6"
  admin_username    = "testadmin230728031950550362"
  admin_password    = "Password1234!230728031950550362"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230728031950550362"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230728031950550362"
  ...
  identifier {
    publisher = "AccTesPublisher230728031950550362"
    offer     = "AccTesOffer230728031950550362"
    sku       = "AccTesSku230728031950550362"
  }
}
