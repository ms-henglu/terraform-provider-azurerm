...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-211126031322378558"
...
resource "azurerm_kusto_database" "test" {
  name                = "acctestkd-211126031322378558"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhubnamespace-211126031322378558"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Standard"
}
...
resource "azurerm_eventhub" "test" {
  name                = "acctesteventhub-211126031322378558"
...
resource "azurerm_eventhub_consumer_group" "test" {
  name                = "acctesteventhubcg-211126031322378558"
  namespace_name      = azurerm_eventhub_namespace.test.name
...
resource "azurerm_kusto_eventhub_data_connection" "test" {
  name                = "acctestkedc-211126031322378558"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  cluster_name        = azurerm_kusto_cluster.test.name
