...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220422025909622598"
  location = "West Europe"
}

resource "azurerm_iothub" "test" {
  name                = "acctestiothub-220422025909622598"
...
resource "azurerm_stream_analytics_job" "test" {
  name                                     = "acctestjob-220422025909622598"
  resource_group_name                      = azurerm_resource_group.test.name
  location                                 = azurerm_resource_group.test.location
...
resource "azurerm_iothub" "updated" {
  name                = "acctestiot2-220422025909622598"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_stream_analytics_stream_input_iothub" "test" {
  name                         = "acctestinput-220422025909622598"
