...
locals {
  number            = "211029015345462457"
  location          = "West Europe"
  domain_name_label = "acctestvm-7l0op"
  random_string     = "7l0op"
  admin_username    = "testadmin211029015345462457"
  admin_password    = "Password1234!211029015345462457"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211029015345462457"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211029015345462457"
  ...
  identifier {
    publisher = "AccTesPublisher211029015345462457"
    offer     = "AccTesOffer211029015345462457"
    sku       = "AccTesSku211029015345462457"
  }
}
