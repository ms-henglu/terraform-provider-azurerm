...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220204055814363662"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220204055814363662"
  ...
  identifier {
    publisher = "AccTesPublisher220204055814363662"
    offer     = "AccTesOffer220204055814363662"
    sku       = "AccTesSku220204055814363662"
  }
}
