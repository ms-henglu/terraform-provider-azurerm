...
locals {
  number            = "220311042149584911"
  location          = "West Europe"
  domain_name_label = "acctestvm-n2q11"
  random_string     = "n2q11"
  admin_username    = "testadmin220311042149584911"
  admin_password    = "Password1234!220311042149584911"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220311042149584911"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220311042149584911"
  ...
  identifier {
    publisher = "AccTesPublisher220311042149584911"
    offer     = "AccTesOffer220311042149584911"
    sku       = "AccTesSku220311042149584911"
  }
}
