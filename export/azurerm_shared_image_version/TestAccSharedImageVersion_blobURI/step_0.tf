...
locals {
  number            = "240112034043035269"
  location          = "West Europe"
  domain_name_label = "acctestvm-rpax0"
  random_string     = "rpax0"
  admin_username    = "testadmin240112034043035269"
  admin_password    = "Password1234!240112034043035269"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240112034043035269"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240112034043035269"
  ...
  identifier {
    publisher = "AccTesPublisher240112034043035269"
    offer     = "AccTesOffer240112034043035269"
    sku       = "AccTesSku240112034043035269"
  }
}
