...
locals {
  number            = "240112034042910086"
  location          = "West Europe"
  domain_name_label = "acctestvm-mj98p"
  random_string     = "mj98p"
  admin_username    = "testadmin240112034042910086"
  admin_password    = "Password1234!240112034042910086"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-240112034042910086"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
