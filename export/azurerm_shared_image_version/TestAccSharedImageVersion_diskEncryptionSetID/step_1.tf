...
locals {
  number            = "230810143140380526"
  location          = "West Europe"
  domain_name_label = "acctestvm-z8wdp"
  random_string     = "z8wdp"
  admin_username    = "testadmin230810143140380526"
  admin_password    = "Password1234!230810143140380526"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230810143140380526"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230810143140380526"
  ...
  identifier {
    publisher = "AccTesPublisher230810143140380526"
    offer     = "AccTesOffer230810143140380526"
    sku       = "AccTesSku230810143140380526"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230810143140380526"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
