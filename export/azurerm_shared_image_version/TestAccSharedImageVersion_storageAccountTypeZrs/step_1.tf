...
locals {
  number            = "230407023100168114"
  location          = "West Europe"
  domain_name_label = "acctestvm-kjn6b"
  random_string     = "kjn6b"
  admin_username    = "testadmin230407023100168114"
  admin_password    = "Password1234!230407023100168114"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230407023100168114"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230407023100168114"
  ...
  identifier {
    publisher = "AccTesPublisher230407023100168114"
    offer     = "AccTesOffer230407023100168114"
    sku       = "AccTesSku230407023100168114"
  }
}
