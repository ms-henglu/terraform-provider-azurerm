...
locals {
  number            = "230613071532220581"
  location          = "West Europe"
  domain_name_label = "acctestvm-3dwoe"
  random_string     = "3dwoe"
  admin_username    = "testadmin230613071532220581"
  admin_password    = "Password1234!230613071532220581"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230613071532220581"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230613071532220581"
  ...
  identifier {
    publisher = "AccTesPublisher230613071532220581"
    offer     = "AccTesOffer230613071532220581"
    sku       = "AccTesSku230613071532220581"
  }
}
