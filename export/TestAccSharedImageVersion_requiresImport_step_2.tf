...
locals {
  number            = "220623223149340556"
  location          = "West Europe"
  domain_name_label = "acctestvm-ilyn0"
  random_string     = "ilyn0"
  admin_username    = "testadmin220623223149340556"
  admin_password    = "Password1234!220623223149340556"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220623223149340556"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220623223149340556"
  ...
  identifier {
    publisher = "AccTesPublisher220623223149340556"
    offer     = "AccTesOffer220623223149340556"
    sku       = "AccTesSku220623223149340556"
  }
}
