...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220311042149582906"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220311042149582906"
  ...
  identifier {
    publisher = "AccTesPublisher220311042149582906"
    offer     = "AccTesOffer220311042149582906"
    sku       = "AccTesSku220311042149582906"
  }
}
