...
locals {
  number            = "230414020945148769"
  location          = "West Europe"
  domain_name_label = "acctestvm-ytyll"
  random_string     = "ytyll"
  admin_username    = "testadmin230414020945148769"
  admin_password    = "Password1234!230414020945148769"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230414020945148769"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230414020945148769"
  ...
  identifier {
    publisher = "AccTesPublisher230414020945148769"
    offer     = "AccTesOffer230414020945148769"
    sku       = "AccTesSku230414020945148769"
  }
}
