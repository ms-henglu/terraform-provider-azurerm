...
locals {
  number            = "230630032848836792"
  location          = "West Europe"
  domain_name_label = "acctestvm-2l77k"
  random_string     = "2l77k"
  admin_username    = "testadmin230630032848836792"
  admin_password    = "Password1234!230630032848836792"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230630032848836792"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230630032848836792"
  ...
  identifier {
    publisher = "AccTesPublisher230630032848836792"
    offer     = "AccTesOffer230630032848836792"
    sku       = "AccTesSku230630032848836792"
  }
}
