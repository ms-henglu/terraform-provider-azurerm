...
locals {
  number            = "221028171853890231"
  location          = "West Europe"
  domain_name_label = "acctestvm-hsqor"
  random_string     = "hsqor"
  admin_username    = "testadmin221028171853890231"
  admin_password    = "Password1234!221028171853890231"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221028171853890231"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221028171853890231"
  ...
  identifier {
    publisher = "AccTesPublisher221028171853890231"
    offer     = "AccTesOffer221028171853890231"
    sku       = "AccTesSku221028171853890231"
  }
}
