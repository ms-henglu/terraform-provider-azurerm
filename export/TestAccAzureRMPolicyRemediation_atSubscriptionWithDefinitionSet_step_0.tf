...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-1ad13"
  policy_type  = "Custom"
  display_name = "testPolicySet-1ad13"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-1ad13"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-1ad13"
