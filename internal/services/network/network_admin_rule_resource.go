	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"rule_collection_id": {
				...
				Required:     true,
				ForceNew:     true,
				ValidateFunc: validate.NetworkAdminRuleCollectionID,
			},
...
func resourceNetworkAdminRuleCreateUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	ruleCollectionId, _ := parse.NetworkAdminRuleCollectionID(d.Get("rule_collection_id").(string))

	id := parse.NewNetworkAdminRuleID(subscriptionId, ruleCollectionId.ResourceGroup, ruleCollectionId.NetworkManagerName, ruleCollectionId.SecurityAdminConfigurationName, ruleCollectionId.RuleCollectionName, name)
	...
	if _, err := client.CreateOrUpdate(ctx, adminRule, id.ResourceGroup, id.NetworkManagerName, id.SecurityAdminConfigurationName, id.RuleCollectionName, id.RuleName); err != nil {
...
func resourceNetworkAdminRuleRead(d *schema.ResourceData, meta interface{}) error {
	...
	d.Set("rule_collection_id", parse.NewNetworkAdminRuleCollectionID(id.SubscriptionId, id.ResourceGroup, id.NetworkManagerName, id.SecurityAdminConfigurationName, id.RuleCollectionName).ID())
...
func resourceNetworkAdminRuleDelete(d *schema.ResourceData, meta interface{}) error {
	...
	if _, err := client.Delete(ctx, id.ResourceGroup, id.NetworkManagerName, id.SecurityAdminConfigurationName, id.RuleCollectionName, id.RuleName); err != nil {
