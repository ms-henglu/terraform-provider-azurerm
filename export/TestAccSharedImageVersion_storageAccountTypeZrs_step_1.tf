...
locals {
  number            = "220513180038359070"
  location          = "West Europe"
  domain_name_label = "acctestvm-fy393"
  random_string     = "fy393"
  admin_username    = "testadmin220513180038359070"
  admin_password    = "Password1234!220513180038359070"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220513180038359070"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220513180038359070"
  ...
  identifier {
    publisher = "AccTesPublisher220513180038359070"
    offer     = "AccTesOffer220513180038359070"
    sku       = "AccTesSku220513180038359070"
  }
}
