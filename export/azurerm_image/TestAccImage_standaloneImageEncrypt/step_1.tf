...
locals {
  number            = "230922053821393640"
  location          = "West Europe"
  domain_name_label = "acctestvm-zqo1a"
  random_string     = "zqo1a"
  admin_username    = "testadmin230922053821393640"
  admin_password    = "Password1234!230922053821393640"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230922053821393640"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
