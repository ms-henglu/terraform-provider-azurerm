...
resource "azuread_user" "test" {
  user_principal_name = "acctestUser-2309220606183594971@${data.azuread_domains.test.domains.0.domain_name}"
  display_name        = "acctestUser-2309220606183594971"
  password            = "p@$$Wde6eav"
}

resource "azuread_group" "test" {
  display_name     = "acctest-group-230922060618359497"
