...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-240119021426610904"
  location = "West Europe"
}

resource "azurerm_api_management" "test" {
  name                = "acctestAM-240119021426610904"
...
resource "azurerm_api_management_api" "test" {
  name                = "acctestapi-240119021426610904"
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_api_management_api_version_set" "test" {
  name                = "acctestAMAVS-240119021426610904"
  resource_group_name = azurerm_resource_group.test.name
  api_management_name = azurerm_api_management.test.name
...
resource "azurerm_api_management_api" "version" {
  name                = "acctestVersion-240119021426610904"
  resource_group_name = azurerm_resource_group.test.name
  api_management_name = azurerm_api_management.test.name
