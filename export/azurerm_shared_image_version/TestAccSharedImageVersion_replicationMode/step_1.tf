...
locals {
  number            = "231013043133458370"
  location          = "West Europe"
  domain_name_label = "acctestvm-ng47y"
  random_string     = "ng47y"
  admin_username    = "testadmin231013043133458370"
  admin_password    = "Password1234!231013043133458370"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231013043133458370"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231013043133458370"
  ...
  identifier {
    publisher = "AccTesPublisher231013043133458370"
    offer     = "AccTesOffer231013043133458370"
    sku       = "AccTesSku231013043133458370"
  }
}
