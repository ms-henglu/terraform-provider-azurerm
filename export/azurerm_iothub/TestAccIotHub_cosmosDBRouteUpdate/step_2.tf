...
resource "azurerm_resource_group" "iothub" {
  name     = "acctest-iothub-240105063949012646"
  location = "eastus"
}

resource "azurerm_resource_group" "endpoint" {
  name     = "acctest-iothub-db-240105063949012646"
  location = "eastus"
}

resource "azurerm_cosmosdb_account" "test" {
  name                = "acctest-ca-240105063949012646"
...
resource "azurerm_cosmosdb_sql_database" "test" {
  name                = "acctest-240105063949012646"
