...
locals {
  number            = "230630032848838776"
  location          = "West Europe"
  domain_name_label = "acctestvm-ykpqk"
  random_string     = "ykpqk"
  admin_username    = "testadmin230630032848838776"
  admin_password    = "Password1234!230630032848838776"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230630032848838776"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230630032848838776"
  ...
  identifier {
    publisher = "AccTesPublisher230630032848838776"
    offer     = "AccTesOffer230630032848838776"
    sku       = "AccTesSku230630032848838776"
  }
}
