...
locals {
  number            = "220826002453892230"
  location          = "West Europe"
  domain_name_label = "acctestvm-qeul4"
  random_string     = "qeul4"
  admin_username    = "testadmin220826002453892230"
  admin_password    = "Password1234!220826002453892230"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220826002453892230"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220826002453892230"
  ...
  identifier {
    publisher = "AccTesPublisher220826002453892230"
    offer     = "AccTesOffer220826002453892230"
    sku       = "AccTesSku220826002453892230"
  }
}
