...
locals {
  number            = "210910021215856902"
  location          = "West Europe"
  domain_name_label = "acctestvm-jhmk8"
  random_string     = "jhmk8"
  admin_username    = "testadmin210910021215856902"
  admin_password    = "Password1234!210910021215856902"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210910021215856902"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210910021215856902"
  ...
  identifier {
    publisher = "AccTesPublisher210910021215856902"
    offer     = "AccTesOffer210910021215856902"
    sku       = "AccTesSku210910021215856902"
  }
}
