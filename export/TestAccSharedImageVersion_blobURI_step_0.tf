...
locals {
  number            = "220916011219834952"
  location          = "West Europe"
  domain_name_label = "acctestvm-ne8si"
  random_string     = "ne8si"
  admin_username    = "testadmin220916011219834952"
  admin_password    = "Password1234!220916011219834952"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220916011219834952"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220916011219834952"
  ...
  identifier {
    publisher = "AccTesPublisher220916011219834952"
    offer     = "AccTesOffer220916011219834952"
    sku       = "AccTesSku220916011219834952"
  }
}
