...
locals {
  number            = "230825024235243003"
  location          = "West Europe"
  domain_name_label = "acctestvm-2mcrh"
  random_string     = "2mcrh"
  admin_username    = "testadmin230825024235243003"
  admin_password    = "Password1234!230825024235243003"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230825024235243003"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230825024235243003"
  ...
  identifier {
    publisher = "AccTesPublisher230825024235243003"
    offer     = "AccTesOffer230825024235243003"
    sku       = "AccTesSku230825024235243003"
  }
}
