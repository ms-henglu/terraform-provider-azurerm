...
func resourceSpringCloudGatewayRead(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	if props := resp.Properties; props != nil {
		...
		if err := d.Set("sso_properties", flattenGatewaySsoProperties(props.SsoProperties)); err != nil {
...
func flattenGatewaySsoProperties(input *appplatform.SsoProperties) []interface{} {
	if input == nil {
		return make([]interface{}, 0)
	}
