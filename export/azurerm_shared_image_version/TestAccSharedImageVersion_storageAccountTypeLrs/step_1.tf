...
locals {
  number            = "231218071435563507"
  location          = "West Europe"
  domain_name_label = "acctestvm-6r614"
  random_string     = "6r614"
  admin_username    = "testadmin231218071435563507"
  admin_password    = "Password1234!231218071435563507"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231218071435563507"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231218071435563507"
  ...
  identifier {
    publisher = "AccTesPublisher231218071435563507"
    offer     = "AccTesOffer231218071435563507"
    sku       = "AccTesSku231218071435563507"
  }
}
