...
type GetDefaultDisableSoftDeleteRequestsObjectResponse struct {
	HttpResponse *http.Response
	Model        *DppBaseResource
}

// GetDefaultDisableSoftDeleteRequestsObject ...
func (c ResourceGuardsClient) GetDefaultDisableSoftDeleteRequestsObject(ctx context.Context, id DisableSoftDeleteRequestId) (result GetDefaultDisableSoftDeleteRequestsObjectResponse, err error) {
...
func (c ResourceGuardsClient) responderForGetDefaultDisableSoftDeleteRequestsObject(resp *http.Response) (result GetDefaultDisableSoftDeleteRequestsObjectResponse, err error) {
