...
locals {
  number            = "230407023100169423"
  location          = "West Europe"
  domain_name_label = "acctestvm-ecmfs"
  random_string     = "ecmfs"
  admin_username    = "testadmin230407023100169423"
  admin_password    = "Password1234!230407023100169423"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230407023100169423"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230407023100169423"
  ...
  identifier {
    publisher = "AccTesPublisher230407023100169423"
    offer     = "AccTesOffer230407023100169423"
    sku       = "AccTesSku230407023100169423"
  }
}
