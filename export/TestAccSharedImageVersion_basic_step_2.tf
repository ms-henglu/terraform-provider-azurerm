...
locals {
  number            = "220520040450452724"
  location          = "West Europe"
  domain_name_label = "acctestvm-n8d0t"
  random_string     = "n8d0t"
  admin_username    = "testadmin220520040450452724"
  admin_password    = "Password1234!220520040450452724"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220520040450452724"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220520040450452724"
  ...
  identifier {
    publisher = "AccTesPublisher220520040450452724"
    offer     = "AccTesOffer220520040450452724"
    sku       = "AccTesSku220520040450452724"
  }
}
