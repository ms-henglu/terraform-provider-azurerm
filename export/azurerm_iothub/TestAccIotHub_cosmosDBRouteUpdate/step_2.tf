...
resource "azurerm_resource_group" "iothub" {
  name     = "acctest-iothub-240112034527580276"
  location = "eastus"
}

resource "azurerm_resource_group" "endpoint" {
  name     = "acctest-iothub-db-240112034527580276"
  location = "eastus"
}

resource "azurerm_cosmosdb_account" "test" {
  name                = "acctest-ca-240112034527580276"
...
resource "azurerm_cosmosdb_sql_database" "test" {
  name                = "acctest-240112034527580276"
