...
locals {
  number            = "230616074443134674"
  location          = "West Europe"
  domain_name_label = "acctestvm-cwjzo"
  random_string     = "cwjzo"
  admin_username    = "testadmin230616074443134674"
  admin_password    = "Password1234!230616074443134674"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230616074443134674"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230616074443134674"
  ...
  identifier {
    publisher = "AccTesPublisher230616074443134674"
    offer     = "AccTesOffer230616074443134674"
    sku       = "AccTesSku230616074443134674"
  }
}
