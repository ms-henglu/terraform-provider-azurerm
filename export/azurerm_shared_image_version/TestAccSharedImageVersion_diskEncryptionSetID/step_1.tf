...
locals {
  number            = "231016033604025261"
  location          = "West Europe"
  domain_name_label = "acctestvm-b4syx"
  random_string     = "b4syx"
  admin_username    = "testadmin231016033604025261"
  admin_password    = "Password1234!231016033604025261"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231016033604025261"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231016033604025261"
  ...
  identifier {
    publisher = "AccTesPublisher231016033604025261"
    offer     = "AccTesOffer231016033604025261"
    sku       = "AccTesSku231016033604025261"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-231016033604025261"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
