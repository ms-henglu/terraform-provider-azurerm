...
locals {
  number            = "220114014015954426"
  location          = "West Europe"
  domain_name_label = "acctestvm-d8a9i"
  random_string     = "d8a9i"
  admin_username    = "testadmin220114014015954426"
  admin_password    = "Password1234!220114014015954426"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220114014015954426"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220114014015954426"
  ...
  identifier {
    publisher = "AccTesPublisher220114014015954426"
    offer     = "AccTesOffer220114014015954426"
    sku       = "AccTesSku220114014015954426"
  }
}
