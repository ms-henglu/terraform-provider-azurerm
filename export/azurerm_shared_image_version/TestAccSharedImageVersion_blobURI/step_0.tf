...
locals {
  number            = "230804025626256573"
  location          = "West Europe"
  domain_name_label = "acctestvm-ag302"
  random_string     = "ag302"
  admin_username    = "testadmin230804025626256573"
  admin_password    = "Password1234!230804025626256573"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230804025626256573"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230804025626256573"
  ...
  identifier {
    publisher = "AccTesPublisher230804025626256573"
    offer     = "AccTesOffer230804025626256573"
    sku       = "AccTesSku230804025626256573"
  }
}
