...
locals {
  number            = "211001223759408870"
  location          = "West Europe"
  domain_name_label = "acctestvm-xx1lz"
  random_string     = "xx1lz"
  admin_username    = "testadmin211001223759408870"
  admin_password    = "Password1234!211001223759408870"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211001223759408870"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211001223759408870"
  ...
  identifier {
    publisher = "AccTesPublisher211001223759408870"
    offer     = "AccTesOffer211001223759408870"
    sku       = "AccTesSku211001223759408870"
  }
}
