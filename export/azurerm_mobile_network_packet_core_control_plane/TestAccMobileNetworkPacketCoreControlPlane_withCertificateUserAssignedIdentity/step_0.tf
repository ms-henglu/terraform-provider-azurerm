...
resource "azurerm_resource_group" "test" {
  name     = "acctest-mn-230613072249892370"
  location = "eastus"
}
...
resource "azurerm_mobile_network_site" "test" {
  name              = "acctest-mns-230613072249892370"
...
resource "azurerm_mobile_network_packet_core_control_plane" "test" {
  name                              = "acctest-mnpccp-230613072249892370"
  resource_group_name               = azurerm_resource_group.test.name
  location                          = "eastus"
  sku                               = "G0"
