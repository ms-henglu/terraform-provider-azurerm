...
locals {
  number            = "220916011219834911"
  location          = "West Europe"
  domain_name_label = "acctestvm-0qfdu"
  random_string     = "0qfdu"
  admin_username    = "testadmin220916011219834911"
  admin_password    = "Password1234!220916011219834911"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220916011219834911"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220916011219834911"
  ...
  identifier {
    publisher = "AccTesPublisher220916011219834911"
    offer     = "AccTesOffer220916011219834911"
    sku       = "AccTesSku220916011219834911"
  }
}
