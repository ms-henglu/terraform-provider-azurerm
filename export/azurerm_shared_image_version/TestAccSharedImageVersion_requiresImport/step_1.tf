...
locals {
  number            = "230512003629465097"
  location          = "West Europe"
  domain_name_label = "acctestvm-19ae9"
  random_string     = "19ae9"
  admin_username    = "testadmin230512003629465097"
  admin_password    = "Password1234!230512003629465097"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230512003629465097"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230512003629465097"
  ...
  identifier {
    publisher = "AccTesPublisher230512003629465097"
    offer     = "AccTesOffer230512003629465097"
    sku       = "AccTesSku230512003629465097"
  }
}
