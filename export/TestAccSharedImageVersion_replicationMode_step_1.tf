...
locals {
  number            = "220722035002639754"
  location          = "West Europe"
  domain_name_label = "acctestvm-bfhq3"
  random_string     = "bfhq3"
  admin_username    = "testadmin220722035002639754"
  admin_password    = "Password1234!220722035002639754"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220722035002639754"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220722035002639754"
  ...
  identifier {
    publisher = "AccTesPublisher220722035002639754"
    offer     = "AccTesOffer220722035002639754"
    sku       = "AccTesSku220722035002639754"
  }
}
