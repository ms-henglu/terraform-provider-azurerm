...
locals {
  number            = "221221204056166367"
  location          = "West Europe"
  domain_name_label = "acctestvm-dqckb"
  random_string     = "dqckb"
  admin_username    = "testadmin221221204056166367"
  admin_password    = "Password1234!221221204056166367"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221221204056166367"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221221204056166367"
  ...
  identifier {
    publisher = "AccTesPublisher221221204056166367"
    offer     = "AccTesOffer221221204056166367"
    sku       = "AccTesSku221221204056166367"
  }
}
