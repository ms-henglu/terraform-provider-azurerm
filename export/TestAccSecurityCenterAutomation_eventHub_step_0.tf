...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-221019054907822764"
  location = "West Europe"
}

resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhub-221019054907822764"
  location            = "West Europe"
...
resource "azurerm_eventhub_authorization_rule" "test" {
  name                = "acctest-eventhub-auth-rule-221019054907822764"
  namespace_name      = azurerm_eventhub_namespace.test.name
...
resource "azurerm_security_center_automation" "test" {
  name                = "acctestautomation-221019054907822764"
  location            = "West Europe"
  resource_group_name = azurerm_resource_group.test.name
