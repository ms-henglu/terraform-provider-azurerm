...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211105035652866194"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211105035652866194"
  ...
  identifier {
    publisher = "AccTesPublisher211105035652866194"
    offer     = "AccTesOffer211105035652866194"
    sku       = "AccTesSku211105035652866194"
  }
}
