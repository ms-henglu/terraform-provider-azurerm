...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-p8rot"
  policy_type  = "Custom"
  display_name = "testPolicySet-p8rot"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-p8rot"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-p8rot"
