...
locals {
  number            = "210825031517184370"
  location          = "West Europe"
  domain_name_label = "acctestvm-0ujwt"
  random_string     = "0ujwt"
  admin_username    = "testadmin210825031517184370"
  admin_password    = "Password1234!210825031517184370"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825031517184370"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825031517184370"
  ...
  identifier {
    publisher = "AccTesPublisher210825031517184370"
    offer     = "AccTesOffer210825031517184370"
    sku       = "AccTesSku210825031517184370"
  }
}
