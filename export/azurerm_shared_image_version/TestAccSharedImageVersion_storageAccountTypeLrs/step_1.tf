...
locals {
  number            = "221111020149333863"
  location          = "West Europe"
  domain_name_label = "acctestvm-qw2f6"
  random_string     = "qw2f6"
  admin_username    = "testadmin221111020149333863"
  admin_password    = "Password1234!221111020149333863"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221111020149333863"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221111020149333863"
  ...
  identifier {
    publisher = "AccTesPublisher221111020149333863"
    offer     = "AccTesOffer221111020149333863"
    sku       = "AccTesSku221111020149333863"
  }
}
