...
locals {
  number            = "220819165017106513"
  location          = "West Europe"
  domain_name_label = "acctestvm-86th8"
  random_string     = "86th8"
  admin_username    = "testadmin220819165017106513"
  admin_password    = "Password1234!220819165017106513"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220819165017106513"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220819165017106513"
  ...
  identifier {
    publisher = "AccTesPublisher220819165017106513"
    offer     = "AccTesOffer220819165017106513"
    sku       = "AccTesSku220819165017106513"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220819165017106513"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
