...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-221221204605953163"
  location = "West Europe"
}

resource "azurerm_application_insights" "test" {
  name                = "acctestAppInsight-221221204605953163"
...
resource "azurerm_application_insights_web_test" "test" {
  name                    = "acctestAppInsight-webtest-221221204605953163"
  location                = azurerm_resource_group.test.location
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_monitor_metric_alert" "test" {
  name                = "acctestMetricAlert-221221204605953163"
  resource_group_name = azurerm_resource_group.test.name
  scopes = [
