...
locals {
  number            = "230512003629460533"
  location          = "West Europe"
  domain_name_label = "acctestvm-jrxyf"
  random_string     = "jrxyf"
  admin_username    = "testadmin230512003629460533"
  admin_password    = "Password1234!230512003629460533"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230512003629460533"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230512003629460533"
  ...
  identifier {
    publisher = "AccTesPublisher230512003629460533"
    offer     = "AccTesOffer230512003629460533"
    sku       = "AccTesSku230512003629460533"
  }
}
