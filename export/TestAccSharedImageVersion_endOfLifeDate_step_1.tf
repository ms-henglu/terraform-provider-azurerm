...
locals {
  number            = "220722035002633163"
  location          = "West Europe"
  domain_name_label = "acctestvm-cfquf"
  random_string     = "cfquf"
  admin_username    = "testadmin220722035002633163"
  admin_password    = "Password1234!220722035002633163"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220722035002633163"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220722035002633163"
  ...
  identifier {
    publisher = "AccTesPublisher220722035002633163"
    offer     = "AccTesOffer220722035002633163"
    sku       = "AccTesSku220722035002633163"
  }
}
...
resource "azurerm_shared_image_version" "test" {
  ...
  end_of_life_date    = "2022-07-22T13:50:02Z"
