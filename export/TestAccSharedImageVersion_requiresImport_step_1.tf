...
locals {
  number            = "210825031517189893"
  location          = "West Europe"
  domain_name_label = "acctestvm-qz1ve"
  random_string     = "qz1ve"
  admin_username    = "testadmin210825031517189893"
  admin_password    = "Password1234!210825031517189893"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825031517189893"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825031517189893"
  ...
  identifier {
    publisher = "AccTesPublisher210825031517189893"
    offer     = "AccTesOffer210825031517189893"
    sku       = "AccTesSku210825031517189893"
  }
}
