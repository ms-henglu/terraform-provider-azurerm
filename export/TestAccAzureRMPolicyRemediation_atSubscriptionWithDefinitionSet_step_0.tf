...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-i1tun"
  policy_type  = "Custom"
  display_name = "testPolicySet-i1tun"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-i1tun"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-i1tun"
