...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-postgresql-220729033130331875"
  location = "West Europe"
}


resource "azurerm_virtual_network" "test" {
  name                = "acctest-vn-220729033130331875"
...
resource "azurerm_subnet" "test" {
  name                 = "acctest-sn-220729033130331875"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_private_dns_zone" "test" {
  name                = "acc220729033130331875.postgres.database.azure.com"
  resource_group_name = azurerm_resource_group.test.name
}

resource "azurerm_private_dns_zone_virtual_network_link" "test" {
  name                  = "acctestVnetZone220729033130331875.com"
...
resource "azurerm_postgresql_flexible_server" "test" {
  name                   = "acctest-fs-220729033130331875"
  resource_group_name    = azurerm_resource_group.test.name
  location               = azurerm_resource_group.test.location
