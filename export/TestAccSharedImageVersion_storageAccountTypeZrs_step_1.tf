...
locals {
  number            = "211105025753276868"
  location          = "West Europe"
  domain_name_label = "acctestvm-qimyo"
  random_string     = "qimyo"
  admin_username    = "testadmin211105025753276868"
  admin_password    = "Password1234!211105025753276868"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211105025753276868"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211105025753276868"
  ...
  identifier {
    publisher = "AccTesPublisher211105025753276868"
    offer     = "AccTesOffer211105025753276868"
    sku       = "AccTesSku211105025753276868"
  }
}
