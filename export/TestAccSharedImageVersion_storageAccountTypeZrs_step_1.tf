...
locals {
  number            = "211203013551388149"
  location          = "West Europe"
  domain_name_label = "acctestvm-27id7"
  random_string     = "27id7"
  admin_username    = "testadmin211203013551388149"
  admin_password    = "Password1234!211203013551388149"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211203013551388149"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211203013551388149"
  ...
  identifier {
    publisher = "AccTesPublisher211203013551388149"
    offer     = "AccTesOffer211203013551388149"
    sku       = "AccTesSku211203013551388149"
  }
}
