...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220422024923906830"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220422024923906830"
  ...
  identifier {
    publisher = "AccTesPublisher220422024923906830"
    offer     = "AccTesOffer220422024923906830"
    sku       = "AccTesSku220422024923906830"
  }
}
