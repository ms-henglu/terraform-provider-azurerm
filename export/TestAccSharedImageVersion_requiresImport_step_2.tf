...
locals {
  number            = "220114014015952680"
  location          = "West Europe"
  domain_name_label = "acctestvm-3uk61"
  random_string     = "3uk61"
  admin_username    = "testadmin220114014015952680"
  admin_password    = "Password1234!220114014015952680"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220114014015952680"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220114014015952680"
  ...
  identifier {
    publisher = "AccTesPublisher220114014015952680"
    offer     = "AccTesOffer220114014015952680"
    sku       = "AccTesSku220114014015952680"
  }
}
