...
locals {
  number            = "220225034148132155"
  location          = "West Europe"
  domain_name_label = "acctestvm-hwi7n"
  random_string     = "hwi7n"
  admin_username    = "testadmin220225034148132155"
  admin_password    = "Password1234!220225034148132155"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220225034148132155"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220225034148132155"
  ...
  identifier {
    publisher = "AccTesPublisher220225034148132155"
    offer     = "AccTesOffer220225034148132155"
    sku       = "AccTesSku220225034148132155"
  }
}
