...
locals {
  number            = "211217075027327993"
  location          = "West Europe"
  domain_name_label = "acctestvm-qxkd4"
  random_string     = "qxkd4"
  admin_username    = "testadmin211217075027327993"
  admin_password    = "Password1234!211217075027327993"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211217075027327993"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211217075027327993"
  ...
  identifier {
    publisher = "AccTesPublisher211217075027327993"
    offer     = "AccTesOffer211217075027327993"
    sku       = "AccTesSku211217075027327993"
  }
}
