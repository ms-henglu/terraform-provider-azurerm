...
locals {
  number            = "220513023023741195"
  location          = "West Europe"
  domain_name_label = "acctestvm-iq2fu"
  random_string     = "iq2fu"
  admin_username    = "testadmin220513023023741195"
  admin_password    = "Password1234!220513023023741195"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220513023023741195"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220513023023741195"
  ...
  identifier {
    publisher = "AccTesPublisher220513023023741195"
    offer     = "AccTesOffer220513023023741195"
    sku       = "AccTesSku220513023023741195"
  }
}
