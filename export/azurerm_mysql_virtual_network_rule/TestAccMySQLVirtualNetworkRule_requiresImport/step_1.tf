...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-240119025452511972"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvnet240119025452511972"
...
resource "azurerm_subnet" "test" {
  name                 = "acctestsubnet240119025452511972"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_mysql_server" "test" {
  name                         = "acctestmysqlsvr-240119025452511972"
  location                     = azurerm_resource_group.test.location
  resource_group_name          = azurerm_resource_group.test.name
...
resource "azurerm_mysql_virtual_network_rule" "test" {
  name                = "acctestmysqlvnetrule240119025452511972"
  resource_group_name = azurerm_resource_group.test.name
