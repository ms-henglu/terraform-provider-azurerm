...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-psql-230106031820774219"
  location = "West Europe"
}

resource "azurerm_postgresql_server" "test" {
  name                = "acctest-psql-server-230106031820774219"
...
resource "azurerm_resource_group" "replica" {
  name     = "acctestRG-psql-230106031820774219-replica"
  location = "West US 2"
}

resource "azurerm_postgresql_server" "replica" {
  name                = "acctest-psql-server-230106031820774219-replica"
  location            = "West US 2"
