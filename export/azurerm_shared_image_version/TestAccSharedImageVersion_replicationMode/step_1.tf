...
locals {
  number            = "230609091011717910"
  location          = "West Europe"
  domain_name_label = "acctestvm-38ycn"
  random_string     = "38ycn"
  admin_username    = "testadmin230609091011717910"
  admin_password    = "Password1234!230609091011717910"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230609091011717910"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230609091011717910"
  ...
  identifier {
    publisher = "AccTesPublisher230609091011717910"
    offer     = "AccTesOffer230609091011717910"
    sku       = "AccTesSku230609091011717910"
  }
}
