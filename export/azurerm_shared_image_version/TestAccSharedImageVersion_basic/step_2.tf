...
locals {
  number            = "230203063036576766"
  location          = "West Europe"
  domain_name_label = "acctestvm-idtgr"
  random_string     = "idtgr"
  admin_username    = "testadmin230203063036576766"
  admin_password    = "Password1234!230203063036576766"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230203063036576766"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230203063036576766"
  ...
  identifier {
    publisher = "AccTesPublisher230203063036576766"
    offer     = "AccTesOffer230203063036576766"
    sku       = "AccTesSku230203063036576766"
  }
}
