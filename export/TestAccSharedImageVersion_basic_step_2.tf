...
locals {
  number            = "220603021818529740"
  location          = "West Europe"
  domain_name_label = "acctestvm-j8a14"
  random_string     = "j8a14"
  admin_username    = "testadmin220603021818529740"
  admin_password    = "Password1234!220603021818529740"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220603021818529740"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220603021818529740"
  ...
  identifier {
    publisher = "AccTesPublisher220603021818529740"
    offer     = "AccTesOffer220603021818529740"
    sku       = "AccTesSku220603021818529740"
  }
}
