...
locals {
  number            = "231218071435575411"
  location          = "West Europe"
  domain_name_label = "acctestvm-m8ped"
  random_string     = "m8ped"
  admin_username    = "testadmin231218071435575411"
  admin_password    = "Password1234!231218071435575411"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231218071435575411"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231218071435575411"
  ...
  identifier {
    publisher = "AccTesPublisher231218071435575411"
    offer     = "AccTesOffer231218071435575411"
    sku       = "AccTesSku231218071435575411"
  }
}
