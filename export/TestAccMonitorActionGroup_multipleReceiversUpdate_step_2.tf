...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-210825041051217814"
  location = "West Europe"
}

resource "azurerm_monitor_action_group" "test" {
  name                = "acctestActionGroup-210825041051217814"
...
resource "azurerm_automation_account" "test" {
  name                = "acctestAA-210825041051217814"
...
resource "azurerm_logic_app_workflow" "test" {
  name                = "acctestLA-210825041051217814"
  location            = "${azurerm_resource_group.test.location}"
  resource_group_name = "${azurerm_resource_group.test.name}"
}
...
resource "azurerm_app_service_plan" "test" {
  name                = "acctestSP-210825041051217814"
  location            = "${azurerm_resource_group.test.location}"
  resource_group_name = "${azurerm_resource_group.test.name}"
...
resource "azurerm_function_app" "test" {
  name                       = "acctestFA-210825041051217814"
  location                   = "${azurerm_resource_group.test.location}"
  resource_group_name        = "${azurerm_resource_group.test.name}"
