...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-240105061534519193"
  location = "West Europe"
}

resource "azurerm_cosmosdb_account" "test" {
  name                = "acctestcosmosdb240105061534519193"
...
resource "azurerm_app_service_plan" "test" {
  name                = "acctestASP-240105061534519193"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_function_app" "test" {
  name                       = "acctest-240105061534519193-func"
  location                   = azurerm_resource_group.test.location
  resource_group_name        = azurerm_resource_group.test.name
...
resource "azurerm_function_app_connection" "test" {
  name               = "acctestserviceconnector240105061534519193"
