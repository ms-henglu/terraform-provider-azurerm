...
locals {
  number            = "211126031012798553"
  location          = "West Europe"
  domain_name_label = "acctestvm-dxbxc"
  random_string     = "dxbxc"
  admin_username    = "testadmin211126031012798553"
  admin_password    = "Password1234!211126031012798553"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211126031012798553"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211126031012798553"
  ...
  identifier {
    publisher = "AccTesPublisher211126031012798553"
    offer     = "AccTesOffer211126031012798553"
    sku       = "AccTesSku211126031012798553"
  }
}
