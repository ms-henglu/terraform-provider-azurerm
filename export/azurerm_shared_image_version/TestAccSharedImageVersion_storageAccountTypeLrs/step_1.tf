...
locals {
  number            = "230721011329118932"
  location          = "West Europe"
  domain_name_label = "acctestvm-1ge1h"
  random_string     = "1ge1h"
  admin_username    = "testadmin230721011329118932"
  admin_password    = "Password1234!230721011329118932"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230721011329118932"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230721011329118932"
  ...
  identifier {
    publisher = "AccTesPublisher230721011329118932"
    offer     = "AccTesOffer230721011329118932"
    sku       = "AccTesSku230721011329118932"
  }
}
