...
locals {
  number            = "230707003540146763"
  location          = "West Europe"
  domain_name_label = "acctestvm-g7hxg"
  random_string     = "g7hxg"
  admin_username    = "testadmin230707003540146763"
  admin_password    = "Password1234!230707003540146763"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230707003540146763"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230707003540146763"
  ...
  identifier {
    publisher = "AccTesPublisher230707003540146763"
    offer     = "AccTesOffer230707003540146763"
    sku       = "AccTesSku230707003540146763"
  }
}
