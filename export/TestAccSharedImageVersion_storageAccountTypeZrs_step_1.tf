...
locals {
  number            = "211021234811795429"
  location          = "West Europe"
  domain_name_label = "acctestvm-96f0g"
  random_string     = "96f0g"
  admin_username    = "testadmin211021234811795429"
  admin_password    = "Password1234!211021234811795429"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211021234811795429"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211021234811795429"
  ...
  identifier {
    publisher = "AccTesPublisher211021234811795429"
    offer     = "AccTesOffer211021234811795429"
    sku       = "AccTesSku211021234811795429"
  }
}
