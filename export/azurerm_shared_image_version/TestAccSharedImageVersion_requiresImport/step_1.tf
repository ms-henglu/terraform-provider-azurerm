...
locals {
  number            = "240112224137956239"
  location          = "West Europe"
  domain_name_label = "acctestvm-mcrwh"
  random_string     = "mcrwh"
  admin_username    = "testadmin240112224137956239"
  admin_password    = "Password1234!240112224137956239"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240112224137956239"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240112224137956239"
  ...
  identifier {
    publisher = "AccTesPublisher240112224137956239"
    offer     = "AccTesOffer240112224137956239"
    sku       = "AccTesSku240112224137956239"
  }
}
