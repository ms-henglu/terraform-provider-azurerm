...
locals {
  number            = "210910021215859690"
  location          = "West Europe"
  domain_name_label = "acctestvm-yrmhz"
  random_string     = "yrmhz"
  admin_username    = "testadmin210910021215859690"
  admin_password    = "Password1234!210910021215859690"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210910021215859690"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210910021215859690"
  ...
  identifier {
    publisher = "AccTesPublisher210910021215859690"
    offer     = "AccTesOffer210910021215859690"
    sku       = "AccTesSku210910021215859690"
  }
}
