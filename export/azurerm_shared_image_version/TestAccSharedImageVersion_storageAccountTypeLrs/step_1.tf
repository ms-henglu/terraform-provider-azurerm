...
locals {
  number            = "230613071532229669"
  location          = "West Europe"
  domain_name_label = "acctestvm-ejut4"
  random_string     = "ejut4"
  admin_username    = "testadmin230613071532229669"
  admin_password    = "Password1234!230613071532229669"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230613071532229669"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230613071532229669"
  ...
  identifier {
    publisher = "AccTesPublisher230613071532229669"
    offer     = "AccTesOffer230613071532229669"
    sku       = "AccTesSku230613071532229669"
  }
}
