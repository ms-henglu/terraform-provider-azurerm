...
locals {
  number            = "230227032410651547"
  location          = "West Europe"
  domain_name_label = "acctestvm-ndu1l"
  random_string     = "ndu1l"
  admin_username    = "testadmin230227032410651547"
  admin_password    = "Password1234!230227032410651547"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230227032410651547"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230227032410651547"
  ...
  identifier {
    publisher = "AccTesPublisher230227032410651547"
    offer     = "AccTesOffer230227032410651547"
    sku       = "AccTesSku230227032410651547"
  }
}
