...
locals {
  number            = "220623223149346569"
  location          = "West Europe"
  domain_name_label = "acctestvm-awd3f"
  random_string     = "awd3f"
  admin_username    = "testadmin220623223149346569"
  admin_password    = "Password1234!220623223149346569"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220623223149346569"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220623223149346569"
  ...
  identifier {
    publisher = "AccTesPublisher220623223149346569"
    offer     = "AccTesOffer220623223149346569"
    sku       = "AccTesSku220623223149346569"
  }
}
