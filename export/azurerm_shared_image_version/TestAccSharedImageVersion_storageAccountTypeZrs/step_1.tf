...
locals {
  number            = "230505050044916204"
  location          = "West Europe"
  domain_name_label = "acctestvm-kjs7w"
  random_string     = "kjs7w"
  admin_username    = "testadmin230505050044916204"
  admin_password    = "Password1234!230505050044916204"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230505050044916204"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230505050044916204"
  ...
  identifier {
    publisher = "AccTesPublisher230505050044916204"
    offer     = "AccTesOffer230505050044916204"
    sku       = "AccTesSku230505050044916204"
  }
}
