...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-acr-230616074517898851"
  location = "West Europe"
}

resource "azurerm_container_registry" "test" {
  name                  = "testacccr230616074517898851"
...
resource "azurerm_container_registry_scope_map" "test" {
  ...
  actions = [
    ...
    "gateway/testacccrc230616074517898851/config/read",
    "gateway/testacccrc230616074517898851/config/write",
    "gateway/testacccrc230616074517898851/message/read",
    "gateway/testacccrc230616074517898851/message/write",
  ]
}

resource "azurerm_container_registry_token" "test" {
  name                    = "testacccrtoken230616074517898851"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
...
resource "azurerm_container_registry_scope_map" "client" {
  name                    = "testacccrclient230616074517898851"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
  actions = [
    "repositories/hello-world/content/delete",
...
resource "azurerm_container_registry_token" "client" {
  name                    = "testacccrtokenclient230616074517898851"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
...
resource "azurerm_container_connected_registry" "test" {
  name                  = "testacccrc230616074517898851"
