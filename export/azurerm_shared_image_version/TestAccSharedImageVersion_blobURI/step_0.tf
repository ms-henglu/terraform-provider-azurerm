...
locals {
  number            = "240112224137953641"
  location          = "West Europe"
  domain_name_label = "acctestvm-11yxj"
  random_string     = "11yxj"
  admin_username    = "testadmin240112224137953641"
  admin_password    = "Password1234!240112224137953641"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240112224137953641"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240112224137953641"
  ...
  identifier {
    publisher = "AccTesPublisher240112224137953641"
    offer     = "AccTesOffer240112224137953641"
    sku       = "AccTesSku240112224137953641"
  }
}
