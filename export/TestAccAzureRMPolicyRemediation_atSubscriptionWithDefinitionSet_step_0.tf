...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-jf0qd"
  policy_type  = "Custom"
  display_name = "testPolicySet-jf0qd"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-jf0qd"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-jf0qd"
