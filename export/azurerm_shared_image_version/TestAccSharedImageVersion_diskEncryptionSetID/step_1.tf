...
locals {
  number            = "240119021734537918"
  location          = "West Europe"
  domain_name_label = "acctestvm-w24wq"
  random_string     = "w24wq"
  admin_username    = "testadmin240119021734537918"
  admin_password    = "Password1234!240119021734537918"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240119021734537918"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240119021734537918"
  ...
  identifier {
    publisher = "AccTesPublisher240119021734537918"
    offer     = "AccTesOffer240119021734537918"
    sku       = "AccTesSku240119021734537918"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-240119021734537918"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
