...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220506015657137829"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220506015657137829"
  ...
  identifier {
    publisher = "AccTesPublisher220506015657137829"
    offer     = "AccTesOffer220506015657137829"
    sku       = "AccTesSku220506015657137829"
  }
}
