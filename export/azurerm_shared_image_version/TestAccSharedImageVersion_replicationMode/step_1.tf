...
locals {
  number            = "230505050044920857"
  location          = "West Europe"
  domain_name_label = "acctestvm-ib6sn"
  random_string     = "ib6sn"
  admin_username    = "testadmin230505050044920857"
  admin_password    = "Password1234!230505050044920857"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230505050044920857"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230505050044920857"
  ...
  identifier {
    publisher = "AccTesPublisher230505050044920857"
    offer     = "AccTesOffer230505050044920857"
    sku       = "AccTesSku230505050044920857"
  }
}
