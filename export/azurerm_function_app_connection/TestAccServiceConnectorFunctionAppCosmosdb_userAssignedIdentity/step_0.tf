...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-231218072532925638"
  location = "West Europe"
}

resource "azurerm_cosmosdb_account" "test" {
  name                = "acctestcosmosdb231218072532925638"
...
resource "azurerm_app_service_plan" "test" {
  name                = "acctestASP-231218072532925638"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_function_app" "test" {
  name                       = "acctest-231218072532925638-func"
  location                   = azurerm_resource_group.test.location
  resource_group_name        = azurerm_resource_group.test.name
...
resource "azurerm_function_app_connection" "test" {
  name               = "acctestserviceconnector231218072532925638"
