...
locals {
  number            = "230609091011717474"
  location          = "West Europe"
  domain_name_label = "acctestvm-338qq"
  random_string     = "338qq"
  admin_username    = "testadmin230609091011717474"
  admin_password    = "Password1234!230609091011717474"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230609091011717474"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230609091011717474"
  ...
  identifier {
    publisher = "AccTesPublisher230609091011717474"
    offer     = "AccTesOffer230609091011717474"
    sku       = "AccTesSku230609091011717474"
  }
}
