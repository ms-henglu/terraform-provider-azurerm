...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-DataCollectionRule-221021031511340871"
...
resource "azurerm_log_analytics_workspace" "test1" {
  name                = "acctest-law-221021031511340871"
...
resource "azurerm_log_analytics_workspace" "test2" {
  name                = "acctest-law2-221021031511340871"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
}
...
resource "azurerm_monitor_data_collection_rule" "test" {
  name                = "acctestmdcr-221021031511340871"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
