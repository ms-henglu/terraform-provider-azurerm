...
locals {
  number            = "220826002453898405"
  location          = "West Europe"
  domain_name_label = "acctestvm-alg6u"
  random_string     = "alg6u"
  admin_username    = "testadmin220826002453898405"
  admin_password    = "Password1234!220826002453898405"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220826002453898405"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220826002453898405"
  ...
  identifier {
    publisher = "AccTesPublisher220826002453898405"
    offer     = "AccTesOffer220826002453898405"
    sku       = "AccTesSku220826002453898405"
  }
}
