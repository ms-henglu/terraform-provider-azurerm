...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-b7sdk"
  policy_type  = "Custom"
  display_name = "testPolicySet-b7sdk"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-b7sdk"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-b7sdk"
