...
locals {
  number            = "220909034011274299"
  location          = "West Europe"
  domain_name_label = "acctestvm-rrrpr"
  random_string     = "rrrpr"
  admin_username    = "testadmin220909034011274299"
  admin_password    = "Password1234!220909034011274299"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220909034011274299"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220909034011274299"
  ...
  identifier {
    publisher = "AccTesPublisher220909034011274299"
    offer     = "AccTesOffer220909034011274299"
    sku       = "AccTesSku220909034011274299"
  }
}
