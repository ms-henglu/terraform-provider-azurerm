...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG1-sql-221202040524850412"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet1-221202040524850412"
...
resource "azurerm_subnet" "test" {
  name                 = "subnet1-221202040524850412"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_network_security_group" "test" {
  name                = "mi-security-group1-221202040524850412"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
}
...
resource "azurerm_route_table" "test" {
  name                          = "routetable1-221202040524850412"
  location                      = azurerm_resource_group.test.location
  resource_group_name           = azurerm_resource_group.test.name
...
resource "azurerm_sql_managed_instance" "test" {
  name                         = "acctestsqlserver221202040524850412"
  resource_group_name          = azurerm_resource_group.test.name
  location                     = azurerm_resource_group.test.location
...
resource "azurerm_sql_managed_database" "test" {
  ...
  name                    = "acctest-221202040524850412"
  location                = azurerm_resource_group.test.location
}
