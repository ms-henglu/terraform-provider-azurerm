...
func TestAccLinuxVirtualMachineScaleSet_otherUefi(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_linux_virtual_machine_scale_set", "test")
	r := LinuxVirtualMachineScaleSetResource{}
...
func (r LinuxVirtualMachineScaleSetResource) otherUefi(data acceptance.TestData, secureBootEnabled, vTpmEnabled bool) string {
	return fmt.Sprintf(`
%s
...
`, r.template(data), data.RandomInteger, secureBootEnabled, vTpmEnabled)
}
