...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-dtwin-220923011807053808"
  location = "West Europe"
}


resource "azurerm_digital_twins_instance" "test" {
  name                = "acctest-DT-220923011807053808"
...
resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhubnamespace-220923011807053808"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_eventhub" "test" {
  name                = "acctesteventhub-220923011807053808"
...
resource "azurerm_eventhub_authorization_rule" "test" {
  name                = "acctest-r220923011807053808"
  namespace_name      = azurerm_eventhub_namespace.test.name
...
resource "azurerm_digital_twins_endpoint_eventhub" "test" {
  name                                 = "acctest-EH-220923011807053808"
