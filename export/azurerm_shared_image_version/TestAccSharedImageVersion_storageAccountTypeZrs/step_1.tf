...
locals {
  number            = "230316221218745527"
  location          = "West Europe"
  domain_name_label = "acctestvm-wf14m"
  random_string     = "wf14m"
  admin_username    = "testadmin230316221218745527"
  admin_password    = "Password1234!230316221218745527"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230316221218745527"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230316221218745527"
  ...
  identifier {
    publisher = "AccTesPublisher230316221218745527"
    offer     = "AccTesOffer230316221218745527"
    sku       = "AccTesSku230316221218745527"
  }
}
