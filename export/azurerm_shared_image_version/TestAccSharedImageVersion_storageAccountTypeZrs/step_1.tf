...
locals {
  number            = "230113180850403793"
  location          = "West Europe"
  domain_name_label = "acctestvm-3oex9"
  random_string     = "3oex9"
  admin_username    = "testadmin230113180850403793"
  admin_password    = "Password1234!230113180850403793"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230113180850403793"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230113180850403793"
  ...
  identifier {
    publisher = "AccTesPublisher230113180850403793"
    offer     = "AccTesOffer230113180850403793"
    sku       = "AccTesSku230113180850403793"
  }
}
