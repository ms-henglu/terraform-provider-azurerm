...
locals {
  number            = "240311031615618372"
  location          = "West Europe"
  domain_name_label = "acctestvm-7f2e0"
  random_string     = "7f2e0"
  admin_username    = "testadmin240311031615618372"
  admin_password    = "Password1234!240311031615618372"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240311031615618372"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240311031615618372"
  ...
  identifier {
    publisher = "AccTesPublisher240311031615618372"
    offer     = "AccTesOffer240311031615618372"
    sku       = "AccTesSku240311031615618372"
  }
}
