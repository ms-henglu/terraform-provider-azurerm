...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211112020355812170"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211112020355812170"
  ...
  identifier {
    publisher = "AccTesPublisher211112020355812170"
    offer     = "AccTesOffer211112020355812170"
    sku       = "AccTesSku211112020355812170"
  }
}
