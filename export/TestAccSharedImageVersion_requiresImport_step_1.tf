...
locals {
  number            = "220826005646574036"
  location          = "West Europe"
  domain_name_label = "acctestvm-ekr2f"
  random_string     = "ekr2f"
  admin_username    = "testadmin220826005646574036"
  admin_password    = "Password1234!220826005646574036"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220826005646574036"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220826005646574036"
  ...
  identifier {
    publisher = "AccTesPublisher220826005646574036"
    offer     = "AccTesOffer220826005646574036"
    sku       = "AccTesSku220826005646574036"
  }
}
