...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-221111021349074621"
  location = "West Europe"
}

resource "azurerm_resource_group" "relay" {
  name     = "acctestRG-relay-221111021349074621"
  location = "West Europe"
}

resource "azurerm_app_service_plan" "test" {
  name                = "acctest-ASP-221111021349074621"
...
resource "azurerm_app_service" "test" {
  name                = "acctest-AS-221111021349074621"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_relay_namespace" "test" {
  name                = "acctest-RN-221111021349074621"
...
resource "azurerm_relay_hybrid_connection" "test" {
  name                 = "acctest-RHC-221111021349074621"
  resource_group_name  = azurerm_resource_group.relay.name
