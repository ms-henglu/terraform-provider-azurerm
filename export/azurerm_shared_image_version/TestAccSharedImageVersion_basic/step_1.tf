...
locals {
  number            = "240119021734532964"
  location          = "West Europe"
  domain_name_label = "acctestvm-70yk4"
  random_string     = "70yk4"
  admin_username    = "testadmin240119021734532964"
  admin_password    = "Password1234!240119021734532964"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240119021734532964"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240119021734532964"
  ...
  identifier {
    publisher = "AccTesPublisher240119021734532964"
    offer     = "AccTesOffer240119021734532964"
    sku       = "AccTesSku240119021734532964"
  }
}
