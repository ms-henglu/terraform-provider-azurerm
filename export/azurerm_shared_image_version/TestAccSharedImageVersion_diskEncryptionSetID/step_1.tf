...
locals {
  number            = "230613071532221023"
  location          = "West Europe"
  domain_name_label = "acctestvm-uu4v7"
  random_string     = "uu4v7"
  admin_username    = "testadmin230613071532221023"
  admin_password    = "Password1234!230613071532221023"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230613071532221023"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230613071532221023"
  ...
  identifier {
    publisher = "AccTesPublisher230613071532221023"
    offer     = "AccTesOffer230613071532221023"
    sku       = "AccTesSku230613071532221023"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230613071532221023"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
