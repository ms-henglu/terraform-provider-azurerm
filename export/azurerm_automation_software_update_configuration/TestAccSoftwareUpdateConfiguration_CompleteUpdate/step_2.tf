...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-230818023543079983"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctest-230818023543079983"
...
resource "azurerm_log_analytics_workspace" "test" {
  name                = "acctestLAW-230818023543079983"
  location            = "west europe"
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "PerGB2018"
...
resource "azurerm_automation_software_update_configuration" "test" {
  ...
  name                  = "acctest-suc-230818023543079983"
  ...
  schedule {
    ...
    start_time         = "2023-08-18T03:36:00Z"
    expiry_time        = "2023-08-18T04:36:00Z"
    is_enabled         = true
    interval           = 2
    frequency          = "Hour"
    time_zone          = "Etc/UTC"
