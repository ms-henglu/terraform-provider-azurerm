...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-230421021713724385"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctestAA-230421021713724385"
...
resource "azurerm_automation_credential" "test" {
  name                    = "acctest-230421021713724385"
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestnw-230421021713724385"
...
resource "azurerm_network_interface" "test" {
  name                = "acctni-230421021713724385"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "test" {
  name                = "acctestVM-230421021713724385"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_automation_hybrid_runbook_worker" "test" {
  ...
  worker_id               = "97c09d31-8679-45eb-acb9-f5ed85aa7cef"
