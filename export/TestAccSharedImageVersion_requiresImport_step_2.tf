...
locals {
  number            = "220506015657135746"
  location          = "West Europe"
  domain_name_label = "acctestvm-3xmji"
  random_string     = "3xmji"
  admin_username    = "testadmin220506015657135746"
  admin_password    = "Password1234!220506015657135746"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220506015657135746"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220506015657135746"
  ...
  identifier {
    publisher = "AccTesPublisher220506015657135746"
    offer     = "AccTesOffer220506015657135746"
    sku       = "AccTesSku220506015657135746"
  }
}
