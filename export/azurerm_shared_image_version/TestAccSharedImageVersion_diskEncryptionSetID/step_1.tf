...
locals {
  number            = "230414020945141844"
  location          = "West Europe"
  domain_name_label = "acctestvm-hpfg4"
  random_string     = "hpfg4"
  admin_username    = "testadmin230414020945141844"
  admin_password    = "Password1234!230414020945141844"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230414020945141844"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230414020945141844"
  ...
  identifier {
    publisher = "AccTesPublisher230414020945141844"
    offer     = "AccTesOffer230414020945141844"
    sku       = "AccTesSku230414020945141844"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230414020945141844"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
