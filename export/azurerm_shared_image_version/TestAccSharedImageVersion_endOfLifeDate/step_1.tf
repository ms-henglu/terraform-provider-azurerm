...
locals {
  number            = "230810143140387381"
  location          = "West Europe"
  domain_name_label = "acctestvm-pcgzp"
  random_string     = "pcgzp"
  admin_username    = "testadmin230810143140387381"
  admin_password    = "Password1234!230810143140387381"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230810143140387381"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230810143140387381"
  ...
  identifier {
    publisher = "AccTesPublisher230810143140387381"
    offer     = "AccTesOffer230810143140387381"
    sku       = "AccTesSku230810143140387381"
  }
}
