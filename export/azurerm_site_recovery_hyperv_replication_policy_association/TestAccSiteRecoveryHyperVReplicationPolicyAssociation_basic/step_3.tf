...
locals {
  rg_name              = "acctest-nested-rg-230414022014835112"
  location             = "West Europe"
  vn_name              = "acctest-nested-vn-230414022014835112"
  ip_name              = "acctest-nested-ip-230414022014835112"
  vm_name              = "acctest-nested-vm-230414022014835112"
  nic_name             = "acctest-nested-nic-230414022014835112"
  disk_name            = "acctest-nested-disk-230414022014835112"
  keyvault_name        = "acctkv230414022014835112"
  nsg_name             = "acctest-nested-nsg-230414022014835112"
  recovery_vault_name  = "acctest-nested-recovery-vault-230414022014835112"
  recovery_site_name   = "acctest-nested-recovery-site-230414022014835112"
  admin_name           = "acctestadmin"
  cert_name            = "acctestcert"
  storage_account_name = "acctestsatvc3a"
}
...
resource "azurerm_windows_virtual_machine" "host" {
  ...
  additional_unattend_content {
    setting = "AutoLogon"
    content = "<AutoLogon><Password><Value>2!T4K^5)y5</Value></Password><Enabled>true</Enabled><LogonCount>1</LogonCount><Username>${local.admin_name}</Username></AutoLogon>"
  }
...
resource "azurerm_site_recovery_hyperv_replication_policy" "test" {
  recovery_vault_id                                  = azurerm_recovery_services_vault.test.id
  name                                               = "acctest-policy-230414022014835112"
