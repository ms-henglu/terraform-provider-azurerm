...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-DataCollectionRule-220729033027047256"
...
resource "azurerm_log_analytics_workspace" "test1" {
  name                = "acctest-law-220729033027047256"
...
resource "azurerm_log_analytics_workspace" "test2" {
  name                = "acctest-law2-220729033027047256"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
}
...
resource "azurerm_monitor_data_collection_rule" "test" {
  name                = "acctestmdcr-220729033027047256"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
