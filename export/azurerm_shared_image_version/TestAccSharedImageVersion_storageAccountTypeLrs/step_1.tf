...
locals {
  number            = "230512010404764284"
  location          = "West Europe"
  domain_name_label = "acctestvm-tay6d"
  random_string     = "tay6d"
  admin_username    = "testadmin230512010404764284"
  admin_password    = "Password1234!230512010404764284"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230512010404764284"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230512010404764284"
  ...
  identifier {
    publisher = "AccTesPublisher230512010404764284"
    offer     = "AccTesOffer230512010404764284"
    sku       = "AccTesSku230512010404764284"
  }
}
