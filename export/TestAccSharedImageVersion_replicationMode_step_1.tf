...
locals {
  number            = "220826005646572958"
  location          = "West Europe"
  domain_name_label = "acctestvm-z9stn"
  random_string     = "z9stn"
  admin_username    = "testadmin220826005646572958"
  admin_password    = "Password1234!220826005646572958"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220826005646572958"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220826005646572958"
  ...
  identifier {
    publisher = "AccTesPublisher220826005646572958"
    offer     = "AccTesOffer220826005646572958"
    sku       = "AccTesSku220826005646572958"
  }
}
