...
locals {
  number            = "230106034233477906"
  location          = "West Europe"
  domain_name_label = "acctestvm-ai1h3"
  random_string     = "ai1h3"
  admin_username    = "testadmin230106034233477906"
  admin_password    = "Password1234!230106034233477906"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230106034233477906"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230106034233477906"
  ...
  identifier {
    publisher = "AccTesPublisher230106034233477906"
    offer     = "AccTesOffer230106034233477906"
    sku       = "AccTesSku230106034233477906"
  }
}
