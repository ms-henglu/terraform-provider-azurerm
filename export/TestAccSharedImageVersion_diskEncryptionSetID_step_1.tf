...
locals {
  number            = "220811053013420645"
  location          = "West Europe"
  domain_name_label = "acctestvm-bzxyx"
  random_string     = "bzxyx"
  admin_username    = "testadmin220811053013420645"
  admin_password    = "Password1234!220811053013420645"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220811053013420645"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220811053013420645"
  ...
  identifier {
    publisher = "AccTesPublisher220811053013420645"
    offer     = "AccTesOffer220811053013420645"
    sku       = "AccTesSku220811053013420645"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220811053013420645"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
