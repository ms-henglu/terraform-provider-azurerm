...
locals {
  number            = "220715004235786080"
  location          = "West Europe"
  domain_name_label = "acctestvm-fj3i8"
  random_string     = "fj3i8"
  admin_username    = "testadmin220715004235786080"
  admin_password    = "Password1234!220715004235786080"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220715004235786080"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220715004235786080"
  ...
  identifier {
    publisher = "AccTesPublisher220715004235786080"
    offer     = "AccTesOffer220715004235786080"
    sku       = "AccTesSku220715004235786080"
  }
}
