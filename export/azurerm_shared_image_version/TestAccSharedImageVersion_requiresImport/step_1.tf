...
locals {
  number            = "230929064556875087"
  location          = "West Europe"
  domain_name_label = "acctestvm-0gd3b"
  random_string     = "0gd3b"
  admin_username    = "testadmin230929064556875087"
  admin_password    = "Password1234!230929064556875087"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230929064556875087"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230929064556875087"
  ...
  identifier {
    publisher = "AccTesPublisher230929064556875087"
    offer     = "AccTesOffer230929064556875087"
    sku       = "AccTesSku230929064556875087"
  }
}
