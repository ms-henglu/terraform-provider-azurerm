...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-230505051255189691"
...
resource "azuread_application" "cluster_explorer" {
  ...
  identifier_uris = ["https://test-l0z1k.${data.azuread_domains.test.domains[0].domain_name}:19080/Explorer/index.html"]
  web {
...
resource "azurerm_service_fabric_cluster" "test" {
  name                = "acctest-230505051255189691"
