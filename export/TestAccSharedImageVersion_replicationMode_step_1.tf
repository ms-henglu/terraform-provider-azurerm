...
locals {
  number            = "220722051724586405"
  location          = "West Europe"
  domain_name_label = "acctestvm-w9v6h"
  random_string     = "w9v6h"
  admin_username    = "testadmin220722051724586405"
  admin_password    = "Password1234!220722051724586405"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220722051724586405"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220722051724586405"
  ...
  identifier {
    publisher = "AccTesPublisher220722051724586405"
    offer     = "AccTesOffer220722051724586405"
    sku       = "AccTesSku220722051724586405"
  }
}
