...
locals {
  number            = "230313020903886282"
  location          = "West Europe"
  domain_name_label = "acctestvm-hh2f2"
  random_string     = "hh2f2"
  admin_username    = "testadmin230313020903886282"
  admin_password    = "Password1234!230313020903886282"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230313020903886282"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230313020903886282"
  ...
  identifier {
    publisher = "AccTesPublisher230313020903886282"
    offer     = "AccTesOffer230313020903886282"
    sku       = "AccTesSku230313020903886282"
  }
}
