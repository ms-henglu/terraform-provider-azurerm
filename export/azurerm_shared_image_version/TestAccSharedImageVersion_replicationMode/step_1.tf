...
locals {
  number            = "221021030948781766"
  location          = "West Europe"
  domain_name_label = "acctestvm-hx86r"
  random_string     = "hx86r"
  admin_username    = "testadmin221021030948781766"
  admin_password    = "Password1234!221021030948781766"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221021030948781766"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221021030948781766"
  ...
  identifier {
    publisher = "AccTesPublisher221021030948781766"
    offer     = "AccTesOffer221021030948781766"
    sku       = "AccTesSku221021030948781766"
  }
}
