...
locals {
  number            = "230728031950567461"
  location          = "West Europe"
  domain_name_label = "acctestvm-cr43c"
  random_string     = "cr43c"
  admin_username    = "testadmin230728031950567461"
  admin_password    = "Password1234!230728031950567461"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230728031950567461"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230728031950567461"
  ...
  identifier {
    publisher = "AccTesPublisher230728031950567461"
    offer     = "AccTesOffer230728031950567461"
    sku       = "AccTesSku230728031950567461"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230728031950567461"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
