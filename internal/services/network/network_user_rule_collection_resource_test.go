...
func (r NetworkSecurityUserRuleCollection) Exists(ctx context.Context, client *clients.Client, state *terraform.InstanceState) (*bool, error) {
	...
	resp, err := client.Network.UserRuleCollectionClient.Get(ctx, id.ResourceGroup, id.NetworkManagerName, id.SecurityUserConfigurationName, id.RuleCollectionName)
	if err != nil {
