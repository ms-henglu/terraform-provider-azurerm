...
locals {
  number            = "240315122550008275"
  location          = "West Europe"
  domain_name_label = "acctestvm-fy41c"
  random_string     = "fy41c"
  admin_username    = "testadmin240315122550008275"
  admin_password    = "Password1234!240315122550008275"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240315122550008275"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240315122550008275"
  ...
  identifier {
    publisher = "AccTesPublisher240315122550008275"
    offer     = "AccTesOffer240315122550008275"
    sku       = "AccTesSku240315122550008275"
  }
}
