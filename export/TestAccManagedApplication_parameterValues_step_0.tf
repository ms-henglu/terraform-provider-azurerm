...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-mapp-220429075629011122"
  location = "West Europe"
}

resource "azurerm_managed_application_definition" "test" {
  name                = "acctestManagedAppDef220429075629011122"
...
resource "azurerm_managed_application" "test" {
  name                        = "acctestManagedApp220429075629011122"
  location                    = azurerm_resource_group.test.location
  resource_group_name         = azurerm_resource_group.test.name
  kind                        = "ServiceCatalog"
  managed_resource_group_name = "infraGroup220429075629011122"
  ...
  parameter_values = <<VALUES
	{
        ...
        "storageAccountNamePrefix": {"value": "storeij6gt"},
