...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-221021034418145522"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-221021034418145522"
...
resource "azurerm_virtual_network" "gateway" {
  name                = "acctestvnet-gw-221021034418145522"
...
resource "azurerm_subnet" "gateway" {
  name                 = "acctestsubnet-gw-221021034418145522"
...
resource "azurerm_lb" "gateway" {
  name                = "acctestlb-221021034418145522"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Gateway"
...
resource "azurerm_lb_backend_address_pool" "gateway" {
  name            = "acctestbap-221021034418145522"
...
resource "azurerm_public_ip" "test" {
  name                = "acctestpip-221021034418145522"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Standard"
...
resource "azurerm_network_interface" "test" {
  name                = "acctestnic-221021034418145522"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
