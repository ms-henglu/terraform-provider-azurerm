...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-iothub-220726002026318577"
  location = "West Europe"
}

resource "azurerm_storage_account" "test" {
  name                     = "acc220726002026318577"
...
resource "azurerm_servicebus_namespace" "test" {
  name                = "acctest-220726002026318577"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Standard"
}
...
resource "azurerm_servicebus_topic" "test" {
  name         = "acctestservicebustopic-220726002026318577"
  namespace_id = azurerm_servicebus_namespace.test.id
}
...
resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhubnamespace-220726002026318577"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Basic"
}
...
resource "azurerm_eventhub" "test" {
  name                = "acctesteventhub-220726002026318577"
...
resource "azurerm_user_assigned_identity" "test" {
  name                = "acctestuai-220726002026318577"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}
...
resource "azurerm_iothub" "test" {
  name                = "acctestIoTHub-220726002026318577"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
