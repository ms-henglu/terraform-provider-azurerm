...
locals {
  number            = "230922053821494736"
  location          = "West Europe"
  domain_name_label = "acctestvm-k3k7t"
  random_string     = "k3k7t"
  admin_username    = "testadmin230922053821494736"
  admin_password    = "Password1234!230922053821494736"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230922053821494736"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230922053821494736"
  ...
  identifier {
    publisher = "AccTesPublisher230922053821494736"
    offer     = "AccTesOffer230922053821494736"
    sku       = "AccTesSku230922053821494736"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230922053821494736"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
