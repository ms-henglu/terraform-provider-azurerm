...
func (r NetworkUserRuleResource) Exists(ctx context.Context, client *clients.Client, state *terraform.InstanceState) (*bool, error) {
	...
	resp, err := client.Network.UserRuleClient.Get(ctx, id.ResourceGroup, id.NetworkManagerName, id.SecurityUserConfigurationName, id.RuleCollectionName, id.RuleName)
	if err != nil {
