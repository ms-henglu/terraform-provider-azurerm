...
locals {
  number            = "230227175227918480"
  location          = "West Europe"
  domain_name_label = "acctestvm-vs7qq"
  random_string     = "vs7qq"
  admin_username    = "testadmin230227175227918480"
  admin_password    = "Password1234!230227175227918480"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230227175227918480"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230227175227918480"
  ...
  identifier {
    publisher = "AccTesPublisher230227175227918480"
    offer     = "AccTesOffer230227175227918480"
    sku       = "AccTesSku230227175227918480"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230227175227918480"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
