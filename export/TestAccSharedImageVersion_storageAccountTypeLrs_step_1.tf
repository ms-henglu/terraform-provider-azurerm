...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211210024414745565"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211210024414745565"
  ...
  identifier {
    publisher = "AccTesPublisher211210024414745565"
    offer     = "AccTesOffer211210024414745565"
    sku       = "AccTesSku211210024414745565"
  }
}
