...
var _ resourceid.Formatter = NetworkManagerId{}

func TestNetworkManagerIDFormatter(t *testing.T) {
	actual := NewNetworkManagerID("12345678-1234-9876-4563-123456789012", "resGroup1", "networkManager1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Network/networkManagers/networkManager1"
	if actual != expected {
