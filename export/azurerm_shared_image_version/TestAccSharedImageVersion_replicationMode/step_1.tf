...
locals {
  number            = "240311031615615756"
  location          = "West Europe"
  domain_name_label = "acctestvm-2bo30"
  random_string     = "2bo30"
  admin_username    = "testadmin240311031615615756"
  admin_password    = "Password1234!240311031615615756"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240311031615615756"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240311031615615756"
  ...
  identifier {
    publisher = "AccTesPublisher240311031615615756"
    offer     = "AccTesOffer240311031615615756"
    sku       = "AccTesSku240311031615615756"
  }
}
