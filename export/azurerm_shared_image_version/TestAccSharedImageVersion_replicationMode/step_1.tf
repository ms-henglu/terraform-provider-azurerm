...
locals {
  number            = "230512003629466546"
  location          = "West Europe"
  domain_name_label = "acctestvm-cpluz"
  random_string     = "cpluz"
  admin_username    = "testadmin230512003629466546"
  admin_password    = "Password1234!230512003629466546"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230512003629466546"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230512003629466546"
  ...
  identifier {
    publisher = "AccTesPublisher230512003629466546"
    offer     = "AccTesOffer230512003629466546"
    sku       = "AccTesSku230512003629466546"
  }
}
