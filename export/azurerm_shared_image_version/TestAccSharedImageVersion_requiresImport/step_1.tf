...
locals {
  number            = "230414020945141999"
  location          = "West Europe"
  domain_name_label = "acctestvm-71wea"
  random_string     = "71wea"
  admin_username    = "testadmin230414020945141999"
  admin_password    = "Password1234!230414020945141999"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230414020945141999"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230414020945141999"
  ...
  identifier {
    publisher = "AccTesPublisher230414020945141999"
    offer     = "AccTesOffer230414020945141999"
    sku       = "AccTesSku230414020945141999"
  }
}
