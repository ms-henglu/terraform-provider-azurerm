...
type ActiveConfigurationsClientAPI interface {
	List(ctx context.Context, resourceGroupName string, networkManagerName string, parameters *interface{}) (result network.ActiveConfigurationListResult, err error)
}
...
// EffectiveConfigurationsClientAPI contains the set of methods on the EffectiveConfigurationsClient type.
type EffectiveConfigurationsClientAPI interface {
	List(ctx context.Context, resourceGroupName string, virtualNetworkName string, parameters interface{}) (result network.ManagerEffectiveConfigurationListResult, err error)
	ListBySubnet(ctx context.Context, resourceGroupName string, virtualNetworkName string, subnetName string, parameters interface{}) (result network.ManagerEffectiveConfigurationListResult, err error)
}

var _ EffectiveConfigurationsClientAPI = (*network.EffectiveConfigurationsClient)(nil)
