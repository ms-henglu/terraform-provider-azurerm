...
locals {
  number            = "230316221218740021"
  location          = "West Europe"
  domain_name_label = "acctestvm-q7rqc"
  random_string     = "q7rqc"
  admin_username    = "testadmin230316221218740021"
  admin_password    = "Password1234!230316221218740021"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230316221218740021"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230316221218740021"
  ...
  identifier {
    publisher = "AccTesPublisher230316221218740021"
    offer     = "AccTesOffer230316221218740021"
    sku       = "AccTesSku230316221218740021"
  }
}
