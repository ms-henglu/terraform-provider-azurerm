...
locals {
  number            = "230825024235251092"
  location          = "West Europe"
  domain_name_label = "acctestvm-7oeeu"
  random_string     = "7oeeu"
  admin_username    = "testadmin230825024235251092"
  admin_password    = "Password1234!230825024235251092"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230825024235251092"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230825024235251092"
  ...
  identifier {
    publisher = "AccTesPublisher230825024235251092"
    offer     = "AccTesOffer230825024235251092"
    sku       = "AccTesSku230825024235251092"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230825024235251092"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
