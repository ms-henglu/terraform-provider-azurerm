...
locals {
  number            = "230428045412227182"
  location          = "West Europe"
  domain_name_label = "acctestvm-0begf"
  random_string     = "0begf"
  admin_username    = "testadmin230428045412227182"
  admin_password    = "Password1234!230428045412227182"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230428045412227182"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230428045412227182"
  ...
  identifier {
    publisher = "AccTesPublisher230428045412227182"
    offer     = "AccTesOffer230428045412227182"
    sku       = "AccTesSku230428045412227182"
  }
}
