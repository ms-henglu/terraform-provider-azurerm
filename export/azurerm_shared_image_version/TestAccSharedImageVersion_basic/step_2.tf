...
locals {
  number            = "230127045135676463"
  location          = "West Europe"
  domain_name_label = "acctestvm-nx3rt"
  random_string     = "nx3rt"
  admin_username    = "testadmin230127045135676463"
  admin_password    = "Password1234!230127045135676463"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230127045135676463"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230127045135676463"
  ...
  identifier {
    publisher = "AccTesPublisher230127045135676463"
    offer     = "AccTesOffer230127045135676463"
    sku       = "AccTesSku230127045135676463"
  }
}
