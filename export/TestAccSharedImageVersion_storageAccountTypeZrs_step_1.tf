...
locals {
  number            = "220326010253723526"
  location          = "West Europe"
  domain_name_label = "acctestvm-w2bak"
  random_string     = "w2bak"
  admin_username    = "testadmin220326010253723526"
  admin_password    = "Password1234!220326010253723526"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220326010253723526"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220326010253723526"
  ...
  identifier {
    publisher = "AccTesPublisher220326010253723526"
    offer     = "AccTesOffer220326010253723526"
    sku       = "AccTesSku220326010253723526"
  }
}
