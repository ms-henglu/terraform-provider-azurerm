...
locals {
  number            = "220826002453896593"
  location          = "West Europe"
  domain_name_label = "acctestvm-1ta7k"
  random_string     = "1ta7k"
  admin_username    = "testadmin220826002453896593"
  admin_password    = "Password1234!220826002453896593"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220826002453896593"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220826002453896593"
  ...
  identifier {
    publisher = "AccTesPublisher220826002453896593"
    offer     = "AccTesOffer220826002453896593"
    sku       = "AccTesSku220826002453896593"
  }
}
