...
locals {
  number            = "230313020903887461"
  location          = "West Europe"
  domain_name_label = "acctestvm-7xxlf"
  random_string     = "7xxlf"
  admin_username    = "testadmin230313020903887461"
  admin_password    = "Password1234!230313020903887461"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230313020903887461"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230313020903887461"
  ...
  identifier {
    publisher = "AccTesPublisher230313020903887461"
    offer     = "AccTesOffer230313020903887461"
    sku       = "AccTesSku230313020903887461"
  }
}
