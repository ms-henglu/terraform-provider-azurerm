...
locals {
  number            = "230922053821498964"
  location          = "West Europe"
  domain_name_label = "acctestvm-c0azw"
  random_string     = "c0azw"
  admin_username    = "testadmin230922053821498964"
  admin_password    = "Password1234!230922053821498964"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230922053821498964"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230922053821498964"
  ...
  identifier {
    publisher = "AccTesPublisher230922053821498964"
    offer     = "AccTesOffer230922053821498964"
    sku       = "AccTesSku230922053821498964"
  }
}
