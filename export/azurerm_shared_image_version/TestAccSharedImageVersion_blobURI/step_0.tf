...
locals {
  number            = "230721011329114070"
  location          = "West Europe"
  domain_name_label = "acctestvm-2g6mz"
  random_string     = "2g6mz"
  admin_username    = "testadmin230721011329114070"
  admin_password    = "Password1234!230721011329114070"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230721011329114070"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230721011329114070"
  ...
  identifier {
    publisher = "AccTesPublisher230721011329114070"
    offer     = "AccTesOffer230721011329114070"
    sku       = "AccTesSku230721011329114070"
  }
}
