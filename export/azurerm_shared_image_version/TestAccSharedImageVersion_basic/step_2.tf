...
locals {
  number            = "230929064556877661"
  location          = "West Europe"
  domain_name_label = "acctestvm-blu6p"
  random_string     = "blu6p"
  admin_username    = "testadmin230929064556877661"
  admin_password    = "Password1234!230929064556877661"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230929064556877661"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230929064556877661"
  ...
  identifier {
    publisher = "AccTesPublisher230929064556877661"
    offer     = "AccTesOffer230929064556877661"
    sku       = "AccTesSku230929064556877661"
  }
}
