...
// Patch ...
func (c ResourceGuardsClient) Patch(ctx context.Context, id ResourceGuardId, input PatchResourceRequestInput) (result PatchResponse, err error) {
...
func (c ResourceGuardsClient) responderForPatch(resp *http.Response) (result PatchResponse, err error) {
