...
locals {
  number            = "231020040746251926"
  location          = "West Europe"
  domain_name_label = "acctestvm-sjlm2"
  random_string     = "sjlm2"
  admin_username    = "testadmin231020040746251926"
  admin_password    = "Password1234!231020040746251926"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231020040746251926"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231020040746251926"
  ...
  identifier {
    publisher = "AccTesPublisher231020040746251926"
    offer     = "AccTesOffer231020040746251926"
    sku       = "AccTesSku231020040746251926"
  }
}
