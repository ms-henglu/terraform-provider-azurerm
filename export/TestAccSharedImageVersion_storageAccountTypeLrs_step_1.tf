...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220124121851418691"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220124121851418691"
  ...
  identifier {
    publisher = "AccTesPublisher220124121851418691"
    offer     = "AccTesOffer220124121851418691"
    sku       = "AccTesSku220124121851418691"
  }
}
