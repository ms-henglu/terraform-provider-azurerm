...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-231013043954296173"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-231013043954296173"
...
resource "azurerm_virtual_network" "gateway" {
  name                = "acctestvnet-gw-231013043954296173"
...
resource "azurerm_subnet" "gateway" {
  name                 = "acctestsubnet-gw-231013043954296173"
...
resource "azurerm_lb" "gateway" {
  name                = "acctestlb-231013043954296173"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Gateway"
...
resource "azurerm_lb_backend_address_pool" "gateway" {
  name            = "acctestbap-231013043954296173"
...
resource "azurerm_public_ip" "test" {
  name                = "acctestpip-231013043954296173"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Standard"
...
resource "azurerm_network_interface" "test" {
  name                = "acctestnic-231013043954296173"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
