...
resource "azurerm_resource_group" "test1" {
  name     = "acctestRG-api1-221202035104524563"
  location = "West Europe"
}

resource "azurerm_resource_group" "test2" {
  name     = "acctestRG-api2-221202035104524563"
  location = "West US 2"
}

resource "azurerm_resource_group" "test3" {
  name     = "acctestRG-api3-221202035104524563"
  location = "East US 2"
}

resource "azurerm_api_management" "test" {
  name                      = "acctestAM-221202035104524563"
  publisher_name            = "pub1"
  ...
  hostname_configuration {
    proxy {
      host_name                    = "acctestAM-221202035104524563.azure-api.net"
