...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-240112224008126395"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctest-240112224008126395"
...
resource "azurerm_log_analytics_workspace" "test" {
  name                = "acctestLAW-240112224008126395"
  location            = "west europe"
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "PerGB2018"
...
resource "azurerm_automation_software_update_configuration" "test" {
  ...
  name                  = "acctest-suc-240112224008126395"
  ...
  schedule {
    ...
    start_time         = "2024-01-12T23:40:00Z"
    expiry_time        = "2024-01-13T00:40:00Z"
    is_enabled         = true
    interval           = 2
    frequency          = "Hour"
    time_zone          = "Etc/UTC"
