...
locals {
  number            = "230526084758998913"
  location          = "West Europe"
  domain_name_label = "acctestvm-m3lt6"
  random_string     = "m3lt6"
  admin_username    = "testadmin230526084758998913"
  admin_password    = "Password1234!230526084758998913"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230526084758998913"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230526084758998913"
  ...
  identifier {
    publisher = "AccTesPublisher230526084758998913"
    offer     = "AccTesOffer230526084758998913"
    sku       = "AccTesSku230526084758998913"
  }
}
