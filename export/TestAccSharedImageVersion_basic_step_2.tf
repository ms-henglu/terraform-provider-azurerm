...
locals {
  number            = "210825044610905071"
  location          = "West Europe"
  domain_name_label = "acctestvm-61ezk"
  random_string     = "61ezk"
  admin_username    = "testadmin210825044610905071"
  admin_password    = "Password1234!210825044610905071"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825044610905071"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825044610905071"
  ...
  identifier {
    publisher = "AccTesPublisher210825044610905071"
    offer     = "AccTesOffer210825044610905071"
    sku       = "AccTesSku210825044610905071"
  }
}
