...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231013043133455367"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231013043133455367"
  ...
  identifier {
    publisher = "AccTesPublisher231013043133455367"
    offer     = "AccTesOffer231013043133455367"
    sku       = "AccTesSku231013043133455367"
  }
}
