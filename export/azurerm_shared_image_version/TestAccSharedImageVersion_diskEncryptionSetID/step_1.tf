...
locals {
  number            = "230609091011712508"
  location          = "West Europe"
  domain_name_label = "acctestvm-79bz7"
  random_string     = "79bz7"
  admin_username    = "testadmin230609091011712508"
  admin_password    = "Password1234!230609091011712508"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230609091011712508"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230609091011712508"
  ...
  identifier {
    publisher = "AccTesPublisher230609091011712508"
    offer     = "AccTesOffer230609091011712508"
    sku       = "AccTesSku230609091011712508"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230609091011712508"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
