...
locals {
  number            = "220826005646579964"
  location          = "West Europe"
  domain_name_label = "acctestvm-ixh12"
  random_string     = "ixh12"
  admin_username    = "testadmin220826005646579964"
  admin_password    = "Password1234!220826005646579964"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220826005646579964"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220826005646579964"
  ...
  identifier {
    publisher = "AccTesPublisher220826005646579964"
    offer     = "AccTesOffer220826005646579964"
    sku       = "AccTesSku220826005646579964"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220826005646579964"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
