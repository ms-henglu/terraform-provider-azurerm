...
func TestNetworkUserRuleIDFormatter(t *testing.T) {
	actual := NewNetworkUserRuleID("12345678-1234-9876-4563-123456789012", "resGroup1", "networkManager1", "securityConfiguration1", "userRule1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Network/networkManagers/networkManager1/securityConfigurations/securityConfiguration1/userRules/userRule1"
	if actual != expected {
...
func TestNetworkUserRuleID(t *testing.T) {
	...
	for _, v := range testData {
		...
		if actual.UserRuleName != v.Expected.UserRuleName {
			t.Fatalf("Expected %q but got %q for UserRuleName", v.Expected.UserRuleName, actual.UserRuleName)
		}
	}
}
