...
locals {
  number            = "210825031517189542"
  location          = "West Europe"
  domain_name_label = "acctestvm-hp270"
  random_string     = "hp270"
  admin_username    = "testadmin210825031517189542"
  admin_password    = "Password1234!210825031517189542"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825031517189542"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825031517189542"
  ...
  identifier {
    publisher = "AccTesPublisher210825031517189542"
    offer     = "AccTesOffer210825031517189542"
    sku       = "AccTesSku210825031517189542"
  }
}
