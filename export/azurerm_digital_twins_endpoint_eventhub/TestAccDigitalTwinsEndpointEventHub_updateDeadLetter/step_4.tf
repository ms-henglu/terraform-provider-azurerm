...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-dtwin-231020041013241172"
  location = "West Europe"
}


resource "azurerm_digital_twins_instance" "test" {
  name                = "acctest-DT-231020041013241172"
...
resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhubnamespace-231020041013241172"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_eventhub" "test" {
  name                = "acctesteventhub-231020041013241172"
...
resource "azurerm_eventhub_authorization_rule" "test" {
  name                = "acctest-r231020041013241172"
  namespace_name      = azurerm_eventhub_namespace.test.name
...
resource "azurerm_digital_twins_endpoint_eventhub" "test" {
  name                                 = "acctest-EH-231020041013241172"
