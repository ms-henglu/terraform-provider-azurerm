...
locals {
  number            = "220627122505820252"
  location          = "West Europe"
  domain_name_label = "acctestvm-n4isy"
  random_string     = "n4isy"
  admin_username    = "testadmin220627122505820252"
  admin_password    = "Password1234!220627122505820252"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627122505820252"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627122505820252"
  ...
  identifier {
    publisher = "AccTesPublisher220627122505820252"
    offer     = "AccTesOffer220627122505820252"
    sku       = "AccTesSku220627122505820252"
  }
}
