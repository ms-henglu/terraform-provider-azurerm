...
locals {
  number            = "230613071532226142"
  location          = "West Europe"
  domain_name_label = "acctestvm-8m1eu"
  random_string     = "8m1eu"
  admin_username    = "testadmin230613071532226142"
  admin_password    = "Password1234!230613071532226142"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230613071532226142"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230613071532226142"
  ...
  identifier {
    publisher = "AccTesPublisher230613071532226142"
    offer     = "AccTesOffer230613071532226142"
    sku       = "AccTesSku230613071532226142"
  }
}
