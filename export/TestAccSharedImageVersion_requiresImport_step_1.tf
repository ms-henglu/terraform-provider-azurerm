...
locals {
  number            = "220726014613804922"
  location          = "West Europe"
  domain_name_label = "acctestvm-12orp"
  random_string     = "12orp"
  admin_username    = "testadmin220726014613804922"
  admin_password    = "Password1234!220726014613804922"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220726014613804922"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220726014613804922"
  ...
  identifier {
    publisher = "AccTesPublisher220726014613804922"
    offer     = "AccTesOffer220726014613804922"
    sku       = "AccTesSku220726014613804922"
  }
}
