...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211119050629413402"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211119050629413402"
  ...
  identifier {
    publisher = "AccTesPublisher211119050629413402"
    offer     = "AccTesOffer211119050629413402"
    sku       = "AccTesSku211119050629413402"
  }
}
