...
locals {
  number            = "220204092752866637"
  location          = "West Europe"
  domain_name_label = "acctestvm-hsl2z"
  random_string     = "hsl2z"
  admin_username    = "testadmin220204092752866637"
  admin_password    = "Password1234!220204092752866637"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220204092752866637"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220204092752866637"
  ...
  identifier {
    publisher = "AccTesPublisher220204092752866637"
    offer     = "AccTesOffer220204092752866637"
    sku       = "AccTesSku220204092752866637"
  }
}
