...
locals {
  number            = "230616074443138621"
  location          = "West Europe"
  domain_name_label = "acctestvm-8mpw3"
  random_string     = "8mpw3"
  admin_username    = "testadmin230616074443138621"
  admin_password    = "Password1234!230616074443138621"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230616074443138621"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230616074443138621"
  ...
  identifier {
    publisher = "AccTesPublisher230616074443138621"
    offer     = "AccTesOffer230616074443138621"
    sku       = "AccTesSku230616074443138621"
  }
}
