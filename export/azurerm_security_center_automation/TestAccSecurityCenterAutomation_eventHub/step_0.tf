...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-240315124003056871"
  location = "West Europe"
}

resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhub-240315124003056871"
  location            = "West Europe"
...
resource "azurerm_eventhub_authorization_rule" "test" {
  name                = "acctest-eventhub-auth-rule-240315124003056871"
  namespace_name      = azurerm_eventhub_namespace.test.name
...
resource "azurerm_security_center_automation" "test" {
  name                = "acctestautomation-240315124003056871"
  location            = "West Europe"
  resource_group_name = azurerm_resource_group.test.name
