...
locals {
  number            = "230810143140386038"
  location          = "West Europe"
  domain_name_label = "acctestvm-jpf2d"
  random_string     = "jpf2d"
  admin_username    = "testadmin230810143140386038"
  admin_password    = "Password1234!230810143140386038"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230810143140386038"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230810143140386038"
  ...
  identifier {
    publisher = "AccTesPublisher230810143140386038"
    offer     = "AccTesOffer230810143140386038"
    sku       = "AccTesSku230810143140386038"
  }
}
