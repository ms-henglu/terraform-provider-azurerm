...
locals {
  number            = "220124121851419151"
  location          = "West Europe"
  domain_name_label = "acctestvm-9wffs"
  random_string     = "9wffs"
  admin_username    = "testadmin220124121851419151"
  admin_password    = "Password1234!220124121851419151"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220124121851419151"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220124121851419151"
  ...
  identifier {
    publisher = "AccTesPublisher220124121851419151"
    offer     = "AccTesOffer220124121851419151"
    sku       = "AccTesSku220124121851419151"
  }
}
