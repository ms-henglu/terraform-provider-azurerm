...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220225034148132636"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220225034148132636"
  ...
  identifier {
    publisher = "AccTesPublisher220225034148132636"
    offer     = "AccTesOffer220225034148132636"
    sku       = "AccTesSku220225034148132636"
  }
}
