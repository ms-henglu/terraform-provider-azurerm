...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220407230802473836"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220407230802473836"
  ...
  identifier {
    publisher = "AccTesPublisher220407230802473836"
    offer     = "AccTesOffer220407230802473836"
    sku       = "AccTesSku220407230802473836"
  }
}
