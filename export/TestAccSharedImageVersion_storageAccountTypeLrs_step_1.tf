...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211217075027322652"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211217075027322652"
  ...
  identifier {
    publisher = "AccTesPublisher211217075027322652"
    offer     = "AccTesOffer211217075027322652"
    sku       = "AccTesSku211217075027322652"
  }
}
