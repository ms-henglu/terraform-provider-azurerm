...
locals {
  number            = "220422011655552994"
  location          = "West Europe"
  domain_name_label = "acctestvm-snr3l"
  random_string     = "snr3l"
  admin_username    = "testadmin220422011655552994"
  admin_password    = "Password1234!220422011655552994"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220422011655552994"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220422011655552994"
  ...
  identifier {
    publisher = "AccTesPublisher220422011655552994"
    offer     = "AccTesOffer220422011655552994"
    sku       = "AccTesSku220422011655552994"
  }
}
