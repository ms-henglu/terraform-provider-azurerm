...
locals {
  number            = "231218071435565351"
  location          = "West Europe"
  domain_name_label = "acctestvm-ekzog"
  random_string     = "ekzog"
  admin_username    = "testadmin231218071435565351"
  admin_password    = "Password1234!231218071435565351"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231218071435565351"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231218071435565351"
  ...
  identifier {
    publisher = "AccTesPublisher231218071435565351"
    offer     = "AccTesOffer231218071435565351"
    sku       = "AccTesSku231218071435565351"
  }
}
