...
locals {
  number            = "240119021734530658"
  location          = "West Europe"
  domain_name_label = "acctestvm-3qt3r"
  random_string     = "3qt3r"
  admin_username    = "testadmin240119021734530658"
  admin_password    = "Password1234!240119021734530658"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240119021734530658"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240119021734530658"
  ...
  identifier {
    publisher = "AccTesPublisher240119021734530658"
    offer     = "AccTesOffer240119021734530658"
    sku       = "AccTesSku240119021734530658"
  }
}
