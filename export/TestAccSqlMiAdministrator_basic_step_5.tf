...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG1-sql-220429075957451967"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet1-220429075957451967"
...
resource "azurerm_subnet" "test" {
  name                 = "subnet1-220429075957451967"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_network_security_group" "test" {
  name                = "mi-security-group1-220429075957451967"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
}
...
resource "azurerm_route_table" "test" {
  name                          = "routetable1-220429075957451967"
  location                      = azurerm_resource_group.test.location
  resource_group_name           = azurerm_resource_group.test.name
...
resource "azurerm_sql_managed_instance" "test" {
  name                         = "acctestsqlserver220429075957451967"
  resource_group_name          = azurerm_resource_group.test.name
  location                     = azurerm_resource_group.test.location
