...
locals {
  number            = "230519074408704475"
  location          = "West Europe"
  domain_name_label = "acctestvm-m3rqr"
  random_string     = "m3rqr"
  admin_username    = "testadmin230519074408704475"
  admin_password    = "Password1234!230519074408704475"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230519074408704475"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230519074408704475"
  ...
  identifier {
    publisher = "AccTesPublisher230519074408704475"
    offer     = "AccTesOffer230519074408704475"
    sku       = "AccTesSku230519074408704475"
  }
}
