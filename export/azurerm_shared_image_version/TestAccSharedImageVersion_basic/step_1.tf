...
locals {
  number            = "230630032848837971"
  location          = "West Europe"
  domain_name_label = "acctestvm-m6ss4"
  random_string     = "m6ss4"
  admin_username    = "testadmin230630032848837971"
  admin_password    = "Password1234!230630032848837971"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230630032848837971"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230630032848837971"
  ...
  identifier {
    publisher = "AccTesPublisher230630032848837971"
    offer     = "AccTesOffer230630032848837971"
    sku       = "AccTesSku230630032848837971"
  }
}
