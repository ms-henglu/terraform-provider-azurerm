...
locals {
  number            = "231020040746124858"
  location          = "West Europe"
  domain_name_label = "acctestvm-ius4h"
  random_string     = "ius4h"
  admin_username    = "testadmin231020040746124858"
  admin_password    = "Password1234!231020040746124858"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-231020040746124858"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
