...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-7bjne"
  policy_type  = "Custom"
  display_name = "testPolicySet-7bjne"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-7bjne"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-7bjne"
