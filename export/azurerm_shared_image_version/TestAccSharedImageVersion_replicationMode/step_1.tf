...
locals {
  number            = "221028171853899598"
  location          = "West Europe"
  domain_name_label = "acctestvm-f6hiw"
  random_string     = "f6hiw"
  admin_username    = "testadmin221028171853899598"
  admin_password    = "Password1234!221028171853899598"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221028171853899598"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221028171853899598"
  ...
  identifier {
    publisher = "AccTesPublisher221028171853899598"
    offer     = "AccTesOffer221028171853899598"
    sku       = "AccTesSku221028171853899598"
  }
}
