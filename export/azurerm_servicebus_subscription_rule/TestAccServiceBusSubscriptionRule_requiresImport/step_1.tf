...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-221111021155600978"
  location = "West Europe"
}

resource "azurerm_servicebus_namespace" "test" {
  name                = "acctestservicebusnamespace-221111021155600978"
...
resource "azurerm_servicebus_topic" "test" {
  name         = "acctestservicebustopic-221111021155600978"
  namespace_id = azurerm_servicebus_namespace.test.id
}

resource "azurerm_servicebus_subscription" "test" {
  name               = "acctestservicebussubscription-221111021155600978"
...
resource "azurerm_servicebus_subscription_rule" "test" {
  name            = "acctestservicebusrule-221111021155600978"
