...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG1-sql-220726015058426419"
  location = "West US 2"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet1-220726015058426419"
...
resource "azurerm_subnet" "test" {
  name                 = "subnet1-220726015058426419"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_network_security_group" "test" {
  name                = "mi-security-group1-220726015058426419"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
}
...
resource "azurerm_route_table" "test" {
  name                          = "routetable1-220726015058426419"
  location                      = azurerm_resource_group.test.location
  resource_group_name           = azurerm_resource_group.test.name
...
resource "azurerm_mssql_managed_instance" "test" {
  name                = "acctestsqlserver220726015058426419"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
