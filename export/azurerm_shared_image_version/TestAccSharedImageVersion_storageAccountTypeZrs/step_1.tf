...
locals {
  number            = "240311031615610922"
  location          = "West Europe"
  domain_name_label = "acctestvm-hgfc0"
  random_string     = "hgfc0"
  admin_username    = "testadmin240311031615610922"
  admin_password    = "Password1234!240311031615610922"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240311031615610922"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240311031615610922"
  ...
  identifier {
    publisher = "AccTesPublisher240311031615610922"
    offer     = "AccTesOffer240311031615610922"
    sku       = "AccTesSku240311031615610922"
  }
}
