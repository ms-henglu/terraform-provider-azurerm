...
locals {
  number            = "230721011329119889"
  location          = "West Europe"
  domain_name_label = "acctestvm-gm0wr"
  random_string     = "gm0wr"
  admin_username    = "testadmin230721011329119889"
  admin_password    = "Password1234!230721011329119889"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230721011329119889"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230721011329119889"
  ...
  identifier {
    publisher = "AccTesPublisher230721011329119889"
    offer     = "AccTesOffer230721011329119889"
    sku       = "AccTesSku230721011329119889"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230721011329119889"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
