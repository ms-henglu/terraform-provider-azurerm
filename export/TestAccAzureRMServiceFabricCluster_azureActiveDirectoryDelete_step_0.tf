...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220407231444579999"
...
resource "azuread_application" "cluster_explorer" {
  ...
  identifier_uris = ["https://test-yea06.${data.azuread_domains.test.domains[0].domain_name}:19080/Explorer/index.html"]
  web {
...
resource "azurerm_service_fabric_cluster" "test" {
  name                = "acctest-220407231444579999"
