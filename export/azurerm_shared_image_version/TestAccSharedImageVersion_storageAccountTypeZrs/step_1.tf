...
locals {
  number            = "221111020149336418"
  location          = "West Europe"
  domain_name_label = "acctestvm-mxhss"
  random_string     = "mxhss"
  admin_username    = "testadmin221111020149336418"
  admin_password    = "Password1234!221111020149336418"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221111020149336418"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221111020149336418"
  ...
  identifier {
    publisher = "AccTesPublisher221111020149336418"
    offer     = "AccTesOffer221111020149336418"
    sku       = "AccTesSku221111020149336418"
  }
}
