...
locals {
  number            = "230526084758993769"
  location          = "West Europe"
  domain_name_label = "acctestvm-bkyzi"
  random_string     = "bkyzi"
  admin_username    = "testadmin230526084758993769"
  admin_password    = "Password1234!230526084758993769"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230526084758993769"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230526084758993769"
  ...
  identifier {
    publisher = "AccTesPublisher230526084758993769"
    offer     = "AccTesOffer230526084758993769"
    sku       = "AccTesSku230526084758993769"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230526084758993769"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
