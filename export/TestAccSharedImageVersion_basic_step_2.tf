...
locals {
  number            = "210825040616683790"
  location          = "West Europe"
  domain_name_label = "acctestvm-hszdo"
  random_string     = "hszdo"
  admin_username    = "testadmin210825040616683790"
  admin_password    = "Password1234!210825040616683790"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825040616683790"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825040616683790"
  ...
  identifier {
    publisher = "AccTesPublisher210825040616683790"
    offer     = "AccTesOffer210825040616683790"
    sku       = "AccTesSku210825040616683790"
  }
}
