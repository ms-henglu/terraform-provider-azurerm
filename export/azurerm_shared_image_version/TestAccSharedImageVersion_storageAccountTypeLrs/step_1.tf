...
locals {
  number            = "221222034403196431"
  location          = "West Europe"
  domain_name_label = "acctestvm-diguo"
  random_string     = "diguo"
  admin_username    = "testadmin221222034403196431"
  admin_password    = "Password1234!221222034403196431"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221222034403196431"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221222034403196431"
  ...
  identifier {
    publisher = "AccTesPublisher221222034403196431"
    offer     = "AccTesOffer221222034403196431"
    sku       = "AccTesSku221222034403196431"
  }
}
