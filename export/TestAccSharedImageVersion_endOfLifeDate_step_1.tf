...
locals {
  number            = "220905045548222773"
  location          = "West Europe"
  domain_name_label = "acctestvm-04mue"
  random_string     = "04mue"
  admin_username    = "testadmin220905045548222773"
  admin_password    = "Password1234!220905045548222773"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220905045548222773"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220905045548222773"
  ...
  identifier {
    publisher = "AccTesPublisher220905045548222773"
    offer     = "AccTesOffer220905045548222773"
    sku       = "AccTesSku220905045548222773"
  }
}
