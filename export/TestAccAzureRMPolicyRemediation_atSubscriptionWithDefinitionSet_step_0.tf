...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-n0wy7"
  policy_type  = "Custom"
  display_name = "testPolicySet-n0wy7"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-n0wy7"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-n0wy7"
