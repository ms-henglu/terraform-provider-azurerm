...
locals {
  number            = "230316221218741063"
  location          = "West Europe"
  domain_name_label = "acctestvm-tjc7s"
  random_string     = "tjc7s"
  admin_username    = "testadmin230316221218741063"
  admin_password    = "Password1234!230316221218741063"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230316221218741063"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230316221218741063"
  ...
  identifier {
    publisher = "AccTesPublisher230316221218741063"
    offer     = "AccTesOffer230316221218741063"
    sku       = "AccTesSku230316221218741063"
  }
}
