...
locals {
  number            = "220121044320002705"
  location          = "West Europe"
  domain_name_label = "acctestvm-cebhw"
  random_string     = "cebhw"
  admin_username    = "testadmin220121044320002705"
  admin_password    = "Password1234!220121044320002705"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220121044320002705"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220121044320002705"
  ...
  identifier {
    publisher = "AccTesPublisher220121044320002705"
    offer     = "AccTesOffer220121044320002705"
    sku       = "AccTesSku220121044320002705"
  }
}
