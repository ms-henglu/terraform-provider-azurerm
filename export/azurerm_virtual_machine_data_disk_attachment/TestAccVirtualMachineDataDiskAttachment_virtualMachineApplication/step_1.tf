...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-240315122550012123"
  location = "West Europe"
}

resource "azurerm_shared_image_gallery" "test" {
  name                = "ACCTESTGAL240315122550012123"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_gallery_application" "test" {
  name              = "acc-app240315122550012123"
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-240315122550012123"
...
resource "azurerm_public_ip" "test" {
  name                = "acctestpip240315122550012123"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_network_interface" "test" {
  name                = "acctestni240315122550012123"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "test" {
  name                  = "acctestvm240315122550012123"
  location              = azurerm_resource_group.test.location
  resource_group_name   = azurerm_resource_group.test.name
...
resource "azurerm_managed_disk" "test" {
  name                 = "acctest240315122550012123"
  location             = azurerm_resource_group.test.location
  resource_group_name  = azurerm_resource_group.test.name
  storage_account_type = "Standard_LRS"
  create_option        = "Empty"
