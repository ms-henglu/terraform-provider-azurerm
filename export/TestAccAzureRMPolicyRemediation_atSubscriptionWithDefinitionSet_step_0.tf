...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-gs14x"
  policy_type  = "Custom"
  display_name = "testPolicySet-gs14x"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-gs14x"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-gs14x"
