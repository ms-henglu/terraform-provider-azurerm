...
locals {
  number            = "221028164721121077"
  location          = "West Europe"
  domain_name_label = "acctestvm-ispxk"
  random_string     = "ispxk"
  admin_username    = "testadmin221028164721121077"
  admin_password    = "Password1234!221028164721121077"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221028164721121077"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221028164721121077"
  ...
  identifier {
    publisher = "AccTesPublisher221028164721121077"
    offer     = "AccTesOffer221028164721121077"
    sku       = "AccTesSku221028164721121077"
  }
}
