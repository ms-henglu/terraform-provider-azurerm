...
locals {
  number            = "220916011219831888"
  location          = "West Europe"
  domain_name_label = "acctestvm-wzi1r"
  random_string     = "wzi1r"
  admin_username    = "testadmin220916011219831888"
  admin_password    = "Password1234!220916011219831888"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220916011219831888"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220916011219831888"
  ...
  identifier {
    publisher = "AccTesPublisher220916011219831888"
    offer     = "AccTesOffer220916011219831888"
    sku       = "AccTesSku220916011219831888"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220916011219831888"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
