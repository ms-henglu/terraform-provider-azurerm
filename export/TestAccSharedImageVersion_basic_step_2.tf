...
locals {
  number            = "220211043347735747"
  location          = "West Europe"
  domain_name_label = "acctestvm-olhb2"
  random_string     = "olhb2"
  admin_username    = "testadmin220211043347735747"
  admin_password    = "Password1234!220211043347735747"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220211043347735747"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220211043347735747"
  ...
  identifier {
    publisher = "AccTesPublisher220211043347735747"
    offer     = "AccTesOffer220211043347735747"
    sku       = "AccTesSku220211043347735747"
  }
}
