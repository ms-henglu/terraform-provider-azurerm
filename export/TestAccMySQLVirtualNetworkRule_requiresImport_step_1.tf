...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220429075720935216"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvnet220429075720935216"
...
resource "azurerm_subnet" "test" {
  name                 = "acctestsubnet220429075720935216"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_mysql_server" "test" {
  name                         = "acctestmysqlsvr-220429075720935216"
  location                     = azurerm_resource_group.test.location
  resource_group_name          = azurerm_resource_group.test.name
...
resource "azurerm_mysql_virtual_network_rule" "test" {
  name                = "acctestmysqlvnetrule220429075720935216"
  resource_group_name = azurerm_resource_group.test.name
