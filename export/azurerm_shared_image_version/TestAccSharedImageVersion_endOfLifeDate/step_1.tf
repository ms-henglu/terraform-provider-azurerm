...
locals {
  number            = "240315122550007988"
  location          = "West Europe"
  domain_name_label = "acctestvm-irboj"
  random_string     = "irboj"
  admin_username    = "testadmin240315122550007988"
  admin_password    = "Password1234!240315122550007988"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240315122550007988"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240315122550007988"
  ...
  identifier {
    publisher = "AccTesPublisher240315122550007988"
    offer     = "AccTesOffer240315122550007988"
    sku       = "AccTesSku240315122550007988"
  }
}
