...
locals {
  number            = "240119021734435138"
  location          = "West Europe"
  domain_name_label = "acctestvm-973ja"
  random_string     = "973ja"
  admin_username    = "testadmin240119021734435138"
  admin_password    = "Password1234!240119021734435138"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-240119021734435138"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
