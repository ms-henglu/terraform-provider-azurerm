...
locals {
  number            = "230227032410657207"
  location          = "West Europe"
  domain_name_label = "acctestvm-em7au"
  random_string     = "em7au"
  admin_username    = "testadmin230227032410657207"
  admin_password    = "Password1234!230227032410657207"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230227032410657207"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230227032410657207"
  ...
  identifier {
    publisher = "AccTesPublisher230227032410657207"
    offer     = "AccTesOffer230227032410657207"
    sku       = "AccTesSku230227032410657207"
  }
}
