...
locals {
  number            = "220627134335459756"
  location          = "West Europe"
  domain_name_label = "acctestvm-riyg7"
  random_string     = "riyg7"
  admin_username    = "testadmin220627134335459756"
  admin_password    = "Password1234!220627134335459756"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627134335459756"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627134335459756"
  ...
  identifier {
    publisher = "AccTesPublisher220627134335459756"
    offer     = "AccTesOffer220627134335459756"
    sku       = "AccTesSku220627134335459756"
  }
}
