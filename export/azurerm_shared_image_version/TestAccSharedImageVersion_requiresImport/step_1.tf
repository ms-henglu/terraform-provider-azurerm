...
locals {
  number            = "240315122550002060"
  location          = "West Europe"
  domain_name_label = "acctestvm-saczc"
  random_string     = "saczc"
  admin_username    = "testadmin240315122550002060"
  admin_password    = "Password1234!240315122550002060"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240315122550002060"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240315122550002060"
  ...
  identifier {
    publisher = "AccTesPublisher240315122550002060"
    offer     = "AccTesOffer240315122550002060"
    sku       = "AccTesSku240315122550002060"
  }
}
