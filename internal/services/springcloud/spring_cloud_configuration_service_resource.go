...
func resourceSpringCloudConfigurationServiceRead(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	if props := resp.Properties; props != nil {
		if props.Settings != nil && props.Settings.GitProperty != nil {
			d.Set("repositories", flattenConfigurationServiceConfigurationServiceGitRepositoryArray(props.Settings.GitProperty.Repositories))
		}
	}
	return nil
}
...
func flattenConfigurationServiceConfigurationServiceGitRepositoryArray(input *[]appplatform.ConfigurationServiceGitRepository) []interface{} {
	...
	for _, item := range *input {
		...
		if item.HostKeyAlgorithm != nil {
			hostKeyAlgorithm = *item.HostKeyAlgorithm
		}
		var password string
