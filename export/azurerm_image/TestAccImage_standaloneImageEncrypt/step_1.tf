...
locals {
  number            = "230922060812794753"
  location          = "West Europe"
  domain_name_label = "acctestvm-7d9h3"
  random_string     = "7d9h3"
  admin_username    = "testadmin230922060812794753"
  admin_password    = "Password1234!230922060812794753"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230922060812794753"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
