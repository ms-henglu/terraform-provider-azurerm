...
locals {
  number            = "220923011626951806"
  location          = "West Europe"
  domain_name_label = "acctestvm-cpt8q"
  random_string     = "cpt8q"
  admin_username    = "testadmin220923011626951806"
  admin_password    = "Password1234!220923011626951806"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220923011626951806"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220923011626951806"
  ...
  identifier {
    publisher = "AccTesPublisher220923011626951806"
    offer     = "AccTesOffer220923011626951806"
    sku       = "AccTesSku220923011626951806"
  }
}
