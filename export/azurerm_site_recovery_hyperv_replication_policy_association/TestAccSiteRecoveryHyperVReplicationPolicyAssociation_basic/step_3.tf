...
locals {
  rg_name              = "acctest-nested-rg-240112035029902513"
  location             = "West Europe"
  vn_name              = "acctest-nested-vn-240112035029902513"
  ip_name              = "acctest-nested-ip-240112035029902513"
  vm_name              = "acctest-nested-vm-240112035029902513"
  nic_name             = "acctest-nested-nic-240112035029902513"
  disk_name            = "acctest-nested-disk-240112035029902513"
  keyvault_name        = "acctkv240112035029902513"
  nsg_name             = "acctest-nested-nsg-240112035029902513"
  recovery_vault_name  = "acctest-nested-recovery-vault-240112035029902513"
  recovery_site_name   = "acctest-nested-recovery-site-240112035029902513"
  admin_name           = "acctestadmin"
  cert_name            = "acctestcert"
  storage_account_name = "acctestsavlrg9"
}
...
resource "azurerm_windows_virtual_machine" "host" {
  ...
  additional_unattend_content {
    setting = "AutoLogon"
    content = "<AutoLogon><Password><Value>@R6(00f1^o</Value></Password><Enabled>true</Enabled><LogonCount>1</LogonCount><Username>${local.admin_name}</Username></AutoLogon>"
  }
...
resource "azurerm_site_recovery_hyperv_replication_policy" "test" {
  recovery_vault_id                                  = azurerm_recovery_services_vault.test.id
  name                                               = "acctest-policy-240112035029902513"
