...
locals {
  number            = "220630223513059831"
  location          = "West Europe"
  domain_name_label = "acctestvm-o7vgh"
  random_string     = "o7vgh"
  admin_username    = "testadmin220630223513059831"
  admin_password    = "Password1234!220630223513059831"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220630223513059831"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220630223513059831"
  ...
  identifier {
    publisher = "AccTesPublisher220630223513059831"
    offer     = "AccTesOffer220630223513059831"
    sku       = "AccTesSku220630223513059831"
  }
}
