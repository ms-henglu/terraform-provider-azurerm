...
locals {
  number            = "230313020903886054"
  location          = "West Europe"
  domain_name_label = "acctestvm-r9628"
  random_string     = "r9628"
  admin_username    = "testadmin230313020903886054"
  admin_password    = "Password1234!230313020903886054"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230313020903886054"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230313020903886054"
  ...
  identifier {
    publisher = "AccTesPublisher230313020903886054"
    offer     = "AccTesOffer230313020903886054"
    sku       = "AccTesSku230313020903886054"
  }
}
