...
locals {
  number            = "230127045135677403"
  location          = "West Europe"
  domain_name_label = "acctestvm-8hfum"
  random_string     = "8hfum"
  admin_username    = "testadmin230127045135677403"
  admin_password    = "Password1234!230127045135677403"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230127045135677403"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230127045135677403"
  ...
  identifier {
    publisher = "AccTesPublisher230127045135677403"
    offer     = "AccTesOffer230127045135677403"
    sku       = "AccTesSku230127045135677403"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230127045135677403"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
