...
locals {
  number            = "230316221218743081"
  location          = "West Europe"
  domain_name_label = "acctestvm-p46st"
  random_string     = "p46st"
  admin_username    = "testadmin230316221218743081"
  admin_password    = "Password1234!230316221218743081"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230316221218743081"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230316221218743081"
  ...
  identifier {
    publisher = "AccTesPublisher230316221218743081"
    offer     = "AccTesOffer230316221218743081"
    sku       = "AccTesSku230316221218743081"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230316221218743081"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
