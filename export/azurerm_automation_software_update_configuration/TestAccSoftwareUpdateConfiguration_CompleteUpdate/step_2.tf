...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-230707003404741118"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctest-230707003404741118"
...
resource "azurerm_log_analytics_workspace" "test" {
  name                = "acctestLAW-230707003404741118"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "PerGB2018"
...
resource "azurerm_automation_software_update_configuration" "test" {
  ...
  name                  = "acctest-suc-230707003404741118"
  ...
  schedule {
    ...
    start_time         = "2023-07-07T01:34:00Z"
    expiry_time        = "2023-07-07T02:34:00Z"
    is_enabled         = true
    interval           = 2
    frequency          = "Hour"
    time_zone          = "Etc/UTC"
