...
resource "azurerm_policy_definition" "test" {
  name         = "acctestpol-220124122600116821"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestpol-220124122600116821"
...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220124122600116821"
  location = "West Europe"
}

resource "azurerm_log_analytics_workspace" "test" {
  name                = "acctestLAW-220124122600116821"
...
resource "azurerm_policy_assignment" "test" {
  name                 = "acctestpa-220124122600116821"
  scope                = azurerm_resource_group.test.id
  policy_definition_id = azurerm_policy_definition.test.id
  description          = "Policy Assignment created via an Acceptance Test"
  display_name         = "Acceptance Test Run 220124122600116821"
...
resource "azurerm_resource_group_template_deployment" "test" {
  name                = "acctestrgtd-220124122600116821"
  resource_group_name = azurerm_resource_group.test.name
...
{
  "description": {
   "value": "description-220124122600116821"
  },
  "displayName": {
    "value": "name--220124122600116821"
  },
  "exemptionCategory": {
    "value": "Waiver"
  },
