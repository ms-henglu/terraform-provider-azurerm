...
locals {
  number            = "220429065303871212"
  location          = "West Europe"
  domain_name_label = "acctestvm-nsogx"
  random_string     = "nsogx"
  admin_username    = "testadmin220429065303871212"
  admin_password    = "Password1234!220429065303871212"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220429065303871212"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220429065303871212"
  ...
  identifier {
    publisher = "AccTesPublisher220429065303871212"
    offer     = "AccTesOffer220429065303871212"
    sku       = "AccTesSku220429065303871212"
  }
}
