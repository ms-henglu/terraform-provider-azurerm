...
locals {
  number            = "220916011219834399"
  location          = "West Europe"
  domain_name_label = "acctestvm-bjcil"
  random_string     = "bjcil"
  admin_username    = "testadmin220916011219834399"
  admin_password    = "Password1234!220916011219834399"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220916011219834399"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220916011219834399"
  ...
  identifier {
    publisher = "AccTesPublisher220916011219834399"
    offer     = "AccTesOffer220916011219834399"
    sku       = "AccTesSku220916011219834399"
  }
}
