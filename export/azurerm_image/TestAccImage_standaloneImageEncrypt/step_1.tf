...
locals {
  number            = "230804025626147701"
  location          = "West Europe"
  domain_name_label = "acctestvm-s8nys"
  random_string     = "s8nys"
  admin_username    = "testadmin230804025626147701"
  admin_password    = "Password1234!230804025626147701"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230804025626147701"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
