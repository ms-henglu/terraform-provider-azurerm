...
locals {
  number            = "220812014802175940"
  location          = "West Europe"
  domain_name_label = "acctestvm-smhom"
  random_string     = "smhom"
  admin_username    = "testadmin220812014802175940"
  admin_password    = "Password1234!220812014802175940"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220812014802175940"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220812014802175940"
  ...
  identifier {
    publisher = "AccTesPublisher220812014802175940"
    offer     = "AccTesOffer220812014802175940"
    sku       = "AccTesSku220812014802175940"
  }
}
