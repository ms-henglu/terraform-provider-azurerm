...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-wps6y"
  policy_type  = "Custom"
  display_name = "testPolicySet-wps6y"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-wps6y"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-wps6y"
