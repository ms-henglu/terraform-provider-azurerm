...
locals {
  number            = "221202035328136114"
  location          = "West Europe"
  domain_name_label = "acctestvm-1cwq4"
  random_string     = "1cwq4"
  admin_username    = "testadmin221202035328136114"
  admin_password    = "Password1234!221202035328136114"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221202035328136114"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221202035328136114"
  ...
  identifier {
    publisher = "AccTesPublisher221202035328136114"
    offer     = "AccTesOffer221202035328136114"
    sku       = "AccTesSku221202035328136114"
  }
}
