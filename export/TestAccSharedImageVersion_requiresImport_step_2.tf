...
locals {
  number            = "220603021818524521"
  location          = "West Europe"
  domain_name_label = "acctestvm-p8stv"
  random_string     = "p8stv"
  admin_username    = "testadmin220603021818524521"
  admin_password    = "Password1234!220603021818524521"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220603021818524521"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220603021818524521"
  ...
  identifier {
    publisher = "AccTesPublisher220603021818524521"
    offer     = "AccTesOffer220603021818524521"
    sku       = "AccTesSku220603021818524521"
  }
}
