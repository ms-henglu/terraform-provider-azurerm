...
locals {
  number            = "210825044610906615"
  location          = "West Europe"
  domain_name_label = "acctestvm-c7vut"
  random_string     = "c7vut"
  admin_username    = "testadmin210825044610906615"
  admin_password    = "Password1234!210825044610906615"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825044610906615"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825044610906615"
  ...
  identifier {
    publisher = "AccTesPublisher210825044610906615"
    offer     = "AccTesOffer210825044610906615"
    sku       = "AccTesSku210825044610906615"
  }
}
