...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-backup-220729033153633931"
...
resource "azurerm_public_ip" "test" {
  ...
  domain_name_label   = "acctestip220729033153633931"
}
...
resource "azurerm_recovery_services_vault" "test" {
  name                = "acctest-220729033153633931"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Standard"
...
resource "azurerm_resource_group" "test2" {
  name     = "acctestRG-backup-220729033153633931-2"
  location = "West Europe"
}

resource "azurerm_recovery_services_vault" "test2" {
  name                = "acctest2-220729033153633931"
