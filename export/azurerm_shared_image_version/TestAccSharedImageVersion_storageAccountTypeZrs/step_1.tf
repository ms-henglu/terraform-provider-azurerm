...
locals {
  number            = "230728031950550621"
  location          = "West Europe"
  domain_name_label = "acctestvm-pu73b"
  random_string     = "pu73b"
  admin_username    = "testadmin230728031950550621"
  admin_password    = "Password1234!230728031950550621"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230728031950550621"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230728031950550621"
  ...
  identifier {
    publisher = "AccTesPublisher230728031950550621"
    offer     = "AccTesOffer230728031950550621"
    sku       = "AccTesSku230728031950550621"
  }
}
