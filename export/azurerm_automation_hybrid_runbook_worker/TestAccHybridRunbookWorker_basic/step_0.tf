...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-230721014531818158"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctestAA-230721014531818158"
...
resource "azurerm_automation_credential" "test" {
  name                    = "acctest-230721014531818158"
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestnw-230721014531818158"
...
resource "azurerm_network_interface" "test" {
  name                = "acctni-230721014531818158"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "test" {
  name                = "acctestVM-230721014531818158"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_automation_hybrid_runbook_worker" "test" {
  ...
  worker_id               = "9c4238e4-fc0e-4d35-a1f1-1c73cc7489c3"
