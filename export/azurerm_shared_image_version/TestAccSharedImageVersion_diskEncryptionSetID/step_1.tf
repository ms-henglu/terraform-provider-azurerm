...
locals {
  number            = "230804025626266126"
  location          = "West Europe"
  domain_name_label = "acctestvm-bq7fm"
  random_string     = "bq7fm"
  admin_username    = "testadmin230804025626266126"
  admin_password    = "Password1234!230804025626266126"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230804025626266126"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230804025626266126"
  ...
  identifier {
    publisher = "AccTesPublisher230804025626266126"
    offer     = "AccTesOffer230804025626266126"
    sku       = "AccTesSku230804025626266126"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230804025626266126"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
