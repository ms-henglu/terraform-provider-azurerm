...
locals {
  number            = "220311032223311566"
  location          = "West Europe"
  domain_name_label = "acctestvm-xfmui"
  random_string     = "xfmui"
  admin_username    = "testadmin220311032223311566"
  admin_password    = "Password1234!220311032223311566"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220311032223311566"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220311032223311566"
  ...
  identifier {
    publisher = "AccTesPublisher220311032223311566"
    offer     = "AccTesOffer220311032223311566"
    sku       = "AccTesSku220311032223311566"
  }
}
