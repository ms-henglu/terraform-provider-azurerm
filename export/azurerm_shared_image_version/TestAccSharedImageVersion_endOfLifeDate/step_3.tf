...
locals {
  number            = "231013043133450791"
  location          = "West Europe"
  domain_name_label = "acctestvm-yzmlj"
  random_string     = "yzmlj"
  admin_username    = "testadmin231013043133450791"
  admin_password    = "Password1234!231013043133450791"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231013043133450791"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231013043133450791"
  ...
  identifier {
    publisher = "AccTesPublisher231013043133450791"
    offer     = "AccTesOffer231013043133450791"
    sku       = "AccTesSku231013043133450791"
  }
}
