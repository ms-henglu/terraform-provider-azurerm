...
locals {
  number            = "220909034011276851"
  location          = "West Europe"
  domain_name_label = "acctestvm-ul2u0"
  random_string     = "ul2u0"
  admin_username    = "testadmin220909034011276851"
  admin_password    = "Password1234!220909034011276851"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220909034011276851"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220909034011276851"
  ...
  identifier {
    publisher = "AccTesPublisher220909034011276851"
    offer     = "AccTesOffer220909034011276851"
    sku       = "AccTesSku220909034011276851"
  }
}
