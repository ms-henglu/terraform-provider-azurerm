...
locals {
  number            = "211013071641597579"
  location          = "West Europe"
  domain_name_label = "acctestvm-h4aaq"
  random_string     = "h4aaq"
  admin_username    = "testadmin211013071641597579"
  admin_password    = "Password1234!211013071641597579"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211013071641597579"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211013071641597579"
  ...
  identifier {
    publisher = "AccTesPublisher211013071641597579"
    offer     = "AccTesOffer211013071641597579"
    sku       = "AccTesSku211013071641597579"
  }
}
