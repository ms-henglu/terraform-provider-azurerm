...
locals {
  number            = "210825025624753933"
  location          = "West Europe"
  domain_name_label = "acctestvm-yez04"
  random_string     = "yez04"
  admin_username    = "testadmin210825025624753933"
  admin_password    = "Password1234!210825025624753933"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825025624753933"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825025624753933"
  ...
  identifier {
    publisher = "AccTesPublisher210825025624753933"
    offer     = "AccTesOffer210825025624753933"
    sku       = "AccTesSku210825025624753933"
  }
}
