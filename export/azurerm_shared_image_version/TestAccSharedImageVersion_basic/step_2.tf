...
locals {
  number            = "221019060412964108"
  location          = "West Europe"
  domain_name_label = "acctestvm-p0ibt"
  random_string     = "p0ibt"
  admin_username    = "testadmin221019060412964108"
  admin_password    = "Password1234!221019060412964108"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221019060412964108"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221019060412964108"
  ...
  identifier {
    publisher = "AccTesPublisher221019060412964108"
    offer     = "AccTesOffer221019060412964108"
    sku       = "AccTesSku221019060412964108"
  }
}
