...
resource "azurerm_resource_group" "test" {
  name     = "acctest-kusto-230227032849"
  location = "West Europe"
}

resource "azurerm_kusto_cluster" "test" {
  name                = "acctestkc230227032849"
...
resource "azurerm_kusto_database" "test2" {
  name                = "acctest-kd-2-230227032856604049"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  cluster_name        = azurerm_kusto_cluster.test.name
}
...
resource "azurerm_kusto_database" "test3" {
  name                = "acctest-kd-3-230227032856604049"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  cluster_name        = azurerm_kusto_cluster.test.name
}
...
resource "azurerm_kusto_database" "test4" {
  name                = "acctest-kd-4-230227032856604049"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  cluster_name        = azurerm_kusto_cluster.test.name
}
...
resource "azurerm_kusto_script" "test" {
  name        = "acctest-ks-230227032856604049"
...
resource "azurerm_kusto_script" "test2" {
  name        = "acctest-ks-2-230227032856604049"
...
resource "azurerm_kusto_script" "test3" {
  name        = "acctest-ks-3-230227032856604049"
...
resource "azurerm_kusto_script" "test4" {
  name        = "acctest-ks-4-230227032856604049"
