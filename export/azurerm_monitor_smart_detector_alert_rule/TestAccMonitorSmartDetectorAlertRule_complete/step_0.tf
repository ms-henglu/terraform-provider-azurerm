...
resource "azurerm_resource_group" "test" {
  name     = "acctestrg-monitor-240112034757528857"
  location = "West Europe"
}

resource "azurerm_application_insights" "test" {
  name                = "acctestappinsights-240112034757528857"
...
resource "azurerm_monitor_action_group" "test" {
  name                = "acctestActionGroup-240112034757528857"
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_monitor_smart_detector_alert_rule" "test" {
  name                = "acctestSDAR-240112034757528857"
  resource_group_name = azurerm_resource_group.test.name
  severity            = "Sev0"
