...
locals {
  number            = "220429065303877904"
  location          = "West Europe"
  domain_name_label = "acctestvm-02cwu"
  random_string     = "02cwu"
  admin_username    = "testadmin220429065303877904"
  admin_password    = "Password1234!220429065303877904"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220429065303877904"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220429065303877904"
  ...
  identifier {
    publisher = "AccTesPublisher220429065303877904"
    offer     = "AccTesOffer220429065303877904"
    sku       = "AccTesSku220429065303877904"
  }
}
