...
locals {
  number            = "230810143140292967"
  location          = "West Europe"
  domain_name_label = "acctestvm-oqyqv"
  random_string     = "oqyqv"
  admin_username    = "testadmin230810143140292967"
  admin_password    = "Password1234!230810143140292967"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230810143140292967"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
