...
locals {
  number            = "231020040746251617"
  location          = "West Europe"
  domain_name_label = "acctestvm-y4d2v"
  random_string     = "y4d2v"
  admin_username    = "testadmin231020040746251617"
  admin_password    = "Password1234!231020040746251617"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231020040746251617"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231020040746251617"
  ...
  identifier {
    publisher = "AccTesPublisher231020040746251617"
    offer     = "AccTesOffer231020040746251617"
    sku       = "AccTesSku231020040746251617"
  }
}
