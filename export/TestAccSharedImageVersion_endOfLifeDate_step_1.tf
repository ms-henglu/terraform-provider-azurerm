...
locals {
  number            = "220712042046044926"
  location          = "West Europe"
  domain_name_label = "acctestvm-lvrwh"
  random_string     = "lvrwh"
  admin_username    = "testadmin220712042046044926"
  admin_password    = "Password1234!220712042046044926"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220712042046044926"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220712042046044926"
  ...
  identifier {
    publisher = "AccTesPublisher220712042046044926"
    offer     = "AccTesOffer220712042046044926"
    sku       = "AccTesSku220712042046044926"
  }
}
...
resource "azurerm_shared_image_version" "test" {
  ...
  end_of_life_date    = "2022-07-12T14:20:46Z"
