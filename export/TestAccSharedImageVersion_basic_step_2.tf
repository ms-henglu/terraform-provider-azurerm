...
locals {
  number            = "211001020609169715"
  location          = "West Europe"
  domain_name_label = "acctestvm-zj3lh"
  random_string     = "zj3lh"
  admin_username    = "testadmin211001020609169715"
  admin_password    = "Password1234!211001020609169715"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211001020609169715"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211001020609169715"
  ...
  identifier {
    publisher = "AccTesPublisher211001020609169715"
    offer     = "AccTesOffer211001020609169715"
    sku       = "AccTesSku211001020609169715"
  }
}
