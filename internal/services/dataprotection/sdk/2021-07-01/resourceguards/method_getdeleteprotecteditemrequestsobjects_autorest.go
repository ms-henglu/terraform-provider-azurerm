...
type GetDeleteProtectedItemRequestsObjectsResponse struct {
	HttpResponse *http.Response
	Model        *[]DppBaseResource

	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (GetDeleteProtectedItemRequestsObjectsResponse, error)
}
...
func (r GetDeleteProtectedItemRequestsObjectsResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r GetDeleteProtectedItemRequestsObjectsResponse) LoadMore(ctx context.Context) (resp GetDeleteProtectedItemRequestsObjectsResponse, err error) {
	if !r.HasMore() {
...
func (c ResourceGuardsClient) GetDeleteProtectedItemRequestsObjects(ctx context.Context, id ResourceGuardId) (resp GetDeleteProtectedItemRequestsObjectsResponse, err error) {
...
func (c ResourceGuardsClient) GetDeleteProtectedItemRequestsObjectsComplete(ctx context.Context, id ResourceGuardId) (GetDeleteProtectedItemRequestsObjectsCompleteResult, error) {
	return c.GetDeleteProtectedItemRequestsObjectsCompleteMatchingPredicate(ctx, id, DppBaseResourcePredicate{})
}
...
func (c ResourceGuardsClient) GetDeleteProtectedItemRequestsObjectsCompleteMatchingPredicate(ctx context.Context, id ResourceGuardId, predicate DppBaseResourcePredicate) (resp GetDeleteProtectedItemRequestsObjectsCompleteResult, err error) {
...
func (c ResourceGuardsClient) responderForGetDeleteProtectedItemRequestsObjects(resp *http.Response) (result GetDeleteProtectedItemRequestsObjectsResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result GetDeleteProtectedItemRequestsObjectsResponse, err error) {
