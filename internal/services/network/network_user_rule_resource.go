	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"rule_collection_id": {
				...
				Required:     true,
				ForceNew:     true,
				ValidateFunc: validate.NetworkUserRuleCollectionID,
			},
...
func resourceNetworkUserRuleCreateUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	ruleCollectionId, _ := parse.NetworkUserRuleCollectionID(d.Get("rule_collection_id").(string))

	id := parse.NewNetworkUserRuleID(subscriptionId, ruleCollectionId.ResourceGroup, ruleCollectionId.NetworkManagerName, ruleCollectionId.SecurityUserConfigurationName, ruleCollectionId.RuleCollectionName, name)

	if d.IsNewResource() {
		existing, err := client.Get(ctx, id.ResourceGroup, id.NetworkManagerName, id.SecurityUserConfigurationName, id.RuleCollectionName, id.RuleName)
		if err != nil {
	...
	if _, err := client.CreateOrUpdate(ctx, userRule, id.ResourceGroup, id.NetworkManagerName, id.SecurityUserConfigurationName, id.RuleCollectionName, id.RuleName); err != nil {
...
func resourceNetworkUserRuleRead(d *schema.ResourceData, meta interface{}) error {
	...
	resp, err := client.Get(ctx, id.ResourceGroup, id.NetworkManagerName, id.SecurityUserConfigurationName, id.RuleCollectionName, id.RuleName)
	if err != nil {
	...
	d.Set("rule_collection_id", parse.NewNetworkUserRuleCollectionID(id.SubscriptionId, id.ResourceGroup, id.NetworkManagerName, id.SecurityUserConfigurationName, id.RuleCollectionName).ID())
...
func resourceNetworkUserRuleDelete(d *schema.ResourceData, meta interface{}) error {
	...
	if _, err := client.Delete(ctx, id.ResourceGroup, id.NetworkManagerName, id.SecurityUserConfigurationName, id.RuleCollectionName, id.RuleName); err != nil {
