...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-230707010014083461"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctest-230707010014083461"
...
resource "azurerm_log_analytics_workspace" "test" {
  name                = "acctestLAW-230707010014083461"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "PerGB2018"
...
resource "azurerm_automation_software_update_configuration" "test" {
  ...
  name                  = "acctest-suc-230707010014083461"
  ...
  schedule {
    ...
    start_time         = "2023-07-07T02:00:00Z"
    expiry_time        = "2023-07-07T03:00:00Z"
    is_enabled         = true
    interval           = 2
    frequency          = "Hour"
    time_zone          = "Etc/UTC"
