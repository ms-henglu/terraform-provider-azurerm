...
locals {
  number            = "230721014716582956"
  location          = "West Europe"
  domain_name_label = "acctestvm-tf0y0"
  random_string     = "tf0y0"
  admin_username    = "testadmin230721014716582956"
  admin_password    = "Password1234!230721014716582956"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230721014716582956"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230721014716582956"
  ...
  identifier {
    publisher = "AccTesPublisher230721014716582956"
    offer     = "AccTesOffer230721014716582956"
    sku       = "AccTesSku230721014716582956"
  }
}
