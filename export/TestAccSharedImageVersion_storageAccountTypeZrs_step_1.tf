...
locals {
  number            = "220630210603393531"
  location          = "West Europe"
  domain_name_label = "acctestvm-wyzsz"
  random_string     = "wyzsz"
  admin_username    = "testadmin220630210603393531"
  admin_password    = "Password1234!220630210603393531"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220630210603393531"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220630210603393531"
  ...
  identifier {
    publisher = "AccTesPublisher220630210603393531"
    offer     = "AccTesOffer220630210603393531"
    sku       = "AccTesSku220630210603393531"
  }
}
