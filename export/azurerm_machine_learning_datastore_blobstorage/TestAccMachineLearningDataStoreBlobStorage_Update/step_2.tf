...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-ml-240119022340695051"
  location = "West Europe"
}

resource "azurerm_application_insights" "test" {
  name                = "acctestai-240119022340695051"
...
resource "azurerm_machine_learning_workspace" "test" {
  name                    = "acctest-MLW-240119022340695051"
  location                = azurerm_resource_group.test.location
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_storage_container" "test" {
  name                  = "acctestcontainer240119022340695051"
...
resource "azurerm_machine_learning_datastore_blobstorage" "test" {
  name                    = "accdatastore240119022340695051"
