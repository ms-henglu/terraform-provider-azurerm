...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-cvko3"
  policy_type  = "Custom"
  display_name = "testPolicySet-cvko3"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-cvko3"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-cvko3"
