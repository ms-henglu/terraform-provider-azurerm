...
locals {
  number            = "231218071435562528"
  location          = "West Europe"
  domain_name_label = "acctestvm-2irce"
  random_string     = "2irce"
  admin_username    = "testadmin231218071435562528"
  admin_password    = "Password1234!231218071435562528"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231218071435562528"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231218071435562528"
  ...
  identifier {
    publisher = "AccTesPublisher231218071435562528"
    offer     = "AccTesOffer231218071435562528"
    sku       = "AccTesSku231218071435562528"
  }
}
