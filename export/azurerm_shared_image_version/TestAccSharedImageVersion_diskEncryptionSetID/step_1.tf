...
locals {
  number            = "240112224137953615"
  location          = "West Europe"
  domain_name_label = "acctestvm-bv90d"
  random_string     = "bv90d"
  admin_username    = "testadmin240112224137953615"
  admin_password    = "Password1234!240112224137953615"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240112224137953615"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240112224137953615"
  ...
  identifier {
    publisher = "AccTesPublisher240112224137953615"
    offer     = "AccTesOffer240112224137953615"
    sku       = "AccTesSku240112224137953615"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-240112224137953615"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
