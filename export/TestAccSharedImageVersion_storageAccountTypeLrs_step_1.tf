...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211015014023157040"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211015014023157040"
  ...
  identifier {
    publisher = "AccTesPublisher211015014023157040"
    offer     = "AccTesOffer211015014023157040"
    sku       = "AccTesSku211015014023157040"
  }
}
