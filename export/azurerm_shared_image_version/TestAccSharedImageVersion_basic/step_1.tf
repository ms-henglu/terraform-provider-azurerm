...
locals {
  number            = "240105063504065856"
  location          = "West Europe"
  domain_name_label = "acctestvm-6xhoj"
  random_string     = "6xhoj"
  admin_username    = "testadmin240105063504065856"
  admin_password    = "Password1234!240105063504065856"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105063504065856"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105063504065856"
  ...
  identifier {
    publisher = "AccTesPublisher240105063504065856"
    offer     = "AccTesOffer240105063504065856"
    sku       = "AccTesSku240105063504065856"
  }
}
