...
locals {
  number            = "220124121851413347"
  location          = "West Europe"
  domain_name_label = "acctestvm-b1by7"
  random_string     = "b1by7"
  admin_username    = "testadmin220124121851413347"
  admin_password    = "Password1234!220124121851413347"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220124121851413347"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220124121851413347"
  ...
  identifier {
    publisher = "AccTesPublisher220124121851413347"
    offer     = "AccTesOffer220124121851413347"
    sku       = "AccTesSku220124121851413347"
  }
}
