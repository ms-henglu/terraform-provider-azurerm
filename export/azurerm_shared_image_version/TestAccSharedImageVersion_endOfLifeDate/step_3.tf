...
locals {
  number            = "221111020149340466"
  location          = "West Europe"
  domain_name_label = "acctestvm-rvh8x"
  random_string     = "rvh8x"
  admin_username    = "testadmin221111020149340466"
  admin_password    = "Password1234!221111020149340466"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221111020149340466"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221111020149340466"
  ...
  identifier {
    publisher = "AccTesPublisher221111020149340466"
    offer     = "AccTesOffer221111020149340466"
    sku       = "AccTesSku221111020149340466"
  }
}
