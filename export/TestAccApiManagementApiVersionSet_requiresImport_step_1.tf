...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-211022001628074494"
  location = "West Europe"
}

resource "azurerm_api_management" "test" {
  name                = "acctestAM-211022001628074494"
...
resource "azurerm_api_management_api_version_set" "test" {
  name                = "acctestAMAVS-211022001628074494"
  resource_group_name = azurerm_api_management.test.resource_group_name
  api_management_name = azurerm_api_management.test.name
  description         = "TestDescription1"
  display_name        = "TestApiVersionSet1211022001628074494"
