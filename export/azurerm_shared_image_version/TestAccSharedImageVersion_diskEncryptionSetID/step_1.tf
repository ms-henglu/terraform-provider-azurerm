...
locals {
  number            = "240105060444557162"
  location          = "West Europe"
  domain_name_label = "acctestvm-gnr48"
  random_string     = "gnr48"
  admin_username    = "testadmin240105060444557162"
  admin_password    = "Password1234!240105060444557162"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105060444557162"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105060444557162"
  ...
  identifier {
    publisher = "AccTesPublisher240105060444557162"
    offer     = "AccTesOffer240105060444557162"
    sku       = "AccTesSku240105060444557162"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-240105060444557162"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
