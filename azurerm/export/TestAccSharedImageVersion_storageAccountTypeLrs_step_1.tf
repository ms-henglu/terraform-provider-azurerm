...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627122505825514"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627122505825514"
  ...
  identifier {
    publisher = "AccTesPublisher220627122505825514"
    offer     = "AccTesOffer220627122505825514"
    sku       = "AccTesSku220627122505825514"
  }
}
