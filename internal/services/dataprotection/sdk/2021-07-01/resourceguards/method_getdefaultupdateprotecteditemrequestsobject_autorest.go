...
type GetDefaultUpdateProtectedItemRequestsObjectResponse struct {
	HttpResponse *http.Response
	Model        *DppBaseResource
}

// GetDefaultUpdateProtectedItemRequestsObject ...
func (c ResourceGuardsClient) GetDefaultUpdateProtectedItemRequestsObject(ctx context.Context, id UpdateProtectedItemRequestId) (result GetDefaultUpdateProtectedItemRequestsObjectResponse, err error) {
...
func (c ResourceGuardsClient) responderForGetDefaultUpdateProtectedItemRequestsObject(resp *http.Response) (result GetDefaultUpdateProtectedItemRequestsObjectResponse, err error) {
