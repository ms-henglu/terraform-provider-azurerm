...
locals {
  number            = "221021030948784971"
  location          = "West Europe"
  domain_name_label = "acctestvm-7qfcv"
  random_string     = "7qfcv"
  admin_username    = "testadmin221021030948784971"
  admin_password    = "Password1234!221021030948784971"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221021030948784971"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221021030948784971"
  ...
  identifier {
    publisher = "AccTesPublisher221021030948784971"
    offer     = "AccTesOffer221021030948784971"
    sku       = "AccTesSku221021030948784971"
  }
}
