...
locals {
  number            = "230922053821484991"
  location          = "West Europe"
  domain_name_label = "acctestvm-jsa8b"
  random_string     = "jsa8b"
  admin_username    = "testadmin230922053821484991"
  admin_password    = "Password1234!230922053821484991"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230922053821484991"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230922053821484991"
  ...
  identifier {
    publisher = "AccTesPublisher230922053821484991"
    offer     = "AccTesOffer230922053821484991"
    sku       = "AccTesSku230922053821484991"
  }
}
