...
locals {
  number            = "231218071435565165"
  location          = "West Europe"
  domain_name_label = "acctestvm-b9xyb"
  random_string     = "b9xyb"
  admin_username    = "testadmin231218071435565165"
  admin_password    = "Password1234!231218071435565165"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231218071435565165"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231218071435565165"
  ...
  identifier {
    publisher = "AccTesPublisher231218071435565165"
    offer     = "AccTesOffer231218071435565165"
    sku       = "AccTesSku231218071435565165"
  }
}
