...
locals {
  number            = "220408051032005724"
  location          = "West Europe"
  domain_name_label = "acctestvm-d739m"
  random_string     = "d739m"
  admin_username    = "testadmin220408051032005724"
  admin_password    = "Password1234!220408051032005724"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220408051032005724"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220408051032005724"
  ...
  identifier {
    publisher = "AccTesPublisher220408051032005724"
    offer     = "AccTesOffer220408051032005724"
    sku       = "AccTesSku220408051032005724"
  }
}
