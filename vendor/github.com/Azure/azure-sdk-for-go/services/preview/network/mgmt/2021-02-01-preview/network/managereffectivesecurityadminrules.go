...
func (client ManagerEffectiveSecurityAdminRulesClient) List(ctx context.Context, resourceGroupName string, virtualNetworkName string, parameters interface{}) (result ManagerEffectiveSecurityAdminRulesListResult, err error) {
...
func (client ManagerEffectiveSecurityAdminRulesClient) ListPreparer(ctx context.Context, resourceGroupName string, virtualNetworkName string, parameters interface{}) (*http.Request, error) {
