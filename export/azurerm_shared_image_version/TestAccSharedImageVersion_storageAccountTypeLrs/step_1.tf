...
locals {
  number            = "230324051802725550"
  location          = "West Europe"
  domain_name_label = "acctestvm-j7fnv"
  random_string     = "j7fnv"
  admin_username    = "testadmin230324051802725550"
  admin_password    = "Password1234!230324051802725550"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230324051802725550"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230324051802725550"
  ...
  identifier {
    publisher = "AccTesPublisher230324051802725550"
    offer     = "AccTesOffer230324051802725550"
    sku       = "AccTesSku230324051802725550"
  }
}
