...
locals {
  number            = "240112034043046218"
  location          = "West Europe"
  domain_name_label = "acctestvm-o46ua"
  random_string     = "o46ua"
  admin_username    = "testadmin240112034043046218"
  admin_password    = "Password1234!240112034043046218"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240112034043046218"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240112034043046218"
  ...
  identifier {
    publisher = "AccTesPublisher240112034043046218"
    offer     = "AccTesOffer240112034043046218"
    sku       = "AccTesSku240112034043046218"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-240112034043046218"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
