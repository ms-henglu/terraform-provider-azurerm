...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-netapp-220107034243012767"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-VirtualNetwork-220107034243012767"
...
resource "azurerm_subnet" "test" {
  name                 = "acctest-Subnet-220107034243012767"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_netapp_account" "test" {
  name                = "acctest-NetAppAccount-220107034243012767"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
}

resource "azurerm_netapp_pool" "test" {
  name                = "acctest-NetAppPool-220107034243012767"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_netapp_volume" "test" {
  name                = "acctest-NetAppVolume-220107034243012767"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  account_name        = azurerm_netapp_account.test.name
  pool_name           = azurerm_netapp_pool.test.name
  volume_path         = "my-unique-file-path-220107034243012767"
  service_level       = "Premium"
...
resource "azurerm_netapp_snapshot" "test" {
  name                = "acctest-NetAppSnapshot-220107034243012767"
  account_name        = azurerm_netapp_account.test.name
  pool_name           = azurerm_netapp_pool.test.name
