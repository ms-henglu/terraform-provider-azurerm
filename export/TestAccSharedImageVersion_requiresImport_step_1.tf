...
locals {
  number            = "210928055247525233"
  location          = "West Europe"
  domain_name_label = "acctestvm-di8th"
  random_string     = "di8th"
  admin_username    = "testadmin210928055247525233"
  admin_password    = "Password1234!210928055247525233"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210928055247525233"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210928055247525233"
  ...
  identifier {
    publisher = "AccTesPublisher210928055247525233"
    offer     = "AccTesOffer210928055247525233"
    sku       = "AccTesSku210928055247525233"
  }
}
