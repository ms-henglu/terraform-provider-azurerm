...
locals {
  number            = "221019060412963676"
  location          = "West Europe"
  domain_name_label = "acctestvm-vwcsa"
  random_string     = "vwcsa"
  admin_username    = "testadmin221019060412963676"
  admin_password    = "Password1234!221019060412963676"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221019060412963676"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221019060412963676"
  ...
  identifier {
    publisher = "AccTesPublisher221019060412963676"
    offer     = "AccTesOffer221019060412963676"
    sku       = "AccTesSku221019060412963676"
  }
}
