...
locals {
  number            = "230120051707947746"
  location          = "West Europe"
  domain_name_label = "acctestvm-ttqc4"
  random_string     = "ttqc4"
  admin_username    = "testadmin230120051707947746"
  admin_password    = "Password1234!230120051707947746"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230120051707947746"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230120051707947746"
  ...
  identifier {
    publisher = "AccTesPublisher230120051707947746"
    offer     = "AccTesOffer230120051707947746"
    sku       = "AccTesSku230120051707947746"
  }
}
