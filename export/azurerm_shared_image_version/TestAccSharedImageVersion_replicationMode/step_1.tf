...
locals {
  number            = "230512010404762186"
  location          = "West Europe"
  domain_name_label = "acctestvm-cl6pu"
  random_string     = "cl6pu"
  admin_username    = "testadmin230512010404762186"
  admin_password    = "Password1234!230512010404762186"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230512010404762186"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230512010404762186"
  ...
  identifier {
    publisher = "AccTesPublisher230512010404762186"
    offer     = "AccTesOffer230512010404762186"
    sku       = "AccTesSku230512010404762186"
  }
}
