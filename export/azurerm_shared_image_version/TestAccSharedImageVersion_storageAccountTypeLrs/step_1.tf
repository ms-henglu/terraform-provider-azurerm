...
locals {
  number            = "221202035328132795"
  location          = "West Europe"
  domain_name_label = "acctestvm-7lc0e"
  random_string     = "7lc0e"
  admin_username    = "testadmin221202035328132795"
  admin_password    = "Password1234!221202035328132795"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221202035328132795"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221202035328132795"
  ...
  identifier {
    publisher = "AccTesPublisher221202035328132795"
    offer     = "AccTesOffer221202035328132795"
    sku       = "AccTesSku221202035328132795"
  }
}
