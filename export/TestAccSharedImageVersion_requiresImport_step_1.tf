...
locals {
  number            = "210825025624753448"
  location          = "West Europe"
  domain_name_label = "acctestvm-9wsyd"
  random_string     = "9wsyd"
  admin_username    = "testadmin210825025624753448"
  admin_password    = "Password1234!210825025624753448"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825025624753448"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825025624753448"
  ...
  identifier {
    publisher = "AccTesPublisher210825025624753448"
    offer     = "AccTesOffer210825025624753448"
    sku       = "AccTesSku210825025624753448"
  }
}
