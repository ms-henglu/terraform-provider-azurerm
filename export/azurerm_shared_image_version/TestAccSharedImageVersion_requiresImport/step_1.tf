...
locals {
  number            = "221111020149341852"
  location          = "West Europe"
  domain_name_label = "acctestvm-ia9ge"
  random_string     = "ia9ge"
  admin_username    = "testadmin221111020149341852"
  admin_password    = "Password1234!221111020149341852"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221111020149341852"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221111020149341852"
  ...
  identifier {
    publisher = "AccTesPublisher221111020149341852"
    offer     = "AccTesOffer221111020149341852"
    sku       = "AccTesSku221111020149341852"
  }
}
