...
locals {
  number            = "240105060444559889"
  location          = "West Europe"
  domain_name_label = "acctestvm-vtvjc"
  random_string     = "vtvjc"
  admin_username    = "testadmin240105060444559889"
  admin_password    = "Password1234!240105060444559889"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105060444559889"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105060444559889"
  ...
  identifier {
    publisher = "AccTesPublisher240105060444559889"
    offer     = "AccTesOffer240105060444559889"
    sku       = "AccTesSku240105060444559889"
  }
}
