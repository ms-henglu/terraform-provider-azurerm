...
locals {
  number            = "220923011626959611"
  location          = "West Europe"
  domain_name_label = "acctestvm-ldnxg"
  random_string     = "ldnxg"
  admin_username    = "testadmin220923011626959611"
  admin_password    = "Password1234!220923011626959611"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220923011626959611"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220923011626959611"
  ...
  identifier {
    publisher = "AccTesPublisher220923011626959611"
    offer     = "AccTesOffer220923011626959611"
    sku       = "AccTesSku220923011626959611"
  }
}
