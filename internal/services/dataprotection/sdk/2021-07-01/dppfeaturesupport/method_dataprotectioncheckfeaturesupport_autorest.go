...
func (c DppFeatureSupportClient) DataProtectionCheckFeatureSupport(ctx context.Context, id LocationId, input FeatureValidationRequestBase) (result DataProtectionCheckFeatureSupportResponse, err error) {
...
func (c DppFeatureSupportClient) responderForDataProtectionCheckFeatureSupport(resp *http.Response) (result DataProtectionCheckFeatureSupportResponse, err error) {
