...
locals {
  number            = "221019054023431516"
  location          = "West Europe"
  domain_name_label = "acctestvm-gpajg"
  random_string     = "gpajg"
  admin_username    = "testadmin221019054023431516"
  admin_password    = "Password1234!221019054023431516"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221019054023431516"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221019054023431516"
  ...
  identifier {
    publisher = "AccTesPublisher221019054023431516"
    offer     = "AccTesOffer221019054023431516"
    sku       = "AccTesSku221019054023431516"
  }
}
