...
type GetUpdateProtectionPolicyRequestsObjectsResponse struct {
	HttpResponse *http.Response
	Model        *[]DppBaseResource

	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (GetUpdateProtectionPolicyRequestsObjectsResponse, error)
}
...
func (r GetUpdateProtectionPolicyRequestsObjectsResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r GetUpdateProtectionPolicyRequestsObjectsResponse) LoadMore(ctx context.Context) (resp GetUpdateProtectionPolicyRequestsObjectsResponse, err error) {
	if !r.HasMore() {
...
func (c ResourceGuardsClient) GetUpdateProtectionPolicyRequestsObjects(ctx context.Context, id ResourceGuardId) (resp GetUpdateProtectionPolicyRequestsObjectsResponse, err error) {
...
func (c ResourceGuardsClient) GetUpdateProtectionPolicyRequestsObjectsComplete(ctx context.Context, id ResourceGuardId) (GetUpdateProtectionPolicyRequestsObjectsCompleteResult, error) {
	return c.GetUpdateProtectionPolicyRequestsObjectsCompleteMatchingPredicate(ctx, id, DppBaseResourcePredicate{})
}
...
func (c ResourceGuardsClient) GetUpdateProtectionPolicyRequestsObjectsCompleteMatchingPredicate(ctx context.Context, id ResourceGuardId, predicate DppBaseResourcePredicate) (resp GetUpdateProtectionPolicyRequestsObjectsCompleteResult, err error) {
...
func (c ResourceGuardsClient) responderForGetUpdateProtectionPolicyRequestsObjects(resp *http.Response) (result GetUpdateProtectionPolicyRequestsObjectsResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result GetUpdateProtectionPolicyRequestsObjectsResponse, err error) {
