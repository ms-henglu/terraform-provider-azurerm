...
locals {
  number            = "220729032452209163"
  location          = "West Europe"
  domain_name_label = "acctestvm-i2ph4"
  random_string     = "i2ph4"
  admin_username    = "testadmin220729032452209163"
  admin_password    = "Password1234!220729032452209163"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220729032452209163"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220729032452209163"
  ...
  identifier {
    publisher = "AccTesPublisher220729032452209163"
    offer     = "AccTesOffer220729032452209163"
    sku       = "AccTesSku220729032452209163"
  }
}
