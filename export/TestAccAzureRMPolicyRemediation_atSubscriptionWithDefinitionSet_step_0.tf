...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-0vt37"
  policy_type  = "Custom"
  display_name = "testPolicySet-0vt37"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-0vt37"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-0vt37"
