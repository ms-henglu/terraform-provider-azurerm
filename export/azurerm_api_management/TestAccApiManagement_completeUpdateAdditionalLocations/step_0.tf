...
resource "azurerm_resource_group" "test1" {
  name     = "acctestRG-api1-231020040437919579"
  location = "West Europe"
}

resource "azurerm_resource_group" "test2" {
  name     = "acctestRG-api2-231020040437919579"
  location = "West US 2"
}

resource "azurerm_resource_group" "test3" {
  name     = "acctestRG-api3-231020040437919579"
  location = "East US 2"
}

resource "azurerm_api_management" "test" {
  name                      = "acctestAM-231020040437919579"
  publisher_name            = "pub1"
  ...
  hostname_configuration {
    proxy {
      host_name                    = "acctestAM-231020040437919579.azure-api.net"
