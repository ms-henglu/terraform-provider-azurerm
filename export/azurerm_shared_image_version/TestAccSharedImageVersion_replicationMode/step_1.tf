...
locals {
  number            = "230922053821492621"
  location          = "West Europe"
  domain_name_label = "acctestvm-0jdia"
  random_string     = "0jdia"
  admin_username    = "testadmin230922053821492621"
  admin_password    = "Password1234!230922053821492621"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230922053821492621"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230922053821492621"
  ...
  identifier {
    publisher = "AccTesPublisher230922053821492621"
    offer     = "AccTesOffer230922053821492621"
    sku       = "AccTesSku230922053821492621"
  }
}
