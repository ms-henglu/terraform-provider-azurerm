...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-ml-231218072045423689"
  location = "West Europe"
}

resource "azurerm_application_insights" "test" {
  name                = "acctestai-231218072045423689"
...
resource "azurerm_machine_learning_workspace" "test" {
  name                    = "acctest-MLW-231218072045423689"
  location                = azurerm_resource_group.test.location
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_storage_container" "test" {
  name                  = "acctestcontainer231218072045423689"
...
resource "azurerm_machine_learning_datastore_blobstorage" "test" {
  name                    = "accdatastore231218072045423689"
