...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211210034450660817"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211210034450660817"
  ...
  identifier {
    publisher = "AccTesPublisher211210034450660817"
    offer     = "AccTesOffer211210034450660817"
    sku       = "AccTesSku211210034450660817"
  }
}
