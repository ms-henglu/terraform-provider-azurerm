...
locals {
  number            = "220627130916060191"
  location          = "West Europe"
  domain_name_label = "acctestvm-vokmx"
  random_string     = "vokmx"
  admin_username    = "testadmin220627130916060191"
  admin_password    = "Password1234!220627130916060191"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627130916060191"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627130916060191"
  ...
  identifier {
    publisher = "AccTesPublisher220627130916060191"
    offer     = "AccTesOffer220627130916060191"
    sku       = "AccTesSku220627130916060191"
  }
}
