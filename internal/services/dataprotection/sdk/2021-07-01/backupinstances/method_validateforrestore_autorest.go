...
// ValidateForRestore ...
func (c BackupInstancesClient) ValidateForRestore(ctx context.Context, id BackupInstanceId, input ValidateRestoreRequestObject) (result ValidateForRestoreResponse, err error) {
...
func (c BackupInstancesClient) senderForValidateForRestore(ctx context.Context, req *http.Request) (future ValidateForRestoreResponse, err error) {
