...
locals {
  number            = "240105063504067862"
  location          = "West Europe"
  domain_name_label = "acctestvm-hgxgz"
  random_string     = "hgxgz"
  admin_username    = "testadmin240105063504067862"
  admin_password    = "Password1234!240105063504067862"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105063504067862"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105063504067862"
  ...
  identifier {
    publisher = "AccTesPublisher240105063504067862"
    offer     = "AccTesOffer240105063504067862"
    sku       = "AccTesSku240105063504067862"
  }
}
