...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-mssql-210917031956043533"
  location = "West Europe"
}

resource "azurerm_sql_server" "test" {
  name                         = "acctest-sqlserver-210917031956043533"
...
resource "azurerm_mssql_database" "test" {
  name         = "acctest-db-210917031956043533"
...
resource "azurerm_resource_group" "second" {
  name     = "acctestRG-mssql2-210917031956043533"
  location = "West US 2"
}

resource "azurerm_sql_server" "second" {
  name                         = "acctest-sqlserver2-210917031956043533"
...
resource "azurerm_mssql_database" "secondary" {
  name                        = "acctest-dbs-210917031956043533"
