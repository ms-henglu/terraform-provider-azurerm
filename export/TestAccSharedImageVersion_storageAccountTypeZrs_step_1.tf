...
locals {
  number            = "220204055814369420"
  location          = "West Europe"
  domain_name_label = "acctestvm-xn4qq"
  random_string     = "xn4qq"
  admin_username    = "testadmin220204055814369420"
  admin_password    = "Password1234!220204055814369420"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220204055814369420"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220204055814369420"
  ...
  identifier {
    publisher = "AccTesPublisher220204055814369420"
    offer     = "AccTesOffer220204055814369420"
    sku       = "AccTesSku220204055814369420"
  }
}
