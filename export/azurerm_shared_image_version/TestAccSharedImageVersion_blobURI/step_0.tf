...
locals {
  number            = "221221204056152248"
  location          = "West Europe"
  domain_name_label = "acctestvm-3dv1s"
  random_string     = "3dv1s"
  admin_username    = "testadmin221221204056152248"
  admin_password    = "Password1234!221221204056152248"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221221204056152248"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221221204056152248"
  ...
  identifier {
    publisher = "AccTesPublisher221221204056152248"
    offer     = "AccTesOffer221221204056152248"
    sku       = "AccTesSku221221204056152248"
  }
}
