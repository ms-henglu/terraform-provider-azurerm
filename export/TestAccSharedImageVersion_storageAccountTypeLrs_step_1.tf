...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220513023023741957"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220513023023741957"
  ...
  identifier {
    publisher = "AccTesPublisher220513023023741957"
    offer     = "AccTesOffer220513023023741957"
    sku       = "AccTesSku220513023023741957"
  }
}
