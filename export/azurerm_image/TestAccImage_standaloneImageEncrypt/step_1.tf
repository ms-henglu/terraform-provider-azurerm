...
locals {
  number            = "240311031615506349"
  location          = "West Europe"
  domain_name_label = "acctestvm-z8080"
  random_string     = "z8080"
  admin_username    = "testadmin240311031615506349"
  admin_password    = "Password1234!240311031615506349"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-240311031615506349"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
