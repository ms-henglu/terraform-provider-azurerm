...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-211217075948677742"
  location = "West Europe"
}

resource "azurerm_iothub" "test" {
  name                = "acctestiothub-211217075948677742"
...
resource "azurerm_stream_analytics_job" "test" {
  name                                     = "acctestjob-211217075948677742"
  resource_group_name                      = azurerm_resource_group.test.name
  location                                 = azurerm_resource_group.test.location
...
resource "azurerm_iothub" "updated" {
  name                = "acctestiot2-211217075948677742"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_stream_analytics_stream_input_iothub" "test" {
  name                         = "acctestinput-211217075948677742"
