...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627134335453594"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627134335453594"
  ...
  identifier {
    publisher = "AccTesPublisher220627134335453594"
    offer     = "AccTesOffer220627134335453594"
    sku       = "AccTesSku220627134335453594"
  }
}
