...
locals {
  number            = "220527023954284191"
  location          = "West Europe"
  domain_name_label = "acctestvm-mhkxh"
  random_string     = "mhkxh"
  admin_username    = "testadmin220527023954284191"
  admin_password    = "Password1234!220527023954284191"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220527023954284191"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220527023954284191"
  ...
  identifier {
    publisher = "AccTesPublisher220527023954284191"
    offer     = "AccTesOffer220527023954284191"
    sku       = "AccTesSku220527023954284191"
  }
}
