...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-230728032823184658"
  location = "West Europe"
}

resource "azurerm_public_ip" "test" {
  name                = "acctest230728032823184658"
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestvirtnet230728032823184658"
...
resource "azurerm_nginx_deployment" "test" {
  name                     = "acctest-230728032823184658"
  resource_group_name      = azurerm_resource_group.test.name
...
resource "azurerm_key_vault_certificate" "test2" {
  name         = "acctestcert2230728032823184658"
  key_vault_id = azurerm_key_vault.test.id
