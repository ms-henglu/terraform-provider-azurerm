...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-acr-221104005240090701"
  location = "West Europe"
}

resource "azurerm_container_registry" "test" {
  name                  = "testacccr221104005240090701"
...
resource "azurerm_container_registry_scope_map" "test" {
  ...
  actions = [
    ...
    "gateway/testacccrc221104005240090701/config/read",
    "gateway/testacccrc221104005240090701/config/write",
    "gateway/testacccrc221104005240090701/message/read",
    "gateway/testacccrc221104005240090701/message/write",
  ]
}

resource "azurerm_container_registry_token" "test" {
  name                    = "testacccrtoken221104005240090701"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
...
resource "azurerm_container_registry_scope_map" "client" {
  name                    = "testacccrclient221104005240090701"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
  actions = [
    "repositories/hello-world/content/delete",
...
resource "azurerm_container_registry_token" "client" {
  name                    = "testacccrtokenclient221104005240090701"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
...
resource "azurerm_container_connected_registry" "test" {
  name                  = "testacccrc221104005240090701"
