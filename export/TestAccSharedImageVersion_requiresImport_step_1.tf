...
locals {
  number            = "210830083803928344"
  location          = "West Europe"
  domain_name_label = "acctestvm-sanms"
  random_string     = "sanms"
  admin_username    = "testadmin210830083803928344"
  admin_password    = "Password1234!210830083803928344"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210830083803928344"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210830083803928344"
  ...
  identifier {
    publisher = "AccTesPublisher210830083803928344"
    offer     = "AccTesOffer210830083803928344"
    sku       = "AccTesSku210830083803928344"
  }
}
