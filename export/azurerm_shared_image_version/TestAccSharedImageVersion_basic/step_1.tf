...
locals {
  number            = "230324051802721357"
  location          = "West Europe"
  domain_name_label = "acctestvm-hoq7j"
  random_string     = "hoq7j"
  admin_username    = "testadmin230324051802721357"
  admin_password    = "Password1234!230324051802721357"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230324051802721357"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230324051802721357"
  ...
  identifier {
    publisher = "AccTesPublisher230324051802721357"
    offer     = "AccTesOffer230324051802721357"
    sku       = "AccTesSku230324051802721357"
  }
}
