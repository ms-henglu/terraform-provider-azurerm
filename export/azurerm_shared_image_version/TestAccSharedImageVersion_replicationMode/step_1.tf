...
locals {
  number            = "230316221218743417"
  location          = "West Europe"
  domain_name_label = "acctestvm-wpckw"
  random_string     = "wpckw"
  admin_username    = "testadmin230316221218743417"
  admin_password    = "Password1234!230316221218743417"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230316221218743417"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230316221218743417"
  ...
  identifier {
    publisher = "AccTesPublisher230316221218743417"
    offer     = "AccTesOffer230316221218743417"
    sku       = "AccTesSku230316221218743417"
  }
}
