...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-drgyc"
  policy_type  = "Custom"
  display_name = "testPolicySet-drgyc"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-drgyc"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-drgyc"
