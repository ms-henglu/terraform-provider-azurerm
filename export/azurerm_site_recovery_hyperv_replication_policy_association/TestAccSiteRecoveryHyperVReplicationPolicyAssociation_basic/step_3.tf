...
locals {
  rg_name              = "acctest-nested-rg-230227175909465167"
  location             = "West Europe"
  vn_name              = "acctest-nested-vn-230227175909465167"
  ip_name              = "acctest-nested-ip-230227175909465167"
  vm_name              = "acctest-nested-vm-230227175909465167"
  nic_name             = "acctest-nested-nic-230227175909465167"
  disk_name            = "acctest-nested-disk-230227175909465167"
  keyvault_name        = "acctkv230227175909465167"
  nsg_name             = "acctest-nested-nsg-230227175909465167"
  recovery_vault_name  = "acctest-nested-recovery-vault-230227175909465167"
  recovery_site_name   = "acctest-nested-recovery-site-230227175909465167"
  admin_name           = "acctestadmin"
  cert_name            = "acctestcert"
  storage_account_name = "acctestsaw18fl"
}
...
resource "azurerm_windows_virtual_machine" "host" {
  ...
  additional_unattend_content {
    setting = "AutoLogon"
    content = "<AutoLogon><Password><Value>Q%680IIg29</Value></Password><Enabled>true</Enabled><LogonCount>1</LogonCount><Username>${local.admin_name}</Username></AutoLogon>"
  }
...
resource "azurerm_site_recovery_hyperv_replication_policy" "test" {
  recovery_vault_id                                  = azurerm_recovery_services_vault.test.id
  name                                               = "acctest-policy-230227175909465167"
