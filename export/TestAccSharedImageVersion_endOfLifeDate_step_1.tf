...
locals {
  number            = "220729032452205378"
  location          = "West Europe"
  domain_name_label = "acctestvm-i6tbr"
  random_string     = "i6tbr"
  admin_username    = "testadmin220729032452205378"
  admin_password    = "Password1234!220729032452205378"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220729032452205378"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220729032452205378"
  ...
  identifier {
    publisher = "AccTesPublisher220729032452205378"
    offer     = "AccTesOffer220729032452205378"
    sku       = "AccTesSku220729032452205378"
  }
}
