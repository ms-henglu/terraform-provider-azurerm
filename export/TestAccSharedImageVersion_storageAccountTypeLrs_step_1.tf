...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220211043347733078"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220211043347733078"
  ...
  identifier {
    publisher = "AccTesPublisher220211043347733078"
    offer     = "AccTesOffer220211043347733078"
    sku       = "AccTesSku220211043347733078"
  }
}
