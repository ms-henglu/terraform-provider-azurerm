...
locals {
  number            = "240105060444556629"
  location          = "West Europe"
  domain_name_label = "acctestvm-s94jp"
  random_string     = "s94jp"
  admin_username    = "testadmin240105060444556629"
  admin_password    = "Password1234!240105060444556629"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105060444556629"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105060444556629"
  ...
  identifier {
    publisher = "AccTesPublisher240105060444556629"
    offer     = "AccTesOffer240105060444556629"
    sku       = "AccTesSku240105060444556629"
  }
}
