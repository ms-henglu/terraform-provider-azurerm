...
locals {
  number            = "230818023718814188"
  location          = "West Europe"
  domain_name_label = "acctestvm-kuw3h"
  random_string     = "kuw3h"
  admin_username    = "testadmin230818023718814188"
  admin_password    = "Password1234!230818023718814188"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230818023718814188"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
