...
locals {
  number            = "240105060444550750"
  location          = "West Europe"
  domain_name_label = "acctestvm-3lx77"
  random_string     = "3lx77"
  admin_username    = "testadmin240105060444550750"
  admin_password    = "Password1234!240105060444550750"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105060444550750"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105060444550750"
  ...
  identifier {
    publisher = "AccTesPublisher240105060444550750"
    offer     = "AccTesOffer240105060444550750"
    sku       = "AccTesSku240105060444550750"
  }
}
