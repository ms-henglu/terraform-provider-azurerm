...
locals {
  number            = "221021033910597200"
  location          = "West Europe"
  domain_name_label = "acctestvm-z4oy0"
  random_string     = "z4oy0"
  admin_username    = "testadmin221021033910597200"
  admin_password    = "Password1234!221021033910597200"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221021033910597200"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221021033910597200"
  ...
  identifier {
    publisher = "AccTesPublisher221021033910597200"
    offer     = "AccTesOffer221021033910597200"
    sku       = "AccTesSku221021033910597200"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-221021033910597200"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
