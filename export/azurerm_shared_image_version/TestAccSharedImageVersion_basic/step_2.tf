...
locals {
  number            = "230721014716584941"
  location          = "West Europe"
  domain_name_label = "acctestvm-93p8s"
  random_string     = "93p8s"
  admin_username    = "testadmin230721014716584941"
  admin_password    = "Password1234!230721014716584941"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230721014716584941"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230721014716584941"
  ...
  identifier {
    publisher = "AccTesPublisher230721014716584941"
    offer     = "AccTesOffer230721014716584941"
    sku       = "AccTesSku230721014716584941"
  }
}
