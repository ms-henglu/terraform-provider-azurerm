...
locals {
  number            = "230512010404760863"
  location          = "West Europe"
  domain_name_label = "acctestvm-qsb09"
  random_string     = "qsb09"
  admin_username    = "testadmin230512010404760863"
  admin_password    = "Password1234!230512010404760863"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230512010404760863"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230512010404760863"
  ...
  identifier {
    publisher = "AccTesPublisher230512010404760863"
    offer     = "AccTesOffer230512010404760863"
    sku       = "AccTesSku230512010404760863"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230512010404760863"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
