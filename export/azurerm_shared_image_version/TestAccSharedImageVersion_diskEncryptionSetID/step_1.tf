...
locals {
  number            = "230707010127176953"
  location          = "West Europe"
  domain_name_label = "acctestvm-pywo9"
  random_string     = "pywo9"
  admin_username    = "testadmin230707010127176953"
  admin_password    = "Password1234!230707010127176953"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230707010127176953"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230707010127176953"
  ...
  identifier {
    publisher = "AccTesPublisher230707010127176953"
    offer     = "AccTesOffer230707010127176953"
    sku       = "AccTesSku230707010127176953"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230707010127176953"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
