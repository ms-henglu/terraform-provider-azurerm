...
var _ resourceids.Id = SpringCloudBuildServiceBuildResultId{}

func TestSpringCloudBuildServiceBuildResultIDFormatter(t *testing.T) {
	actual := NewSpringCloudBuildServiceBuildResultID("12345678-1234-9876-4563-123456789012", "resourceGroup1", "service1", "buildService1", "build1", "result1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resourceGroup1/providers/Microsoft.AppPlatform/Spring/service1/buildServices/buildService1/builds/build1/results/result1"
	if actual != expected {
...
func TestSpringCloudBuildServiceBuildResultID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *SpringCloudBuildServiceBuildResultId
	}{
	...
	for _, v := range testData {
		...
		actual, err := SpringCloudBuildServiceBuildResultID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
