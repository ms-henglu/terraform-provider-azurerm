...
locals {
  number            = "221021030948788648"
  location          = "West Europe"
  domain_name_label = "acctestvm-b74lp"
  random_string     = "b74lp"
  admin_username    = "testadmin221021030948788648"
  admin_password    = "Password1234!221021030948788648"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221021030948788648"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221021030948788648"
  ...
  identifier {
    publisher = "AccTesPublisher221021030948788648"
    offer     = "AccTesOffer221021030948788648"
    sku       = "AccTesSku221021030948788648"
  }
}
