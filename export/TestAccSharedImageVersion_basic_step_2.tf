...
locals {
  number            = "220627130916062464"
  location          = "West Europe"
  domain_name_label = "acctestvm-a06sq"
  random_string     = "a06sq"
  admin_username    = "testadmin220627130916062464"
  admin_password    = "Password1234!220627130916062464"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627130916062464"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627130916062464"
  ...
  identifier {
    publisher = "AccTesPublisher220627130916062464"
    offer     = "AccTesOffer220627130916062464"
    sku       = "AccTesSku220627130916062464"
  }
}
