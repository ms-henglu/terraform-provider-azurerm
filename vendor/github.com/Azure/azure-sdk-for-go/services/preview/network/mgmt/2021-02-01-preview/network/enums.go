...
const (
	...
	// SecurityUser ...
	SecurityUser ConfigurationType = "SecurityUser"
)
...
func PossibleConfigurationTypeValues() []ConfigurationType {
	return []ConfigurationType{Connectivity, SecurityAdmin, SecurityUser}
}
...
// KindBasicActiveBaseSecurityUserRule enumerates the values for kind basic active base security user rule.
type KindBasicActiveBaseSecurityUserRule string

const (
	// KindBasicActiveBaseSecurityUserRuleKindActiveBaseSecurityUserRule ...
	KindBasicActiveBaseSecurityUserRuleKindActiveBaseSecurityUserRule KindBasicActiveBaseSecurityUserRule = "ActiveBaseSecurityUserRule"
	// KindBasicActiveBaseSecurityUserRuleKindCustom ...
	KindBasicActiveBaseSecurityUserRuleKindCustom KindBasicActiveBaseSecurityUserRule = "Custom"
	// KindBasicActiveBaseSecurityUserRuleKindDefault ...
	KindBasicActiveBaseSecurityUserRuleKindDefault KindBasicActiveBaseSecurityUserRule = "Default"
)

// PossibleKindBasicActiveBaseSecurityUserRuleValues returns an array of possible values for the KindBasicActiveBaseSecurityUserRule const type.
func PossibleKindBasicActiveBaseSecurityUserRuleValues() []KindBasicActiveBaseSecurityUserRule {
	return []KindBasicActiveBaseSecurityUserRule{KindBasicActiveBaseSecurityUserRuleKindActiveBaseSecurityUserRule, KindBasicActiveBaseSecurityUserRuleKindCustom, KindBasicActiveBaseSecurityUserRuleKindDefault}
}
