...
resource "azurerm_resource_group" "test" {
  name     = "acctest220627124528286569"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-220627124528286569"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestpol-220627124528286569"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestpol-220627124528286569"
...
resource "azurerm_resource_policy_assignment" "test" {
  name                 = "acctestpa-220627124528286569"
