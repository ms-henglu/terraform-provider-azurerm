...
locals {
  number            = "230804025626252707"
  location          = "West Europe"
  domain_name_label = "acctestvm-rpa3l"
  random_string     = "rpa3l"
  admin_username    = "testadmin230804025626252707"
  admin_password    = "Password1234!230804025626252707"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230804025626252707"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230804025626252707"
  ...
  identifier {
    publisher = "AccTesPublisher230804025626252707"
    offer     = "AccTesOffer230804025626252707"
    sku       = "AccTesSku230804025626252707"
  }
}
