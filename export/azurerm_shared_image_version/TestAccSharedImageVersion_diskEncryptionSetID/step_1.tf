...
locals {
  number            = "221202035328139327"
  location          = "West Europe"
  domain_name_label = "acctestvm-axrsc"
  random_string     = "axrsc"
  admin_username    = "testadmin221202035328139327"
  admin_password    = "Password1234!221202035328139327"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221202035328139327"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221202035328139327"
  ...
  identifier {
    publisher = "AccTesPublisher221202035328139327"
    offer     = "AccTesOffer221202035328139327"
    sku       = "AccTesSku221202035328139327"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-221202035328139327"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
