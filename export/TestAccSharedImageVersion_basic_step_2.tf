...
locals {
  number            = "220603004640121943"
  location          = "West Europe"
  domain_name_label = "acctestvm-ao4jm"
  random_string     = "ao4jm"
  admin_username    = "testadmin220603004640121943"
  admin_password    = "Password1234!220603004640121943"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220603004640121943"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220603004640121943"
  ...
  identifier {
    publisher = "AccTesPublisher220603004640121943"
    offer     = "AccTesOffer220603004640121943"
    sku       = "AccTesSku220603004640121943"
  }
}
