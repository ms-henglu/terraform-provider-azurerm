...
resource "azurerm_resource_group" "test" {
  name     = "acctest-dp-240315122834739676"
  location = "West Europe"
}

resource "azurerm_resource_group" "snap" {
  name     = "acctest-dp-snap-240315122834739676"
  location = "West Europe"
}

resource "azurerm_data_protection_backup_vault" "test" {
  name                = "acctest-dbv-240315122834739676"
...
resource "azurerm_kubernetes_cluster" "test" {
  name                = "acctestaks240315122834739676"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  dns_prefix          = "acctestaks240315122834739676"
...
resource "azurerm_kubernetes_cluster_extension" "test" {
  name              = "acctest-kce-240315122834739676"
...
resource "azurerm_data_protection_backup_policy_kubernetes_cluster" "test" {
  name                = "acctest-paks-240315122834739676"
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_data_protection_backup_instance_kubernetes_cluster" "test" {
  name                         = "acctest-iaks-240315122834739676"
  location                     = azurerm_resource_group.test.location
