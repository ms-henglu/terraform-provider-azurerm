...
locals {
  number            = "230602030259351166"
  location          = "West Europe"
  domain_name_label = "acctestvm-a4wfo"
  random_string     = "a4wfo"
  admin_username    = "testadmin230602030259351166"
  admin_password    = "Password1234!230602030259351166"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230602030259351166"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230602030259351166"
  ...
  identifier {
    publisher = "AccTesPublisher230602030259351166"
    offer     = "AccTesOffer230602030259351166"
    sku       = "AccTesSku230602030259351166"
  }
}
