...
locals {
  number            = "220722051724582267"
  location          = "West Europe"
  domain_name_label = "acctestvm-q0ew0"
  random_string     = "q0ew0"
  admin_username    = "testadmin220722051724582267"
  admin_password    = "Password1234!220722051724582267"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220722051724582267"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220722051724582267"
  ...
  identifier {
    publisher = "AccTesPublisher220722051724582267"
    offer     = "AccTesOffer220722051724582267"
    sku       = "AccTesSku220722051724582267"
  }
}
