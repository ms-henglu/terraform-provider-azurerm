...
locals {
  number            = "240105060444551421"
  location          = "West Europe"
  domain_name_label = "acctestvm-onbuy"
  random_string     = "onbuy"
  admin_username    = "testadmin240105060444551421"
  admin_password    = "Password1234!240105060444551421"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105060444551421"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105060444551421"
  ...
  identifier {
    publisher = "AccTesPublisher240105060444551421"
    offer     = "AccTesOffer240105060444551421"
    sku       = "AccTesSku240105060444551421"
  }
}
