...
locals {
  number            = "230512010404769328"
  location          = "West Europe"
  domain_name_label = "acctestvm-is6cb"
  random_string     = "is6cb"
  admin_username    = "testadmin230512010404769328"
  admin_password    = "Password1234!230512010404769328"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230512010404769328"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230512010404769328"
  ...
  identifier {
    publisher = "AccTesPublisher230512010404769328"
    offer     = "AccTesOffer230512010404769328"
    sku       = "AccTesSku230512010404769328"
  }
}
