...
locals {
  number            = "230922060812878727"
  location          = "West Europe"
  domain_name_label = "acctestvm-h4thj"
  random_string     = "h4thj"
  admin_username    = "testadmin230922060812878727"
  admin_password    = "Password1234!230922060812878727"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230922060812878727"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230922060812878727"
  ...
  identifier {
    publisher = "AccTesPublisher230922060812878727"
    offer     = "AccTesOffer230922060812878727"
    sku       = "AccTesSku230922060812878727"
  }
}
