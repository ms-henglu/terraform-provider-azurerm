...
locals {
  number            = "220630223513057944"
  location          = "West Europe"
  domain_name_label = "acctestvm-eb6pu"
  random_string     = "eb6pu"
  admin_username    = "testadmin220630223513057944"
  admin_password    = "Password1234!220630223513057944"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220630223513057944"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220630223513057944"
  ...
  identifier {
    publisher = "AccTesPublisher220630223513057944"
    offer     = "AccTesOffer220630223513057944"
    sku       = "AccTesSku220630223513057944"
  }
}
...
resource "azurerm_shared_image_version" "test" {
  ...
  end_of_life_date    = "2022-07-01T08:35:13Z"
