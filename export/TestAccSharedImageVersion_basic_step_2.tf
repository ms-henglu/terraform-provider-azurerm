...
locals {
  number            = "211008044203075866"
  location          = "West Europe"
  domain_name_label = "acctestvm-sl2mb"
  random_string     = "sl2mb"
  admin_username    = "testadmin211008044203075866"
  admin_password    = "Password1234!211008044203075866"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211008044203075866"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211008044203075866"
  ...
  identifier {
    publisher = "AccTesPublisher211008044203075866"
    offer     = "AccTesOffer211008044203075866"
    sku       = "AccTesSku211008044203075866"
  }
}
