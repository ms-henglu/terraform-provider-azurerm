...
locals {
  number            = "210825042656067519"
  location          = "West Europe"
  domain_name_label = "acctestvm-9zlay"
  random_string     = "9zlay"
  admin_username    = "testadmin210825042656067519"
  admin_password    = "Password1234!210825042656067519"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825042656067519"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825042656067519"
  ...
  identifier {
    publisher = "AccTesPublisher210825042656067519"
    offer     = "AccTesOffer210825042656067519"
    sku       = "AccTesSku210825042656067519"
  }
}
