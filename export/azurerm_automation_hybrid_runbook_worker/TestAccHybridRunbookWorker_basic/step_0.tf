...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-230526084632278194"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctestAA-230526084632278194"
...
resource "azurerm_automation_credential" "test" {
  name                    = "acctest-230526084632278194"
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestnw-230526084632278194"
...
resource "azurerm_network_interface" "test" {
  name                = "acctni-230526084632278194"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "test" {
  name                = "acctestVM-230526084632278194"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_automation_hybrid_runbook_worker" "test" {
  ...
  worker_id               = "7e805942-7f1f-4d49-aa1d-37d1ba8a09c8"
