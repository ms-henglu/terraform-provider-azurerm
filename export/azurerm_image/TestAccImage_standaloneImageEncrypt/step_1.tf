...
locals {
  number            = "230915023108408631"
  location          = "West Europe"
  domain_name_label = "acctestvm-8d1mx"
  random_string     = "8d1mx"
  admin_username    = "testadmin230915023108408631"
  admin_password    = "Password1234!230915023108408631"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230915023108408631"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
