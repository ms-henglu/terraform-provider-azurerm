...
locals {
  number            = "210906022054104145"
  location          = "West Europe"
  domain_name_label = "acctestvm-xv7fc"
  random_string     = "xv7fc"
  admin_username    = "testadmin210906022054104145"
  admin_password    = "Password1234!210906022054104145"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210906022054104145"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210906022054104145"
  ...
  identifier {
    publisher = "AccTesPublisher210906022054104145"
    offer     = "AccTesOffer210906022054104145"
    sku       = "AccTesSku210906022054104145"
  }
}
