...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220812014802179019"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220812014802179019"
  ...
  identifier {
    publisher = "AccTesPublisher220812014802179019"
    offer     = "AccTesOffer220812014802179019"
    sku       = "AccTesSku220812014802179019"
  }
}
