...
locals {
  number            = "230616074443137550"
  location          = "West Europe"
  domain_name_label = "acctestvm-hz6sf"
  random_string     = "hz6sf"
  admin_username    = "testadmin230616074443137550"
  admin_password    = "Password1234!230616074443137550"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230616074443137550"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230616074443137550"
  ...
  identifier {
    publisher = "AccTesPublisher230616074443137550"
    offer     = "AccTesOffer230616074443137550"
    sku       = "AccTesSku230616074443137550"
  }
}
