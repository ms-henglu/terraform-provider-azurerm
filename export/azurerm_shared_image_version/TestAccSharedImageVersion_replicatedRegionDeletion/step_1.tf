...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230922053821493154"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230922053821493154"
  ...
  identifier {
    publisher = "AccTesPublisher230922053821493154"
    offer     = "AccTesOffer230922053821493154"
    sku       = "AccTesSku230922053821493154"
  }
}
