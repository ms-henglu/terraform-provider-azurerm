...
locals {
  number            = "220128052306100749"
  location          = "West Europe"
  domain_name_label = "acctestvm-7yj7p"
  random_string     = "7yj7p"
  admin_username    = "testadmin220128052306100749"
  admin_password    = "Password1234!220128052306100749"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220128052306100749"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220128052306100749"
  ...
  identifier {
    publisher = "AccTesPublisher220128052306100749"
    offer     = "AccTesOffer220128052306100749"
    sku       = "AccTesSku220128052306100749"
  }
}
