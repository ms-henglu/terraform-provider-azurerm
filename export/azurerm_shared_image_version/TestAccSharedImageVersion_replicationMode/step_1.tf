...
locals {
  number            = "221222034403203841"
  location          = "West Europe"
  domain_name_label = "acctestvm-j8wo9"
  random_string     = "j8wo9"
  admin_username    = "testadmin221222034403203841"
  admin_password    = "Password1234!221222034403203841"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221222034403203841"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221222034403203841"
  ...
  identifier {
    publisher = "AccTesPublisher221222034403203841"
    offer     = "AccTesOffer221222034403203841"
    sku       = "AccTesSku221222034403203841"
  }
}
