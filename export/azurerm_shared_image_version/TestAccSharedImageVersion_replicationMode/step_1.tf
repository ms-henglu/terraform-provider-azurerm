...
locals {
  number            = "240105060444558462"
  location          = "West Europe"
  domain_name_label = "acctestvm-oen4a"
  random_string     = "oen4a"
  admin_username    = "testadmin240105060444558462"
  admin_password    = "Password1234!240105060444558462"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105060444558462"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105060444558462"
  ...
  identifier {
    publisher = "AccTesPublisher240105060444558462"
    offer     = "AccTesOffer240105060444558462"
    sku       = "AccTesSku240105060444558462"
  }
}
