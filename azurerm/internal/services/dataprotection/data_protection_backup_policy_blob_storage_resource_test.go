...
resource "azurerm_data_protection_backup_policy_blob_storage" "import" {
  ...
  resource_group_name = azurerm_data_protection_backup_policy_blob_storage.test.resource_group_name
  vault_name          = azurerm_data_protection_backup_policy_blob_storage.test.vault_name
  retention_duration  = "P30D"
}
`, config)
}
