...
locals {
  number            = "220128052306110589"
  location          = "West Europe"
  domain_name_label = "acctestvm-rnim9"
  random_string     = "rnim9"
  admin_username    = "testadmin220128052306110589"
  admin_password    = "Password1234!220128052306110589"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220128052306110589"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220128052306110589"
  ...
  identifier {
    publisher = "AccTesPublisher220128052306110589"
    offer     = "AccTesOffer220128052306110589"
    sku       = "AccTesSku220128052306110589"
  }
}
