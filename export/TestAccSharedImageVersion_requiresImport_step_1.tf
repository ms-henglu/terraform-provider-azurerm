...
locals {
  number            = "220124124841967376"
  location          = "West Europe"
  domain_name_label = "acctestvm-9tta1"
  random_string     = "9tta1"
  admin_username    = "testadmin220124124841967376"
  admin_password    = "Password1234!220124124841967376"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220124124841967376"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220124124841967376"
  ...
  identifier {
    publisher = "AccTesPublisher220124124841967376"
    offer     = "AccTesOffer220124124841967376"
    sku       = "AccTesSku220124124841967376"
  }
}
