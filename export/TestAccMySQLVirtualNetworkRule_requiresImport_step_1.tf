...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220630211131097447"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvnet220630211131097447"
...
resource "azurerm_subnet" "test" {
  name                 = "acctestsubnet220630211131097447"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_mysql_server" "test" {
  name                         = "acctestmysqlsvr-220630211131097447"
  location                     = azurerm_resource_group.test.location
  resource_group_name          = azurerm_resource_group.test.name
...
resource "azurerm_mysql_virtual_network_rule" "test" {
  name                = "acctestmysqlvnetrule220630211131097447"
  resource_group_name = azurerm_resource_group.test.name
