...
locals {
  number            = "230929064556876094"
  location          = "West Europe"
  domain_name_label = "acctestvm-zqt4y"
  random_string     = "zqt4y"
  admin_username    = "testadmin230929064556876094"
  admin_password    = "Password1234!230929064556876094"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230929064556876094"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230929064556876094"
  ...
  identifier {
    publisher = "AccTesPublisher230929064556876094"
    offer     = "AccTesOffer230929064556876094"
    sku       = "AccTesSku230929064556876094"
  }
}
