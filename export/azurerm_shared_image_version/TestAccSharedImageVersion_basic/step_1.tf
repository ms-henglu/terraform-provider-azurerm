...
locals {
  number            = "230316221218743598"
  location          = "West Europe"
  domain_name_label = "acctestvm-rydf8"
  random_string     = "rydf8"
  admin_username    = "testadmin230316221218743598"
  admin_password    = "Password1234!230316221218743598"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230316221218743598"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230316221218743598"
  ...
  identifier {
    publisher = "AccTesPublisher230316221218743598"
    offer     = "AccTesOffer230316221218743598"
    sku       = "AccTesSku230316221218743598"
  }
}
