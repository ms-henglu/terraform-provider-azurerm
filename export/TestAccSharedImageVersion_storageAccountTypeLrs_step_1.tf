...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220715014258875805"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220715014258875805"
  ...
  identifier {
    publisher = "AccTesPublisher220715014258875805"
    offer     = "AccTesOffer220715014258875805"
    sku       = "AccTesSku220715014258875805"
  }
}
