...
locals {
  number            = "221202035328134930"
  location          = "West Europe"
  domain_name_label = "acctestvm-t13kl"
  random_string     = "t13kl"
  admin_username    = "testadmin221202035328134930"
  admin_password    = "Password1234!221202035328134930"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221202035328134930"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221202035328134930"
  ...
  identifier {
    publisher = "AccTesPublisher221202035328134930"
    offer     = "AccTesOffer221202035328134930"
    sku       = "AccTesSku221202035328134930"
  }
}
