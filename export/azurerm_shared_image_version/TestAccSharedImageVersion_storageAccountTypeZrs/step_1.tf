...
locals {
  number            = "240112034043032830"
  location          = "West Europe"
  domain_name_label = "acctestvm-ngc0l"
  random_string     = "ngc0l"
  admin_username    = "testadmin240112034043032830"
  admin_password    = "Password1234!240112034043032830"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240112034043032830"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240112034043032830"
  ...
  identifier {
    publisher = "AccTesPublisher240112034043032830"
    offer     = "AccTesOffer240112034043032830"
    sku       = "AccTesSku240112034043032830"
  }
}
