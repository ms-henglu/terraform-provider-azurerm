...
locals {
  number            = "210928075302202861"
  location          = "West Europe"
  domain_name_label = "acctestvm-dwao2"
  random_string     = "dwao2"
  admin_username    = "testadmin210928075302202861"
  admin_password    = "Password1234!210928075302202861"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210928075302202861"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210928075302202861"
  ...
  identifier {
    publisher = "AccTesPublisher210928075302202861"
    offer     = "AccTesOffer210928075302202861"
    sku       = "AccTesSku210928075302202861"
  }
}
