...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220311032223316958"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220311032223316958"
  ...
  identifier {
    publisher = "AccTesPublisher220311032223316958"
    offer     = "AccTesOffer220311032223316958"
    sku       = "AccTesSku220311032223316958"
  }
}
