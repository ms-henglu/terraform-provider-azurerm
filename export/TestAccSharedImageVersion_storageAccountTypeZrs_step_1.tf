...
locals {
  number            = "220722051724572919"
  location          = "West Europe"
  domain_name_label = "acctestvm-9jeeh"
  random_string     = "9jeeh"
  admin_username    = "testadmin220722051724572919"
  admin_password    = "Password1234!220722051724572919"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220722051724572919"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220722051724572919"
  ...
  identifier {
    publisher = "AccTesPublisher220722051724572919"
    offer     = "AccTesOffer220722051724572919"
    sku       = "AccTesSku220722051724572919"
  }
}
