...
locals {
  number            = "230818023718895621"
  location          = "West Europe"
  domain_name_label = "acctestvm-fu1we"
  random_string     = "fu1we"
  admin_username    = "testadmin230818023718895621"
  admin_password    = "Password1234!230818023718895621"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230818023718895621"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230818023718895621"
  ...
  identifier {
    publisher = "AccTesPublisher230818023718895621"
    offer     = "AccTesOffer230818023718895621"
    sku       = "AccTesSku230818023718895621"
  }
}
