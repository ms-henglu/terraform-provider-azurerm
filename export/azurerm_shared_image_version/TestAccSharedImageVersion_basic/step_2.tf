...
locals {
  number            = "221111020149338588"
  location          = "West Europe"
  domain_name_label = "acctestvm-9kgy2"
  random_string     = "9kgy2"
  admin_username    = "testadmin221111020149338588"
  admin_password    = "Password1234!221111020149338588"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221111020149338588"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221111020149338588"
  ...
  identifier {
    publisher = "AccTesPublisher221111020149338588"
    offer     = "AccTesOffer221111020149338588"
    sku       = "AccTesSku221111020149338588"
  }
}
