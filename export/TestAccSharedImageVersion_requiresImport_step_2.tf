...
locals {
  number            = "220429075220069118"
  location          = "West Europe"
  domain_name_label = "acctestvm-br8i0"
  random_string     = "br8i0"
  admin_username    = "testadmin220429075220069118"
  admin_password    = "Password1234!220429075220069118"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220429075220069118"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220429075220069118"
  ...
  identifier {
    publisher = "AccTesPublisher220429075220069118"
    offer     = "AccTesOffer220429075220069118"
    sku       = "AccTesSku220429075220069118"
  }
}
