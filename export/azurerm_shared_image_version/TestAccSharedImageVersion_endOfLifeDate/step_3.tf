...
locals {
  number            = "231016033604026584"
  location          = "West Europe"
  domain_name_label = "acctestvm-asw9s"
  random_string     = "asw9s"
  admin_username    = "testadmin231016033604026584"
  admin_password    = "Password1234!231016033604026584"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231016033604026584"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231016033604026584"
  ...
  identifier {
    publisher = "AccTesPublisher231016033604026584"
    offer     = "AccTesOffer231016033604026584"
    sku       = "AccTesSku231016033604026584"
  }
}
