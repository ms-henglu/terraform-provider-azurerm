...
locals {
  number            = "210825040616682320"
  location          = "West Europe"
  domain_name_label = "acctestvm-1ytsx"
  random_string     = "1ytsx"
  admin_username    = "testadmin210825040616682320"
  admin_password    = "Password1234!210825040616682320"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825040616682320"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825040616682320"
  ...
  identifier {
    publisher = "AccTesPublisher210825040616682320"
    offer     = "AccTesOffer210825040616682320"
    sku       = "AccTesSku210825040616682320"
  }
}
