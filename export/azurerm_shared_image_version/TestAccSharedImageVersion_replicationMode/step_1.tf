...
locals {
  number            = "230421021839856301"
  location          = "West Europe"
  domain_name_label = "acctestvm-t68ys"
  random_string     = "t68ys"
  admin_username    = "testadmin230421021839856301"
  admin_password    = "Password1234!230421021839856301"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230421021839856301"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230421021839856301"
  ...
  identifier {
    publisher = "AccTesPublisher230421021839856301"
    offer     = "AccTesOffer230421021839856301"
    sku       = "AccTesSku230421021839856301"
  }
}
