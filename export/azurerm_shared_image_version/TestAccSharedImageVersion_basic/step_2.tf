...
locals {
  number            = "230512003629466248"
  location          = "West Europe"
  domain_name_label = "acctestvm-k9jqq"
  random_string     = "k9jqq"
  admin_username    = "testadmin230512003629466248"
  admin_password    = "Password1234!230512003629466248"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230512003629466248"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230512003629466248"
  ...
  identifier {
    publisher = "AccTesPublisher230512003629466248"
    offer     = "AccTesOffer230512003629466248"
    sku       = "AccTesSku230512003629466248"
  }
}
