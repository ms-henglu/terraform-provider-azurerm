...
locals {
  number            = "220712042046045380"
  location          = "West Europe"
  domain_name_label = "acctestvm-wfhun"
  random_string     = "wfhun"
  admin_username    = "testadmin220712042046045380"
  admin_password    = "Password1234!220712042046045380"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220712042046045380"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220712042046045380"
  ...
  identifier {
    publisher = "AccTesPublisher220712042046045380"
    offer     = "AccTesOffer220712042046045380"
    sku       = "AccTesSku220712042046045380"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220712042046045380"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
