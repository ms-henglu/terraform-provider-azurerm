...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220610022923585360"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-220610022923585360"
...
resource "azurerm_virtual_network" "gateway" {
  name                = "acctestvnet-gw-220610022923585360"
...
resource "azurerm_subnet" "gateway" {
  name                 = "acctestsubnet-gw-220610022923585360"
...
resource "azurerm_lb" "gateway" {
  name                = "acctestlb-220610022923585360"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Gateway"
...
resource "azurerm_lb_backend_address_pool" "gateway" {
  name            = "acctestbap-220610022923585360"
...
resource "azurerm_public_ip" "test" {
  name                = "acctestpip-220610022923585360"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Standard"
...
resource "azurerm_network_interface" "test" {
  name                = "acctestnic-220610022923585360"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
