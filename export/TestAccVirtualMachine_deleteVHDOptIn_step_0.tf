...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-211112020355832391"
  location = "West Europe"
}

resource "azurerm_resource_group" "test-sa" {
  name     = "acctestRG-sa-211112020355832391"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctvn-211112020355832391"
...
resource "azurerm_subnet" "test" {
  name                 = "acctsub-211112020355832391"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_network_interface" "test" {
  name                = "acctni-211112020355832391"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_virtual_machine" "test" {
  name                  = "acctvm-211112020355832391"
  location              = azurerm_resource_group.test.location
  resource_group_name   = azurerm_resource_group.test.name
  ...
  os_profile {
    computer_name  = "hn211112020355832391"
