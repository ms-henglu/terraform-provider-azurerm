...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-vpn-220513023611477276"
  location = "West Europe"
}


resource "azurerm_virtual_wan" "test" {
  name                = "acctest-vwan-220513023611477276"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_virtual_hub" "test" {
  name                = "acctest-vhub-220513023611477276"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_vpn_gateway" "test" {
  name                = "acctest-vpngw-220513023611477276"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_vpn_site" "test" {
  name                = "acctest-vpnsite-220513023611477276"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  virtual_wan_id      = azurerm_virtual_wan.test.id
...
resource "azurerm_vpn_gateway_nat_rule" "test" {
  name                            = "acctest-vpngwnatrule-220513023611477276"
  resource_group_name             = azurerm_resource_group.test.name
...
resource "azurerm_vpn_gateway_nat_rule" "test2" {
  name                            = "acctest-vpngwnatrule2-220513023611477276"
  resource_group_name             = azurerm_resource_group.test.name
  vpn_gateway_id                  = azurerm_vpn_gateway.test.id
...
resource "azurerm_vpn_gateway_nat_rule" "test3" {
  name                            = "acctest-vpngwnatrule3-220513023611477276"
  resource_group_name             = azurerm_resource_group.test.name
  vpn_gateway_id                  = azurerm_vpn_gateway.test.id
...
resource "azurerm_vpn_gateway_nat_rule" "test4" {
  name                            = "acctest-vpngwnatrule4-220513023611477276"
  resource_group_name             = azurerm_resource_group.test.name
  vpn_gateway_id                  = azurerm_vpn_gateway.test.id
...
resource "azurerm_vpn_gateway_connection" "test" {
  name               = "acctest-VpnGwConn-220513023611477276"
  vpn_gateway_id     = azurerm_vpn_gateway.test.id
