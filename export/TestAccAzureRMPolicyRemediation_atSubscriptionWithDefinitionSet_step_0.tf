...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-d9i7o"
  policy_type  = "Custom"
  display_name = "testPolicySet-d9i7o"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-d9i7o"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-d9i7o"
