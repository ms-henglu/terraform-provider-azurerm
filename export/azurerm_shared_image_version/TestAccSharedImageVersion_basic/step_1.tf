...
locals {
  number            = "231020040746246811"
  location          = "West Europe"
  domain_name_label = "acctestvm-qyqv2"
  random_string     = "qyqv2"
  admin_username    = "testadmin231020040746246811"
  admin_password    = "Password1234!231020040746246811"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231020040746246811"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231020040746246811"
  ...
  identifier {
    publisher = "AccTesPublisher231020040746246811"
    offer     = "AccTesOffer231020040746246811"
    sku       = "AccTesSku231020040746246811"
  }
}
