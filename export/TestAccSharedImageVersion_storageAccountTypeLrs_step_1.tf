...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210928055247515555"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210928055247515555"
  ...
  identifier {
    publisher = "AccTesPublisher210928055247515555"
    offer     = "AccTesOffer210928055247515555"
    sku       = "AccTesSku210928055247515555"
  }
}
