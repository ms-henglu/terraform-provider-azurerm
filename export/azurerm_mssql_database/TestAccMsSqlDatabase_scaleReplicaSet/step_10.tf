...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-mssql-230825024940411737"
  location = "West Europe"
}

resource "azurerm_mssql_server" "test" {
  name                         = "acctest-sqlserver-230825024940411737"
...
resource "azurerm_mssql_database" "primary" {
  name        = "acctest-db-230825024940411737"
...
resource "azurerm_resource_group" "secondary" {
  name     = "acctestRG-mssql2-230825024940411737"
  location = "West US 2"
}

resource "azurerm_mssql_server" "secondary" {
  name                         = "acctest-sqlserver2-230825024940411737"
