...
locals {
  number            = "230106031234906904"
  location          = "West Europe"
  domain_name_label = "acctestvm-sdnin"
  random_string     = "sdnin"
  admin_username    = "testadmin230106031234906904"
  admin_password    = "Password1234!230106031234906904"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230106031234906904"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230106031234906904"
  ...
  identifier {
    publisher = "AccTesPublisher230106031234906904"
    offer     = "AccTesOffer230106031234906904"
    sku       = "AccTesSku230106031234906904"
  }
}
