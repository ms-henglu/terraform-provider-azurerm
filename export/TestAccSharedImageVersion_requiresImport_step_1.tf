...
locals {
  number            = "220107063800659737"
  location          = "West Europe"
  domain_name_label = "acctestvm-po11e"
  random_string     = "po11e"
  admin_username    = "testadmin220107063800659737"
  admin_password    = "Password1234!220107063800659737"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220107063800659737"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220107063800659737"
  ...
  identifier {
    publisher = "AccTesPublisher220107063800659737"
    offer     = "AccTesOffer220107063800659737"
    sku       = "AccTesSku220107063800659737"
  }
}
