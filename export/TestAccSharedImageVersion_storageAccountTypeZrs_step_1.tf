...
locals {
  number            = "220811053013427620"
  location          = "West Europe"
  domain_name_label = "acctestvm-ubrck"
  random_string     = "ubrck"
  admin_username    = "testadmin220811053013427620"
  admin_password    = "Password1234!220811053013427620"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220811053013427620"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220811053013427620"
  ...
  identifier {
    publisher = "AccTesPublisher220811053013427620"
    offer     = "AccTesOffer220811053013427620"
    sku       = "AccTesSku220811053013427620"
  }
}
