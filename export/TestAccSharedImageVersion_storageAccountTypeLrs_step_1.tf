...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220630223513050570"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220630223513050570"
  ...
  identifier {
    publisher = "AccTesPublisher220630223513050570"
    offer     = "AccTesOffer220630223513050570"
    sku       = "AccTesSku220630223513050570"
  }
}
