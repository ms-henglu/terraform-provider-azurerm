...
locals {
  number            = "211022001757130628"
  location          = "West Europe"
  domain_name_label = "acctestvm-f3vsw"
  random_string     = "f3vsw"
  admin_username    = "testadmin211022001757130628"
  admin_password    = "Password1234!211022001757130628"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211022001757130628"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211022001757130628"
  ...
  identifier {
    publisher = "AccTesPublisher211022001757130628"
    offer     = "AccTesOffer211022001757130628"
    sku       = "AccTesSku211022001757130628"
  }
}
