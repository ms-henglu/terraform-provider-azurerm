...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220722040003521036"
...
resource "azuread_application" "cluster_explorer" {
  ...
  identifier_uris = ["https://test-plwo0.${data.azuread_domains.test.domains[0].domain_name}:19080/Explorer/index.html"]
  web {
...
resource "azurerm_service_fabric_cluster" "test" {
  name                = "acctest-220722040003521036"
