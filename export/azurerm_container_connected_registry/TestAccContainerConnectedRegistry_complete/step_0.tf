...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-acr-230113180906218465"
  location = "West Europe"
}

resource "azurerm_container_registry" "test" {
  name                  = "testacccr230113180906218465"
...
resource "azurerm_container_registry_scope_map" "test" {
  ...
  actions = [
    ...
    "gateway/testacccrc230113180906218465/config/read",
    "gateway/testacccrc230113180906218465/config/write",
    "gateway/testacccrc230113180906218465/message/read",
    "gateway/testacccrc230113180906218465/message/write",
  ]
}

resource "azurerm_container_registry_token" "test" {
  name                    = "testacccrtoken230113180906218465"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
...
resource "azurerm_container_registry_scope_map" "client" {
  name                    = "testacccrclient230113180906218465"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
  actions = [
    "repositories/hello-world/content/delete",
...
resource "azurerm_container_registry_token" "client" {
  name                    = "testacccrtokenclient230113180906218465"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
...
resource "azurerm_container_connected_registry" "test" {
  name                  = "testacccrc230113180906218465"
