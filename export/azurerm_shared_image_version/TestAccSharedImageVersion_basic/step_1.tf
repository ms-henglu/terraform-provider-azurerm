...
locals {
  number            = "230818023718892492"
  location          = "West Europe"
  domain_name_label = "acctestvm-q3bkq"
  random_string     = "q3bkq"
  admin_username    = "testadmin230818023718892492"
  admin_password    = "Password1234!230818023718892492"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230818023718892492"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230818023718892492"
  ...
  identifier {
    publisher = "AccTesPublisher230818023718892492"
    offer     = "AccTesOffer230818023718892492"
    sku       = "AccTesSku230818023718892492"
  }
}
