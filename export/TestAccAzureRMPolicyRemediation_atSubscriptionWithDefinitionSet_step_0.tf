...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-rqjo4"
  policy_type  = "Custom"
  display_name = "testPolicySet-rqjo4"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-rqjo4"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-rqjo4"
