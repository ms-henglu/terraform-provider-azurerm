...
locals {
  number            = "230106034233470274"
  location          = "West Europe"
  domain_name_label = "acctestvm-jiqgu"
  random_string     = "jiqgu"
  admin_username    = "testadmin230106034233470274"
  admin_password    = "Password1234!230106034233470274"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230106034233470274"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230106034233470274"
  ...
  identifier {
    publisher = "AccTesPublisher230106034233470274"
    offer     = "AccTesOffer230106034233470274"
    sku       = "AccTesSku230106034233470274"
  }
}
