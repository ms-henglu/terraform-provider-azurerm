...
locals {
  number            = "220429075220064324"
  location          = "West Europe"
  domain_name_label = "acctestvm-b8zwh"
  random_string     = "b8zwh"
  admin_username    = "testadmin220429075220064324"
  admin_password    = "Password1234!220429075220064324"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220429075220064324"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220429075220064324"
  ...
  identifier {
    publisher = "AccTesPublisher220429075220064324"
    offer     = "AccTesOffer220429075220064324"
    sku       = "AccTesSku220429075220064324"
  }
}
