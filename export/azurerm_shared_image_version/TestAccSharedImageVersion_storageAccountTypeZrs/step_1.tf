...
locals {
  number            = "221104005221359804"
  location          = "West Europe"
  domain_name_label = "acctestvm-ryddh"
  random_string     = "ryddh"
  admin_username    = "testadmin221104005221359804"
  admin_password    = "Password1234!221104005221359804"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221104005221359804"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221104005221359804"
  ...
  identifier {
    publisher = "AccTesPublisher221104005221359804"
    offer     = "AccTesOffer221104005221359804"
    sku       = "AccTesSku221104005221359804"
  }
}
