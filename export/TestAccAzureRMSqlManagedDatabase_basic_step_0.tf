...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-sql-211013072427124961"
  location = "West Europe"
}

resource "azurerm_network_security_group" "test" {
  name                = "mi-security-group-211013072427124961"
...
resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet-211013072427124961"
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_subnet" "test" {
  name                 = "subnet-211013072427124961"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_route_table" "test" {
  name                          = "routetable-211013072427124961"
  location                      = azurerm_resource_group.test.location
  resource_group_name           = azurerm_resource_group.test.name
...
resource "azurerm_sql_managed_instance" "test" {
  name                         = "acctestsqlserver211013072427124961"
  resource_group_name          = azurerm_resource_group.test.name
  location                     = azurerm_resource_group.test.location
...
resource "azurerm_sql_managed_database" "test" {
  ...
  name                    = "acctest-211013072427124961"
  location                = azurerm_resource_group.test.location
}
