...
locals {
  number            = "230428045412221840"
  location          = "West Europe"
  domain_name_label = "acctestvm-lwwzi"
  random_string     = "lwwzi"
  admin_username    = "testadmin230428045412221840"
  admin_password    = "Password1234!230428045412221840"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230428045412221840"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230428045412221840"
  ...
  identifier {
    publisher = "AccTesPublisher230428045412221840"
    offer     = "AccTesOffer230428045412221840"
    sku       = "AccTesSku230428045412221840"
  }
}
