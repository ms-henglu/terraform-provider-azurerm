...
locals {
  number            = "230120054357241813"
  location          = "West Europe"
  domain_name_label = "acctestvm-2fmh9"
  random_string     = "2fmh9"
  admin_username    = "testadmin230120054357241813"
  admin_password    = "Password1234!230120054357241813"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230120054357241813"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230120054357241813"
  ...
  identifier {
    publisher = "AccTesPublisher230120054357241813"
    offer     = "AccTesOffer230120054357241813"
    sku       = "AccTesSku230120054357241813"
  }
}
