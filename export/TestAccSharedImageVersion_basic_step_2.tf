...
locals {
  number            = "220627123942229166"
  location          = "West Europe"
  domain_name_label = "acctestvm-gxtbl"
  random_string     = "gxtbl"
  admin_username    = "testadmin220627123942229166"
  admin_password    = "Password1234!220627123942229166"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627123942229166"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627123942229166"
  ...
  identifier {
    publisher = "AccTesPublisher220627123942229166"
    offer     = "AccTesOffer220627123942229166"
    sku       = "AccTesSku220627123942229166"
  }
}
