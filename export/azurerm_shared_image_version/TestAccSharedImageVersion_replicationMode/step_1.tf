...
locals {
  number            = "221117230632448809"
  location          = "West Europe"
  domain_name_label = "acctestvm-91sce"
  random_string     = "91sce"
  admin_username    = "testadmin221117230632448809"
  admin_password    = "Password1234!221117230632448809"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221117230632448809"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221117230632448809"
  ...
  identifier {
    publisher = "AccTesPublisher221117230632448809"
    offer     = "AccTesOffer221117230632448809"
    sku       = "AccTesSku221117230632448809"
  }
}
