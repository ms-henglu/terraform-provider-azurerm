...
locals {
  number            = "220107063800654411"
  location          = "West Europe"
  domain_name_label = "acctestvm-79ph7"
  random_string     = "79ph7"
  admin_username    = "testadmin220107063800654411"
  admin_password    = "Password1234!220107063800654411"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220107063800654411"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220107063800654411"
  ...
  identifier {
    publisher = "AccTesPublisher220107063800654411"
    offer     = "AccTesOffer220107063800654411"
    sku       = "AccTesSku220107063800654411"
  }
}
