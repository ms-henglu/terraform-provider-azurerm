...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210826023203594026"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210826023203594026"
  ...
  identifier {
    publisher = "AccTesPublisher210826023203594026"
    offer     = "AccTesOffer210826023203594026"
    sku       = "AccTesSku210826023203594026"
  }
}
