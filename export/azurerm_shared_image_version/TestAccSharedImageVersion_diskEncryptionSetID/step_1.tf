...
locals {
  number            = "221117230632440454"
  location          = "West Europe"
  domain_name_label = "acctestvm-0cjfr"
  random_string     = "0cjfr"
  admin_username    = "testadmin221117230632440454"
  admin_password    = "Password1234!221117230632440454"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221117230632440454"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221117230632440454"
  ...
  identifier {
    publisher = "AccTesPublisher221117230632440454"
    offer     = "AccTesOffer221117230632440454"
    sku       = "AccTesSku221117230632440454"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-221117230632440454"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
