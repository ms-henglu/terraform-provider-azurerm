...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-al3ts"
  policy_type  = "Custom"
  display_name = "testPolicySet-al3ts"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-al3ts"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-al3ts"
