...
type GetDefaultBackupSecurityPINRequestsObjectResponse struct {
	HttpResponse *http.Response
	Model        *DppBaseResource
}

// GetDefaultBackupSecurityPINRequestsObject ...
func (c ResourceGuardsClient) GetDefaultBackupSecurityPINRequestsObject(ctx context.Context, id GetBackupSecurityPINRequestId) (result GetDefaultBackupSecurityPINRequestsObjectResponse, err error) {
...
func (c ResourceGuardsClient) responderForGetDefaultBackupSecurityPINRequestsObject(resp *http.Response) (result GetDefaultBackupSecurityPINRequestsObjectResponse, err error) {
