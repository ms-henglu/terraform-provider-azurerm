...
locals {
  number            = "210825042656062287"
  location          = "West Europe"
  domain_name_label = "acctestvm-sqaw8"
  random_string     = "sqaw8"
  admin_username    = "testadmin210825042656062287"
  admin_password    = "Password1234!210825042656062287"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825042656062287"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825042656062287"
  ...
  identifier {
    publisher = "AccTesPublisher210825042656062287"
    offer     = "AccTesOffer210825042656062287"
    sku       = "AccTesSku210825042656062287"
  }
}
