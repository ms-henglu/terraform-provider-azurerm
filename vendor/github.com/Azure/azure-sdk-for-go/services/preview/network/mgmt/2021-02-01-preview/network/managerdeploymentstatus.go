...
// List post List of Network Manager Deployment Status.
// Parameters:
...
func (client ManagerDeploymentStatusClient) List(ctx context.Context, parameters ManagerDeploymentStatusParameter, resourceGroupName string, networkManagerName string, top *int32, skipToken string) (result ManagerDeploymentStatusListResultPage, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ManagerDeploymentStatusClient.List")
		defer func() {
			sc := -1
			if result.mdslr.Response.Response != nil {
				sc = result.mdslr.Response.Response.StatusCode
			}
	...
	req, err := client.ListPreparer(ctx, parameters, resourceGroupName, networkManagerName, top, skipToken)
	if err != nil {
...
func (client ManagerDeploymentStatusClient) ListPreparer(ctx context.Context, parameters ManagerDeploymentStatusParameter, resourceGroupName string, networkManagerName string, top *int32, skipToken string) (*http.Request, error) {
...
func (client ManagerDeploymentStatusClient) listNextResults(ctx context.Context, lastResults ManagerDeploymentStatusListResult) (result ManagerDeploymentStatusListResult, err error) {
	req, err := lastResults.managerDeploymentStatusListResultPreparer(ctx)
	if err != nil {
		return result, autorest.NewErrorWithError(err, "network.ManagerDeploymentStatusClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "network.ManagerDeploymentStatusClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "network.ManagerDeploymentStatusClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}

// ListComplete enumerates all values, automatically crossing page boundaries as required.
func (client ManagerDeploymentStatusClient) ListComplete(ctx context.Context, parameters ManagerDeploymentStatusParameter, resourceGroupName string, networkManagerName string, top *int32, skipToken string) (result ManagerDeploymentStatusListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ManagerDeploymentStatusClient.List")
		defer func() {
			sc := -1
	...
	result.page, err = client.List(ctx, parameters, resourceGroupName, networkManagerName, top, skipToken)
	return
}
