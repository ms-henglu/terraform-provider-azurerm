...
locals {
  number            = "230728031950554974"
  location          = "West Europe"
  domain_name_label = "acctestvm-9z9lp"
  random_string     = "9z9lp"
  admin_username    = "testadmin230728031950554974"
  admin_password    = "Password1234!230728031950554974"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230728031950554974"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230728031950554974"
  ...
  identifier {
    publisher = "AccTesPublisher230728031950554974"
    offer     = "AccTesOffer230728031950554974"
    sku       = "AccTesSku230728031950554974"
  }
}
