...
locals {
  number            = "230728031950559479"
  location          = "West Europe"
  domain_name_label = "acctestvm-0zwh7"
  random_string     = "0zwh7"
  admin_username    = "testadmin230728031950559479"
  admin_password    = "Password1234!230728031950559479"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230728031950559479"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230728031950559479"
  ...
  identifier {
    publisher = "AccTesPublisher230728031950559479"
    offer     = "AccTesOffer230728031950559479"
    sku       = "AccTesSku230728031950559479"
  }
}
