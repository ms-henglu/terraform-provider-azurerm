...
locals {
  number            = "230512003629461580"
  location          = "West Europe"
  domain_name_label = "acctestvm-ea28n"
  random_string     = "ea28n"
  admin_username    = "testadmin230512003629461580"
  admin_password    = "Password1234!230512003629461580"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230512003629461580"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230512003629461580"
  ...
  identifier {
    publisher = "AccTesPublisher230512003629461580"
    offer     = "AccTesOffer230512003629461580"
    sku       = "AccTesSku230512003629461580"
  }
}
