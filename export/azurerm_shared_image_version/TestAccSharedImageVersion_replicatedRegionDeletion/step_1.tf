...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240112034043049184"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240112034043049184"
  ...
  identifier {
    publisher = "AccTesPublisher240112034043049184"
    offer     = "AccTesOffer240112034043049184"
    sku       = "AccTesSku240112034043049184"
  }
}
