...
locals {
  number            = "230127045135672831"
  location          = "West Europe"
  domain_name_label = "acctestvm-94jf2"
  random_string     = "94jf2"
  admin_username    = "testadmin230127045135672831"
  admin_password    = "Password1234!230127045135672831"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230127045135672831"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230127045135672831"
  ...
  identifier {
    publisher = "AccTesPublisher230127045135672831"
    offer     = "AccTesOffer230127045135672831"
    sku       = "AccTesSku230127045135672831"
  }
}
