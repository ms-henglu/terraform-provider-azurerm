...
func (r Registration) SupportedResources() map[string]*pluginsdk.Resource {
	return map[string]*pluginsdk.Resource{
		...
		"azurerm_network_manager":                           resourceNetworkManager(),
		"azurerm_network_group":                             resourceNetworkGroup(),
		"azurerm_network_connectivity_configuration":        resourceNetworkConnectivityConfiguration(),
		"azurerm_network_security_admin_configuration":      resourceNetworkSecurityAdminConfiguration(),
		"azurerm_network_security_user_configuration":       resourceNetworkSecurityUserConfiguration(),
		"azurerm_network_admin_rule_collection":             resourceNetworkAdminRuleCollection(),
		"azurerm_network_user_rule_collection":              resourceNetworkUserRuleCollection(),
		"azurerm_network_admin_rule":                        resourceNetworkAdminRule(),
		"azurerm_network_user_rule":                         resourceNetworkUserRule(),
