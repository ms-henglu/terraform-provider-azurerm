...
locals {
  number            = "220826005646579868"
  location          = "West Europe"
  domain_name_label = "acctestvm-78hbi"
  random_string     = "78hbi"
  admin_username    = "testadmin220826005646579868"
  admin_password    = "Password1234!220826005646579868"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220826005646579868"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220826005646579868"
  ...
  identifier {
    publisher = "AccTesPublisher220826005646579868"
    offer     = "AccTesOffer220826005646579868"
    sku       = "AccTesSku220826005646579868"
  }
}
