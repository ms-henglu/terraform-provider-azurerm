...
locals {
  number            = "220818234946126761"
  location          = "West Europe"
  domain_name_label = "acctestvm-tuf9u"
  random_string     = "tuf9u"
  admin_username    = "testadmin220818234946126761"
  admin_password    = "Password1234!220818234946126761"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220818234946126761"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220818234946126761"
  ...
  identifier {
    publisher = "AccTesPublisher220818234946126761"
    offer     = "AccTesOffer220818234946126761"
    sku       = "AccTesSku220818234946126761"
  }
}
