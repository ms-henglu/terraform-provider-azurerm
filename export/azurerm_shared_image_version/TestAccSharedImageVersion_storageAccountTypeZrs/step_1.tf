...
locals {
  number            = "221216013235530227"
  location          = "West Europe"
  domain_name_label = "acctestvm-m6qvs"
  random_string     = "m6qvs"
  admin_username    = "testadmin221216013235530227"
  admin_password    = "Password1234!221216013235530227"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221216013235530227"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221216013235530227"
  ...
  identifier {
    publisher = "AccTesPublisher221216013235530227"
    offer     = "AccTesOffer221216013235530227"
    sku       = "AccTesSku221216013235530227"
  }
}
