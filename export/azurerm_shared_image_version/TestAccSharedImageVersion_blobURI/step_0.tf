...
locals {
  number            = "221216013235539130"
  location          = "West Europe"
  domain_name_label = "acctestvm-dvf66"
  random_string     = "dvf66"
  admin_username    = "testadmin221216013235539130"
  admin_password    = "Password1234!221216013235539130"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221216013235539130"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221216013235539130"
  ...
  identifier {
    publisher = "AccTesPublisher221216013235539130"
    offer     = "AccTesOffer221216013235539130"
    sku       = "AccTesSku221216013235539130"
  }
}
