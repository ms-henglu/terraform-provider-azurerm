...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-cognitive-220506015630585335"
  location = "West US 2"
}
...
resource "azurerm_cognitive_account" "test" {
  name                  = "acctest-cogacc-220506015630585335"
  location              = azurerm_resource_group.test.location
  resource_group_name   = azurerm_resource_group.test.name
  kind                  = "SpeechServices"
  sku_name              = "S0"
  custom_subdomain_name = "acctest-cogacc-220506015630585335"
  identity {
