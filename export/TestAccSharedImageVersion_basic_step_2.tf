...
locals {
  number            = "220513180038359518"
  location          = "West Europe"
  domain_name_label = "acctestvm-v2fap"
  random_string     = "v2fap"
  admin_username    = "testadmin220513180038359518"
  admin_password    = "Password1234!220513180038359518"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220513180038359518"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220513180038359518"
  ...
  identifier {
    publisher = "AccTesPublisher220513180038359518"
    offer     = "AccTesOffer220513180038359518"
    sku       = "AccTesSku220513180038359518"
  }
}
