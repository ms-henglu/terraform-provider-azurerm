...
locals {
  number            = "230428045412228317"
  location          = "West Europe"
  domain_name_label = "acctestvm-fccmq"
  random_string     = "fccmq"
  admin_username    = "testadmin230428045412228317"
  admin_password    = "Password1234!230428045412228317"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230428045412228317"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230428045412228317"
  ...
  identifier {
    publisher = "AccTesPublisher230428045412228317"
    offer     = "AccTesOffer230428045412228317"
    sku       = "AccTesSku230428045412228317"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230428045412228317"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
