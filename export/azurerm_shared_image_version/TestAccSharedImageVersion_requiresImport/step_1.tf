...
locals {
  number            = "230421021839855678"
  location          = "West Europe"
  domain_name_label = "acctestvm-7t6ex"
  random_string     = "7t6ex"
  admin_username    = "testadmin230421021839855678"
  admin_password    = "Password1234!230421021839855678"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230421021839855678"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230421021839855678"
  ...
  identifier {
    publisher = "AccTesPublisher230421021839855678"
    offer     = "AccTesOffer230421021839855678"
    sku       = "AccTesSku230421021839855678"
  }
}
