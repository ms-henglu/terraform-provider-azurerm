...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-n2won"
  policy_type  = "Custom"
  display_name = "testPolicySet-n2won"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-n2won"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-n2won"
