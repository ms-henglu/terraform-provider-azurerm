...
locals {
  number            = "231016033604020190"
  location          = "West Europe"
  domain_name_label = "acctestvm-hctdn"
  random_string     = "hctdn"
  admin_username    = "testadmin231016033604020190"
  admin_password    = "Password1234!231016033604020190"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231016033604020190"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231016033604020190"
  ...
  identifier {
    publisher = "AccTesPublisher231016033604020190"
    offer     = "AccTesOffer231016033604020190"
    sku       = "AccTesSku231016033604020190"
  }
}
