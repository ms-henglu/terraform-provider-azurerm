...
locals {
  number            = "230227175227914814"
  location          = "West Europe"
  domain_name_label = "acctestvm-1e2tx"
  random_string     = "1e2tx"
  admin_username    = "testadmin230227175227914814"
  admin_password    = "Password1234!230227175227914814"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230227175227914814"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230227175227914814"
  ...
  identifier {
    publisher = "AccTesPublisher230227175227914814"
    offer     = "AccTesOffer230227175227914814"
    sku       = "AccTesSku230227175227914814"
  }
}
