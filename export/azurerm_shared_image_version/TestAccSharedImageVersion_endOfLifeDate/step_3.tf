...
locals {
  number            = "230227032410655868"
  location          = "West Europe"
  domain_name_label = "acctestvm-3xiik"
  random_string     = "3xiik"
  admin_username    = "testadmin230227032410655868"
  admin_password    = "Password1234!230227032410655868"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230227032410655868"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230227032410655868"
  ...
  identifier {
    publisher = "AccTesPublisher230227032410655868"
    offer     = "AccTesOffer230227032410655868"
    sku       = "AccTesSku230227032410655868"
  }
}
