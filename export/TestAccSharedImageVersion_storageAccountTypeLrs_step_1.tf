...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220610022336700194"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220610022336700194"
  ...
  identifier {
    publisher = "AccTesPublisher220610022336700194"
    offer     = "AccTesOffer220610022336700194"
    sku       = "AccTesSku220610022336700194"
  }
}
