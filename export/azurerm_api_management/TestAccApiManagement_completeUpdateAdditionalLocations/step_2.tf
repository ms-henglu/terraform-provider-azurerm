...
resource "azurerm_resource_group" "test1" {
  name     = "acctestRG-api1-231016033300959484"
  location = "West Europe"
}

resource "azurerm_resource_group" "test2" {
  name     = "acctestRG-api2-231016033300959484"
  location = "West US 2"
}

resource "azurerm_resource_group" "test3" {
  name     = "acctestRG-api3-231016033300959484"
  location = "East US 2"
}

resource "azurerm_api_management" "test" {
  name                      = "acctestAM-231016033300959484"
  publisher_name            = "pub1"
  ...
  hostname_configuration {
    proxy {
      host_name                    = "acctestAM-231016033300959484.azure-api.net"
