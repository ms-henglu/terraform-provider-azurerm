...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220603004640123974"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220603004640123974"
  ...
  identifier {
    publisher = "AccTesPublisher220603004640123974"
    offer     = "AccTesOffer220603004640123974"
    sku       = "AccTesSku220603004640123974"
  }
}
