...
locals {
  number            = "230120054357241443"
  location          = "West Europe"
  domain_name_label = "acctestvm-wp4wo"
  random_string     = "wp4wo"
  admin_username    = "testadmin230120054357241443"
  admin_password    = "Password1234!230120054357241443"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230120054357241443"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230120054357241443"
  ...
  identifier {
    publisher = "AccTesPublisher230120054357241443"
    offer     = "AccTesOffer230120054357241443"
    sku       = "AccTesSku230120054357241443"
  }
}
