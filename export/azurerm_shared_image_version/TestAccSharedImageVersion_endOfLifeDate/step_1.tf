...
locals {
  number            = "230407023100164950"
  location          = "West Europe"
  domain_name_label = "acctestvm-7mjhe"
  random_string     = "7mjhe"
  admin_username    = "testadmin230407023100164950"
  admin_password    = "Password1234!230407023100164950"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230407023100164950"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230407023100164950"
  ...
  identifier {
    publisher = "AccTesPublisher230407023100164950"
    offer     = "AccTesOffer230407023100164950"
    sku       = "AccTesSku230407023100164950"
  }
}
