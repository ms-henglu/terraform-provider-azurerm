...
type GetBackupSecurityPINRequestsObjectsResponse struct {
	HttpResponse *http.Response
	Model        *[]DppBaseResource

	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (GetBackupSecurityPINRequestsObjectsResponse, error)
}
...
func (r GetBackupSecurityPINRequestsObjectsResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r GetBackupSecurityPINRequestsObjectsResponse) LoadMore(ctx context.Context) (resp GetBackupSecurityPINRequestsObjectsResponse, err error) {
	if !r.HasMore() {
...
func (c ResourceGuardsClient) GetBackupSecurityPINRequestsObjects(ctx context.Context, id ResourceGuardId) (resp GetBackupSecurityPINRequestsObjectsResponse, err error) {
...
func (c ResourceGuardsClient) GetBackupSecurityPINRequestsObjectsComplete(ctx context.Context, id ResourceGuardId) (GetBackupSecurityPINRequestsObjectsCompleteResult, error) {
	return c.GetBackupSecurityPINRequestsObjectsCompleteMatchingPredicate(ctx, id, DppBaseResourcePredicate{})
}

// GetBackupSecurityPINRequestsObjectsCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c ResourceGuardsClient) GetBackupSecurityPINRequestsObjectsCompleteMatchingPredicate(ctx context.Context, id ResourceGuardId, predicate DppBaseResourcePredicate) (resp GetBackupSecurityPINRequestsObjectsCompleteResult, err error) {
...
func (c ResourceGuardsClient) responderForGetBackupSecurityPINRequestsObjects(resp *http.Response) (result GetBackupSecurityPINRequestsObjectsResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result GetBackupSecurityPINRequestsObjectsResponse, err error) {
