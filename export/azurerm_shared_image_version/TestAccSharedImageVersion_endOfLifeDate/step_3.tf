...
locals {
  number            = "221021033910593980"
  location          = "West Europe"
  domain_name_label = "acctestvm-vn6j1"
  random_string     = "vn6j1"
  admin_username    = "testadmin221021033910593980"
  admin_password    = "Password1234!221021033910593980"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221021033910593980"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221021033910593980"
  ...
  identifier {
    publisher = "AccTesPublisher221021033910593980"
    offer     = "AccTesOffer221021033910593980"
    sku       = "AccTesSku221021033910593980"
  }
}
