...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-240311033106878479"
  location = "West Europe"
}

resource "azurerm_cosmosdb_account" "test" {
  name                = "acctestcosmosdb240311033106878479"
...
resource "azurerm_app_service_plan" "test" {
  name                = "acctestASP-240311033106878479"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_function_app" "test" {
  name                       = "acctest-240311033106878479-func"
  location                   = azurerm_resource_group.test.location
  resource_group_name        = azurerm_resource_group.test.name
...
resource "azurerm_function_app_connection" "test" {
  name               = "acctestserviceconnector240311033106878479"
