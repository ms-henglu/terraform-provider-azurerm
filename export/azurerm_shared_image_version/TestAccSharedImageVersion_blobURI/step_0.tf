...
locals {
  number            = "240311031615619379"
  location          = "West Europe"
  domain_name_label = "acctestvm-m83ln"
  random_string     = "m83ln"
  admin_username    = "testadmin240311031615619379"
  admin_password    = "Password1234!240311031615619379"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240311031615619379"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240311031615619379"
  ...
  identifier {
    publisher = "AccTesPublisher240311031615619379"
    offer     = "AccTesOffer240311031615619379"
    sku       = "AccTesSku240311031615619379"
  }
}
