...
locals {
  number            = "210917031451907388"
  location          = "West Europe"
  domain_name_label = "acctestvm-1j3p7"
  random_string     = "1j3p7"
  admin_username    = "testadmin210917031451907388"
  admin_password    = "Password1234!210917031451907388"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210917031451907388"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210917031451907388"
  ...
  identifier {
    publisher = "AccTesPublisher210917031451907388"
    offer     = "AccTesOffer210917031451907388"
    sku       = "AccTesSku210917031451907388"
  }
}
