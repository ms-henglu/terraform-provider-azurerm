...
locals {
  number            = "211217035034680155"
  location          = "West Europe"
  domain_name_label = "acctestvm-fvz1o"
  random_string     = "fvz1o"
  admin_username    = "testadmin211217035034680155"
  admin_password    = "Password1234!211217035034680155"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211217035034680155"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211217035034680155"
  ...
  identifier {
    publisher = "AccTesPublisher211217035034680155"
    offer     = "AccTesOffer211217035034680155"
    sku       = "AccTesSku211217035034680155"
  }
}
