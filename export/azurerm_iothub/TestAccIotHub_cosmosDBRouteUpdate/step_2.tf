...
resource "azurerm_resource_group" "iothub" {
  name     = "acctest-iothub-240119022218852723"
  location = "eastus"
}

resource "azurerm_resource_group" "endpoint" {
  name     = "acctest-iothub-db-240119022218852723"
  location = "eastus"
}

resource "azurerm_cosmosdb_account" "test" {
  name                = "acctest-ca-240119022218852723"
...
resource "azurerm_cosmosdb_sql_database" "test" {
  name                = "acctest-240119022218852723"
