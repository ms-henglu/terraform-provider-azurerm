...
locals {
  number            = "221019054023432446"
  location          = "West Europe"
  domain_name_label = "acctestvm-woxej"
  random_string     = "woxej"
  admin_username    = "testadmin221019054023432446"
  admin_password    = "Password1234!221019054023432446"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221019054023432446"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221019054023432446"
  ...
  identifier {
    publisher = "AccTesPublisher221019054023432446"
    offer     = "AccTesOffer221019054023432446"
    sku       = "AccTesSku221019054023432446"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-221019054023432446"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
