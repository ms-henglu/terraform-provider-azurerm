...
func TestAccSpringCloudBuildServiceBuilder_complete(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_spring_cloud_builder", "test")
	r := SpringCloudBuildServiceBuilderResource{}
	data.ResourceTest(t, r, []resource.TestStep{
		{
...
func TestAccSpringCloudBuildServiceBuilder_update(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_spring_cloud_builder", "test")
	r := SpringCloudBuildServiceBuilderResource{}
	data.ResourceTest(t, r, []resource.TestStep{
		{
...
func (r SpringCloudBuildServiceBuilderResource) complete(data acceptance.TestData) string {
	template := r.template(data)
	return fmt.Sprintf(`
%s
