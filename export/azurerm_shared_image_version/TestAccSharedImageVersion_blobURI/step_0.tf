...
locals {
  number            = "230120054357249889"
  location          = "West Europe"
  domain_name_label = "acctestvm-bbek4"
  random_string     = "bbek4"
  admin_username    = "testadmin230120054357249889"
  admin_password    = "Password1234!230120054357249889"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230120054357249889"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230120054357249889"
  ...
  identifier {
    publisher = "AccTesPublisher230120054357249889"
    offer     = "AccTesOffer230120054357249889"
    sku       = "AccTesSku230120054357249889"
  }
}
