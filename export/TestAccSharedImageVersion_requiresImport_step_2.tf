...
locals {
  number            = "211015014431936116"
  location          = "West Europe"
  domain_name_label = "acctestvm-xdsn0"
  random_string     = "xdsn0"
  admin_username    = "testadmin211015014431936116"
  admin_password    = "Password1234!211015014431936116"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211015014431936116"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211015014431936116"
  ...
  identifier {
    publisher = "AccTesPublisher211015014431936116"
    offer     = "AccTesOffer211015014431936116"
    sku       = "AccTesSku211015014431936116"
  }
}
