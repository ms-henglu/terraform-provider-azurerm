...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220630210603398043"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220630210603398043"
  ...
  identifier {
    publisher = "AccTesPublisher220630210603398043"
    offer     = "AccTesOffer220630210603398043"
    sku       = "AccTesSku220630210603398043"
  }
}
