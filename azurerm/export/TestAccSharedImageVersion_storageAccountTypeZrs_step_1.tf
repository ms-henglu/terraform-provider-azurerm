...
locals {
  number            = "220627134335456008"
  location          = "West Europe"
  domain_name_label = "acctestvm-kh72y"
  random_string     = "kh72y"
  admin_username    = "testadmin220627134335456008"
  admin_password    = "Password1234!220627134335456008"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627134335456008"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627134335456008"
  ...
  identifier {
    publisher = "AccTesPublisher220627134335456008"
    offer     = "AccTesOffer220627134335456008"
    sku       = "AccTesSku220627134335456008"
  }
}
