...
locals {
  number            = "231016033604021406"
  location          = "West Europe"
  domain_name_label = "acctestvm-dgm0m"
  random_string     = "dgm0m"
  admin_username    = "testadmin231016033604021406"
  admin_password    = "Password1234!231016033604021406"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231016033604021406"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231016033604021406"
  ...
  identifier {
    publisher = "AccTesPublisher231016033604021406"
    offer     = "AccTesOffer231016033604021406"
    sku       = "AccTesSku231016033604021406"
  }
}
