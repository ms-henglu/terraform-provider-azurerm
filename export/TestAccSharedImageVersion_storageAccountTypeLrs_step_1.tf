...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825044607839644"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825044607839644"
  ...
  identifier {
    publisher = "AccTesPublisher210825044607839644"
    offer     = "AccTesOffer210825044607839644"
    sku       = "AccTesSku210825044607839644"
  }
}
