...
locals {
  number            = "230407023100163716"
  location          = "West Europe"
  domain_name_label = "acctestvm-lqy6x"
  random_string     = "lqy6x"
  admin_username    = "testadmin230407023100163716"
  admin_password    = "Password1234!230407023100163716"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230407023100163716"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230407023100163716"
  ...
  identifier {
    publisher = "AccTesPublisher230407023100163716"
    offer     = "AccTesOffer230407023100163716"
    sku       = "AccTesSku230407023100163716"
  }
}
