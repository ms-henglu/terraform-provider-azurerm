...
locals {
  number            = "211008044203075513"
  location          = "West Europe"
  domain_name_label = "acctestvm-a12y0"
  random_string     = "a12y0"
  admin_username    = "testadmin211008044203075513"
  admin_password    = "Password1234!211008044203075513"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211008044203075513"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211008044203075513"
  ...
  identifier {
    publisher = "AccTesPublisher211008044203075513"
    offer     = "AccTesOffer211008044203075513"
    sku       = "AccTesSku211008044203075513"
  }
}
