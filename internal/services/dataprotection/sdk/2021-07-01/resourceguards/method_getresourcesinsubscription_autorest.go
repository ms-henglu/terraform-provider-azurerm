...
type GetResourcesInSubscriptionResponse struct {
	HttpResponse *http.Response
	Model        *[]ResourceGuardResource

	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (GetResourcesInSubscriptionResponse, error)
}
...
func (r GetResourcesInSubscriptionResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r GetResourcesInSubscriptionResponse) LoadMore(ctx context.Context) (resp GetResourcesInSubscriptionResponse, err error) {
	if !r.HasMore() {
...
func (c ResourceGuardsClient) GetResourcesInSubscription(ctx context.Context, id commonids.SubscriptionId) (resp GetResourcesInSubscriptionResponse, err error) {
...
func (c ResourceGuardsClient) GetResourcesInSubscriptionComplete(ctx context.Context, id commonids.SubscriptionId) (GetResourcesInSubscriptionCompleteResult, error) {
	return c.GetResourcesInSubscriptionCompleteMatchingPredicate(ctx, id, ResourceGuardResourcePredicate{})
}

// GetResourcesInSubscriptionCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c ResourceGuardsClient) GetResourcesInSubscriptionCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, predicate ResourceGuardResourcePredicate) (resp GetResourcesInSubscriptionCompleteResult, err error) {
...
func (c ResourceGuardsClient) responderForGetResourcesInSubscription(resp *http.Response) (result GetResourcesInSubscriptionResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result GetResourcesInSubscriptionResponse, err error) {
