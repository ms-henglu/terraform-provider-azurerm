...
locals {
  number            = "230505050044918252"
  location          = "West Europe"
  domain_name_label = "acctestvm-ipbfm"
  random_string     = "ipbfm"
  admin_username    = "testadmin230505050044918252"
  admin_password    = "Password1234!230505050044918252"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230505050044918252"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230505050044918252"
  ...
  identifier {
    publisher = "AccTesPublisher230505050044918252"
    offer     = "AccTesOffer230505050044918252"
    sku       = "AccTesSku230505050044918252"
  }
}
