...
locals {
  number            = "210825044607836389"
  location          = "West Europe"
  domain_name_label = "acctestvm-wrapw"
  random_string     = "wrapw"
  admin_username    = "testadmin210825044607836389"
  admin_password    = "Password1234!210825044607836389"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825044607836389"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825044607836389"
  ...
  identifier {
    publisher = "AccTesPublisher210825044607836389"
    offer     = "AccTesOffer210825044607836389"
    sku       = "AccTesSku210825044607836389"
  }
}
