...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-zsaaq"
  policy_type  = "Custom"
  display_name = "testPolicySet-zsaaq"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-zsaaq"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-zsaaq"
