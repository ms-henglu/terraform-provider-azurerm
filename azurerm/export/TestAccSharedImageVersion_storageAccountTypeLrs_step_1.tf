...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627125722841495"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627125722841495"
  ...
  identifier {
    publisher = "AccTesPublisher220627125722841495"
    offer     = "AccTesOffer220627125722841495"
    sku       = "AccTesSku220627125722841495"
  }
}
