...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220627125811305739"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvnet220627125811305739"
...
resource "azurerm_subnet" "test" {
  name                 = "acctestsubnet220627125811305739"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_data_lake_store" "test" {
  name                = "acctestadls06271258113"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_data_lake_store_virtual_network_rule" "test" {
  name                = "acctestadlsvnetrule220627125811305739"
  resource_group_name = azurerm_resource_group.test.name
