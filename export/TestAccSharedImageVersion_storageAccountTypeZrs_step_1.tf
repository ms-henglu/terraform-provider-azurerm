...
locals {
  number            = "221019054023430965"
  location          = "West Europe"
  domain_name_label = "acctestvm-mzfb8"
  random_string     = "mzfb8"
  admin_username    = "testadmin221019054023430965"
  admin_password    = "Password1234!221019054023430965"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221019054023430965"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221019054023430965"
  ...
  identifier {
    publisher = "AccTesPublisher221019054023430965"
    offer     = "AccTesOffer221019054023430965"
    sku       = "AccTesSku221019054023430965"
  }
}
