...
locals {
  number            = "220324160038489340"
  location          = "West Europe"
  domain_name_label = "acctestvm-oylz6"
  random_string     = "oylz6"
  admin_username    = "testadmin220324160038489340"
  admin_password    = "Password1234!220324160038489340"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220324160038489340"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220324160038489340"
  ...
  identifier {
    publisher = "AccTesPublisher220324160038489340"
    offer     = "AccTesOffer220324160038489340"
    sku       = "AccTesSku220324160038489340"
  }
}
