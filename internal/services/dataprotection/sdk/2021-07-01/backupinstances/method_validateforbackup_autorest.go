...
// ValidateForBackup ...
func (c BackupInstancesClient) ValidateForBackup(ctx context.Context, id BackupVaultId, input ValidateForBackupRequest) (result ValidateForBackupResponse, err error) {
...
func (c BackupInstancesClient) senderForValidateForBackup(ctx context.Context, req *http.Request) (future ValidateForBackupResponse, err error) {
