...
locals {
  number            = "220610092433254195"
  location          = "West Europe"
  domain_name_label = "acctestvm-yo7cu"
  random_string     = "yo7cu"
  admin_username    = "testadmin220610092433254195"
  admin_password    = "Password1234!220610092433254195"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220610092433254195"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220610092433254195"
  ...
  identifier {
    publisher = "AccTesPublisher220610092433254195"
    offer     = "AccTesOffer220610092433254195"
    sku       = "AccTesSku220610092433254195"
  }
}
