...
locals {
  number            = "240112034043043336"
  location          = "West Europe"
  domain_name_label = "acctestvm-oqv4c"
  random_string     = "oqv4c"
  admin_username    = "testadmin240112034043043336"
  admin_password    = "Password1234!240112034043043336"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240112034043043336"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240112034043043336"
  ...
  identifier {
    publisher = "AccTesPublisher240112034043043336"
    offer     = "AccTesOffer240112034043043336"
    sku       = "AccTesSku240112034043043336"
  }
}
