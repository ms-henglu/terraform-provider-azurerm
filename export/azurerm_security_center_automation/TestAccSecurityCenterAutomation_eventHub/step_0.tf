...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-221028165505737932"
  location = "West Europe"
}

resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhub-221028165505737932"
  location            = "West Europe"
...
resource "azurerm_eventhub_authorization_rule" "test" {
  name                = "acctest-eventhub-auth-rule-221028165505737932"
  namespace_name      = azurerm_eventhub_namespace.test.name
...
resource "azurerm_security_center_automation" "test" {
  name                = "acctestautomation-221028165505737932"
  location            = "West Europe"
  resource_group_name = azurerm_resource_group.test.name
