...
locals {
  number            = "220429065303876239"
  location          = "West Europe"
  domain_name_label = "acctestvm-9y34s"
  random_string     = "9y34s"
  admin_username    = "testadmin220429065303876239"
  admin_password    = "Password1234!220429065303876239"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220429065303876239"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220429065303876239"
  ...
  identifier {
    publisher = "AccTesPublisher220429065303876239"
    offer     = "AccTesOffer220429065303876239"
    sku       = "AccTesSku220429065303876239"
  }
}
