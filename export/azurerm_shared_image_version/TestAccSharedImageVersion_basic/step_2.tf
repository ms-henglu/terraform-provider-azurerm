...
locals {
  number            = "230721011329114326"
  location          = "West Europe"
  domain_name_label = "acctestvm-v0weo"
  random_string     = "v0weo"
  admin_username    = "testadmin230721011329114326"
  admin_password    = "Password1234!230721011329114326"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230721011329114326"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230721011329114326"
  ...
  identifier {
    publisher = "AccTesPublisher230721011329114326"
    offer     = "AccTesOffer230721011329114326"
    sku       = "AccTesSku230721011329114326"
  }
}
