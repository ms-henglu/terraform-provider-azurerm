...
locals {
  number            = "230106031234907808"
  location          = "West Europe"
  domain_name_label = "acctestvm-2mfjk"
  random_string     = "2mfjk"
  admin_username    = "testadmin230106031234907808"
  admin_password    = "Password1234!230106031234907808"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230106031234907808"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230106031234907808"
  ...
  identifier {
    publisher = "AccTesPublisher230106031234907808"
    offer     = "AccTesOffer230106031234907808"
    sku       = "AccTesSku230106031234907808"
  }
}
