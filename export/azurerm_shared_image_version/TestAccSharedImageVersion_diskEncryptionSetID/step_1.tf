...
locals {
  number            = "230324051802725849"
  location          = "West Europe"
  domain_name_label = "acctestvm-jtxhv"
  random_string     = "jtxhv"
  admin_username    = "testadmin230324051802725849"
  admin_password    = "Password1234!230324051802725849"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230324051802725849"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230324051802725849"
  ...
  identifier {
    publisher = "AccTesPublisher230324051802725849"
    offer     = "AccTesOffer230324051802725849"
    sku       = "AccTesSku230324051802725849"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230324051802725849"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
