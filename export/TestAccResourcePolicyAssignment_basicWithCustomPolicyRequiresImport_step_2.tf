...
resource "azurerm_resource_group" "test" {
  name     = "acctest211105030357127639"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-211105030357127639"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestpol-211105030357127639"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestpol-211105030357127639"
...
resource "azurerm_resource_policy_assignment" "test" {
  name                 = "acctestpa-211105030357127639"
