...
locals {
  number            = "230421021839854459"
  location          = "West Europe"
  domain_name_label = "acctestvm-3ymmw"
  random_string     = "3ymmw"
  admin_username    = "testadmin230421021839854459"
  admin_password    = "Password1234!230421021839854459"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230421021839854459"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230421021839854459"
  ...
  identifier {
    publisher = "AccTesPublisher230421021839854459"
    offer     = "AccTesOffer230421021839854459"
    sku       = "AccTesSku230421021839854459"
  }
}
