...
locals {
  number            = "240105060444559769"
  location          = "West Europe"
  domain_name_label = "acctestvm-kinx1"
  random_string     = "kinx1"
  admin_username    = "testadmin240105060444559769"
  admin_password    = "Password1234!240105060444559769"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105060444559769"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105060444559769"
  ...
  identifier {
    publisher = "AccTesPublisher240105060444559769"
    offer     = "AccTesOffer240105060444559769"
    sku       = "AccTesSku240105060444559769"
  }
}
