...
locals {
  number            = "221124181402013961"
  location          = "West Europe"
  domain_name_label = "acctestvm-hstej"
  random_string     = "hstej"
  admin_username    = "testadmin221124181402013961"
  admin_password    = "Password1234!221124181402013961"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221124181402013961"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221124181402013961"
  ...
  identifier {
    publisher = "AccTesPublisher221124181402013961"
    offer     = "AccTesOffer221124181402013961"
    sku       = "AccTesSku221124181402013961"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-221124181402013961"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
