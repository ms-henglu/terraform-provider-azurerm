...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-231020040746256334"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctvn-231020040746256334"
...
resource "azurerm_subnet" "test" {
  name                 = "acctsub-231020040746256334"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_network_interface" "test" {
  name                = "acctni-231020040746256334"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_virtual_machine" "test" {
  name                  = "acctvm-231020040746256334"
  location              = azurerm_resource_group.test.location
  resource_group_name   = azurerm_resource_group.test.name
  ...
  os_profile {
    computer_name  = "hostname231020040746256334"
...
resource "azurerm_virtual_machine_extension" "test" {
  name                 = "acctvme-231020040746256334"
