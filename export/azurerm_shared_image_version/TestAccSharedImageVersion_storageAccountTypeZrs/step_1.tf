...
locals {
  number            = "240112224137955758"
  location          = "West Europe"
  domain_name_label = "acctestvm-eocyz"
  random_string     = "eocyz"
  admin_username    = "testadmin240112224137955758"
  admin_password    = "Password1234!240112224137955758"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240112224137955758"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240112224137955758"
  ...
  identifier {
    publisher = "AccTesPublisher240112224137955758"
    offer     = "AccTesOffer240112224137955758"
    sku       = "AccTesSku240112224137955758"
  }
}
