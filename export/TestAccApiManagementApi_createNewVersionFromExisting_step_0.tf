...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220415030109958245"
  location = "West Europe"
}

resource "azurerm_api_management" "test" {
  name                = "acctestAM-220415030109958245"
...
resource "azurerm_api_management_api" "test" {
  name                = "acctestapi-220415030109958245"
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_api_management_api_version_set" "test" {
  name                = "acctestAMAVS-220415030109958245"
  resource_group_name = azurerm_resource_group.test.name
  api_management_name = azurerm_api_management.test.name
...
resource "azurerm_api_management_api" "version" {
  name                = "acctestVersion-220415030109958245"
  resource_group_name = azurerm_resource_group.test.name
  api_management_name = azurerm_api_management.test.name
