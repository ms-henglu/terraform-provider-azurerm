...
locals {
  number            = "230707003540142307"
  location          = "West Europe"
  domain_name_label = "acctestvm-mc8bg"
  random_string     = "mc8bg"
  admin_username    = "testadmin230707003540142307"
  admin_password    = "Password1234!230707003540142307"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230707003540142307"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230707003540142307"
  ...
  identifier {
    publisher = "AccTesPublisher230707003540142307"
    offer     = "AccTesOffer230707003540142307"
    sku       = "AccTesSku230707003540142307"
  }
}
