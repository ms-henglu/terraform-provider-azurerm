...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220905045548229519"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220905045548229519"
  ...
  identifier {
    publisher = "AccTesPublisher220905045548229519"
    offer     = "AccTesOffer220905045548229519"
    sku       = "AccTesSku220905045548229519"
  }
}
