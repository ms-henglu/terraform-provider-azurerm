...
locals {
  ...
  vm_name           = "acctestsourcevm-230915023108406480"
  admin_username    = "testadmin230915023108406480"
  admin_password    = "Password1234!230915023108406480"
}

resource "azurerm_resource_group" "test" {
  name     = "acctestRG-230915023108406480"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestnw-230915023108406480"
...
resource "azurerm_public_ip" "test" {
  name                = "acctpip-230915023108406480"
  location            = "${azurerm_resource_group.test.location}"
  resource_group_name = "${azurerm_resource_group.test.name}"
...
resource "azurerm_network_interface" "public" {
  name                = "acctnicsource-230915023108406480"
  location            = "${azurerm_resource_group.test.location}"
  resource_group_name = "${azurerm_resource_group.test.name}"
...
resource "azurerm_network_interface" "test" {
  name                = "acctestnic-230915023108406480"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "source" {
  name                            = "acctestsourceVM-230915023108406480"
  resource_group_name             = azurerm_resource_group.test.name
  location                        = azurerm_resource_group.test.location
  size                            = "Standard_F2"
...
resource "azurerm_linux_virtual_machine" "test" {
  name                            = "acctestVM-230915023108406480"
  resource_group_name             = azurerm_resource_group.test.name
  location                        = azurerm_resource_group.test.location
  size                            = "Standard_F2"
