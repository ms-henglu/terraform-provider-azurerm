...
locals {
  number            = "210924010808662743"
  location          = "West Europe"
  domain_name_label = "acctestvm-ef8qm"
  random_string     = "ef8qm"
  admin_username    = "testadmin210924010808662743"
  admin_password    = "Password1234!210924010808662743"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210924010808662743"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210924010808662743"
  ...
  identifier {
    publisher = "AccTesPublisher210924010808662743"
    offer     = "AccTesOffer210924010808662743"
    sku       = "AccTesSku210924010808662743"
  }
}
