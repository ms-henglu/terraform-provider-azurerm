...
locals {
  number            = "230113180850406840"
  location          = "West Europe"
  domain_name_label = "acctestvm-4fgyu"
  random_string     = "4fgyu"
  admin_username    = "testadmin230113180850406840"
  admin_password    = "Password1234!230113180850406840"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230113180850406840"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230113180850406840"
  ...
  identifier {
    publisher = "AccTesPublisher230113180850406840"
    offer     = "AccTesOffer230113180850406840"
    sku       = "AccTesSku230113180850406840"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230113180850406840"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
