...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-211210035452452882"
  location = "West Europe"
}

resource "azurerm_iothub" "test" {
  name                = "acctestiothub-211210035452452882"
...
resource "azurerm_stream_analytics_job" "test" {
  name                                     = "acctestjob-211210035452452882"
  resource_group_name                      = azurerm_resource_group.test.name
  location                                 = azurerm_resource_group.test.location
...
resource "azurerm_iothub" "updated" {
  name                = "acctestiot2-211210035452452882"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_stream_analytics_stream_input_iothub" "test" {
  name                         = "acctestinput-211210035452452882"
