...
locals {
  number            = "220627130916066616"
  location          = "West Europe"
  domain_name_label = "acctestvm-nm9gp"
  random_string     = "nm9gp"
  admin_username    = "testadmin220627130916066616"
  admin_password    = "Password1234!220627130916066616"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627130916066616"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627130916066616"
  ...
  identifier {
    publisher = "AccTesPublisher220627130916066616"
    offer     = "AccTesOffer220627130916066616"
    sku       = "AccTesSku220627130916066616"
  }
}
