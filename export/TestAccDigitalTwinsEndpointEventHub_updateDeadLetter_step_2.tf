...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-dtwin-211029015539230175"
  location = "West Europe"
}


resource "azurerm_digital_twins_instance" "test" {
  name                = "acctest-DT-211029015539230175"
...
resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhubnamespace-211029015539230175"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_eventhub" "test" {
  name                = "acctesteventhub-211029015539230175"
...
resource "azurerm_eventhub_authorization_rule" "test" {
  name                = "acctest-r211029015539230175"
  namespace_name      = azurerm_eventhub_namespace.test.name
...
resource "azurerm_digital_twins_endpoint_eventhub" "test" {
  name                                 = "acctest-EH-211029015539230175"
