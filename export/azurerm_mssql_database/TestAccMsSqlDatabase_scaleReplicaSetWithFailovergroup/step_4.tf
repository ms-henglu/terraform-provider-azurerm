...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-mssql-240311032631157073"
  location = "West Europe"
}

resource "azurerm_mssql_server" "test" {
  name                         = "acctest-sqlserver-240311032631157073"
...
resource "azurerm_mssql_database" "test" {
  name         = "acctest-db-240311032631157073"
...
resource "azurerm_resource_group" "second" {
  name     = "acctestRG-mssql2-240311032631157073"
  location = "West US 2"
}

resource "azurerm_mssql_server" "second" {
  name                         = "acctest-sqlserver2-240311032631157073"
...
resource "azurerm_mssql_failover_group" "failover_group" {
  name      = "acctest-fog-240311032631157073"
  server_id = azurerm_mssql_server.test.id
