...
locals {
  number            = "231016033603931965"
  location          = "West Europe"
  domain_name_label = "acctestvm-1p6af"
  random_string     = "1p6af"
  admin_username    = "testadmin231016033603931965"
  admin_password    = "Password1234!231016033603931965"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-231016033603931965"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
