...
locals {
  number            = "220415030257363468"
  location          = "West Europe"
  domain_name_label = "acctestvm-merra"
  random_string     = "merra"
  admin_username    = "testadmin220415030257363468"
  admin_password    = "Password1234!220415030257363468"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220415030257363468"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220415030257363468"
  ...
  identifier {
    publisher = "AccTesPublisher220415030257363468"
    offer     = "AccTesOffer220415030257363468"
    sku       = "AccTesSku220415030257363468"
  }
}
