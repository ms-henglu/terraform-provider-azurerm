...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220422011655555635"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220422011655555635"
  ...
  identifier {
    publisher = "AccTesPublisher220422011655555635"
    offer     = "AccTesOffer220422011655555635"
    sku       = "AccTesSku220422011655555635"
  }
}
