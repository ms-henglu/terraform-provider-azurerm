...
locals {
  number            = "230616074443134394"
  location          = "West Europe"
  domain_name_label = "acctestvm-kj8db"
  random_string     = "kj8db"
  admin_username    = "testadmin230616074443134394"
  admin_password    = "Password1234!230616074443134394"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230616074443134394"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230616074443134394"
  ...
  identifier {
    publisher = "AccTesPublisher230616074443134394"
    offer     = "AccTesOffer230616074443134394"
    sku       = "AccTesSku230616074443134394"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230616074443134394"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
