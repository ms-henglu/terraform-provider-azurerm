...
locals {
  number            = "221019060412967517"
  location          = "West Europe"
  domain_name_label = "acctestvm-0bz44"
  random_string     = "0bz44"
  admin_username    = "testadmin221019060412967517"
  admin_password    = "Password1234!221019060412967517"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221019060412967517"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221019060412967517"
  ...
  identifier {
    publisher = "AccTesPublisher221019060412967517"
    offer     = "AccTesOffer221019060412967517"
    sku       = "AccTesSku221019060412967517"
  }
}
