...
locals {
  rg_name              = "acctest-nested-rg-230227033301612544"
  location             = "West Europe"
  vn_name              = "acctest-nested-vn-230227033301612544"
  ip_name              = "acctest-nested-ip-230227033301612544"
  vm_name              = "acctest-nested-vm-230227033301612544"
  nic_name             = "acctest-nested-nic-230227033301612544"
  disk_name            = "acctest-nested-disk-230227033301612544"
  keyvault_name        = "acctkv230227033301612544"
  nsg_name             = "acctest-nested-nsg-230227033301612544"
  recovery_vault_name  = "acctest-nested-recovery-vault-230227033301612544"
  recovery_site_name   = "acctest-nested-recovery-site-230227033301612544"
  admin_name           = "acctestadmin"
  cert_name            = "acctestcert"
  storage_account_name = "acctestsajmx0d"
}
...
resource "azurerm_windows_virtual_machine" "host" {
  ...
  additional_unattend_content {
    setting = "AutoLogon"
    content = "<AutoLogon><Password><Value>^i!#Ia225e</Value></Password><Enabled>true</Enabled><LogonCount>1</LogonCount><Username>${local.admin_name}</Username></AutoLogon>"
  }
...
resource "azurerm_site_recovery_hyperv_replication_policy" "test" {
  recovery_vault_id                                  = azurerm_recovery_services_vault.test.id
  name                                               = "acctest-policy-230227033301612544"
