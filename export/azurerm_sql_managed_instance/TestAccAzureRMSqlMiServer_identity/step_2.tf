...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG1-sql-230707011013315533"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet1-230707011013315533"
...
resource "azurerm_subnet" "test" {
  name                 = "subnet1-230707011013315533"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_network_security_group" "test" {
  name                = "mi-security-group1-230707011013315533"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
}
...
resource "azurerm_route_table" "test" {
  name                          = "routetable1-230707011013315533"
  location                      = azurerm_resource_group.test.location
  resource_group_name           = azurerm_resource_group.test.name
...
resource "azurerm_sql_managed_instance" "test" {
  name                         = "acctestsqlserver230707011013315533"
  resource_group_name          = azurerm_resource_group.test.name
  location                     = azurerm_resource_group.test.location
