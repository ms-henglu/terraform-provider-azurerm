...
locals {
  number            = "230505050044916932"
  location          = "West Europe"
  domain_name_label = "acctestvm-9qumd"
  random_string     = "9qumd"
  admin_username    = "testadmin230505050044916932"
  admin_password    = "Password1234!230505050044916932"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230505050044916932"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230505050044916932"
  ...
  identifier {
    publisher = "AccTesPublisher230505050044916932"
    offer     = "AccTesOffer230505050044916932"
    sku       = "AccTesSku230505050044916932"
  }
}
