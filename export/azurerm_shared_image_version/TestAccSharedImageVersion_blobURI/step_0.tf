...
locals {
  number            = "230609091011719131"
  location          = "West Europe"
  domain_name_label = "acctestvm-qw1m6"
  random_string     = "qw1m6"
  admin_username    = "testadmin230609091011719131"
  admin_password    = "Password1234!230609091011719131"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230609091011719131"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230609091011719131"
  ...
  identifier {
    publisher = "AccTesPublisher230609091011719131"
    offer     = "AccTesOffer230609091011719131"
    sku       = "AccTesSku230609091011719131"
  }
}
