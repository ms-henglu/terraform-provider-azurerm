...
locals {
  number            = "220905045548228171"
  location          = "West Europe"
  domain_name_label = "acctestvm-11dvi"
  random_string     = "11dvi"
  admin_username    = "testadmin220905045548228171"
  admin_password    = "Password1234!220905045548228171"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220905045548228171"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220905045548228171"
  ...
  identifier {
    publisher = "AccTesPublisher220905045548228171"
    offer     = "AccTesOffer220905045548228171"
    sku       = "AccTesSku220905045548228171"
  }
}
