...
locals {
  number            = "220715004235785706"
  location          = "West Europe"
  domain_name_label = "acctestvm-o4uwk"
  random_string     = "o4uwk"
  admin_username    = "testadmin220715004235785706"
  admin_password    = "Password1234!220715004235785706"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220715004235785706"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220715004235785706"
  ...
  identifier {
    publisher = "AccTesPublisher220715004235785706"
    offer     = "AccTesOffer220715004235785706"
    sku       = "AccTesSku220715004235785706"
  }
}
