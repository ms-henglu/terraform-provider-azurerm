...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-dbms-230613071646364317"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestVnet-dbms-230613071646364317"
...
resource "azurerm_subnet" "test" {
  name                 = "acctestSubnet-dbms-230613071646364317"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_database_migration_service" "test" {
  name                = "acctestDbms-230613071646364317"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_database_migration_project" "test" {
  name                = "acctestDbmsProject-230613071646364317"
