...
locals {
  number            = "220905045548227034"
  location          = "West Europe"
  domain_name_label = "acctestvm-0dywy"
  random_string     = "0dywy"
  admin_username    = "testadmin220905045548227034"
  admin_password    = "Password1234!220905045548227034"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220905045548227034"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220905045548227034"
  ...
  identifier {
    publisher = "AccTesPublisher220905045548227034"
    offer     = "AccTesOffer220905045548227034"
    sku       = "AccTesSku220905045548227034"
  }
}
