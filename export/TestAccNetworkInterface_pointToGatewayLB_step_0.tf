...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220128052857300780"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-220128052857300780"
...
resource "azurerm_virtual_network" "gateway" {
  name                = "acctestvnet-gw-220128052857300780"
...
resource "azurerm_subnet" "gateway" {
  name                 = "acctestsubnet-gw-220128052857300780"
...
resource "azurerm_lb" "gateway" {
  name                = "acctestlb-220128052857300780"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Gateway"
...
resource "azurerm_lb_backend_address_pool" "gateway" {
  name            = "acctestbap-220128052857300780"
...
resource "azurerm_public_ip" "test" {
  name                = "acctestpip-220128052857300780"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Standard"
...
resource "azurerm_network_interface" "test" {
  name                = "acctestnic-220128052857300780"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
