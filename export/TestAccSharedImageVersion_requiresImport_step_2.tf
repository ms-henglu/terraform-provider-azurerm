...
locals {
  number            = "220729032452207035"
  location          = "West Europe"
  domain_name_label = "acctestvm-ub6lu"
  random_string     = "ub6lu"
  admin_username    = "testadmin220729032452207035"
  admin_password    = "Password1234!220729032452207035"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220729032452207035"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220729032452207035"
  ...
  identifier {
    publisher = "AccTesPublisher220729032452207035"
    offer     = "AccTesOffer220729032452207035"
    sku       = "AccTesSku220729032452207035"
  }
}
