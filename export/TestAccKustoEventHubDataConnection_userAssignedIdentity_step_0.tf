...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-211021235129362299"
...
resource "azurerm_kusto_database" "test" {
  name                = "acctestkd-211021235129362299"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhubnamespace-211021235129362299"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Standard"
}
...
resource "azurerm_eventhub" "test" {
  name                = "acctesteventhub-211021235129362299"
...
resource "azurerm_eventhub_consumer_group" "test" {
  name                = "acctesteventhubcg-211021235129362299"
  namespace_name      = azurerm_eventhub_namespace.test.name
...
resource "azurerm_kusto_eventhub_data_connection" "test" {
  name                = "acctestkedc-211021235129362299"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  cluster_name        = azurerm_kusto_cluster.test.name
