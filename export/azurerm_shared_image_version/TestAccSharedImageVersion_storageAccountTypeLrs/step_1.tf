...
locals {
  number            = "221104005221352383"
  location          = "West Europe"
  domain_name_label = "acctestvm-ess4i"
  random_string     = "ess4i"
  admin_username    = "testadmin221104005221352383"
  admin_password    = "Password1234!221104005221352383"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221104005221352383"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221104005221352383"
  ...
  identifier {
    publisher = "AccTesPublisher221104005221352383"
    offer     = "AccTesOffer221104005221352383"
    sku       = "AccTesSku221104005221352383"
  }
}
