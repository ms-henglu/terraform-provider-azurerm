...
locals {
  number            = "220722051724577448"
  location          = "West Europe"
  domain_name_label = "acctestvm-z0lcd"
  random_string     = "z0lcd"
  admin_username    = "testadmin220722051724577448"
  admin_password    = "Password1234!220722051724577448"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220722051724577448"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220722051724577448"
  ...
  identifier {
    publisher = "AccTesPublisher220722051724577448"
    offer     = "AccTesOffer220722051724577448"
    sku       = "AccTesSku220722051724577448"
  }
}
