...
locals {
  number            = "220627134335456236"
  location          = "West Europe"
  domain_name_label = "acctestvm-avxs4"
  random_string     = "avxs4"
  admin_username    = "testadmin220627134335456236"
  admin_password    = "Password1234!220627134335456236"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627134335456236"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627134335456236"
  ...
  identifier {
    publisher = "AccTesPublisher220627134335456236"
    offer     = "AccTesOffer220627134335456236"
    sku       = "AccTesSku220627134335456236"
  }
}
