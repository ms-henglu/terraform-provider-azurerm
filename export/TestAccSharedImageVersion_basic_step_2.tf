...
locals {
  number            = "210917031451898726"
  location          = "West Europe"
  domain_name_label = "acctestvm-rwzc8"
  random_string     = "rwzc8"
  admin_username    = "testadmin210917031451898726"
  admin_password    = "Password1234!210917031451898726"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210917031451898726"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210917031451898726"
  ...
  identifier {
    publisher = "AccTesPublisher210917031451898726"
    offer     = "AccTesOffer210917031451898726"
    sku       = "AccTesSku210917031451898726"
  }
}
