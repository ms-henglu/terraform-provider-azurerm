...
locals {
  number            = "230818023718894606"
  location          = "West Europe"
  domain_name_label = "acctestvm-ok7hu"
  random_string     = "ok7hu"
  admin_username    = "testadmin230818023718894606"
  admin_password    = "Password1234!230818023718894606"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230818023718894606"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230818023718894606"
  ...
  identifier {
    publisher = "AccTesPublisher230818023718894606"
    offer     = "AccTesOffer230818023718894606"
    sku       = "AccTesSku230818023718894606"
  }
}
