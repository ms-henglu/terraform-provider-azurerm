...
locals {
  number            = "230613071532220513"
  location          = "West Europe"
  domain_name_label = "acctestvm-ryov7"
  random_string     = "ryov7"
  admin_username    = "testadmin230613071532220513"
  admin_password    = "Password1234!230613071532220513"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230613071532220513"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230613071532220513"
  ...
  identifier {
    publisher = "AccTesPublisher230613071532220513"
    offer     = "AccTesOffer230613071532220513"
    sku       = "AccTesSku230613071532220513"
  }
}
