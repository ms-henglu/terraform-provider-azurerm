...
locals {
  number            = "240315122549890872"
  location          = "West Europe"
  domain_name_label = "acctestvm-vxwst"
  random_string     = "vxwst"
  admin_username    = "testadmin240315122549890872"
  admin_password    = "Password1234!240315122549890872"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-240315122549890872"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
