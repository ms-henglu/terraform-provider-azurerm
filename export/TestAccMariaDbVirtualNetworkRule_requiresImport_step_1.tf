...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-210910021627725471"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvnet210910021627725471"
...
resource "azurerm_subnet" "test" {
  name                 = "acctestsubnet210910021627725471"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_mariadb_server" "test" {
  name                         = "acctestmariadbsvr-210910021627725471"
  location                     = azurerm_resource_group.test.location
  resource_group_name          = azurerm_resource_group.test.name
...
resource "azurerm_mariadb_virtual_network_rule" "test" {
  name                = "acctestmariadbvnetrule210910021627725471"
  resource_group_name = azurerm_resource_group.test.name
