...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105060444553563"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105060444553563"
  ...
  identifier {
    publisher = "AccTesPublisher240105060444553563"
    offer     = "AccTesOffer240105060444553563"
    sku       = "AccTesSku240105060444553563"
  }
}
