...
locals {
  number            = "221111013238944050"
  location          = "West Europe"
  domain_name_label = "acctestvm-prw2z"
  random_string     = "prw2z"
  admin_username    = "testadmin221111013238944050"
  admin_password    = "Password1234!221111013238944050"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221111013238944050"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221111013238944050"
  ...
  identifier {
    publisher = "AccTesPublisher221111013238944050"
    offer     = "AccTesOffer221111013238944050"
    sku       = "AccTesSku221111013238944050"
  }
}
