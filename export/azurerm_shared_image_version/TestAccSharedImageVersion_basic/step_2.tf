...
locals {
  number            = "230227032410654250"
  location          = "West Europe"
  domain_name_label = "acctestvm-4asoh"
  random_string     = "4asoh"
  admin_username    = "testadmin230227032410654250"
  admin_password    = "Password1234!230227032410654250"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230227032410654250"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230227032410654250"
  ...
  identifier {
    publisher = "AccTesPublisher230227032410654250"
    offer     = "AccTesOffer230227032410654250"
    sku       = "AccTesSku230227032410654250"
  }
}
