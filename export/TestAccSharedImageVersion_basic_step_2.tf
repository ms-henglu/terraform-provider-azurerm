...
locals {
  number            = "210910021215856809"
  location          = "West Europe"
  domain_name_label = "acctestvm-n3drw"
  random_string     = "n3drw"
  admin_username    = "testadmin210910021215856809"
  admin_password    = "Password1234!210910021215856809"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210910021215856809"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210910021215856809"
  ...
  identifier {
    publisher = "AccTesPublisher210910021215856809"
    offer     = "AccTesOffer210910021215856809"
    sku       = "AccTesSku210910021215856809"
  }
}
