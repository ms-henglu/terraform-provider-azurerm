...
func (client AdminRulesClient) CreateOrUpdate(ctx context.Context, adminRule BasicBaseRule, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string, ruleName string) (result BaseRuleModel, err error) {
...
func (client AdminRulesClient) CreateOrUpdatePreparer(ctx context.Context, adminRule BasicBaseRule, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string, ruleName string) (*http.Request, error) {
...
func (client AdminRulesClient) CreateOrUpdateResponder(resp *http.Response) (result BaseRuleModel, err error) {
...
// ruleCollectionName - the name of the network manager security Configuration rule collection.
// ruleName - the name of the rule.
func (client AdminRulesClient) Get(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string, ruleName string) (result BaseRuleModel, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client AdminRulesClient) GetResponder(resp *http.Response) (result BaseRuleModel, err error) {
	err = autorest.Respond(
		resp,
...
func (client AdminRulesClient) List(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string, top *int32, skipToken string) (result RuleListResultPage, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client AdminRulesClient) ListResponder(resp *http.Response) (result RuleListResult, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK),
		autorest.ByUnmarshallingJSON(&result),
...
func (client AdminRulesClient) listNextResults(ctx context.Context, lastResults RuleListResult) (result RuleListResult, err error) {
...
func (client AdminRulesClient) ListComplete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string, top *int32, skipToken string) (result RuleListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/AdminRulesClient.List")
		defer func() {
			sc := -1
