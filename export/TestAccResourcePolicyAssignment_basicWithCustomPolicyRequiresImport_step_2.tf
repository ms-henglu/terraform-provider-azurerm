...
resource "azurerm_resource_group" "test" {
  name     = "acctest220905050307898122"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-220905050307898122"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestpol-220905050307898122"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestpol-220905050307898122"
...
resource "azurerm_resource_policy_assignment" "test" {
  name                 = "acctestpa-220905050307898122"
