...
locals {
  number            = "220623223149345365"
  location          = "West Europe"
  domain_name_label = "acctestvm-eo2ug"
  random_string     = "eo2ug"
  admin_username    = "testadmin220623223149345365"
  admin_password    = "Password1234!220623223149345365"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220623223149345365"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220623223149345365"
  ...
  identifier {
    publisher = "AccTesPublisher220623223149345365"
    offer     = "AccTesOffer220623223149345365"
    sku       = "AccTesSku220623223149345365"
  }
}
