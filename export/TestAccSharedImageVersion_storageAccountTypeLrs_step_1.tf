...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220527033935756441"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220527033935756441"
  ...
  identifier {
    publisher = "AccTesPublisher220527033935756441"
    offer     = "AccTesOffer220527033935756441"
    sku       = "AccTesSku220527033935756441"
  }
}
