...
locals {
  number            = "220513023023746847"
  location          = "West Europe"
  domain_name_label = "acctestvm-msftj"
  random_string     = "msftj"
  admin_username    = "testadmin220513023023746847"
  admin_password    = "Password1234!220513023023746847"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220513023023746847"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220513023023746847"
  ...
  identifier {
    publisher = "AccTesPublisher220513023023746847"
    offer     = "AccTesOffer220513023023746847"
    sku       = "AccTesSku220513023023746847"
  }
}
