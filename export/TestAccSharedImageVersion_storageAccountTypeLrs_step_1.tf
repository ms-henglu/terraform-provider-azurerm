...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220204092752865381"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220204092752865381"
  ...
  identifier {
    publisher = "AccTesPublisher220204092752865381"
    offer     = "AccTesOffer220204092752865381"
    sku       = "AccTesSku220204092752865381"
  }
}
