...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-230922053647702718"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctestAA-230922053647702718"
...
resource "azurerm_automation_credential" "test" {
  name                    = "acctest-230922053647702718"
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestnw-230922053647702718"
...
resource "azurerm_network_interface" "test" {
  name                = "acctni-230922053647702718"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "test" {
  name                = "acctestVM-230922053647702718"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_automation_hybrid_runbook_worker" "test" {
  ...
  worker_id               = "80cfab46-947a-45c1-a4df-a6c925d38f30"
