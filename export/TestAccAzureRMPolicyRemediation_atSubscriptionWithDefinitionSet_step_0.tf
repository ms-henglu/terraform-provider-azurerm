...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-zfnhp"
  policy_type  = "Custom"
  display_name = "testPolicySet-zfnhp"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-zfnhp"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-zfnhp"
