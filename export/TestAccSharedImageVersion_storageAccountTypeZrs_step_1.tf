...
locals {
  number            = "220211130332034248"
  location          = "West Europe"
  domain_name_label = "acctestvm-2zpse"
  random_string     = "2zpse"
  admin_username    = "testadmin220211130332034248"
  admin_password    = "Password1234!220211130332034248"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220211130332034248"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220211130332034248"
  ...
  identifier {
    publisher = "AccTesPublisher220211130332034248"
    offer     = "AccTesOffer220211130332034248"
    sku       = "AccTesSku220211130332034248"
  }
}
