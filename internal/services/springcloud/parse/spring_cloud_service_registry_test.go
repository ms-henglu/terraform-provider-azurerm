...
func TestSpringCloudServiceRegistryIDFormatter(t *testing.T) {
	actual := NewSpringCloudServiceRegistryID("12345678-1234-9876-4563-123456789012", "resourceGroup1", "service1", "serviceRegistry1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resourceGroup1/providers/Microsoft.AppPlatform/Spring/service1/serviceRegistries/serviceRegistry1"
	if actual != expected {
...
func TestSpringCloudServiceRegistryID(t *testing.T) {
	testData := []struct {
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resourceGroup1/providers/Microsoft.AppPlatform/Spring/service1/serviceRegistries/",
			Error: true,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resourceGroup1/providers/Microsoft.AppPlatform/Spring/service1/serviceRegistries/serviceRegistry1",
			Expected: &SpringCloudServiceRegistryId{
