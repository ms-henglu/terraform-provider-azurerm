...
locals {
  number            = "240311031615618652"
  location          = "West Europe"
  domain_name_label = "acctestvm-vxvbx"
  random_string     = "vxvbx"
  admin_username    = "testadmin240311031615618652"
  admin_password    = "Password1234!240311031615618652"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240311031615618652"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240311031615618652"
  ...
  identifier {
    publisher = "AccTesPublisher240311031615618652"
    offer     = "AccTesOffer240311031615618652"
    sku       = "AccTesSku240311031615618652"
  }
}
