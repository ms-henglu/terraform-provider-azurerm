...
locals {
  number            = "220715014258877067"
  location          = "West Europe"
  domain_name_label = "acctestvm-9tcjj"
  random_string     = "9tcjj"
  admin_username    = "testadmin220715014258877067"
  admin_password    = "Password1234!220715014258877067"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220715014258877067"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220715014258877067"
  ...
  identifier {
    publisher = "AccTesPublisher220715014258877067"
    offer     = "AccTesOffer220715014258877067"
    sku       = "AccTesSku220715014258877067"
  }
}
