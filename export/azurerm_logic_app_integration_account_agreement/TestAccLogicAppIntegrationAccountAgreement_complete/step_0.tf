...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-logic-230602030716713976"
  location = "West Europe"
}

resource "azurerm_logic_app_integration_account" "test" {
  name                = "acctest-ia-230602030716713976"
...
resource "azurerm_logic_app_integration_account_partner" "host" {
  name                     = "acctest-hostpartner-230602030716713976"
  resource_group_name      = azurerm_resource_group.test.name
...
resource "azurerm_logic_app_integration_account_partner" "guest" {
  name                     = "acctest-guestpartner-230602030716713976"
  resource_group_name      = azurerm_resource_group.test.name
  integration_account_name = azurerm_logic_app_integration_account.test.name
...
resource "azurerm_logic_app_integration_account_agreement" "test" {
  name                     = "acctest-agreement-230602030716713976"
  resource_group_name      = azurerm_resource_group.test.name
  integration_account_name = azurerm_logic_app_integration_account.test.name
  agreement_type           = "AS2"
