...
locals {
  number            = "211001053545928576"
  location          = "West Europe"
  domain_name_label = "acctestvm-omnyb"
  random_string     = "omnyb"
  admin_username    = "testadmin211001053545928576"
  admin_password    = "Password1234!211001053545928576"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211001053545928576"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211001053545928576"
  ...
  identifier {
    publisher = "AccTesPublisher211001053545928576"
    offer     = "AccTesOffer211001053545928576"
    sku       = "AccTesSku211001053545928576"
  }
}
