...
locals {
  number            = "230915023108513179"
  location          = "West Europe"
  domain_name_label = "acctestvm-19dpe"
  random_string     = "19dpe"
  admin_username    = "testadmin230915023108513179"
  admin_password    = "Password1234!230915023108513179"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230915023108513179"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230915023108513179"
  ...
  identifier {
    publisher = "AccTesPublisher230915023108513179"
    offer     = "AccTesOffer230915023108513179"
    sku       = "AccTesSku230915023108513179"
  }
}
