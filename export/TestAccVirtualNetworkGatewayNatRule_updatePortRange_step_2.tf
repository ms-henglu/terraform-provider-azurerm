...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-vnetgwnatrule-220630211149443412"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-220630211149443412"
...
resource "azurerm_public_ip" "test" {
  name                = "acctestpip-220630211149443412"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network_gateway" "test" {
  name                = "acctestvng-220630211149443412"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network_gateway_nat_rule" "test" {
  name                       = "acctest-vnetgwnatrule-220630211149443412"
  resource_group_name        = azurerm_resource_group.test.name
