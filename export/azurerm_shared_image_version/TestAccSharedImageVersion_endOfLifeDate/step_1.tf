...
locals {
  number            = "230922053821494246"
  location          = "West Europe"
  domain_name_label = "acctestvm-iud0r"
  random_string     = "iud0r"
  admin_username    = "testadmin230922053821494246"
  admin_password    = "Password1234!230922053821494246"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230922053821494246"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230922053821494246"
  ...
  identifier {
    publisher = "AccTesPublisher230922053821494246"
    offer     = "AccTesOffer230922053821494246"
    sku       = "AccTesSku230922053821494246"
  }
}
