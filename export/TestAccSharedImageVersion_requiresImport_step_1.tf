...
locals {
  number            = "211217075027329272"
  location          = "West Europe"
  domain_name_label = "acctestvm-teh2i"
  random_string     = "teh2i"
  admin_username    = "testadmin211217075027329272"
  admin_password    = "Password1234!211217075027329272"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211217075027329272"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211217075027329272"
  ...
  identifier {
    publisher = "AccTesPublisher211217075027329272"
    offer     = "AccTesOffer211217075027329272"
    sku       = "AccTesSku211217075027329272"
  }
}
