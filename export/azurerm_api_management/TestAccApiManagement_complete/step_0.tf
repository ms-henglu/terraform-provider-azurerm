...
resource "azurerm_resource_group" "test1" {
  name     = "acctestRG-api1-240112033744194552"
  location = "West Europe"
}

resource "azurerm_resource_group" "test2" {
  name     = "acctestRG-api2-240112033744194552"
  location = "West US 2"
}

resource "azurerm_resource_group" "test3" {
  name     = "acctestRG-api3-240112033744194552"
  location = "East US 2"
}

resource "azurerm_api_management" "test" {
  name                      = "acctestAM-240112033744194552"
  publisher_name            = "pub1"
  ...
  hostname_configuration {
    proxy {
      host_name                    = "acctestAM-240112033744194552.azure-api.net"
