...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-ase-210928080030725843"
  location = "West Europe"
}

resource "azurerm_resource_group" "test2" {
  name     = "acctestRG2-ase-210928080030725843"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet-210928080030725843"
...
resource "azurerm_subnet" "test" {
  name                 = "acctest-subnet-210928080030725843"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_app_service_environment_v3" "test" {
  name                = "acctest-ase-210928080030725843"
  resource_group_name = azurerm_resource_group.test.name
