...
locals {
  number            = "220729032452206033"
  location          = "West Europe"
  domain_name_label = "acctestvm-8dwaf"
  random_string     = "8dwaf"
  admin_username    = "testadmin220729032452206033"
  admin_password    = "Password1234!220729032452206033"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220729032452206033"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220729032452206033"
  ...
  identifier {
    publisher = "AccTesPublisher220729032452206033"
    offer     = "AccTesOffer220729032452206033"
    sku       = "AccTesSku220729032452206033"
  }
}
