...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220726014613800316"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220726014613800316"
  ...
  identifier {
    publisher = "AccTesPublisher220726014613800316"
    offer     = "AccTesOffer220726014613800316"
    sku       = "AccTesSku220726014613800316"
  }
}
