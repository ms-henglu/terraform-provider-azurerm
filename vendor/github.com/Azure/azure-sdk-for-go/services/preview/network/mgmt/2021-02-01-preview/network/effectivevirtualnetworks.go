...
func (client EffectiveVirtualNetworksClient) ListByNetworkGroup(ctx context.Context, resourceGroupName string, networkManagerName string, networkGroupName string, parameters QueryRequestOptions) (result EffectiveVirtualNetworksListResult, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: parameters,
			Constraints: []validation.Constraint{{Target: "parameters.Top", Name: validation.Null, Rule: false,
				...
				{Target: "parameters.Skip", Name: validation.Null, Rule: false,
					Chain: []validation.Constraint{{Target: "parameters.Skip", Name: validation.InclusiveMinimum, Rule: int64(0), Chain: nil}}}}}}); err != nil {
...
func (client EffectiveVirtualNetworksClient) ListByNetworkManager(ctx context.Context, resourceGroupName string, networkManagerName string, top *int32, skipToken string, parameters *EffectiveVirtualNetworksParameter) (result EffectiveVirtualNetworksListResult, err error) {
	if tracing.IsEnabled() {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: parameters,
			Constraints: []validation.Constraint{{Target: "parameters", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "parameters.Options", Name: validation.Null, Rule: false,
					Chain: []validation.Constraint{{Target: "parameters.Options.Top", Name: validation.Null, Rule: false,
						Chain: []validation.Constraint{{Target: "parameters.Options.Top", Name: validation.InclusiveMaximum, Rule: int64(1000), Chain: nil},
							{Target: "parameters.Options.Top", Name: validation.InclusiveMinimum, Rule: int64(1), Chain: nil},
						}},
						{Target: "parameters.Options.Skip", Name: validation.Null, Rule: false,
							Chain: []validation.Constraint{{Target: "parameters.Options.Skip", Name: validation.InclusiveMinimum, Rule: int64(0), Chain: nil}}},
					}},
				}}}}}); err != nil {
