...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-240112033911084520"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctestAA-240112033911084520"
...
resource "azurerm_automation_credential" "test" {
  name                    = "acctest-240112033911084520"
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestnw-240112033911084520"
...
resource "azurerm_network_interface" "test" {
  name                = "acctni-240112033911084520"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "test" {
  name                = "acctestVM-240112033911084520"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_automation_hybrid_runbook_worker" "test" {
  ...
  worker_id               = "fc7d719b-d880-4b51-aec9-041bb28dde13"
