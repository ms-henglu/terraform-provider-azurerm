...
locals {
  number            = "230421021839855885"
  location          = "West Europe"
  domain_name_label = "acctestvm-1k1s4"
  random_string     = "1k1s4"
  admin_username    = "testadmin230421021839855885"
  admin_password    = "Password1234!230421021839855885"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230421021839855885"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230421021839855885"
  ...
  identifier {
    publisher = "AccTesPublisher230421021839855885"
    offer     = "AccTesOffer230421021839855885"
    sku       = "AccTesSku230421021839855885"
  }
}
