...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-221019055046422539"
  location = "West Europe"
}

resource "azurerm_iothub" "test" {
  name                = "acctestiothub-221019055046422539"
...
resource "azurerm_stream_analytics_job" "test" {
  name                                     = "acctestjob-221019055046422539"
  resource_group_name                      = azurerm_resource_group.test.name
  location                                 = azurerm_resource_group.test.location
...
resource "azurerm_iothub" "updated" {
  name                = "acctestiot2-221019055046422539"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_stream_analytics_stream_input_iothub" "test" {
  name                         = "acctestinput-221019055046422539"
