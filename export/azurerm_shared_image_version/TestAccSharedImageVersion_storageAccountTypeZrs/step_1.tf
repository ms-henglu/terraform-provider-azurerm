...
locals {
  number            = "230519074408703410"
  location          = "West Europe"
  domain_name_label = "acctestvm-tuc1v"
  random_string     = "tuc1v"
  admin_username    = "testadmin230519074408703410"
  admin_password    = "Password1234!230519074408703410"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230519074408703410"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230519074408703410"
  ...
  identifier {
    publisher = "AccTesPublisher230519074408703410"
    offer     = "AccTesOffer230519074408703410"
    sku       = "AccTesSku230519074408703410"
  }
}
