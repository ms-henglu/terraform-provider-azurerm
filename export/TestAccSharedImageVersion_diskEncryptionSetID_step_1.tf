...
locals {
  number            = "220630223513057081"
  location          = "West Europe"
  domain_name_label = "acctestvm-3exa3"
  random_string     = "3exa3"
  admin_username    = "testadmin220630223513057081"
  admin_password    = "Password1234!220630223513057081"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220630223513057081"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220630223513057081"
  ...
  identifier {
    publisher = "AccTesPublisher220630223513057081"
    offer     = "AccTesOffer220630223513057081"
    sku       = "AccTesSku220630223513057081"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220630223513057081"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
