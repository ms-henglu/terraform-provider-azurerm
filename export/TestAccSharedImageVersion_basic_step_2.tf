...
locals {
  number            = "220124124841961654"
  location          = "West Europe"
  domain_name_label = "acctestvm-rxc7s"
  random_string     = "rxc7s"
  admin_username    = "testadmin220124124841961654"
  admin_password    = "Password1234!220124124841961654"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220124124841961654"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220124124841961654"
  ...
  identifier {
    publisher = "AccTesPublisher220124124841961654"
    offer     = "AccTesOffer220124124841961654"
    sku       = "AccTesSku220124124841961654"
  }
}
