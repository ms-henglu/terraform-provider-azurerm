...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825025624753793"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825025624753793"
  ...
  identifier {
    publisher = "AccTesPublisher210825025624753793"
    offer     = "AccTesOffer210825025624753793"
    sku       = "AccTesSku210825025624753793"
  }
}
