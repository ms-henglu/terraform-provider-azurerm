...
locals {
  number            = "220114063934531505"
  location          = "West Europe"
  domain_name_label = "acctestvm-6fl6j"
  random_string     = "6fl6j"
  admin_username    = "testadmin220114063934531505"
  admin_password    = "Password1234!220114063934531505"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220114063934531505"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220114063934531505"
  ...
  identifier {
    publisher = "AccTesPublisher220114063934531505"
    offer     = "AccTesOffer220114063934531505"
    sku       = "AccTesSku220114063934531505"
  }
}
