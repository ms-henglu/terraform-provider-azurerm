...
func (r SynapseWorkloadClassifierResource) Exists(ctx context.Context, client *clients.Client, state *pluginsdk.InstanceState) (*bool, error) {
	...
	resp, err := client.Synapse.SQLPoolWorkloadClassifierClient.Get(ctx, id.ResourceGroup, id.WorkspaceName, id.SqlPoolName, id.WorkloadClassifierName, id.WorkloadClassifierName)
	if err != nil {
