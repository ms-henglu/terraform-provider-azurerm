...
resource "azurerm_data_protection_backup_policy_disk" "import" {
  ...
  resource_group_name             = azurerm_data_protection_backup_policy_disk.test.resource_group_name
  vault_name                      = azurerm_data_protection_backup_policy_disk.test.vault_name
  backup_repeating_time_intervals = ["R/2021-05-19T06:33:16+00:00/PT4H"]
  default_retention_duration      = "P7D"
}
`, config)
