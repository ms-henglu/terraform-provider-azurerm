...
locals {
  number            = "211203161152214186"
  location          = "West Europe"
  domain_name_label = "acctestvm-kp3f0"
  random_string     = "kp3f0"
  admin_username    = "testadmin211203161152214186"
  admin_password    = "Password1234!211203161152214186"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211203161152214186"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211203161152214186"
  ...
  identifier {
    publisher = "AccTesPublisher211203161152214186"
    offer     = "AccTesOffer211203161152214186"
    sku       = "AccTesSku211203161152214186"
  }
}
