...
locals {
  number            = "220107033655661303"
  location          = "West Europe"
  domain_name_label = "acctestvm-jts6c"
  random_string     = "jts6c"
  admin_username    = "testadmin220107033655661303"
  admin_password    = "Password1234!220107033655661303"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220107033655661303"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220107033655661303"
  ...
  identifier {
    publisher = "AccTesPublisher220107033655661303"
    offer     = "AccTesOffer220107033655661303"
    sku       = "AccTesSku220107033655661303"
  }
}
