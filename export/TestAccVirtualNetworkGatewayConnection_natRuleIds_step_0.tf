...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220630211149441061"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-220630211149441061"
...
resource "azurerm_public_ip" "test" {
  name                = "acctestpip-220630211149441061"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network_gateway" "test" {
  name                = "acctestvnetgw-220630211149441061"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_local_network_gateway" "test" {
  name                = "acctestlocalnetworkgw-220630211149441061"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network_gateway_nat_rule" "test" {
  name                       = "acctestvnetgwegressnatrule-220630211149441061"
  resource_group_name        = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network_gateway_nat_rule" "test2" {
  name                       = "acctestvnetgwingressnatrule-220630211149441061"
  resource_group_name        = azurerm_resource_group.test.name
  virtual_network_gateway_id = data.azurerm_virtual_network_gateway.test.id
  mode                       = "IngressSnat"
  type                       = "Dynamic"
...
resource "azurerm_virtual_network_gateway_connection" "test" {
  name                = "acctestvnetgwconn-220630211149441061"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
