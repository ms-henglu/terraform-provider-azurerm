...
locals {
  number            = "240119024707326478"
  location          = "West Europe"
  domain_name_label = "acctestvm-msbtv"
  random_string     = "msbtv"
  admin_username    = "testadmin240119024707326478"
  admin_password    = "Password1234!240119024707326478"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-240119024707326478"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
