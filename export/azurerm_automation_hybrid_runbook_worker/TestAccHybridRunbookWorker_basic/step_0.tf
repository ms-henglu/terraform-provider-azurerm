...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-240112224008119082"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctestAA-240112224008119082"
...
resource "azurerm_automation_credential" "test" {
  name                    = "acctest-240112224008119082"
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestnw-240112224008119082"
...
resource "azurerm_network_interface" "test" {
  name                = "acctni-240112224008119082"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "test" {
  name                = "acctestVM-240112224008119082"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_automation_hybrid_runbook_worker" "test" {
  ...
  worker_id               = "fa1364a5-e6b1-44a1-ac6f-b3a7374fca3a"
