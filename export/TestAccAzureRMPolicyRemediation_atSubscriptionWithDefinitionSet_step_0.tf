...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-oc9tl"
  policy_type  = "Custom"
  display_name = "testPolicySet-oc9tl"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-oc9tl"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-oc9tl"
