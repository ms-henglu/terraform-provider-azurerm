...
locals {
  number            = "230113180850406184"
  location          = "West Europe"
  domain_name_label = "acctestvm-2mkvd"
  random_string     = "2mkvd"
  admin_username    = "testadmin230113180850406184"
  admin_password    = "Password1234!230113180850406184"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230113180850406184"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230113180850406184"
  ...
  identifier {
    publisher = "AccTesPublisher230113180850406184"
    offer     = "AccTesOffer230113180850406184"
    sku       = "AccTesSku230113180850406184"
  }
}
