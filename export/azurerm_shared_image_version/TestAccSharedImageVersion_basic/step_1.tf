...
locals {
  number            = "231013043133450774"
  location          = "West Europe"
  domain_name_label = "acctestvm-qpbw4"
  random_string     = "qpbw4"
  admin_username    = "testadmin231013043133450774"
  admin_password    = "Password1234!231013043133450774"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231013043133450774"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231013043133450774"
  ...
  identifier {
    publisher = "AccTesPublisher231013043133450774"
    offer     = "AccTesOffer231013043133450774"
    sku       = "AccTesSku231013043133450774"
  }
}
