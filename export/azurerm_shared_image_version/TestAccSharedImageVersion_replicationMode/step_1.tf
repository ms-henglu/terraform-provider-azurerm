...
locals {
  number            = "221111020149340369"
  location          = "West Europe"
  domain_name_label = "acctestvm-0pe1l"
  random_string     = "0pe1l"
  admin_username    = "testadmin221111020149340369"
  admin_password    = "Password1234!221111020149340369"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221111020149340369"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221111020149340369"
  ...
  identifier {
    publisher = "AccTesPublisher221111020149340369"
    offer     = "AccTesOffer221111020149340369"
    sku       = "AccTesSku221111020149340369"
  }
}
