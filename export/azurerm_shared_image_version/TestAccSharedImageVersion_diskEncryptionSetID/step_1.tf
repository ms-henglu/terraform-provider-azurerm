...
locals {
  number            = "230505050044913201"
  location          = "West Europe"
  domain_name_label = "acctestvm-trwsd"
  random_string     = "trwsd"
  admin_username    = "testadmin230505050044913201"
  admin_password    = "Password1234!230505050044913201"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230505050044913201"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230505050044913201"
  ...
  identifier {
    publisher = "AccTesPublisher230505050044913201"
    offer     = "AccTesOffer230505050044913201"
    sku       = "AccTesSku230505050044913201"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230505050044913201"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
