...
locals {
  number            = "220811053013426663"
  location          = "West Europe"
  domain_name_label = "acctestvm-ea9li"
  random_string     = "ea9li"
  admin_username    = "testadmin220811053013426663"
  admin_password    = "Password1234!220811053013426663"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220811053013426663"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220811053013426663"
  ...
  identifier {
    publisher = "AccTesPublisher220811053013426663"
    offer     = "AccTesOffer220811053013426663"
    sku       = "AccTesSku220811053013426663"
  }
}
