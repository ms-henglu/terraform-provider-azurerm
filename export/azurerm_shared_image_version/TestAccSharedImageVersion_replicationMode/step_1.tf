...
locals {
  number            = "221111013238941986"
  location          = "West Europe"
  domain_name_label = "acctestvm-xphek"
  random_string     = "xphek"
  admin_username    = "testadmin221111013238941986"
  admin_password    = "Password1234!221111013238941986"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221111013238941986"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221111013238941986"
  ...
  identifier {
    publisher = "AccTesPublisher221111013238941986"
    offer     = "AccTesOffer221111013238941986"
    sku       = "AccTesSku221111013238941986"
  }
}
