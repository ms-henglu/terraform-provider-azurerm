...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-dkibl"
  policy_type  = "Custom"
  display_name = "testPolicySet-dkibl"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-dkibl"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-dkibl"
