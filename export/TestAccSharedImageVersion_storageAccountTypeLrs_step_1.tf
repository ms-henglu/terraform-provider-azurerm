...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211217035034687147"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211217035034687147"
  ...
  identifier {
    publisher = "AccTesPublisher211217035034687147"
    offer     = "AccTesOffer211217035034687147"
    sku       = "AccTesSku211217035034687147"
  }
}
