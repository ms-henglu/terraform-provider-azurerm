...
locals {
  number            = "220818234946135843"
  location          = "West Europe"
  domain_name_label = "acctestvm-x7tuj"
  random_string     = "x7tuj"
  admin_username    = "testadmin220818234946135843"
  admin_password    = "Password1234!220818234946135843"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220818234946135843"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220818234946135843"
  ...
  identifier {
    publisher = "AccTesPublisher220818234946135843"
    offer     = "AccTesOffer220818234946135843"
    sku       = "AccTesSku220818234946135843"
  }
}
