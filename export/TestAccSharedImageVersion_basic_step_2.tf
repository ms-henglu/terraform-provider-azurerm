...
locals {
  number            = "220623233411088778"
  location          = "West Europe"
  domain_name_label = "acctestvm-ktsxu"
  random_string     = "ktsxu"
  admin_username    = "testadmin220623233411088778"
  admin_password    = "Password1234!220623233411088778"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220623233411088778"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220623233411088778"
  ...
  identifier {
    publisher = "AccTesPublisher220623233411088778"
    offer     = "AccTesOffer220623233411088778"
    sku       = "AccTesSku220623233411088778"
  }
}
