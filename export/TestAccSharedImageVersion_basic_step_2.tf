...
locals {
  number            = "211203161152216664"
  location          = "West Europe"
  domain_name_label = "acctestvm-eap9a"
  random_string     = "eap9a"
  admin_username    = "testadmin211203161152216664"
  admin_password    = "Password1234!211203161152216664"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211203161152216664"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211203161152216664"
  ...
  identifier {
    publisher = "AccTesPublisher211203161152216664"
    offer     = "AccTesOffer211203161152216664"
    sku       = "AccTesSku211203161152216664"
  }
}
