...
locals {
  number            = "230613071532229443"
  location          = "West Europe"
  domain_name_label = "acctestvm-gssv9"
  random_string     = "gssv9"
  admin_username    = "testadmin230613071532229443"
  admin_password    = "Password1234!230613071532229443"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230613071532229443"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230613071532229443"
  ...
  identifier {
    publisher = "AccTesPublisher230613071532229443"
    offer     = "AccTesOffer230613071532229443"
    sku       = "AccTesSku230613071532229443"
  }
}
