...
resource "azurerm_resource_group" "test" {
  name     = "acctest220324163754801008"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-220324163754801008"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestpol-220324163754801008"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestpol-220324163754801008"
...
resource "azurerm_resource_policy_assignment" "test" {
  name                 = "acctestpa-220324163754801008"
