...
// EvaluateImport the operation to evaluate import NSG to security user configurations.
// Parameters:
// resourceGroupName - the name of the resource group.
// networkManagerName - the name of the network manager.
// configurationName - the name of the network manager security Configuration.
...
func (client SecurityUserConfigurationsClient) EvaluateImport(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, parameters ManagerSecurityConfigurationImport, top *int32, skipToken string) (result SecurityConfigurationRuleListResultPage, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/SecurityUserConfigurationsClient.EvaluateImport")
		defer func() {
			sc := -1
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("network.SecurityUserConfigurationsClient", "EvaluateImport", err.Error())
	}
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "network.SecurityUserConfigurationsClient", "EvaluateImport", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "network.SecurityUserConfigurationsClient", "EvaluateImport", resp, "Failure sending request")
		return
	}

	result.scrlr, err = client.EvaluateImportResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "network.SecurityUserConfigurationsClient", "EvaluateImport", resp, "Failure responding to request")
		return
	}
...
func (client SecurityUserConfigurationsClient) EvaluateImportPreparer(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, parameters ManagerSecurityConfigurationImport, top *int32, skipToken string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"configurationName":  autorest.Encode("path", configurationName),
		"networkManagerName": autorest.Encode("path", networkManagerName),
		"resourceGroupName":  autorest.Encode("path", resourceGroupName),
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.AsPost(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkManagers/{networkManagerName}/securityUserConfigurations/{configurationName}/evaluateImport", pathParameters),
...
// http.Response Body if it receives an error.
func (client SecurityUserConfigurationsClient) EvaluateImportSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, azure.DoRetryWithRegistration(client.Client))
}

// EvaluateImportResponder handles the response to the EvaluateImport request. The method always
// closes the http.Response Body.
func (client SecurityUserConfigurationsClient) EvaluateImportResponder(resp *http.Response) (result SecurityConfigurationRuleListResult, err error) {
	err = autorest.Respond(
		resp,
...
func (client SecurityUserConfigurationsClient) evaluateImportNextResults(ctx context.Context, lastResults SecurityConfigurationRuleListResult) (result SecurityConfigurationRuleListResult, err error) {
	req, err := lastResults.securityConfigurationRuleListResultPreparer(ctx)
	if err != nil {
		return result, autorest.NewErrorWithError(err, "network.SecurityUserConfigurationsClient", "evaluateImportNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "network.SecurityUserConfigurationsClient", "evaluateImportNextResults", resp, "Failure sending next results request")
	}
	result, err = client.EvaluateImportResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "network.SecurityUserConfigurationsClient", "evaluateImportNextResults", resp, "Failure responding to next results request")
	}
	return
}

// EvaluateImportComplete enumerates all values, automatically crossing page boundaries as required.
func (client SecurityUserConfigurationsClient) EvaluateImportComplete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, parameters ManagerSecurityConfigurationImport, top *int32, skipToken string) (result SecurityConfigurationRuleListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/SecurityUserConfigurationsClient.EvaluateImport")
		defer func() {
			sc := -1
...
// configurationName - the name of the network manager security Configuration.
// parameters - import Security configuration parameter
func (client SecurityUserConfigurationsClient) Import(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, parameters ManagerSecurityConfigurationImport) (result SecurityConfigurationImportResult, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/SecurityUserConfigurationsClient.Import")
		defer func() {
			sc := -1
			if result.Response.Response != nil {
				sc = result.Response.Response.StatusCode
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "network.SecurityUserConfigurationsClient", "Import", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "network.SecurityUserConfigurationsClient", "Import", resp, "Failure sending request")
		return
	}

	result, err = client.ImportResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "network.SecurityUserConfigurationsClient", "Import", resp, "Failure responding to request")
		return
	}
...
func (client SecurityUserConfigurationsClient) ImportPreparer(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, parameters ManagerSecurityConfigurationImport) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"configurationName":  autorest.Encode("path", configurationName),
		"networkManagerName": autorest.Encode("path", networkManagerName),
		"resourceGroupName":  autorest.Encode("path", resourceGroupName),
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.AsPost(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkManagers/{networkManagerName}/securityUserConfigurations/{configurationName}/import", pathParameters),
		autorest.WithJSON(parameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
// http.Response Body if it receives an error.
func (client SecurityUserConfigurationsClient) ImportSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, azure.DoRetryWithRegistration(client.Client))
}

// ImportResponder handles the response to the Import request. The method always
// closes the http.Response Body.
func (client SecurityUserConfigurationsClient) ImportResponder(resp *http.Response) (result SecurityConfigurationImportResult, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK),
		autorest.ByUnmarshallingJSON(&result),
