...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230922060812878906"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230922060812878906"
  ...
  identifier {
    publisher = "AccTesPublisher230922060812878906"
    offer     = "AccTesOffer230922060812878906"
    sku       = "AccTesSku230922060812878906"
  }
}
