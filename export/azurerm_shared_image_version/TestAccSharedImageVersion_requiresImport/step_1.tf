...
locals {
  number            = "230519074408704231"
  location          = "West Europe"
  domain_name_label = "acctestvm-cl80r"
  random_string     = "cl80r"
  admin_username    = "testadmin230519074408704231"
  admin_password    = "Password1234!230519074408704231"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230519074408704231"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230519074408704231"
  ...
  identifier {
    publisher = "AccTesPublisher230519074408704231"
    offer     = "AccTesOffer230519074408704231"
    sku       = "AccTesSku230519074408704231"
  }
}
