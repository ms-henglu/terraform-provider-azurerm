...
locals {
  number            = "221221204056151335"
  location          = "West Europe"
  domain_name_label = "acctestvm-4f6rk"
  random_string     = "4f6rk"
  admin_username    = "testadmin221221204056151335"
  admin_password    = "Password1234!221221204056151335"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221221204056151335"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221221204056151335"
  ...
  identifier {
    publisher = "AccTesPublisher221221204056151335"
    offer     = "AccTesOffer221221204056151335"
    sku       = "AccTesSku221221204056151335"
  }
}
