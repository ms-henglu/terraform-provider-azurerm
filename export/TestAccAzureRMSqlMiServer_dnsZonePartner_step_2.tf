...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-sql-211105030624025136"
  location = "West Europe"
}

resource "azurerm_network_security_group" "test" {
  name                = "mi-security-group-211105030624025136"
...
resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet-211105030624025136"
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_subnet" "test" {
  name                 = "subnet-211105030624025136"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_route_table" "test" {
  name                          = "routetable-211105030624025136"
  location                      = azurerm_resource_group.test.location
  resource_group_name           = azurerm_resource_group.test.name
...
resource "azurerm_sql_managed_instance" "test" {
  name                         = "acctestsqlserver211105030624025136"
  resource_group_name          = azurerm_resource_group.test.name
  location                     = azurerm_resource_group.test.location
...
resource "azurerm_resource_group" "test1" {
  name     = "acctestRG2-sql-211105030624025136"
  location = "West US 2"
}

resource "azurerm_virtual_network" "test1" {
  name                = "acctest-vnet2-211105030624025136"
...
resource "azurerm_subnet" "test1" {
  name                 = "subnet2-211105030624025136"
  resource_group_name  = azurerm_resource_group.test1.name
...
resource "azurerm_network_security_group" "test1" {
  name                = "mi-security-group2-211105030624025136"
  location            = azurerm_resource_group.test1.location
  resource_group_name = azurerm_resource_group.test1.name
}
...
resource "azurerm_sql_managed_instance" "test1" {
  name                         = "acctestsqlserver2211105030624025136"
  resource_group_name          = azurerm_resource_group.test1.name
  location                     = azurerm_resource_group.test1.location
  administrator_login          = "mradministrator"
  administrator_login_password = "thisIsDog11"
