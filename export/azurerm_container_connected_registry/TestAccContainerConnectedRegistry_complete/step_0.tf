...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-acr-230810143212711530"
  location = "West Europe"
}

resource "azurerm_container_registry" "test" {
  name                  = "testacccr230810143212711530"
...
resource "azurerm_container_registry_scope_map" "test" {
  ...
  actions = [
    ...
    "gateway/testacccrc230810143212711530/config/read",
    "gateway/testacccrc230810143212711530/config/write",
    "gateway/testacccrc230810143212711530/message/read",
    "gateway/testacccrc230810143212711530/message/write",
  ]
}

resource "azurerm_container_registry_token" "test" {
  name                    = "testacccrtoken230810143212711530"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
...
resource "azurerm_container_registry_scope_map" "client" {
  name                    = "testacccrclient230810143212711530"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
  actions = [
    "repositories/hello-world/content/delete",
...
resource "azurerm_container_registry_token" "client" {
  name                    = "testacccrtokenclient230810143212711530"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
...
resource "azurerm_container_connected_registry" "test" {
  name                  = "testacccrc230810143212711530"
