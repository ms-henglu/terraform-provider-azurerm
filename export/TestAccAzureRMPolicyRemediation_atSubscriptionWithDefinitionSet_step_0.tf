...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-mtk94"
  policy_type  = "Custom"
  display_name = "testPolicySet-mtk94"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-mtk94"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-mtk94"
