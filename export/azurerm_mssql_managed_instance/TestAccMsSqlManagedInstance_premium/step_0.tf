...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG1-sql-231016034342450842"
  location = "West US 2"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet1-231016034342450842"
...
resource "azurerm_subnet" "test" {
  name                 = "subnet1-231016034342450842"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_network_security_group" "test" {
  name                = "mi-security-group1-231016034342450842"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
}
...
resource "azurerm_route_table" "test" {
  name                          = "routetable1-231016034342450842"
  location                      = azurerm_resource_group.test.location
  resource_group_name           = azurerm_resource_group.test.name
...
resource "azurerm_mssql_managed_instance" "test" {
  name                = "acctestsqlserver231016034342450842"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
