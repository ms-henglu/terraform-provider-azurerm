...
locals {
  number            = "220527023954285630"
  location          = "West Europe"
  domain_name_label = "acctestvm-s9uvh"
  random_string     = "s9uvh"
  admin_username    = "testadmin220527023954285630"
  admin_password    = "Password1234!220527023954285630"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220527023954285630"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220527023954285630"
  ...
  identifier {
    publisher = "AccTesPublisher220527023954285630"
    offer     = "AccTesOffer220527023954285630"
    sku       = "AccTesSku220527023954285630"
  }
}
