...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-hqlvc"
  policy_type  = "Custom"
  display_name = "testPolicySet-hqlvc"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-hqlvc"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-hqlvc"
