...
func (client SecurityAdminConfigurationsClient) CreateOrUpdate(ctx context.Context, securityAdminConfiguration SecurityConfiguration, resourceGroupName string, networkManagerName string, configurationName string) (result SecurityConfiguration, err error) {
...
func (client SecurityAdminConfigurationsClient) CreateOrUpdatePreparer(ctx context.Context, securityAdminConfiguration SecurityConfiguration, resourceGroupName string, networkManagerName string, configurationName string) (*http.Request, error) {
...
func (client SecurityAdminConfigurationsClient) CreateOrUpdateResponder(resp *http.Response) (result SecurityConfiguration, err error) {
...
// networkManagerName - the name of the network manager.
// configurationName - the name of the network manager security Configuration.
func (client SecurityAdminConfigurationsClient) Delete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "network.SecurityAdminConfigurationsClient", "Delete", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "network.SecurityAdminConfigurationsClient", "Delete", resp, "Failure responding to request")
		return
	}
...
func (client SecurityAdminConfigurationsClient) DeletePreparer(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"configurationName":  autorest.Encode("path", configurationName),
		"networkManagerName": autorest.Encode("path", networkManagerName),
		"resourceGroupName":  autorest.Encode("path", resourceGroupName),
...
// http.Response Body if it receives an error.
func (client SecurityAdminConfigurationsClient) DeleteSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, azure.DoRetryWithRegistration(client.Client))
}
...
// networkManagerName - the name of the network manager.
// configurationName - the name of the network manager security Configuration.
func (client SecurityAdminConfigurationsClient) Get(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string) (result SecurityConfiguration, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client SecurityAdminConfigurationsClient) GetResponder(resp *http.Response) (result SecurityConfiguration, err error) {
	err = autorest.Respond(
		resp,
...
func (client SecurityAdminConfigurationsClient) List(ctx context.Context, resourceGroupName string, networkManagerName string, top *int32, skipToken string) (result SecurityConfigurationListResultPage, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client SecurityAdminConfigurationsClient) ListResponder(resp *http.Response) (result SecurityConfigurationListResult, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK),
		autorest.ByUnmarshallingJSON(&result),
...
func (client SecurityAdminConfigurationsClient) listNextResults(ctx context.Context, lastResults SecurityConfigurationListResult) (result SecurityConfigurationListResult, err error) {
...
func (client SecurityAdminConfigurationsClient) ListComplete(ctx context.Context, resourceGroupName string, networkManagerName string, top *int32, skipToken string) (result SecurityConfigurationListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/SecurityAdminConfigurationsClient.List")
		defer func() {
			sc := -1
