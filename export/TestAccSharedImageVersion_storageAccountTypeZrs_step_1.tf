...
locals {
  number            = "211217035034682287"
  location          = "West Europe"
  domain_name_label = "acctestvm-9gego"
  random_string     = "9gego"
  admin_username    = "testadmin211217035034682287"
  admin_password    = "Password1234!211217035034682287"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211217035034682287"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211217035034682287"
  ...
  identifier {
    publisher = "AccTesPublisher211217035034682287"
    offer     = "AccTesOffer211217035034682287"
    sku       = "AccTesSku211217035034682287"
  }
}
