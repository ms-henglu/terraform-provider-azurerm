...
locals {
  number            = "220527023954280881"
  location          = "West Europe"
  domain_name_label = "acctestvm-hua8f"
  random_string     = "hua8f"
  admin_username    = "testadmin220527023954280881"
  admin_password    = "Password1234!220527023954280881"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220527023954280881"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220527023954280881"
  ...
  identifier {
    publisher = "AccTesPublisher220527023954280881"
    offer     = "AccTesOffer220527023954280881"
    sku       = "AccTesSku220527023954280881"
  }
}
