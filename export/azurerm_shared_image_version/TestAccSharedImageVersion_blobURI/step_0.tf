...
locals {
  number            = "230227175227915358"
  location          = "West Europe"
  domain_name_label = "acctestvm-ectxv"
  random_string     = "ectxv"
  admin_username    = "testadmin230227175227915358"
  admin_password    = "Password1234!230227175227915358"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230227175227915358"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230227175227915358"
  ...
  identifier {
    publisher = "AccTesPublisher230227175227915358"
    offer     = "AccTesOffer230227175227915358"
    sku       = "AccTesSku230227175227915358"
  }
}
