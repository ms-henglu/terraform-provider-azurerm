...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220826005646577718"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220826005646577718"
  ...
  identifier {
    publisher = "AccTesPublisher220826005646577718"
    offer     = "AccTesOffer220826005646577718"
    sku       = "AccTesSku220826005646577718"
  }
}
