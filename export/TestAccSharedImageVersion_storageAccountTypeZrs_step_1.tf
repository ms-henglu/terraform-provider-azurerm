...
locals {
  number            = "220905045548224670"
  location          = "West Europe"
  domain_name_label = "acctestvm-3cz47"
  random_string     = "3cz47"
  admin_username    = "testadmin220905045548224670"
  admin_password    = "Password1234!220905045548224670"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220905045548224670"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220905045548224670"
  ...
  identifier {
    publisher = "AccTesPublisher220905045548224670"
    offer     = "AccTesOffer220905045548224670"
    sku       = "AccTesSku220905045548224670"
  }
}
