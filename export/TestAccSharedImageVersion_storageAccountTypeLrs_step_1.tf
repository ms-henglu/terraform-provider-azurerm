...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220114063934537694"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220114063934537694"
  ...
  identifier {
    publisher = "AccTesPublisher220114063934537694"
    offer     = "AccTesOffer220114063934537694"
    sku       = "AccTesSku220114063934537694"
  }
}
