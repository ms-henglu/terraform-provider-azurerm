...
locals {
  number            = "220324160038482882"
  location          = "West Europe"
  domain_name_label = "acctestvm-tq3ag"
  random_string     = "tq3ag"
  admin_username    = "testadmin220324160038482882"
  admin_password    = "Password1234!220324160038482882"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220324160038482882"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220324160038482882"
  ...
  identifier {
    publisher = "AccTesPublisher220324160038482882"
    offer     = "AccTesOffer220324160038482882"
    sku       = "AccTesSku220324160038482882"
  }
}
