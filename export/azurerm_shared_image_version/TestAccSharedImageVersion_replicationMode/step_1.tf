...
locals {
  number            = "240315122550009670"
  location          = "West Europe"
  domain_name_label = "acctestvm-ynguu"
  random_string     = "ynguu"
  admin_username    = "testadmin240315122550009670"
  admin_password    = "Password1234!240315122550009670"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240315122550009670"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240315122550009670"
  ...
  identifier {
    publisher = "AccTesPublisher240315122550009670"
    offer     = "AccTesOffer240315122550009670"
    sku       = "AccTesSku240315122550009670"
  }
}
