...
locals {
  number            = "221021030948789987"
  location          = "West Europe"
  domain_name_label = "acctestvm-9xis2"
  random_string     = "9xis2"
  admin_username    = "testadmin221021030948789987"
  admin_password    = "Password1234!221021030948789987"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221021030948789987"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221021030948789987"
  ...
  identifier {
    publisher = "AccTesPublisher221021030948789987"
    offer     = "AccTesOffer221021030948789987"
    sku       = "AccTesSku221021030948789987"
  }
}
