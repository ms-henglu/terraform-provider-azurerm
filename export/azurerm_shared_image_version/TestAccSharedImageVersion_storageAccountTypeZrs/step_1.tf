...
locals {
  number            = "231020040746243492"
  location          = "West Europe"
  domain_name_label = "acctestvm-qq3ev"
  random_string     = "qq3ev"
  admin_username    = "testadmin231020040746243492"
  admin_password    = "Password1234!231020040746243492"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231020040746243492"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231020040746243492"
  ...
  identifier {
    publisher = "AccTesPublisher231020040746243492"
    offer     = "AccTesOffer231020040746243492"
    sku       = "AccTesSku231020040746243492"
  }
}
