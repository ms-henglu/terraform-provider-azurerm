...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220819165017109105"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220819165017109105"
  ...
  identifier {
    publisher = "AccTesPublisher220819165017109105"
    offer     = "AccTesOffer220819165017109105"
    sku       = "AccTesSku220819165017109105"
  }
}
