...
locals {
  number            = "210826023203594184"
  location          = "West Europe"
  domain_name_label = "acctestvm-6x2z0"
  random_string     = "6x2z0"
  admin_username    = "testadmin210826023203594184"
  admin_password    = "Password1234!210826023203594184"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210826023203594184"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210826023203594184"
  ...
  identifier {
    publisher = "AccTesPublisher210826023203594184"
    offer     = "AccTesOffer210826023203594184"
    sku       = "AccTesSku210826023203594184"
  }
}
