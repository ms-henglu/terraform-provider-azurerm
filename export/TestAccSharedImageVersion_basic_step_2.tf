...
locals {
  number            = "220506005527657336"
  location          = "West Europe"
  domain_name_label = "acctestvm-j1tyf"
  random_string     = "j1tyf"
  admin_username    = "testadmin220506005527657336"
  admin_password    = "Password1234!220506005527657336"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220506005527657336"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220506005527657336"
  ...
  identifier {
    publisher = "AccTesPublisher220506005527657336"
    offer     = "AccTesOffer220506005527657336"
    sku       = "AccTesSku220506005527657336"
  }
}
