...
type Client struct {
	...
	SecurityConfigurationClient            *previewNetwork.SecurityConfigurationsClient
...
func NewClient(o *common.ClientOptions) *Client {
	...
	SecurityConfigurationClient := previewNetwork.NewSecurityConfigurationsClientWithBaseURI(o.ResourceManagerEndpoint, o.SubscriptionId)
	o.ConfigureClient(&SecurityConfigurationClient.Client, o.ResourceManagerAuthorizer)
	...
	return &Client{
		...
		SecurityConfigurationClient:            &SecurityConfigurationClient,
