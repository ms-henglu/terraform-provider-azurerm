...
resource "azurerm_resource_group" "test" {
  name     = "acctest220415030918158813"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-220415030918158813"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestpol-220415030918158813"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestpol-220415030918158813"
...
resource "azurerm_resource_policy_assignment" "test" {
  name                 = "acctestpa-220415030918158813"
