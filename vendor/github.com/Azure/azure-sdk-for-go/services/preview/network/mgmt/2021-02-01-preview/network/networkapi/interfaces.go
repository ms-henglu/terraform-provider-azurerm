...
type EffectiveVirtualNetworksClientAPI interface {
	...
	ListByNetworkManager(ctx context.Context, resourceGroupName string, networkManagerName string, top *int32, skipToken string, parameters *network.EffectiveVirtualNetworksParameter) (result network.EffectiveVirtualNetworksListResult, err error)
}
...
type ActiveConnectivityConfigurationsClientAPI interface {
	List(ctx context.Context, resourceGroupName string, networkManagerName string, parameters interface{}) (result network.ActiveConnectivityConfigurationsListResult, err error)
}
...
type ActiveSecurityAdminRulesClientAPI interface {
	List(ctx context.Context, resourceGroupName string, networkManagerName string, parameters interface{}) (result network.ActiveSecurityAdminRulesListResult, err error)
}
...
type ActiveSecurityUserRulesClientAPI interface {
	List(ctx context.Context, resourceGroupName string, networkManagerName string, parameters interface{}) (result network.ActiveSecurityUserRulesListResult, err error)
}
...
type EffectiveConnectivityConfigurationsClientAPI interface {
	List(ctx context.Context, resourceGroupName string, virtualNetworkName string, parameters interface{}) (result network.ManagerEffectiveConnectivityConfigurationListResult, err error)
}
...
type ManagerEffectiveSecurityAdminRulesClientAPI interface {
	List(ctx context.Context, resourceGroupName string, virtualNetworkName string, parameters interface{}) (result network.ManagerEffectiveSecurityAdminRulesListResult, err error)
}
