...
locals {
  number            = "231013043133452141"
  location          = "West Europe"
  domain_name_label = "acctestvm-gxt9s"
  random_string     = "gxt9s"
  admin_username    = "testadmin231013043133452141"
  admin_password    = "Password1234!231013043133452141"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231013043133452141"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231013043133452141"
  ...
  identifier {
    publisher = "AccTesPublisher231013043133452141"
    offer     = "AccTesOffer231013043133452141"
    sku       = "AccTesSku231013043133452141"
  }
}
