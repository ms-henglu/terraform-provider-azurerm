...
resource "azurerm_policy_definition" "test" {
  name         = "acctestpol-220128053012137315"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestpol-220128053012137315"
...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220128053012137315"
  location = "West Europe"
}

resource "azurerm_log_analytics_workspace" "test" {
  name                = "acctestLAW-220128053012137315"
...
resource "azurerm_policy_assignment" "test" {
  name                 = "acctestpa-220128053012137315"
  scope                = azurerm_resource_group.test.id
  policy_definition_id = azurerm_policy_definition.test.id
  description          = "Policy Assignment created via an Acceptance Test"
  display_name         = "Acceptance Test Run 220128053012137315"
...
resource "azurerm_resource_group_template_deployment" "test" {
  name                = "acctestrgtd-220128053012137315"
  resource_group_name = azurerm_resource_group.test.name
...
{
  "description": {
   "value": "description-220128053012137315"
  },
  "displayName": {
    "value": "name--220128053012137315"
  },
  "exemptionCategory": {
    "value": "Waiver"
  },
