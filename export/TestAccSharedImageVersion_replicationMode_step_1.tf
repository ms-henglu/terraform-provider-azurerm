...
locals {
  number            = "220819165017103177"
  location          = "West Europe"
  domain_name_label = "acctestvm-rwuhm"
  random_string     = "rwuhm"
  admin_username    = "testadmin220819165017103177"
  admin_password    = "Password1234!220819165017103177"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220819165017103177"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220819165017103177"
  ...
  identifier {
    publisher = "AccTesPublisher220819165017103177"
    offer     = "AccTesOffer220819165017103177"
    sku       = "AccTesSku220819165017103177"
  }
}
