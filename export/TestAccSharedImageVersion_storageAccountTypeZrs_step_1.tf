...
locals {
  number            = "210830083803911186"
  location          = "West Europe"
  domain_name_label = "acctestvm-gw7cv"
  random_string     = "gw7cv"
  admin_username    = "testadmin210830083803911186"
  admin_password    = "Password1234!210830083803911186"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210830083803911186"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210830083803911186"
  ...
  identifier {
    publisher = "AccTesPublisher210830083803911186"
    offer     = "AccTesOffer210830083803911186"
    sku       = "AccTesSku210830083803911186"
  }
}
