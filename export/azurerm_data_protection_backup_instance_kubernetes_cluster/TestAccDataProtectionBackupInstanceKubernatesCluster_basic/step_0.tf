...
resource "azurerm_resource_group" "test" {
  name     = "acctest-dp-240311031904966280"
  location = "West Europe"
}

resource "azurerm_resource_group" "snap" {
  name     = "acctest-dp-snap-240311031904966280"
  location = "West Europe"
}

resource "azurerm_data_protection_backup_vault" "test" {
  name                = "acctest-dbv-240311031904966280"
...
resource "azurerm_kubernetes_cluster" "test" {
  name                = "acctestaks240311031904966280"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  dns_prefix          = "acctestaks240311031904966280"
...
resource "azurerm_kubernetes_cluster_extension" "test" {
  name              = "acctest-kce-240311031904966280"
...
resource "azurerm_data_protection_backup_policy_kubernetes_cluster" "test" {
  name                = "acctest-paks-240311031904966280"
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_data_protection_backup_instance_kubernetes_cluster" "test" {
  name                         = "acctest-iaks-240311031904966280"
  location                     = azurerm_resource_group.test.location
