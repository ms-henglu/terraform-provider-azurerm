...
func TestPrivateEndpointConnectionIDFormatter(t *testing.T) {
	actual := NewPrivateEndpointConnectionID("12345678-1234-9876-4563-123456789012", "resourceGroup1", "account1", "privateEndpointConnection1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resourceGroup1/providers/Microsoft.CognitiveServices/accounts/account1/privateEndpointConnections/privateEndpointConnection1"
	if actual != expected {
