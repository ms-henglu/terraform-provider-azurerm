...
type GetInSubscriptionResponse struct {
	HttpResponse *http.Response
	Model        *[]BackupVaultResource

	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (GetInSubscriptionResponse, error)
}
...
func (r GetInSubscriptionResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r GetInSubscriptionResponse) LoadMore(ctx context.Context) (resp GetInSubscriptionResponse, err error) {
	if !r.HasMore() {
...
// GetInSubscription ...
func (c BackupVaultsClient) GetInSubscription(ctx context.Context, id commonids.SubscriptionId) (resp GetInSubscriptionResponse, err error) {
...
func (c BackupVaultsClient) GetInSubscriptionComplete(ctx context.Context, id commonids.SubscriptionId) (GetInSubscriptionCompleteResult, error) {
	return c.GetInSubscriptionCompleteMatchingPredicate(ctx, id, BackupVaultResourcePredicate{})
}

// GetInSubscriptionCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c BackupVaultsClient) GetInSubscriptionCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, predicate BackupVaultResourcePredicate) (resp GetInSubscriptionCompleteResult, err error) {
...
func (c BackupVaultsClient) responderForGetInSubscription(resp *http.Response) (result GetInSubscriptionResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result GetInSubscriptionResponse, err error) {
