...
locals {
  number            = "230227032410658698"
  location          = "West Europe"
  domain_name_label = "acctestvm-0ith1"
  random_string     = "0ith1"
  admin_username    = "testadmin230227032410658698"
  admin_password    = "Password1234!230227032410658698"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230227032410658698"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230227032410658698"
  ...
  identifier {
    publisher = "AccTesPublisher230227032410658698"
    offer     = "AccTesOffer230227032410658698"
    sku       = "AccTesSku230227032410658698"
  }
}
