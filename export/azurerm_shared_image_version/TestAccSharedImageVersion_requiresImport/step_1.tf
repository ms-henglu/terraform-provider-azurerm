...
locals {
  number            = "221028171853898456"
  location          = "West Europe"
  domain_name_label = "acctestvm-uhtr2"
  random_string     = "uhtr2"
  admin_username    = "testadmin221028171853898456"
  admin_password    = "Password1234!221028171853898456"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221028171853898456"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221028171853898456"
  ...
  identifier {
    publisher = "AccTesPublisher221028171853898456"
    offer     = "AccTesOffer221028171853898456"
    sku       = "AccTesSku221028171853898456"
  }
}
