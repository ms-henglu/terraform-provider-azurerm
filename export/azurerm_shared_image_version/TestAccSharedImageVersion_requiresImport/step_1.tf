...
locals {
  number            = "230728025312842975"
  location          = "West Europe"
  domain_name_label = "acctestvm-zxe32"
  random_string     = "zxe32"
  admin_username    = "testadmin230728025312842975"
  admin_password    = "Password1234!230728025312842975"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230728025312842975"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230728025312842975"
  ...
  identifier {
    publisher = "AccTesPublisher230728025312842975"
    offer     = "AccTesOffer230728025312842975"
    sku       = "AccTesSku230728025312842975"
  }
}
