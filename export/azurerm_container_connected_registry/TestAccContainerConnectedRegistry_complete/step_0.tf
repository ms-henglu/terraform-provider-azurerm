...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-acr-230609091047828990"
  location = "West Europe"
}

resource "azurerm_container_registry" "test" {
  name                  = "testacccr230609091047828990"
...
resource "azurerm_container_registry_scope_map" "test" {
  ...
  actions = [
    ...
    "gateway/testacccrc230609091047828990/config/read",
    "gateway/testacccrc230609091047828990/config/write",
    "gateway/testacccrc230609091047828990/message/read",
    "gateway/testacccrc230609091047828990/message/write",
  ]
}

resource "azurerm_container_registry_token" "test" {
  name                    = "testacccrtoken230609091047828990"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
...
resource "azurerm_container_registry_scope_map" "client" {
  name                    = "testacccrclient230609091047828990"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
  actions = [
    "repositories/hello-world/content/delete",
...
resource "azurerm_container_registry_token" "client" {
  name                    = "testacccrtokenclient230609091047828990"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
...
resource "azurerm_container_connected_registry" "test" {
  name                  = "testacccrc230609091047828990"
