...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220722035002630388"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220722035002630388"
  ...
  identifier {
    publisher = "AccTesPublisher220722035002630388"
    offer     = "AccTesOffer220722035002630388"
    sku       = "AccTesSku220722035002630388"
  }
}
