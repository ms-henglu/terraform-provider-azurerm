...
locals {
  number            = "211126031012798266"
  location          = "West Europe"
  domain_name_label = "acctestvm-hs9hs"
  random_string     = "hs9hs"
  admin_username    = "testadmin211126031012798266"
  admin_password    = "Password1234!211126031012798266"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211126031012798266"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211126031012798266"
  ...
  identifier {
    publisher = "AccTesPublisher211126031012798266"
    offer     = "AccTesOffer211126031012798266"
    sku       = "AccTesSku211126031012798266"
  }
}
