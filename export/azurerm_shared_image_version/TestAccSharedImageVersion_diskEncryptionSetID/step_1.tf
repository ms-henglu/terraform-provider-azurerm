...
locals {
  number            = "230421021839852982"
  location          = "West Europe"
  domain_name_label = "acctestvm-gv8qp"
  random_string     = "gv8qp"
  admin_username    = "testadmin230421021839852982"
  admin_password    = "Password1234!230421021839852982"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230421021839852982"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230421021839852982"
  ...
  identifier {
    publisher = "AccTesPublisher230421021839852982"
    offer     = "AccTesOffer230421021839852982"
    sku       = "AccTesSku230421021839852982"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230421021839852982"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
