...
locals {
  number            = "230707010127170571"
  location          = "West Europe"
  domain_name_label = "acctestvm-y3wvv"
  random_string     = "y3wvv"
  admin_username    = "testadmin230707010127170571"
  admin_password    = "Password1234!230707010127170571"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230707010127170571"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230707010127170571"
  ...
  identifier {
    publisher = "AccTesPublisher230707010127170571"
    offer     = "AccTesOffer230707010127170571"
    sku       = "AccTesSku230707010127170571"
  }
}
