...
locals {
  number            = "230804025626255447"
  location          = "West Europe"
  domain_name_label = "acctestvm-rg6bg"
  random_string     = "rg6bg"
  admin_username    = "testadmin230804025626255447"
  admin_password    = "Password1234!230804025626255447"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230804025626255447"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230804025626255447"
  ...
  identifier {
    publisher = "AccTesPublisher230804025626255447"
    offer     = "AccTesOffer230804025626255447"
    sku       = "AccTesSku230804025626255447"
  }
}
