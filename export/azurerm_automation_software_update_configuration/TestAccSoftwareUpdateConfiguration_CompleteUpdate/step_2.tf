...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-231013042959965146"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctest-231013042959965146"
...
resource "azurerm_log_analytics_workspace" "test" {
  name                = "acctestLAW-231013042959965146"
  location            = "west europe"
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "PerGB2018"
...
resource "azurerm_automation_software_update_configuration" "test" {
  ...
  name                  = "acctest-suc-231013042959965146"
  ...
  schedule {
    ...
    start_time         = "2023-10-13T05:30:00Z"
    expiry_time        = "2023-10-13T06:30:00Z"
    is_enabled         = true
    interval           = 2
    frequency          = "Hour"
    time_zone          = "Etc/UTC"
