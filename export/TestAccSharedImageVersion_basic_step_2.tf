...
locals {
  number            = "211119050629412696"
  location          = "West Europe"
  domain_name_label = "acctestvm-d0q8f"
  random_string     = "d0q8f"
  admin_username    = "testadmin211119050629412696"
  admin_password    = "Password1234!211119050629412696"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211119050629412696"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211119050629412696"
  ...
  identifier {
    publisher = "AccTesPublisher211119050629412696"
    offer     = "AccTesOffer211119050629412696"
    sku       = "AccTesSku211119050629412696"
  }
}
