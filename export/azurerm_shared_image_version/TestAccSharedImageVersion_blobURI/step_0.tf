...
locals {
  number            = "230512003629468792"
  location          = "West Europe"
  domain_name_label = "acctestvm-2r3vc"
  random_string     = "2r3vc"
  admin_username    = "testadmin230512003629468792"
  admin_password    = "Password1234!230512003629468792"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230512003629468792"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230512003629468792"
  ...
  identifier {
    publisher = "AccTesPublisher230512003629468792"
    offer     = "AccTesOffer230512003629468792"
    sku       = "AccTesSku230512003629468792"
  }
}
