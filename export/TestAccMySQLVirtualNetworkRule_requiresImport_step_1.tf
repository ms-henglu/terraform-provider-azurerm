...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-210825041110531884"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvnet210825041110531884"
...
resource "azurerm_subnet" "test" {
  name                 = "acctestsubnet210825041110531884"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_mysql_server" "test" {
  name                         = "acctestmysqlsvr-210825041110531884"
  location                     = azurerm_resource_group.test.location
  resource_group_name          = azurerm_resource_group.test.name
...
resource "azurerm_mysql_virtual_network_rule" "test" {
  name                = "acctestmysqlvnetrule210825041110531884"
  resource_group_name = azurerm_resource_group.test.name
