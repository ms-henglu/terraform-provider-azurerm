...
locals {
  ...
  vm_name           = "acctestsourcevm-240311031615508201"
  admin_username    = "testadmin240311031615508201"
  admin_password    = "Password1234!240311031615508201"
}

resource "azurerm_resource_group" "test" {
  name     = "acctestRG-240311031615508201"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestnw-240311031615508201"
...
resource "azurerm_public_ip" "test" {
  name                = "acctpip-240311031615508201"
  location            = "${azurerm_resource_group.test.location}"
  resource_group_name = "${azurerm_resource_group.test.name}"
...
resource "azurerm_network_interface" "public" {
  name                = "acctnicsource-240311031615508201"
  location            = "${azurerm_resource_group.test.location}"
  resource_group_name = "${azurerm_resource_group.test.name}"
...
resource "azurerm_network_interface" "test" {
  name                = "acctestnic-240311031615508201"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "source" {
  name                            = "acctestsourceVM-240311031615508201"
  resource_group_name             = azurerm_resource_group.test.name
  location                        = azurerm_resource_group.test.location
  size                            = "Standard_F2"
