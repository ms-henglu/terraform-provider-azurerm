...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-210906022054116207"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctvn-210906022054116207"
...
resource "azurerm_subnet" "test" {
  name                 = "acctsub-210906022054116207"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_virtual_machine_scale_set" "test" {
  name                = "acctvmss-210906022054116207"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  ...
  os_profile {
    computer_name_prefix = "testvm-210906022054116207"
...
resource "azurerm_subnet" "gwtest" {
  name                 = "gw-subnet-210906022054116207"
  resource_group_name  = azurerm_resource_group.test.name
  virtual_network_name = azurerm_virtual_network.test.name
...
resource "azurerm_public_ip" "test" {
  name                = "acctest-pubip-210906022054116207"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_application_gateway" "test" {
  name                = "acctestgw-210906022054116207"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
