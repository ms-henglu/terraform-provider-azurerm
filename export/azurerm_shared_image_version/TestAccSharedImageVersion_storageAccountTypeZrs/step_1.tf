...
locals {
  number            = "230602030259358974"
  location          = "West Europe"
  domain_name_label = "acctestvm-6dn9w"
  random_string     = "6dn9w"
  admin_username    = "testadmin230602030259358974"
  admin_password    = "Password1234!230602030259358974"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230602030259358974"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230602030259358974"
  ...
  identifier {
    publisher = "AccTesPublisher230602030259358974"
    offer     = "AccTesOffer230602030259358974"
    sku       = "AccTesSku230602030259358974"
  }
}
