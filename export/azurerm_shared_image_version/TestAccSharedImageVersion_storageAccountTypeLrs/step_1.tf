...
locals {
  number            = "240112224137953451"
  location          = "West Europe"
  domain_name_label = "acctestvm-z8wdj"
  random_string     = "z8wdj"
  admin_username    = "testadmin240112224137953451"
  admin_password    = "Password1234!240112224137953451"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240112224137953451"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240112224137953451"
  ...
  identifier {
    publisher = "AccTesPublisher240112224137953451"
    offer     = "AccTesOffer240112224137953451"
    sku       = "AccTesSku240112224137953451"
  }
}
