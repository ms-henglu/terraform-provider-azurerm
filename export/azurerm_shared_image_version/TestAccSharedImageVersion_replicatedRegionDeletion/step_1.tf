...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240315122550007177"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240315122550007177"
  ...
  identifier {
    publisher = "AccTesPublisher240315122550007177"
    offer     = "AccTesOffer240315122550007177"
    sku       = "AccTesSku240315122550007177"
  }
}
