...
locals {
  number            = "231020040746242706"
  location          = "West Europe"
  domain_name_label = "acctestvm-0jwk2"
  random_string     = "0jwk2"
  admin_username    = "testadmin231020040746242706"
  admin_password    = "Password1234!231020040746242706"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231020040746242706"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231020040746242706"
  ...
  identifier {
    publisher = "AccTesPublisher231020040746242706"
    offer     = "AccTesOffer231020040746242706"
    sku       = "AccTesSku231020040746242706"
  }
}
