...
locals {
  number            = "230721011329117108"
  location          = "West Europe"
  domain_name_label = "acctestvm-qcuor"
  random_string     = "qcuor"
  admin_username    = "testadmin230721011329117108"
  admin_password    = "Password1234!230721011329117108"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230721011329117108"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230721011329117108"
  ...
  identifier {
    publisher = "AccTesPublisher230721011329117108"
    offer     = "AccTesOffer230721011329117108"
    sku       = "AccTesSku230721011329117108"
  }
}
