...
locals {
  number            = "210924010808665611"
  location          = "West Europe"
  domain_name_label = "acctestvm-p1p2t"
  random_string     = "p1p2t"
  admin_username    = "testadmin210924010808665611"
  admin_password    = "Password1234!210924010808665611"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210924010808665611"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210924010808665611"
  ...
  identifier {
    publisher = "AccTesPublisher210924010808665611"
    offer     = "AccTesOffer210924010808665611"
    sku       = "AccTesSku210924010808665611"
  }
}
