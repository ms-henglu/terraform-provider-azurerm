...
// ExportJobsTrigger ...
func (c AzureBackupJobClient) ExportJobsTrigger(ctx context.Context, id BackupVaultId) (result ExportJobsTriggerResponse, err error) {
...
func (c AzureBackupJobClient) senderForExportJobsTrigger(ctx context.Context, req *http.Request) (future ExportJobsTriggerResponse, err error) {
