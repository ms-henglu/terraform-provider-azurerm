...
locals {
  number            = "220520040450453232"
  location          = "West Europe"
  domain_name_label = "acctestvm-v1hg1"
  random_string     = "v1hg1"
  admin_username    = "testadmin220520040450453232"
  admin_password    = "Password1234!220520040450453232"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220520040450453232"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220520040450453232"
  ...
  identifier {
    publisher = "AccTesPublisher220520040450453232"
    offer     = "AccTesOffer220520040450453232"
    sku       = "AccTesSku220520040450453232"
  }
}
