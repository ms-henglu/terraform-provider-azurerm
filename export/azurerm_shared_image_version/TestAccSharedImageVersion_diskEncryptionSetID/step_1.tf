...
locals {
  number            = "231218071435567175"
  location          = "West Europe"
  domain_name_label = "acctestvm-3bv2p"
  random_string     = "3bv2p"
  admin_username    = "testadmin231218071435567175"
  admin_password    = "Password1234!231218071435567175"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231218071435567175"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231218071435567175"
  ...
  identifier {
    publisher = "AccTesPublisher231218071435567175"
    offer     = "AccTesOffer231218071435567175"
    sku       = "AccTesSku231218071435567175"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-231218071435567175"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
