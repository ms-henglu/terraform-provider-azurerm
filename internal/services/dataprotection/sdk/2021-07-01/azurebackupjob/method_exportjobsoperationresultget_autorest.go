...
func (c AzureBackupJobClient) ExportJobsOperationResultGet(ctx context.Context, id OperationIdId) (result ExportJobsOperationResultGetResponse, err error) {
...
func (c AzureBackupJobClient) responderForExportJobsOperationResultGet(resp *http.Response) (result ExportJobsOperationResultGetResponse, err error) {
