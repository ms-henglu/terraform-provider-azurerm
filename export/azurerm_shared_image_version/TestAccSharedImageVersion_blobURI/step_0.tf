...
locals {
  number            = "230721014716587058"
  location          = "West Europe"
  domain_name_label = "acctestvm-dxv2w"
  random_string     = "dxv2w"
  admin_username    = "testadmin230721014716587058"
  admin_password    = "Password1234!230721014716587058"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230721014716587058"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230721014716587058"
  ...
  identifier {
    publisher = "AccTesPublisher230721014716587058"
    offer     = "AccTesOffer230721014716587058"
    sku       = "AccTesSku230721014716587058"
  }
}
