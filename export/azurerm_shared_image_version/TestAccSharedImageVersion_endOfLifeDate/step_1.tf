...
locals {
  number            = "221221204056167362"
  location          = "West Europe"
  domain_name_label = "acctestvm-7eiv1"
  random_string     = "7eiv1"
  admin_username    = "testadmin221221204056167362"
  admin_password    = "Password1234!221221204056167362"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221221204056167362"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221221204056167362"
  ...
  identifier {
    publisher = "AccTesPublisher221221204056167362"
    offer     = "AccTesOffer221221204056167362"
    sku       = "AccTesSku221221204056167362"
  }
}
