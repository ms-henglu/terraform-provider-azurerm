...
locals {
  number            = "240119024707420413"
  location          = "West Europe"
  domain_name_label = "acctestvm-tp80l"
  random_string     = "tp80l"
  admin_username    = "testadmin240119024707420413"
  admin_password    = "Password1234!240119024707420413"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240119024707420413"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240119024707420413"
  ...
  identifier {
    publisher = "AccTesPublisher240119024707420413"
    offer     = "AccTesOffer240119024707420413"
    sku       = "AccTesSku240119024707420413"
  }
}
