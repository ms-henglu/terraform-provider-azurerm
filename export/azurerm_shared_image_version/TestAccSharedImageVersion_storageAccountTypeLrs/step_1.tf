...
locals {
  number            = "230721014716588059"
  location          = "West Europe"
  domain_name_label = "acctestvm-erwuu"
  random_string     = "erwuu"
  admin_username    = "testadmin230721014716588059"
  admin_password    = "Password1234!230721014716588059"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230721014716588059"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230721014716588059"
  ...
  identifier {
    publisher = "AccTesPublisher230721014716588059"
    offer     = "AccTesOffer230721014716588059"
    sku       = "AccTesSku230721014716588059"
  }
}
