...
locals {
  number            = "230728031950562743"
  location          = "West Europe"
  domain_name_label = "acctestvm-t3oes"
  random_string     = "t3oes"
  admin_username    = "testadmin230728031950562743"
  admin_password    = "Password1234!230728031950562743"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230728031950562743"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230728031950562743"
  ...
  identifier {
    publisher = "AccTesPublisher230728031950562743"
    offer     = "AccTesOffer230728031950562743"
    sku       = "AccTesSku230728031950562743"
  }
}
