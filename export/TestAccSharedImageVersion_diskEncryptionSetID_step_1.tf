...
locals {
  number            = "220726001659729601"
  location          = "West Europe"
  domain_name_label = "acctestvm-8aip9"
  random_string     = "8aip9"
  admin_username    = "testadmin220726001659729601"
  admin_password    = "Password1234!220726001659729601"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220726001659729601"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220726001659729601"
  ...
  identifier {
    publisher = "AccTesPublisher220726001659729601"
    offer     = "AccTesOffer220726001659729601"
    sku       = "AccTesSku220726001659729601"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220726001659729601"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
