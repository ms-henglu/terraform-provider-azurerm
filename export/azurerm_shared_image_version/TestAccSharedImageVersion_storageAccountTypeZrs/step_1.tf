...
locals {
  number            = "230616074443134133"
  location          = "West Europe"
  domain_name_label = "acctestvm-it36f"
  random_string     = "it36f"
  admin_username    = "testadmin230616074443134133"
  admin_password    = "Password1234!230616074443134133"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230616074443134133"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230616074443134133"
  ...
  identifier {
    publisher = "AccTesPublisher230616074443134133"
    offer     = "AccTesOffer230616074443134133"
    sku       = "AccTesSku230616074443134133"
  }
}
