...
// TriggerRestore ...
func (c BackupInstancesClient) TriggerRestore(ctx context.Context, id BackupInstanceId, input AzureBackupRestoreRequest) (result TriggerRestoreResponse, err error) {
...
func (c BackupInstancesClient) senderForTriggerRestore(ctx context.Context, req *http.Request) (future TriggerRestoreResponse, err error) {
