...
locals {
  number            = "230428045412226111"
  location          = "West Europe"
  domain_name_label = "acctestvm-t7fko"
  random_string     = "t7fko"
  admin_username    = "testadmin230428045412226111"
  admin_password    = "Password1234!230428045412226111"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230428045412226111"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230428045412226111"
  ...
  identifier {
    publisher = "AccTesPublisher230428045412226111"
    offer     = "AccTesOffer230428045412226111"
    sku       = "AccTesSku230428045412226111"
  }
}
