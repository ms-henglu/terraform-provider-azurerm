...
locals {
  number            = "230707003540145671"
  location          = "West Europe"
  domain_name_label = "acctestvm-3u9om"
  random_string     = "3u9om"
  admin_username    = "testadmin230707003540145671"
  admin_password    = "Password1234!230707003540145671"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230707003540145671"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230707003540145671"
  ...
  identifier {
    publisher = "AccTesPublisher230707003540145671"
    offer     = "AccTesOffer230707003540145671"
    sku       = "AccTesSku230707003540145671"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230707003540145671"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
