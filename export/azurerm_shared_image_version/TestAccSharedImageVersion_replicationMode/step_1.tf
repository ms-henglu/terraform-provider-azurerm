...
locals {
  number            = "230804025626262527"
  location          = "West Europe"
  domain_name_label = "acctestvm-44ora"
  random_string     = "44ora"
  admin_username    = "testadmin230804025626262527"
  admin_password    = "Password1234!230804025626262527"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230804025626262527"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230804025626262527"
  ...
  identifier {
    publisher = "AccTesPublisher230804025626262527"
    offer     = "AccTesOffer230804025626262527"
    sku       = "AccTesSku230804025626262527"
  }
}
