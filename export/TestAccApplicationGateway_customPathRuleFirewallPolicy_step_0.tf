...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220916011826774911"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet-220916011826774911"
...
resource "azurerm_subnet" "test" {
  name                                          = "subnet-220916011826774911"
  resource_group_name                           = azurerm_resource_group.test.name
...
resource "azurerm_public_ip" "test" {
  name                = "acctest-pubip-220916011826774911"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_public_ip" "teststd" {
  name                = "acctest-PubIpStd-220916011826774911"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_web_application_firewall_policy" "testfwp" {
  name                = "acctest-fwp-220916011826774911"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_web_application_firewall_policy" "testfwp_path_rule" {
  name                = "acctest-fwp-path-rule-220916011826774911"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_application_gateway" "test" {
  name                = "acctestag-220916011826774911"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
