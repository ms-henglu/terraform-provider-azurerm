...
locals {
  number            = "220124124841967861"
  location          = "West Europe"
  domain_name_label = "acctestvm-tntu6"
  random_string     = "tntu6"
  admin_username    = "testadmin220124124841967861"
  admin_password    = "Password1234!220124124841967861"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220124124841967861"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220124124841967861"
  ...
  identifier {
    publisher = "AccTesPublisher220124124841967861"
    offer     = "AccTesOffer220124124841967861"
    sku       = "AccTesSku220124124841967861"
  }
}
