...
locals {
  number            = "220429075220069831"
  location          = "West Europe"
  domain_name_label = "acctestvm-ksatb"
  random_string     = "ksatb"
  admin_username    = "testadmin220429075220069831"
  admin_password    = "Password1234!220429075220069831"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220429075220069831"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220429075220069831"
  ...
  identifier {
    publisher = "AccTesPublisher220429075220069831"
    offer     = "AccTesOffer220429075220069831"
    sku       = "AccTesSku220429075220069831"
  }
}
