...
resource "azurerm_resource_group" "test" {
  name     = "acctest-kusto-240112224671"
  location = "West Europe"
}

resource "azurerm_kusto_cluster" "test" {
  name                = "acctestkc240112224671"
...
resource "azurerm_kusto_database" "test2" {
  name                = "acctest-kd-2-240112224651452071"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  cluster_name        = azurerm_kusto_cluster.test.name
}
...
resource "azurerm_kusto_database" "test3" {
  name                = "acctest-kd-3-240112224651452071"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  cluster_name        = azurerm_kusto_cluster.test.name
}
...
resource "azurerm_kusto_database" "test4" {
  name                = "acctest-kd-4-240112224651452071"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  cluster_name        = azurerm_kusto_cluster.test.name
}
...
resource "azurerm_kusto_script" "test" {
  name        = "acctest-ks-240112224651452071"
...
resource "azurerm_kusto_script" "test2" {
  name        = "acctest-ks-2-240112224651452071"
...
resource "azurerm_kusto_script" "test3" {
  name        = "acctest-ks-3-240112224651452071"
...
resource "azurerm_kusto_script" "test4" {
  name        = "acctest-ks-4-240112224651452071"
