...
locals {
  number            = "221021033910590259"
  location          = "West Europe"
  domain_name_label = "acctestvm-ouws9"
  random_string     = "ouws9"
  admin_username    = "testadmin221021033910590259"
  admin_password    = "Password1234!221021033910590259"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221021033910590259"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221021033910590259"
  ...
  identifier {
    publisher = "AccTesPublisher221021033910590259"
    offer     = "AccTesOffer221021033910590259"
    sku       = "AccTesSku221021033910590259"
  }
}
