...
locals {
  number            = "230106034233472562"
  location          = "West Europe"
  domain_name_label = "acctestvm-kyvee"
  random_string     = "kyvee"
  admin_username    = "testadmin230106034233472562"
  admin_password    = "Password1234!230106034233472562"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230106034233472562"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230106034233472562"
  ...
  identifier {
    publisher = "AccTesPublisher230106034233472562"
    offer     = "AccTesOffer230106034233472562"
    sku       = "AccTesSku230106034233472562"
  }
}
