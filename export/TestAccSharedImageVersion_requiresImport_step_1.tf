...
locals {
  number            = "211001053545929383"
  location          = "West Europe"
  domain_name_label = "acctestvm-4vyv0"
  random_string     = "4vyv0"
  admin_username    = "testadmin211001053545929383"
  admin_password    = "Password1234!211001053545929383"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211001053545929383"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211001053545929383"
  ...
  identifier {
    publisher = "AccTesPublisher211001053545929383"
    offer     = "AccTesOffer211001053545929383"
    sku       = "AccTesSku211001053545929383"
  }
}
