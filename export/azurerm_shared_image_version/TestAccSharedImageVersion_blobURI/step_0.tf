...
locals {
  number            = "230120051707949186"
  location          = "West Europe"
  domain_name_label = "acctestvm-slzri"
  random_string     = "slzri"
  admin_username    = "testadmin230120051707949186"
  admin_password    = "Password1234!230120051707949186"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230120051707949186"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230120051707949186"
  ...
  identifier {
    publisher = "AccTesPublisher230120051707949186"
    offer     = "AccTesOffer230120051707949186"
    sku       = "AccTesSku230120051707949186"
  }
}
