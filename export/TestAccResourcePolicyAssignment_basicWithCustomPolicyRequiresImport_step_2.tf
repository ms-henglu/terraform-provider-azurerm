...
resource "azurerm_resource_group" "test" {
  name     = "acctest220623234128664532"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-220623234128664532"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestpol-220623234128664532"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestpol-220623234128664532"
...
resource "azurerm_resource_policy_assignment" "test" {
  name                 = "acctestpa-220623234128664532"
