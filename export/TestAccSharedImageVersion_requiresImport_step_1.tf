...
locals {
  number            = "210825040616686755"
  location          = "West Europe"
  domain_name_label = "acctestvm-i49je"
  random_string     = "i49je"
  admin_username    = "testadmin210825040616686755"
  admin_password    = "Password1234!210825040616686755"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210825040616686755"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210825040616686755"
  ...
  identifier {
    publisher = "AccTesPublisher210825040616686755"
    offer     = "AccTesOffer210825040616686755"
    sku       = "AccTesSku210825040616686755"
  }
}
