...
locals {
  number            = "210928075302206676"
  location          = "West Europe"
  domain_name_label = "acctestvm-13fvm"
  random_string     = "13fvm"
  admin_username    = "testadmin210928075302206676"
  admin_password    = "Password1234!210928075302206676"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210928075302206676"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210928075302206676"
  ...
  identifier {
    publisher = "AccTesPublisher210928075302206676"
    offer     = "AccTesOffer210928075302206676"
    sku       = "AccTesSku210928075302206676"
  }
}
