...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220124121851422392"
  location = "West Europe"
}

resource "azurerm_resource_group" "test-sa" {
  name     = "acctestRG-sa-220124121851422392"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctvn-220124121851422392"
...
resource "azurerm_subnet" "test" {
  name                 = "acctsub-220124121851422392"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_network_interface" "test" {
  name                = "acctni-220124121851422392"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_virtual_machine" "test" {
  name                  = "acctvm-220124121851422392"
  location              = azurerm_resource_group.test.location
  resource_group_name   = azurerm_resource_group.test.name
  ...
  os_profile {
    computer_name  = "hn220124121851422392"
