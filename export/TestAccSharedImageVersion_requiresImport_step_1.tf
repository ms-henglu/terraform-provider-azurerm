...
locals {
  number            = "220923011626952757"
  location          = "West Europe"
  domain_name_label = "acctestvm-c9rbe"
  random_string     = "c9rbe"
  admin_username    = "testadmin220923011626952757"
  admin_password    = "Password1234!220923011626952757"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220923011626952757"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220923011626952757"
  ...
  identifier {
    publisher = "AccTesPublisher220923011626952757"
    offer     = "AccTesOffer220923011626952757"
    sku       = "AccTesSku220923011626952757"
  }
}
