...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-211015014303639124"
  location = "West Europe"
}

resource "azurerm_api_management" "test" {
  name                = "acctestAM-211015014303639124"
...
resource "azurerm_api_management_api" "test" {
  name                = "acctestapi-211015014303639124"
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_api_management_api_version_set" "test" {
  name                = "acctestAMAVS-211015014303639124"
  resource_group_name = azurerm_resource_group.test.name
  api_management_name = azurerm_api_management.test.name
...
resource "azurerm_api_management_api" "version" {
  name                = "acctestVersion-211015014303639124"
  resource_group_name = azurerm_resource_group.test.name
  api_management_name = azurerm_api_management.test.name
