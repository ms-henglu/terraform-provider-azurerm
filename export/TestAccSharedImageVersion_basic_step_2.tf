...
locals {
  number            = "220225034148137306"
  location          = "West Europe"
  domain_name_label = "acctestvm-nhd8d"
  random_string     = "nhd8d"
  admin_username    = "testadmin220225034148137306"
  admin_password    = "Password1234!220225034148137306"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220225034148137306"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220225034148137306"
  ...
  identifier {
    publisher = "AccTesPublisher220225034148137306"
    offer     = "AccTesOffer220225034148137306"
    sku       = "AccTesSku220225034148137306"
  }
}
