...
locals {
  number            = "230810143140385430"
  location          = "West Europe"
  domain_name_label = "acctestvm-l9ai0"
  random_string     = "l9ai0"
  admin_username    = "testadmin230810143140385430"
  admin_password    = "Password1234!230810143140385430"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230810143140385430"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230810143140385430"
  ...
  identifier {
    publisher = "AccTesPublisher230810143140385430"
    offer     = "AccTesOffer230810143140385430"
    sku       = "AccTesSku230810143140385430"
  }
}
