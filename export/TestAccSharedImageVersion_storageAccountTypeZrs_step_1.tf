...
locals {
  number            = "220826005646578743"
  location          = "West Europe"
  domain_name_label = "acctestvm-34l2p"
  random_string     = "34l2p"
  admin_username    = "testadmin220826005646578743"
  admin_password    = "Password1234!220826005646578743"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220826005646578743"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220826005646578743"
  ...
  identifier {
    publisher = "AccTesPublisher220826005646578743"
    offer     = "AccTesOffer220826005646578743"
    sku       = "AccTesSku220826005646578743"
  }
}
