...
locals {
  number            = "231016033604027116"
  location          = "West Europe"
  domain_name_label = "acctestvm-owbp2"
  random_string     = "owbp2"
  admin_username    = "testadmin231016033604027116"
  admin_password    = "Password1234!231016033604027116"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231016033604027116"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231016033604027116"
  ...
  identifier {
    publisher = "AccTesPublisher231016033604027116"
    offer     = "AccTesOffer231016033604027116"
    sku       = "AccTesSku231016033604027116"
  }
}
