...
locals {
  number            = "221019060412968597"
  location          = "West Europe"
  domain_name_label = "acctestvm-g9nwj"
  random_string     = "g9nwj"
  admin_username    = "testadmin221019060412968597"
  admin_password    = "Password1234!221019060412968597"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221019060412968597"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221019060412968597"
  ...
  identifier {
    publisher = "AccTesPublisher221019060412968597"
    offer     = "AccTesOffer221019060412968597"
    sku       = "AccTesSku221019060412968597"
  }
}
