...
locals {
  number            = "221221204056167650"
  location          = "West Europe"
  domain_name_label = "acctestvm-y8mvv"
  random_string     = "y8mvv"
  admin_username    = "testadmin221221204056167650"
  admin_password    = "Password1234!221221204056167650"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221221204056167650"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221221204056167650"
  ...
  identifier {
    publisher = "AccTesPublisher221221204056167650"
    offer     = "AccTesOffer221221204056167650"
    sku       = "AccTesSku221221204056167650"
  }
}
