...
locals {
  number            = "221028164721122629"
  location          = "West Europe"
  domain_name_label = "acctestvm-rcrnb"
  random_string     = "rcrnb"
  admin_username    = "testadmin221028164721122629"
  admin_password    = "Password1234!221028164721122629"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221028164721122629"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221028164721122629"
  ...
  identifier {
    publisher = "AccTesPublisher221028164721122629"
    offer     = "AccTesOffer221028164721122629"
    sku       = "AccTesSku221028164721122629"
  }
}
