...
locals {
  number            = "220818234946133262"
  location          = "West Europe"
  domain_name_label = "acctestvm-880rl"
  random_string     = "880rl"
  admin_username    = "testadmin220818234946133262"
  admin_password    = "Password1234!220818234946133262"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220818234946133262"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220818234946133262"
  ...
  identifier {
    publisher = "AccTesPublisher220818234946133262"
    offer     = "AccTesOffer220818234946133262"
    sku       = "AccTesSku220818234946133262"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-220818234946133262"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
