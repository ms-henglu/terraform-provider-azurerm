...
locals {
  number            = "221019060412967814"
  location          = "West Europe"
  domain_name_label = "acctestvm-ek7ab"
  random_string     = "ek7ab"
  admin_username    = "testadmin221019060412967814"
  admin_password    = "Password1234!221019060412967814"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221019060412967814"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221019060412967814"
  ...
  identifier {
    publisher = "AccTesPublisher221019060412967814"
    offer     = "AccTesOffer221019060412967814"
    sku       = "AccTesSku221019060412967814"
  }
}
