...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-hmgus"
  policy_type  = "Custom"
  display_name = "testPolicySet-hmgus"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-hmgus"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-hmgus"
