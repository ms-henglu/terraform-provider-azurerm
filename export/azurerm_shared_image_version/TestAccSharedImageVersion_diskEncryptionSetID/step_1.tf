...
locals {
  number            = "230929064556875508"
  location          = "West Europe"
  domain_name_label = "acctestvm-cy8nq"
  random_string     = "cy8nq"
  admin_username    = "testadmin230929064556875508"
  admin_password    = "Password1234!230929064556875508"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230929064556875508"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230929064556875508"
  ...
  identifier {
    publisher = "AccTesPublisher230929064556875508"
    offer     = "AccTesOffer230929064556875508"
    sku       = "AccTesSku230929064556875508"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230929064556875508"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
