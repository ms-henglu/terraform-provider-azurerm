...
locals {
  number            = "230728031950563466"
  location          = "West Europe"
  domain_name_label = "acctestvm-1gcnk"
  random_string     = "1gcnk"
  admin_username    = "testadmin230728031950563466"
  admin_password    = "Password1234!230728031950563466"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230728031950563466"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230728031950563466"
  ...
  identifier {
    publisher = "AccTesPublisher230728031950563466"
    offer     = "AccTesOffer230728031950563466"
    sku       = "AccTesSku230728031950563466"
  }
}
