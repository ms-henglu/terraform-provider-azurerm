...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-lab-231016034125816583"
  location = "West Europe"
}


resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231016034125816583"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231016034125816583"
  ...
  identifier {
    publisher = "AccTesPublisher231016034125816583"
    offer     = "AccTesOffer231016034125816583"
    sku       = "AccTesSku231016034125816583"
  }
}
...
resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet-231016034125816583"
...
resource "azurerm_subnet" "test" {
  name                 = "acctest-sn-231016034125816583"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_network_interface" "test" {
  name                = "acctestnic-231016034125816583"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "test" {
  name                = "acctestVM-linux-231016034125816583"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  size                = "Standard_F2"
...
resource "azurerm_lab_service_plan" "test" {
  name                = "acctest-lslp-231016034125816583"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_lab_service_lab" "test" {
  name                = "acctest-lab-231016034125816583"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  title               = "Test Title"
