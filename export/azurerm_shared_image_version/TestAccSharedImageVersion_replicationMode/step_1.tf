...
locals {
  number            = "240119021734534447"
  location          = "West Europe"
  domain_name_label = "acctestvm-4d7ro"
  random_string     = "4d7ro"
  admin_username    = "testadmin240119021734534447"
  admin_password    = "Password1234!240119021734534447"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240119021734534447"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240119021734534447"
  ...
  identifier {
    publisher = "AccTesPublisher240119021734534447"
    offer     = "AccTesOffer240119021734534447"
    sku       = "AccTesSku240119021734534447"
  }
}
