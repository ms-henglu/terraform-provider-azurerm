...
locals {
  number            = "220812014802177327"
  location          = "West Europe"
  domain_name_label = "acctestvm-pnekj"
  random_string     = "pnekj"
  admin_username    = "testadmin220812014802177327"
  admin_password    = "Password1234!220812014802177327"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220812014802177327"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220812014802177327"
  ...
  identifier {
    publisher = "AccTesPublisher220812014802177327"
    offer     = "AccTesOffer220812014802177327"
    sku       = "AccTesSku220812014802177327"
  }
}
