...
locals {
  number            = "221111013238938884"
  location          = "West Europe"
  domain_name_label = "acctestvm-1qxl9"
  random_string     = "1qxl9"
  admin_username    = "testadmin221111013238938884"
  admin_password    = "Password1234!221111013238938884"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221111013238938884"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221111013238938884"
  ...
  identifier {
    publisher = "AccTesPublisher221111013238938884"
    offer     = "AccTesOffer221111013238938884"
    sku       = "AccTesSku221111013238938884"
  }
}
