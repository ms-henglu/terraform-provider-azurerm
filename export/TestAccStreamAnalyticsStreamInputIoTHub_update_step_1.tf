...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220603022747379643"
  location = "West Europe"
}

resource "azurerm_iothub" "test" {
  name                = "acctestiothub-220603022747379643"
...
resource "azurerm_stream_analytics_job" "test" {
  name                                     = "acctestjob-220603022747379643"
  resource_group_name                      = azurerm_resource_group.test.name
  location                                 = azurerm_resource_group.test.location
...
resource "azurerm_iothub" "updated" {
  name                = "acctestiot2-220603022747379643"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_stream_analytics_stream_input_iothub" "test" {
  name                         = "acctestinput-220603022747379643"
