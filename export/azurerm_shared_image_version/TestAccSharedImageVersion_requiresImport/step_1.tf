...
locals {
  number            = "221216013235530443"
  location          = "West Europe"
  domain_name_label = "acctestvm-f8qny"
  random_string     = "f8qny"
  admin_username    = "testadmin221216013235530443"
  admin_password    = "Password1234!221216013235530443"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221216013235530443"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221216013235530443"
  ...
  identifier {
    publisher = "AccTesPublisher221216013235530443"
    offer     = "AccTesOffer221216013235530443"
    sku       = "AccTesSku221216013235530443"
  }
}
