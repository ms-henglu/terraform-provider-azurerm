...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220715004235786594"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220715004235786594"
  ...
  identifier {
    publisher = "AccTesPublisher220715004235786594"
    offer     = "AccTesOffer220715004235786594"
    sku       = "AccTesSku220715004235786594"
  }
}
