...
locals {
  number            = "211001020609170620"
  location          = "West Europe"
  domain_name_label = "acctestvm-w2ibs"
  random_string     = "w2ibs"
  admin_username    = "testadmin211001020609170620"
  admin_password    = "Password1234!211001020609170620"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211001020609170620"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211001020609170620"
  ...
  identifier {
    publisher = "AccTesPublisher211001020609170620"
    offer     = "AccTesOffer211001020609170620"
    sku       = "AccTesSku211001020609170620"
  }
}
