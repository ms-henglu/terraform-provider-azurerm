...
type Client struct {
	...
	SQLPoolSensitivityLabelsClient                    *synapse.SQLPoolSensitivityLabelsClient
...
func NewClient(o *common.ClientOptions) *Client {
	...
	sqlPoolSensitivityLabelsClient := synapse.NewSQLPoolSensitivityLabelsClientWithBaseURI(o.ResourceManagerEndpoint, o.SubscriptionId)
	o.ConfigureClient(&sqlPoolSensitivityLabelsClient.Client, o.ResourceManagerAuthorizer)
	...
	return &Client{
		...
		SQLPoolSensitivityLabelsClient:                    &sqlPoolSensitivityLabelsClient,
