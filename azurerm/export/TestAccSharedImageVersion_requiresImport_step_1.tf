...
locals {
  number            = "220627125722845392"
  location          = "West Europe"
  domain_name_label = "acctestvm-fbor4"
  random_string     = "fbor4"
  admin_username    = "testadmin220627125722845392"
  admin_password    = "Password1234!220627125722845392"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627125722845392"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627125722845392"
  ...
  identifier {
    publisher = "AccTesPublisher220627125722845392"
    offer     = "AccTesOffer220627125722845392"
    sku       = "AccTesSku220627125722845392"
  }
}
