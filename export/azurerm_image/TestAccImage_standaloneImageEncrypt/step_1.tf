...
locals {
  number            = "240105060444424180"
  location          = "West Europe"
  domain_name_label = "acctestvm-80pel"
  random_string     = "80pel"
  admin_username    = "testadmin240105060444424180"
  admin_password    = "Password1234!240105060444424180"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-240105060444424180"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
