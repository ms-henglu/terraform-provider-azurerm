...
locals {
  number            = "220722035002631847"
  location          = "West Europe"
  domain_name_label = "acctestvm-pfjk2"
  random_string     = "pfjk2"
  admin_username    = "testadmin220722035002631847"
  admin_password    = "Password1234!220722035002631847"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220722035002631847"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220722035002631847"
  ...
  identifier {
    publisher = "AccTesPublisher220722035002631847"
    offer     = "AccTesOffer220722035002631847"
    sku       = "AccTesSku220722035002631847"
  }
}
