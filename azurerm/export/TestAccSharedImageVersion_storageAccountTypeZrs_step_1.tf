...
locals {
  number            = "220627125722841108"
  location          = "West Europe"
  domain_name_label = "acctestvm-i47el"
  random_string     = "i47el"
  admin_username    = "testadmin220627125722841108"
  admin_password    = "Password1234!220627125722841108"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627125722841108"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627125722841108"
  ...
  identifier {
    publisher = "AccTesPublisher220627125722841108"
    offer     = "AccTesOffer220627125722841108"
    sku       = "AccTesSku220627125722841108"
  }
}
