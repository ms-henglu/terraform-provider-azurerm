...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-210917031601590643"
  location = "West Europe"
}

resource "azurerm_virtual_network" "vnet1" {
  name                = "acctestvnet1210917031601590643"
...
resource "azurerm_virtual_network" "vnet2" {
  name                = "acctestvnet2210917031601590643"
...
resource "azurerm_subnet" "vnet1_subnet1" {
  name                 = "acctestsubnet1210917031601590643"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_subnet" "vnet1_subnet2" {
  name                 = "acctestsubnet2210917031601590643"
  resource_group_name  = azurerm_resource_group.test.name
  virtual_network_name = azurerm_virtual_network.vnet1.name
...
resource "azurerm_subnet" "vnet2_subnet1" {
  name                 = "acctestsubnet3210917031601590643"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_data_lake_store_virtual_network_rule" "test" {
  name                = "acctestsqlvnetrule1210917031601590643"
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_data_lake_store_virtual_network_rule" "rule2" {
  name                = "acctestsqlvnetrule2210917031601590643"
  resource_group_name = azurerm_resource_group.test.name
  account_name        = azurerm_data_lake_store.test.name
...
resource "azurerm_data_lake_store_virtual_network_rule" "rule3" {
  name                = "acctestsqlvnetrule3210917031601590643"
  resource_group_name = azurerm_resource_group.test.name
  account_name        = azurerm_data_lake_store.test.name
