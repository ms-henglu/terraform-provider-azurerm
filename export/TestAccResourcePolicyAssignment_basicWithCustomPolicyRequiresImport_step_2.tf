...
resource "azurerm_resource_group" "test" {
  name     = "acctest220715014840458351"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-220715014840458351"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestpol-220715014840458351"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestpol-220715014840458351"
...
resource "azurerm_resource_policy_assignment" "test" {
  name                 = "acctestpa-220715014840458351"
