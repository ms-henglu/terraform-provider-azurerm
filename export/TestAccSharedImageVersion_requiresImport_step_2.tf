...
locals {
  number            = "220422024923914841"
  location          = "West Europe"
  domain_name_label = "acctestvm-nbipa"
  random_string     = "nbipa"
  admin_username    = "testadmin220422024923914841"
  admin_password    = "Password1234!220422024923914841"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220422024923914841"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220422024923914841"
  ...
  identifier {
    publisher = "AccTesPublisher220422024923914841"
    offer     = "AccTesOffer220422024923914841"
    sku       = "AccTesSku220422024923914841"
  }
}
