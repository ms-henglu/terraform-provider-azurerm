...
locals {
  number            = "220506005527659641"
  location          = "West Europe"
  domain_name_label = "acctestvm-22pit"
  random_string     = "22pit"
  admin_username    = "testadmin220506005527659641"
  admin_password    = "Password1234!220506005527659641"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220506005527659641"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220506005527659641"
  ...
  identifier {
    publisher = "AccTesPublisher220506005527659641"
    offer     = "AccTesOffer220506005527659641"
    sku       = "AccTesSku220506005527659641"
  }
}
