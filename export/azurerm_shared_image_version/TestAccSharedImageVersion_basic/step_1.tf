...
locals {
  number            = "230106034233475572"
  location          = "West Europe"
  domain_name_label = "acctestvm-6cvyz"
  random_string     = "6cvyz"
  admin_username    = "testadmin230106034233475572"
  admin_password    = "Password1234!230106034233475572"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230106034233475572"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230106034233475572"
  ...
  identifier {
    publisher = "AccTesPublisher230106034233475572"
    offer     = "AccTesOffer230106034233475572"
    sku       = "AccTesSku230106034233475572"
  }
}
