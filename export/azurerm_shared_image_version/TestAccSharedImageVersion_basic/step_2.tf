...
locals {
  number            = "230512010404763931"
  location          = "West Europe"
  domain_name_label = "acctestvm-nbz2n"
  random_string     = "nbz2n"
  admin_username    = "testadmin230512010404763931"
  admin_password    = "Password1234!230512010404763931"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230512010404763931"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230512010404763931"
  ...
  identifier {
    publisher = "AccTesPublisher230512010404763931"
    offer     = "AccTesOffer230512010404763931"
    sku       = "AccTesSku230512010404763931"
  }
}
