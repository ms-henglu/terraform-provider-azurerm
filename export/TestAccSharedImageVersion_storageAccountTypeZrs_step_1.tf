...
locals {
  number            = "220415030257363316"
  location          = "West Europe"
  domain_name_label = "acctestvm-4a1gx"
  random_string     = "4a1gx"
  admin_username    = "testadmin220415030257363316"
  admin_password    = "Password1234!220415030257363316"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220415030257363316"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220415030257363316"
  ...
  identifier {
    publisher = "AccTesPublisher220415030257363316"
    offer     = "AccTesOffer220415030257363316"
    sku       = "AccTesSku220415030257363316"
  }
}
