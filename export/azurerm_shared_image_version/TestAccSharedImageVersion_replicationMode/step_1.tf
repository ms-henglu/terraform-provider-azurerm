...
locals {
  number            = "230519074408702374"
  location          = "West Europe"
  domain_name_label = "acctestvm-rpg1t"
  random_string     = "rpg1t"
  admin_username    = "testadmin230519074408702374"
  admin_password    = "Password1234!230519074408702374"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230519074408702374"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230519074408702374"
  ...
  identifier {
    publisher = "AccTesPublisher230519074408702374"
    offer     = "AccTesOffer230519074408702374"
    sku       = "AccTesSku230519074408702374"
  }
}
