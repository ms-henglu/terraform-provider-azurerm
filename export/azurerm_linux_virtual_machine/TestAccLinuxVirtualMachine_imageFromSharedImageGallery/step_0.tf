...
locals {
  ...
  vm_name           = "acctestsourcevm-240112224137857014"
  admin_username    = "testadmin240112224137857014"
  admin_password    = "Password1234!240112224137857014"
}

resource "azurerm_resource_group" "test" {
  name     = "acctestRG-240112224137857014"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestnw-240112224137857014"
...
resource "azurerm_public_ip" "test" {
  name                = "acctpip-240112224137857014"
  location            = "${azurerm_resource_group.test.location}"
  resource_group_name = "${azurerm_resource_group.test.name}"
...
resource "azurerm_network_interface" "public" {
  name                = "acctnicsource-240112224137857014"
  location            = "${azurerm_resource_group.test.location}"
  resource_group_name = "${azurerm_resource_group.test.name}"
...
resource "azurerm_network_interface" "test" {
  name                = "acctestnic-240112224137857014"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "source" {
  name                            = "acctestsourceVM-240112224137857014"
  resource_group_name             = azurerm_resource_group.test.name
  location                        = azurerm_resource_group.test.location
  size                            = "Standard_F2"
