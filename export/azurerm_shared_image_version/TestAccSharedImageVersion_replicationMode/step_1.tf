...
locals {
  number            = "231218071435567488"
  location          = "West Europe"
  domain_name_label = "acctestvm-j3eve"
  random_string     = "j3eve"
  admin_username    = "testadmin231218071435567488"
  admin_password    = "Password1234!231218071435567488"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231218071435567488"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231218071435567488"
  ...
  identifier {
    publisher = "AccTesPublisher231218071435567488"
    offer     = "AccTesOffer231218071435567488"
    sku       = "AccTesSku231218071435567488"
  }
}
