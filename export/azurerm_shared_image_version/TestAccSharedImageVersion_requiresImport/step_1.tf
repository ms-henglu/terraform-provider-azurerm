...
locals {
  number            = "230915023108512020"
  location          = "West Europe"
  domain_name_label = "acctestvm-vcvjz"
  random_string     = "vcvjz"
  admin_username    = "testadmin230915023108512020"
  admin_password    = "Password1234!230915023108512020"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230915023108512020"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230915023108512020"
  ...
  identifier {
    publisher = "AccTesPublisher230915023108512020"
    offer     = "AccTesOffer230915023108512020"
    sku       = "AccTesSku230915023108512020"
  }
}
