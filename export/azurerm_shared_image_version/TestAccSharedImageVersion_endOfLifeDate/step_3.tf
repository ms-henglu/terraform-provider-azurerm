...
locals {
  number            = "230922060812879589"
  location          = "West Europe"
  domain_name_label = "acctestvm-xcdqd"
  random_string     = "xcdqd"
  admin_username    = "testadmin230922060812879589"
  admin_password    = "Password1234!230922060812879589"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230922060812879589"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230922060812879589"
  ...
  identifier {
    publisher = "AccTesPublisher230922060812879589"
    offer     = "AccTesOffer230922060812879589"
    sku       = "AccTesSku230922060812879589"
  }
}
