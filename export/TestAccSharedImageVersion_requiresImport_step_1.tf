...
locals {
  number            = "221019054023433644"
  location          = "West Europe"
  domain_name_label = "acctestvm-rb9rp"
  random_string     = "rb9rp"
  admin_username    = "testadmin221019054023433644"
  admin_password    = "Password1234!221019054023433644"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221019054023433644"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221019054023433644"
  ...
  identifier {
    publisher = "AccTesPublisher221019054023433644"
    offer     = "AccTesOffer221019054023433644"
    sku       = "AccTesSku221019054023433644"
  }
}
