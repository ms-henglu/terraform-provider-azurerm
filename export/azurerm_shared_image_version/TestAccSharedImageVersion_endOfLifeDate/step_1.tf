...
locals {
  number            = "221124181402014726"
  location          = "West Europe"
  domain_name_label = "acctestvm-r76mg"
  random_string     = "r76mg"
  admin_username    = "testadmin221124181402014726"
  admin_password    = "Password1234!221124181402014726"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221124181402014726"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221124181402014726"
  ...
  identifier {
    publisher = "AccTesPublisher221124181402014726"
    offer     = "AccTesOffer221124181402014726"
    sku       = "AccTesSku221124181402014726"
  }
}
