...
const (
	// HubAndSpokeTopology ...
	HubAndSpokeTopology ConnectivityTopology = "HubAndSpokeTopology"
	// MeshTopology ...
	MeshTopology ConnectivityTopology = "MeshTopology"
)
...
func PossibleConnectivityTopologyValues() []ConnectivityTopology {
	return []ConnectivityTopology{HubAndSpokeTopology, MeshTopology}
}
...
// RuleTypeBasicBaseRule enumerates the values for rule type basic base rule.
type RuleTypeBasicBaseRule string

const (
	// RuleTypeAdminRule ...
	RuleTypeAdminRule RuleTypeBasicBaseRule = "AdminRule"
	// RuleTypeBaseRule ...
	RuleTypeBaseRule RuleTypeBasicBaseRule = "BaseRule"
	// RuleTypeDefaultAdminRule ...
	RuleTypeDefaultAdminRule RuleTypeBasicBaseRule = "DefaultAdminRule"
	// RuleTypeDefaultUserRule ...
	RuleTypeDefaultUserRule RuleTypeBasicBaseRule = "DefaultUserRule"
	// RuleTypeUserRule ...
	RuleTypeUserRule RuleTypeBasicBaseRule = "UserRule"
)

// PossibleRuleTypeBasicBaseRuleValues returns an array of possible values for the RuleTypeBasicBaseRule const type.
func PossibleRuleTypeBasicBaseRuleValues() []RuleTypeBasicBaseRule {
	return []RuleTypeBasicBaseRule{RuleTypeAdminRule, RuleTypeBaseRule, RuleTypeDefaultAdminRule, RuleTypeDefaultUserRule, RuleTypeUserRule}
}
