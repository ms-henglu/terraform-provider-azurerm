...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-230810143007135848"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctest-230810143007135848"
...
resource "azurerm_log_analytics_workspace" "test" {
  name                = "acctestLAW-230810143007135848"
  location            = "west europe"
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "PerGB2018"
...
resource "azurerm_automation_software_update_configuration" "test" {
  ...
  name                  = "acctest-suc-230810143007135848"
  ...
  schedule {
    ...
    start_time         = "2023-08-10T15:30:00Z"
    expiry_time        = "2023-08-10T16:30:00Z"
    is_enabled         = true
    interval           = 2
    frequency          = "Hour"
    time_zone          = "Etc/UTC"
