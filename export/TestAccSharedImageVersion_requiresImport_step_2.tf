...
locals {
  number            = "211021234811795491"
  location          = "West Europe"
  domain_name_label = "acctestvm-zchtj"
  random_string     = "zchtj"
  admin_username    = "testadmin211021234811795491"
  admin_password    = "Password1234!211021234811795491"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211021234811795491"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211021234811795491"
  ...
  identifier {
    publisher = "AccTesPublisher211021234811795491"
    offer     = "AccTesOffer211021234811795491"
    sku       = "AccTesSku211021234811795491"
  }
}
