...
locals {
  number            = "211015014023150802"
  location          = "West Europe"
  domain_name_label = "acctestvm-e9ksa"
  random_string     = "e9ksa"
  admin_username    = "testadmin211015014023150802"
  admin_password    = "Password1234!211015014023150802"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211015014023150802"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211015014023150802"
  ...
  identifier {
    publisher = "AccTesPublisher211015014023150802"
    offer     = "AccTesOffer211015014023150802"
    sku       = "AccTesSku211015014023150802"
  }
}
