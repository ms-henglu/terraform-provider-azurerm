...
locals {
  number            = "230630032848831678"
  location          = "West Europe"
  domain_name_label = "acctestvm-kxh0l"
  random_string     = "kxh0l"
  admin_username    = "testadmin230630032848831678"
  admin_password    = "Password1234!230630032848831678"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230630032848831678"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230630032848831678"
  ...
  identifier {
    publisher = "AccTesPublisher230630032848831678"
    offer     = "AccTesOffer230630032848831678"
    sku       = "AccTesSku230630032848831678"
  }
}
