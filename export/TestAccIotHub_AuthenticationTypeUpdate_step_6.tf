...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-iothub-220211043738589754"
  location = "West Europe"
}

resource "azurerm_storage_account" "test" {
  name                     = "acc220211043738589754"
...
resource "azurerm_servicebus_namespace" "test" {
  name                = "acctest-220211043738589754"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Standard"
}
...
resource "azurerm_servicebus_topic" "test" {
  name                = "acctestservicebustopic-220211043738589754"
  namespace_name      = azurerm_servicebus_namespace.test.name
  resource_group_name = azurerm_resource_group.test.name
}
...
resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhubnamespace-220211043738589754"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Basic"
}
...
resource "azurerm_eventhub" "test" {
  name                = "acctesteventhub-220211043738589754"
...
resource "azurerm_user_assigned_identity" "test" {
  name                = "acctestuai-220211043738589754"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}
...
resource "azurerm_iothub" "test" {
  name                = "acctestIoTHub-220211043738589754"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
