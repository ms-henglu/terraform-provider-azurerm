...
locals {
  number            = "230825024235244850"
  location          = "West Europe"
  domain_name_label = "acctestvm-2wkqb"
  random_string     = "2wkqb"
  admin_username    = "testadmin230825024235244850"
  admin_password    = "Password1234!230825024235244850"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230825024235244850"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230825024235244850"
  ...
  identifier {
    publisher = "AccTesPublisher230825024235244850"
    offer     = "AccTesOffer230825024235244850"
    sku       = "AccTesSku230825024235244850"
  }
}
