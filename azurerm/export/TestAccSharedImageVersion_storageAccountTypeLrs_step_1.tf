...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627131710508363"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627131710508363"
  ...
  identifier {
    publisher = "AccTesPublisher220627131710508363"
    offer     = "AccTesOffer220627131710508363"
    sku       = "AccTesSku220627131710508363"
  }
}
