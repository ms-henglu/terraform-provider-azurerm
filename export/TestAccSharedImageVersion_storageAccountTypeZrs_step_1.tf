...
locals {
  number            = "220712042046046763"
  location          = "West Europe"
  domain_name_label = "acctestvm-9vxmg"
  random_string     = "9vxmg"
  admin_username    = "testadmin220712042046046763"
  admin_password    = "Password1234!220712042046046763"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220712042046046763"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220712042046046763"
  ...
  identifier {
    publisher = "AccTesPublisher220712042046046763"
    offer     = "AccTesOffer220712042046046763"
    sku       = "AccTesSku220712042046046763"
  }
}
