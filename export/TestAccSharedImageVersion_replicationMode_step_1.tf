...
locals {
  number            = "220826002453901918"
  location          = "West Europe"
  domain_name_label = "acctestvm-rql4c"
  random_string     = "rql4c"
  admin_username    = "testadmin220826002453901918"
  admin_password    = "Password1234!220826002453901918"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220826002453901918"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220826002453901918"
  ...
  identifier {
    publisher = "AccTesPublisher220826002453901918"
    offer     = "AccTesOffer220826002453901918"
    sku       = "AccTesSku220826002453901918"
  }
}
