...
type GetInResourceGroupResponse struct {
	HttpResponse *http.Response
	Model        *[]BackupVaultResource

	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (GetInResourceGroupResponse, error)
}
...
func (r GetInResourceGroupResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r GetInResourceGroupResponse) LoadMore(ctx context.Context) (resp GetInResourceGroupResponse, err error) {
	if !r.HasMore() {
...
// GetInResourceGroup ...
func (c BackupVaultsClient) GetInResourceGroup(ctx context.Context, id commonids.ResourceGroupId) (resp GetInResourceGroupResponse, err error) {
...
func (c BackupVaultsClient) GetInResourceGroupComplete(ctx context.Context, id commonids.ResourceGroupId) (GetInResourceGroupCompleteResult, error) {
	return c.GetInResourceGroupCompleteMatchingPredicate(ctx, id, BackupVaultResourcePredicate{})
}

// GetInResourceGroupCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c BackupVaultsClient) GetInResourceGroupCompleteMatchingPredicate(ctx context.Context, id commonids.ResourceGroupId, predicate BackupVaultResourcePredicate) (resp GetInResourceGroupCompleteResult, err error) {
...
func (c BackupVaultsClient) responderForGetInResourceGroup(resp *http.Response) (result GetInResourceGroupResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result GetInResourceGroupResponse, err error) {
