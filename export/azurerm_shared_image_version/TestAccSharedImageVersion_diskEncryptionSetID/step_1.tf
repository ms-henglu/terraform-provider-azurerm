...
locals {
  number            = "230407023100168714"
  location          = "West Europe"
  domain_name_label = "acctestvm-l79xv"
  random_string     = "l79xv"
  admin_username    = "testadmin230407023100168714"
  admin_password    = "Password1234!230407023100168714"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230407023100168714"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230407023100168714"
  ...
  identifier {
    publisher = "AccTesPublisher230407023100168714"
    offer     = "AccTesOffer230407023100168714"
    sku       = "AccTesSku230407023100168714"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230407023100168714"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
