...
locals {
  number            = "220422024923911984"
  location          = "West Europe"
  domain_name_label = "acctestvm-ccmrc"
  random_string     = "ccmrc"
  admin_username    = "testadmin220422024923911984"
  admin_password    = "Password1234!220422024923911984"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220422024923911984"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220422024923911984"
  ...
  identifier {
    publisher = "AccTesPublisher220422024923911984"
    offer     = "AccTesOffer220422024923911984"
    sku       = "AccTesSku220422024923911984"
  }
}
