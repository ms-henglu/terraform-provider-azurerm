...
locals {
  number            = "240112224137957290"
  location          = "West Europe"
  domain_name_label = "acctestvm-fxvih"
  random_string     = "fxvih"
  admin_username    = "testadmin240112224137957290"
  admin_password    = "Password1234!240112224137957290"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240112224137957290"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240112224137957290"
  ...
  identifier {
    publisher = "AccTesPublisher240112224137957290"
    offer     = "AccTesOffer240112224137957290"
    sku       = "AccTesSku240112224137957290"
  }
}
