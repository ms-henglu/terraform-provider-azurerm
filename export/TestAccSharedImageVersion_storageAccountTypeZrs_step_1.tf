...
locals {
  number            = "211119050629415973"
  location          = "West Europe"
  domain_name_label = "acctestvm-vtig6"
  random_string     = "vtig6"
  admin_username    = "testadmin211119050629415973"
  admin_password    = "Password1234!211119050629415973"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211119050629415973"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211119050629415973"
  ...
  identifier {
    publisher = "AccTesPublisher211119050629415973"
    offer     = "AccTesOffer211119050629415973"
    sku       = "AccTesSku211119050629415973"
  }
}
