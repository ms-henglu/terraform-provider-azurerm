...
locals {
  number            = "221104005221352723"
  location          = "West Europe"
  domain_name_label = "acctestvm-7a1j3"
  random_string     = "7a1j3"
  admin_username    = "testadmin221104005221352723"
  admin_password    = "Password1234!221104005221352723"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221104005221352723"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221104005221352723"
  ...
  identifier {
    publisher = "AccTesPublisher221104005221352723"
    offer     = "AccTesOffer221104005221352723"
    sku       = "AccTesSku221104005221352723"
  }
}
