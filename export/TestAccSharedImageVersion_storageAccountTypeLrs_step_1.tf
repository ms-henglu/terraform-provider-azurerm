...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220107033655658599"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220107033655658599"
  ...
  identifier {
    publisher = "AccTesPublisher220107033655658599"
    offer     = "AccTesOffer220107033655658599"
    sku       = "AccTesSku220107033655658599"
  }
}
