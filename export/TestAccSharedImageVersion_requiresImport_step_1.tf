...
locals {
  number            = "220324163104842255"
  location          = "West Europe"
  domain_name_label = "acctestvm-g7xjh"
  random_string     = "g7xjh"
  admin_username    = "testadmin220324163104842255"
  admin_password    = "Password1234!220324163104842255"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220324163104842255"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220324163104842255"
  ...
  identifier {
    publisher = "AccTesPublisher220324163104842255"
    offer     = "AccTesOffer220324163104842255"
    sku       = "AccTesSku220324163104842255"
  }
}
