...
type GetDefaultDeleteProtectedItemRequestsObjectResponse struct {
	HttpResponse *http.Response
	Model        *DppBaseResource
}

// GetDefaultDeleteProtectedItemRequestsObject ...
func (c ResourceGuardsClient) GetDefaultDeleteProtectedItemRequestsObject(ctx context.Context, id DeleteProtectedItemRequestId) (result GetDefaultDeleteProtectedItemRequestsObjectResponse, err error) {
...
func (c ResourceGuardsClient) responderForGetDefaultDeleteProtectedItemRequestsObject(resp *http.Response) (result GetDefaultDeleteProtectedItemRequestsObjectResponse, err error) {
