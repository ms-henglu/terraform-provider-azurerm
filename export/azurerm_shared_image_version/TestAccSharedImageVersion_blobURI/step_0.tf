...
locals {
  number            = "221028164721126003"
  location          = "West Europe"
  domain_name_label = "acctestvm-q7x2w"
  random_string     = "q7x2w"
  admin_username    = "testadmin221028164721126003"
  admin_password    = "Password1234!221028164721126003"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221028164721126003"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221028164721126003"
  ...
  identifier {
    publisher = "AccTesPublisher221028164721126003"
    offer     = "AccTesOffer221028164721126003"
    sku       = "AccTesSku221028164721126003"
  }
}
