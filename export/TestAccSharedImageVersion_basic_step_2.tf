...
locals {
  number            = "220128082215742847"
  location          = "West Europe"
  domain_name_label = "acctestvm-9ddi2"
  random_string     = "9ddi2"
  admin_username    = "testadmin220128082215742847"
  admin_password    = "Password1234!220128082215742847"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220128082215742847"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220128082215742847"
  ...
  identifier {
    publisher = "AccTesPublisher220128082215742847"
    offer     = "AccTesOffer220128082215742847"
    sku       = "AccTesSku220128082215742847"
  }
}
