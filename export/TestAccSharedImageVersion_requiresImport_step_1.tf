...
locals {
  number            = "220506005527651879"
  location          = "West Europe"
  domain_name_label = "acctestvm-hsng1"
  random_string     = "hsng1"
  admin_username    = "testadmin220506005527651879"
  admin_password    = "Password1234!220506005527651879"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220506005527651879"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220506005527651879"
  ...
  identifier {
    publisher = "AccTesPublisher220506005527651879"
    offer     = "AccTesOffer220506005527651879"
    sku       = "AccTesSku220506005527651879"
  }
}
