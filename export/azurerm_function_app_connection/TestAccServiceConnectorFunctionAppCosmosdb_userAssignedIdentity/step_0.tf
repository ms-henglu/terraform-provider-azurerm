...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-231016034713728948"
  location = "West Europe"
}

resource "azurerm_cosmosdb_account" "test" {
  name                = "acctestcosmosdb231016034713728948"
...
resource "azurerm_app_service_plan" "test" {
  name                = "acctestASP-231016034713728948"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_function_app" "test" {
  name                       = "acctest-231016034713728948-func"
  location                   = azurerm_resource_group.test.location
  resource_group_name        = azurerm_resource_group.test.name
...
resource "azurerm_function_app_connection" "test" {
  name               = "acctestserviceconnector231016034713728948"
