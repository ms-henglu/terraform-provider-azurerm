...
locals {
  number            = "230512010404768964"
  location          = "West Europe"
  domain_name_label = "acctestvm-h4rsp"
  random_string     = "h4rsp"
  admin_username    = "testadmin230512010404768964"
  admin_password    = "Password1234!230512010404768964"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230512010404768964"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230512010404768964"
  ...
  identifier {
    publisher = "AccTesPublisher230512010404768964"
    offer     = "AccTesOffer230512010404768964"
    sku       = "AccTesSku230512010404768964"
  }
}
