...
locals {
  number            = "220114014015956220"
  location          = "West Europe"
  domain_name_label = "acctestvm-6i9f0"
  random_string     = "6i9f0"
  admin_username    = "testadmin220114014015956220"
  admin_password    = "Password1234!220114014015956220"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220114014015956220"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220114014015956220"
  ...
  identifier {
    publisher = "AccTesPublisher220114014015956220"
    offer     = "AccTesOffer220114014015956220"
    sku       = "AccTesSku220114014015956220"
  }
}
