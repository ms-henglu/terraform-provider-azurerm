...
locals {
  number            = "211210034450661986"
  location          = "West Europe"
  domain_name_label = "acctestvm-702pc"
  random_string     = "702pc"
  admin_username    = "testadmin211210034450661986"
  admin_password    = "Password1234!211210034450661986"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211210034450661986"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211210034450661986"
  ...
  identifier {
    publisher = "AccTesPublisher211210034450661986"
    offer     = "AccTesOffer211210034450661986"
    sku       = "AccTesSku211210034450661986"
  }
}
