...
resource "azurerm_resource_group" "test" {
  name     = "acctest-mn-230526085512586771"
  location = "eastus"
}
...
resource "azurerm_mobile_network_site" "test" {
  name              = "acctest-mns-230526085512586771"
...
resource "azurerm_mobile_network_packet_core_control_plane" "test" {
  name                              = "acctest-mnpccp-230526085512586771"
  resource_group_name               = azurerm_resource_group.test.name
  location                          = "eastus"
  sku                               = "G0"
