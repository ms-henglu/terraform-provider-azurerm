...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-b1ed9"
  policy_type  = "Custom"
  display_name = "testPolicySet-b1ed9"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-b1ed9"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-b1ed9"
