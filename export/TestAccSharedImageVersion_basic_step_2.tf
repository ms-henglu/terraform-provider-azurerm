...
locals {
  number            = "220726001659723463"
  location          = "West Europe"
  domain_name_label = "acctestvm-nxwyx"
  random_string     = "nxwyx"
  admin_username    = "testadmin220726001659723463"
  admin_password    = "Password1234!220726001659723463"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220726001659723463"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220726001659723463"
  ...
  identifier {
    publisher = "AccTesPublisher220726001659723463"
    offer     = "AccTesOffer220726001659723463"
    sku       = "AccTesSku220726001659723463"
  }
}
