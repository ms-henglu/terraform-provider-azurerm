...
locals {
  number            = "230120051707946141"
  location          = "West Europe"
  domain_name_label = "acctestvm-qufd7"
  random_string     = "qufd7"
  admin_username    = "testadmin230120051707946141"
  admin_password    = "Password1234!230120051707946141"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230120051707946141"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230120051707946141"
  ...
  identifier {
    publisher = "AccTesPublisher230120051707946141"
    offer     = "AccTesOffer230120051707946141"
    sku       = "AccTesSku230120051707946141"
  }
}
