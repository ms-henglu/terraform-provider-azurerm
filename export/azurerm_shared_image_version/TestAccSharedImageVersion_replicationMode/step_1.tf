...
locals {
  number            = "240112034043049460"
  location          = "West Europe"
  domain_name_label = "acctestvm-64xgs"
  random_string     = "64xgs"
  admin_username    = "testadmin240112034043049460"
  admin_password    = "Password1234!240112034043049460"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240112034043049460"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240112034043049460"
  ...
  identifier {
    publisher = "AccTesPublisher240112034043049460"
    offer     = "AccTesOffer240112034043049460"
    sku       = "AccTesSku240112034043049460"
  }
}
