...
locals {
  number            = "221019060412966031"
  location          = "West Europe"
  domain_name_label = "acctestvm-9q9yz"
  random_string     = "9q9yz"
  admin_username    = "testadmin221019060412966031"
  admin_password    = "Password1234!221019060412966031"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221019060412966031"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221019060412966031"
  ...
  identifier {
    publisher = "AccTesPublisher221019060412966031"
    offer     = "AccTesOffer221019060412966031"
    sku       = "AccTesSku221019060412966031"
  }
}
