...
locals {
  number            = "221222034403206899"
  location          = "West Europe"
  domain_name_label = "acctestvm-vldis"
  random_string     = "vldis"
  admin_username    = "testadmin221222034403206899"
  admin_password    = "Password1234!221222034403206899"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221222034403206899"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221222034403206899"
  ...
  identifier {
    publisher = "AccTesPublisher221222034403206899"
    offer     = "AccTesOffer221222034403206899"
    sku       = "AccTesSku221222034403206899"
  }
}
