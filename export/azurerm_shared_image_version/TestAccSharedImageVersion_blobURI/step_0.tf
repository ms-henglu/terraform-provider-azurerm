...
locals {
  number            = "230106034233477786"
  location          = "West Europe"
  domain_name_label = "acctestvm-1sawp"
  random_string     = "1sawp"
  admin_username    = "testadmin230106034233477786"
  admin_password    = "Password1234!230106034233477786"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230106034233477786"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230106034233477786"
  ...
  identifier {
    publisher = "AccTesPublisher230106034233477786"
    offer     = "AccTesOffer230106034233477786"
    sku       = "AccTesSku230106034233477786"
  }
}
