...
locals {
  number            = "221104005221351718"
  location          = "West Europe"
  domain_name_label = "acctestvm-q19sh"
  random_string     = "q19sh"
  admin_username    = "testadmin221104005221351718"
  admin_password    = "Password1234!221104005221351718"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221104005221351718"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221104005221351718"
  ...
  identifier {
    publisher = "AccTesPublisher221104005221351718"
    offer     = "AccTesOffer221104005221351718"
    sku       = "AccTesSku221104005221351718"
  }
}
