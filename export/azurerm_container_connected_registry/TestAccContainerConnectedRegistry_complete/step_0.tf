...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-acr-240112034116480550"
  location = "West Europe"
}

resource "azurerm_container_registry" "test" {
  name                  = "testacccr240112034116480550"
...
resource "azurerm_container_registry_scope_map" "test" {
  ...
  actions = [
    ...
    "gateway/testacccrc240112034116480550/config/read",
    "gateway/testacccrc240112034116480550/config/write",
    "gateway/testacccrc240112034116480550/message/read",
    "gateway/testacccrc240112034116480550/message/write",
  ]
}

resource "azurerm_container_registry_token" "test" {
  name                    = "testacccrtoken240112034116480550"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
...
resource "azurerm_container_registry_scope_map" "client" {
  name                    = "testacccrclient240112034116480550"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
  actions = [
    "repositories/hello-world/content/delete",
...
resource "azurerm_container_registry_token" "client" {
  name                    = "testacccrtokenclient240112034116480550"
  container_registry_name = azurerm_container_registry.test.name
  resource_group_name     = azurerm_container_registry.test.resource_group_name
...
resource "azurerm_container_connected_registry" "test" {
  name                  = "testacccrc240112034116480550"
