...
locals {
  number            = "230324051802720011"
  location          = "West Europe"
  domain_name_label = "acctestvm-r3qfq"
  random_string     = "r3qfq"
  admin_username    = "testadmin230324051802720011"
  admin_password    = "Password1234!230324051802720011"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230324051802720011"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230324051802720011"
  ...
  identifier {
    publisher = "AccTesPublisher230324051802720011"
    offer     = "AccTesOffer230324051802720011"
    sku       = "AccTesSku230324051802720011"
  }
}
