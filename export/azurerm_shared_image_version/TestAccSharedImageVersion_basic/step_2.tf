...
locals {
  number            = "240112034043037060"
  location          = "West Europe"
  domain_name_label = "acctestvm-zula7"
  random_string     = "zula7"
  admin_username    = "testadmin240112034043037060"
  admin_password    = "Password1234!240112034043037060"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240112034043037060"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240112034043037060"
  ...
  identifier {
    publisher = "AccTesPublisher240112034043037060"
    offer     = "AccTesOffer240112034043037060"
    sku       = "AccTesSku240112034043037060"
  }
}
