...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-ase-220128053250342942"
  location = "West Europe"
}

resource "azurerm_resource_group" "test2" {
  name     = "acctestRG2-ase-220128053250342942"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet-220128053250342942"
...
resource "azurerm_subnet" "test" {
  name                 = "acctest-subnet-220128053250342942"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_app_service_environment_v3" "test" {
  name                = "acctest-ase-220128053250342942"
  resource_group_name = azurerm_resource_group.test.name
