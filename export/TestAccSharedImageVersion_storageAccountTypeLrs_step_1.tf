...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211015014431936275"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211015014431936275"
  ...
  identifier {
    publisher = "AccTesPublisher211015014431936275"
    offer     = "AccTesOffer211015014431936275"
    sku       = "AccTesSku211015014431936275"
  }
}
