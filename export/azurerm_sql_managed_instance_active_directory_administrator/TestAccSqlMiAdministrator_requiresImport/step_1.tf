...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG1-sql-221021034632136634"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet1-221021034632136634"
...
resource "azurerm_subnet" "test" {
  name                 = "subnet1-221021034632136634"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_network_security_group" "test" {
  name                = "mi-security-group1-221021034632136634"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
}
...
resource "azurerm_route_table" "test" {
  name                          = "routetable1-221021034632136634"
  location                      = azurerm_resource_group.test.location
  resource_group_name           = azurerm_resource_group.test.name
...
resource "azurerm_sql_managed_instance" "test" {
  name                         = "acctestsqlserver221021034632136634"
  resource_group_name          = azurerm_resource_group.test.name
  location                     = azurerm_resource_group.test.location
