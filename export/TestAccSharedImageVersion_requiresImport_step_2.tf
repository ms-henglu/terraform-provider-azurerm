...
locals {
  number            = "220603004640120166"
  location          = "West Europe"
  domain_name_label = "acctestvm-ikznt"
  random_string     = "ikznt"
  admin_username    = "testadmin220603004640120166"
  admin_password    = "Password1234!220603004640120166"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220603004640120166"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220603004640120166"
  ...
  identifier {
    publisher = "AccTesPublisher220603004640120166"
    offer     = "AccTesOffer220603004640120166"
    sku       = "AccTesSku220603004640120166"
  }
}
