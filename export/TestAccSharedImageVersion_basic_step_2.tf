...
locals {
  number            = "211013071641594007"
  location          = "West Europe"
  domain_name_label = "acctestvm-ynlfh"
  random_string     = "ynlfh"
  admin_username    = "testadmin211013071641594007"
  admin_password    = "Password1234!211013071641594007"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211013071641594007"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211013071641594007"
  ...
  identifier {
    publisher = "AccTesPublisher211013071641594007"
    offer     = "AccTesOffer211013071641594007"
    sku       = "AccTesSku211013071641594007"
  }
}
