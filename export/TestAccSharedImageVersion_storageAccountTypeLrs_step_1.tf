...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220415030257365105"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220415030257365105"
  ...
  identifier {
    publisher = "AccTesPublisher220415030257365105"
    offer     = "AccTesOffer220415030257365105"
    sku       = "AccTesSku220415030257365105"
  }
}
