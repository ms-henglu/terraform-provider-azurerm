...
locals {
  rg_name              = "acctest-nested-rg-230810144114280005"
  location             = "West Europe"
  vn_name              = "acctest-nested-vn-230810144114280005"
  ip_name              = "acctest-nested-ip-230810144114280005"
  vm_name              = "acctest-nested-vm-230810144114280005"
  nic_name             = "acctest-nested-nic-230810144114280005"
  disk_name            = "acctest-nested-disk-230810144114280005"
  keyvault_name        = "acctkv230810144114280005"
  nsg_name             = "acctest-nested-nsg-230810144114280005"
  recovery_vault_name  = "acctest-nested-recovery-vault-230810144114280005"
  recovery_site_name   = "acctest-nested-recovery-site-230810144114280005"
  admin_name           = "acctestadmin"
  cert_name            = "acctestcert"
  storage_account_name = "acctestsaivy0y"
}
...
resource "azurerm_windows_virtual_machine" "host" {
  ...
  additional_unattend_content {
    setting = "AutoLogon"
    content = "<AutoLogon><Password><Value>7E1#ng4M^6</Value></Password><Enabled>true</Enabled><LogonCount>1</LogonCount><Username>${local.admin_name}</Username></AutoLogon>"
  }
...
resource "azurerm_site_recovery_hyperv_replication_policy" "test" {
  recovery_vault_id                                  = azurerm_recovery_services_vault.test.id
  name                                               = "acctest-policy-230810144114280005"
