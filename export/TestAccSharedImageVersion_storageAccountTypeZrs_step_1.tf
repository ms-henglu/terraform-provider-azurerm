...
locals {
  number            = "211217075027327115"
  location          = "West Europe"
  domain_name_label = "acctestvm-khb7o"
  random_string     = "khb7o"
  admin_username    = "testadmin211217075027327115"
  admin_password    = "Password1234!211217075027327115"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211217075027327115"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211217075027327115"
  ...
  identifier {
    publisher = "AccTesPublisher211217075027327115"
    offer     = "AccTesOffer211217075027327115"
    sku       = "AccTesSku211217075027327115"
  }
}
