...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220520040450459121"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220520040450459121"
  ...
  identifier {
    publisher = "AccTesPublisher220520040450459121"
    offer     = "AccTesOffer220520040450459121"
    sku       = "AccTesSku220520040450459121"
  }
}
