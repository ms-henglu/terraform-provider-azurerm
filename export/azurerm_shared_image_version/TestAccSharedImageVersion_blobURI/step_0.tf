...
locals {
  number            = "231020040746241042"
  location          = "West Europe"
  domain_name_label = "acctestvm-flq8p"
  random_string     = "flq8p"
  admin_username    = "testadmin231020040746241042"
  admin_password    = "Password1234!231020040746241042"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231020040746241042"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231020040746241042"
  ...
  identifier {
    publisher = "AccTesPublisher231020040746241042"
    offer     = "AccTesOffer231020040746241042"
    sku       = "AccTesSku231020040746241042"
  }
}
