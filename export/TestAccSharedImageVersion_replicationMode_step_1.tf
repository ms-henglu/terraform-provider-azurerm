...
locals {
  number            = "220726014613802986"
  location          = "West Europe"
  domain_name_label = "acctestvm-bx1ko"
  random_string     = "bx1ko"
  admin_username    = "testadmin220726014613802986"
  admin_password    = "Password1234!220726014613802986"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220726014613802986"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220726014613802986"
  ...
  identifier {
    publisher = "AccTesPublisher220726014613802986"
    offer     = "AccTesOffer220726014613802986"
    sku       = "AccTesSku220726014613802986"
  }
}
