...
locals {
  number            = "230407023100167381"
  location          = "West Europe"
  domain_name_label = "acctestvm-qriu4"
  random_string     = "qriu4"
  admin_username    = "testadmin230407023100167381"
  admin_password    = "Password1234!230407023100167381"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230407023100167381"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230407023100167381"
  ...
  identifier {
    publisher = "AccTesPublisher230407023100167381"
    offer     = "AccTesOffer230407023100167381"
    sku       = "AccTesSku230407023100167381"
  }
}
