...
locals {
  number            = "220627131710509425"
  location          = "West Europe"
  domain_name_label = "acctestvm-7qbwd"
  random_string     = "7qbwd"
  admin_username    = "testadmin220627131710509425"
  admin_password    = "Password1234!220627131710509425"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627131710509425"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627131710509425"
  ...
  identifier {
    publisher = "AccTesPublisher220627131710509425"
    offer     = "AccTesOffer220627131710509425"
    sku       = "AccTesSku220627131710509425"
  }
}
