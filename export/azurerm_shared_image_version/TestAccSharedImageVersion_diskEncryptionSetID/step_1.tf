...
locals {
  number            = "230120051707943601"
  location          = "West Europe"
  domain_name_label = "acctestvm-rjglw"
  random_string     = "rjglw"
  admin_username    = "testadmin230120051707943601"
  admin_password    = "Password1234!230120051707943601"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230120051707943601"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230120051707943601"
  ...
  identifier {
    publisher = "AccTesPublisher230120051707943601"
    offer     = "AccTesOffer230120051707943601"
    sku       = "AccTesSku230120051707943601"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230120051707943601"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
