...
locals {
  number            = "220114063934539803"
  location          = "West Europe"
  domain_name_label = "acctestvm-6y2ju"
  random_string     = "6y2ju"
  admin_username    = "testadmin220114063934539803"
  admin_password    = "Password1234!220114063934539803"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220114063934539803"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220114063934539803"
  ...
  identifier {
    publisher = "AccTesPublisher220114063934539803"
    offer     = "AccTesOffer220114063934539803"
    sku       = "AccTesSku220114063934539803"
  }
}
