...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-nqgpo"
  policy_type  = "Custom"
  display_name = "testPolicySet-nqgpo"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-nqgpo"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-nqgpo"
