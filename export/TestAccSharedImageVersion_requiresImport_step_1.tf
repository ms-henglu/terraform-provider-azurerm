...
locals {
  number            = "220114063934532655"
  location          = "West Europe"
  domain_name_label = "acctestvm-oawiz"
  random_string     = "oawiz"
  admin_username    = "testadmin220114063934532655"
  admin_password    = "Password1234!220114063934532655"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220114063934532655"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220114063934532655"
  ...
  identifier {
    publisher = "AccTesPublisher220114063934532655"
    offer     = "AccTesOffer220114063934532655"
    sku       = "AccTesSku220114063934532655"
  }
}
