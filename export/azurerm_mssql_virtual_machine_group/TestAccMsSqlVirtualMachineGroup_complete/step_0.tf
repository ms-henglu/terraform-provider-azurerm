...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-mssql-240112034811679308"
  location = "West Europe"
}

resource "azurerm_storage_account" "test" {
  name                     = "unlikely23exst2acctbpb2o"
...
resource "azurerm_mssql_virtual_machine_group" "test" {
  ...
  wsfc_domain_profile {
    ...
    cluster_bootstrap_account_name = "bootstrapaccbpb2o"
    cluster_operator_account_name  = "opaccbpb2o"
    sql_service_account_name       = "sqlsrvaccbpb2o"
