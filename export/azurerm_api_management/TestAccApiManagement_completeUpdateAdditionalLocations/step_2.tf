...
resource "azurerm_resource_group" "test1" {
  name     = "acctestRG-api1-230922053516783008"
  location = "West Europe"
}

resource "azurerm_resource_group" "test2" {
  name     = "acctestRG-api2-230922053516783008"
  location = "West US 2"
}

resource "azurerm_resource_group" "test3" {
  name     = "acctestRG-api3-230922053516783008"
  location = "East US 2"
}

resource "azurerm_api_management" "test" {
  name                      = "acctestAM-230922053516783008"
  publisher_name            = "pub1"
  ...
  hostname_configuration {
    proxy {
      host_name                    = "acctestAM-230922053516783008.azure-api.net"
