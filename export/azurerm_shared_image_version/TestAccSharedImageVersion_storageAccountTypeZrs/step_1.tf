...
locals {
  number            = "230810143140382950"
  location          = "West Europe"
  domain_name_label = "acctestvm-iz4lq"
  random_string     = "iz4lq"
  admin_username    = "testadmin230810143140382950"
  admin_password    = "Password1234!230810143140382950"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230810143140382950"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230810143140382950"
  ...
  identifier {
    publisher = "AccTesPublisher230810143140382950"
    offer     = "AccTesOffer230810143140382950"
    sku       = "AccTesSku230810143140382950"
  }
}
