...
locals {
  number            = "230120054357242695"
  location          = "West Europe"
  domain_name_label = "acctestvm-3cfiw"
  random_string     = "3cfiw"
  admin_username    = "testadmin230120054357242695"
  admin_password    = "Password1234!230120054357242695"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230120054357242695"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230120054357242695"
  ...
  identifier {
    publisher = "AccTesPublisher230120054357242695"
    offer     = "AccTesOffer230120054357242695"
    sku       = "AccTesSku230120054357242695"
  }
}
