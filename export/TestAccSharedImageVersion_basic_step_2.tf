...
locals {
  number            = "220527033935750209"
  location          = "West Europe"
  domain_name_label = "acctestvm-ne8y4"
  random_string     = "ne8y4"
  admin_username    = "testadmin220527033935750209"
  admin_password    = "Password1234!220527033935750209"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220527033935750209"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220527033935750209"
  ...
  identifier {
    publisher = "AccTesPublisher220527033935750209"
    offer     = "AccTesOffer220527033935750209"
    sku       = "AccTesSku220527033935750209"
  }
}
