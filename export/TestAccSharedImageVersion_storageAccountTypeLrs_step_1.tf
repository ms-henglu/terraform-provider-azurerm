...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220923011626958840"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220923011626958840"
  ...
  identifier {
    publisher = "AccTesPublisher220923011626958840"
    offer     = "AccTesOffer220923011626958840"
    sku       = "AccTesSku220923011626958840"
  }
}
