...
locals {
  number            = "230922060812874817"
  location          = "West Europe"
  domain_name_label = "acctestvm-dmjqd"
  random_string     = "dmjqd"
  admin_username    = "testadmin230922060812874817"
  admin_password    = "Password1234!230922060812874817"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230922060812874817"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230922060812874817"
  ...
  identifier {
    publisher = "AccTesPublisher230922060812874817"
    offer     = "AccTesOffer230922060812874817"
    sku       = "AccTesSku230922060812874817"
  }
}
