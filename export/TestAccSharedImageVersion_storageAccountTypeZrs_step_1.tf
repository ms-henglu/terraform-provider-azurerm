...
locals {
  number            = "211015014023158768"
  location          = "West Europe"
  domain_name_label = "acctestvm-o34cy"
  random_string     = "o34cy"
  admin_username    = "testadmin211015014023158768"
  admin_password    = "Password1234!211015014023158768"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211015014023158768"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211015014023158768"
  ...
  identifier {
    publisher = "AccTesPublisher211015014023158768"
    offer     = "AccTesOffer211015014023158768"
    sku       = "AccTesSku211015014023158768"
  }
}
