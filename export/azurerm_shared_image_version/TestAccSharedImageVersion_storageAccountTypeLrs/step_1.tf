...
locals {
  number            = "221019060412966081"
  location          = "West Europe"
  domain_name_label = "acctestvm-4rac8"
  random_string     = "4rac8"
  admin_username    = "testadmin221019060412966081"
  admin_password    = "Password1234!221019060412966081"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221019060412966081"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221019060412966081"
  ...
  identifier {
    publisher = "AccTesPublisher221019060412966081"
    offer     = "AccTesOffer221019060412966081"
    sku       = "AccTesSku221019060412966081"
  }
}
