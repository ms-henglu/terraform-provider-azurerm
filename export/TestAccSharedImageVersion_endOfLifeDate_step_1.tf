...
locals {
  number            = "220726014613800017"
  location          = "West Europe"
  domain_name_label = "acctestvm-uvexx"
  random_string     = "uvexx"
  admin_username    = "testadmin220726014613800017"
  admin_password    = "Password1234!220726014613800017"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220726014613800017"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220726014613800017"
  ...
  identifier {
    publisher = "AccTesPublisher220726014613800017"
    offer     = "AccTesOffer220726014613800017"
    sku       = "AccTesSku220726014613800017"
  }
}
