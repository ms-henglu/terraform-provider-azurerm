...
locals {
  number            = "220630210603395406"
  location          = "West Europe"
  domain_name_label = "acctestvm-jg368"
  random_string     = "jg368"
  admin_username    = "testadmin220630210603395406"
  admin_password    = "Password1234!220630210603395406"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220630210603395406"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220630210603395406"
  ...
  identifier {
    publisher = "AccTesPublisher220630210603395406"
    offer     = "AccTesOffer220630210603395406"
    sku       = "AccTesSku220630210603395406"
  }
}
...
resource "azurerm_shared_image_version" "test" {
  ...
  end_of_life_date    = "2022-07-01T07:06:03Z"
