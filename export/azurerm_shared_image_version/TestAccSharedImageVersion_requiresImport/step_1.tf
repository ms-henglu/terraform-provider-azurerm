...
locals {
  number            = "230721014716586948"
  location          = "West Europe"
  domain_name_label = "acctestvm-9vju7"
  random_string     = "9vju7"
  admin_username    = "testadmin230721014716586948"
  admin_password    = "Password1234!230721014716586948"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230721014716586948"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230721014716586948"
  ...
  identifier {
    publisher = "AccTesPublisher230721014716586948"
    offer     = "AccTesOffer230721014716586948"
    sku       = "AccTesSku230721014716586948"
  }
}
