...
locals {
  number            = "220407230802470250"
  location          = "West Europe"
  domain_name_label = "acctestvm-stgh2"
  random_string     = "stgh2"
  admin_username    = "testadmin220407230802470250"
  admin_password    = "Password1234!220407230802470250"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220407230802470250"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220407230802470250"
  ...
  identifier {
    publisher = "AccTesPublisher220407230802470250"
    offer     = "AccTesOffer220407230802470250"
    sku       = "AccTesSku220407230802470250"
  }
}
