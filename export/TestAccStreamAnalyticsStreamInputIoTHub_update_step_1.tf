...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-210917032254839824"
  location = "West Europe"
}

resource "azurerm_iothub" "test" {
  name                = "acctestiothub-210917032254839824"
...
resource "azurerm_stream_analytics_job" "test" {
  name                                     = "acctestjob-210917032254839824"
  resource_group_name                      = azurerm_resource_group.test.name
  location                                 = azurerm_resource_group.test.location
...
resource "azurerm_iothub" "updated" {
  name                = "acctestiot2-210917032254839824"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_stream_analytics_stream_input_iothub" "test" {
  name                         = "acctestinput-210917032254839824"
