...
locals {
  number            = "230313020903882874"
  location          = "West Europe"
  domain_name_label = "acctestvm-c7gup"
  random_string     = "c7gup"
  admin_username    = "testadmin230313020903882874"
  admin_password    = "Password1234!230313020903882874"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230313020903882874"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230313020903882874"
  ...
  identifier {
    publisher = "AccTesPublisher230313020903882874"
    offer     = "AccTesOffer230313020903882874"
    sku       = "AccTesSku230313020903882874"
  }
}
