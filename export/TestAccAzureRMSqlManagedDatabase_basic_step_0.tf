...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-sql-211021235549102155"
  location = "West Europe"
}

resource "azurerm_network_security_group" "test" {
  name                = "mi-security-group-211021235549102155"
...
resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet-211021235549102155"
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_subnet" "test" {
  name                 = "subnet-211021235549102155"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_route_table" "test" {
  name                          = "routetable-211021235549102155"
  location                      = azurerm_resource_group.test.location
  resource_group_name           = azurerm_resource_group.test.name
...
resource "azurerm_sql_managed_instance" "test" {
  name                         = "acctestsqlserver211021235549102155"
  resource_group_name          = azurerm_resource_group.test.name
  location                     = azurerm_resource_group.test.location
...
resource "azurerm_sql_managed_database" "test" {
  ...
  name                    = "acctest-211021235549102155"
  location                = azurerm_resource_group.test.location
}
