...
locals {
  number            = "220627122505828487"
  location          = "West Europe"
  domain_name_label = "acctestvm-ov1qw"
  random_string     = "ov1qw"
  admin_username    = "testadmin220627122505828487"
  admin_password    = "Password1234!220627122505828487"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627122505828487"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627122505828487"
  ...
  identifier {
    publisher = "AccTesPublisher220627122505828487"
    offer     = "AccTesOffer220627122505828487"
    sku       = "AccTesSku220627122505828487"
  }
}
