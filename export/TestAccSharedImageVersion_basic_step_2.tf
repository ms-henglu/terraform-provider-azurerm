...
locals {
  number            = "211105025753277419"
  location          = "West Europe"
  domain_name_label = "acctestvm-at7fo"
  random_string     = "at7fo"
  admin_username    = "testadmin211105025753277419"
  admin_password    = "Password1234!211105025753277419"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211105025753277419"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211105025753277419"
  ...
  identifier {
    publisher = "AccTesPublisher211105025753277419"
    offer     = "AccTesOffer211105025753277419"
    sku       = "AccTesSku211105025753277419"
  }
}
