...
locals {
  number            = "230407023100162048"
  location          = "West Europe"
  domain_name_label = "acctestvm-pv18f"
  random_string     = "pv18f"
  admin_username    = "testadmin230407023100162048"
  admin_password    = "Password1234!230407023100162048"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230407023100162048"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230407023100162048"
  ...
  identifier {
    publisher = "AccTesPublisher230407023100162048"
    offer     = "AccTesOffer230407023100162048"
    sku       = "AccTesSku230407023100162048"
  }
}
