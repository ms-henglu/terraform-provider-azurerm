...
locals {
  number            = "220812014802171302"
  location          = "West Europe"
  domain_name_label = "acctestvm-0gpke"
  random_string     = "0gpke"
  admin_username    = "testadmin220812014802171302"
  admin_password    = "Password1234!220812014802171302"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220812014802171302"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220812014802171302"
  ...
  identifier {
    publisher = "AccTesPublisher220812014802171302"
    offer     = "AccTesOffer220812014802171302"
    sku       = "AccTesSku220812014802171302"
  }
}
