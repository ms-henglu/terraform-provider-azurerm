...
resource "azurerm_resource_group" "test1" {
  name     = "acctestRG-api1-221111015937959988"
  location = "West Europe"
}

resource "azurerm_resource_group" "test2" {
  name     = "acctestRG-api2-221111015937959988"
  location = "West US 2"
}

resource "azurerm_resource_group" "test3" {
  name     = "acctestRG-api3-221111015937959988"
  location = "East US 2"
}

resource "azurerm_api_management" "test" {
  name                      = "acctestAM-221111015937959988"
  publisher_name            = "pub1"
  ...
  hostname_configuration {
    proxy {
      host_name                    = "acctestAM-221111015937959988.azure-api.net"
