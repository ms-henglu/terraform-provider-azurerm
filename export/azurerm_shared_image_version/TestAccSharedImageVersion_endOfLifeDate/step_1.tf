...
locals {
  number            = "240105063504067701"
  location          = "West Europe"
  domain_name_label = "acctestvm-j1rvg"
  random_string     = "j1rvg"
  admin_username    = "testadmin240105063504067701"
  admin_password    = "Password1234!240105063504067701"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240105063504067701"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240105063504067701"
  ...
  identifier {
    publisher = "AccTesPublisher240105063504067701"
    offer     = "AccTesOffer240105063504067701"
    sku       = "AccTesSku240105063504067701"
  }
}
