...
locals {
  number            = "220324163104847539"
  location          = "West Europe"
  domain_name_label = "acctestvm-nod8h"
  random_string     = "nod8h"
  admin_username    = "testadmin220324163104847539"
  admin_password    = "Password1234!220324163104847539"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220324163104847539"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220324163104847539"
  ...
  identifier {
    publisher = "AccTesPublisher220324163104847539"
    offer     = "AccTesOffer220324163104847539"
    sku       = "AccTesSku220324163104847539"
  }
}
