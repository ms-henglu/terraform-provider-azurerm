...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-230616075211618987"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestvn-230616075211618987"
...
resource "azurerm_virtual_network" "gateway" {
  name                = "acctestvnet-gw-230616075211618987"
...
resource "azurerm_subnet" "gateway" {
  name                 = "acctestsubnet-gw-230616075211618987"
...
resource "azurerm_lb" "gateway" {
  name                = "acctestlb-230616075211618987"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Gateway"
...
resource "azurerm_lb_backend_address_pool" "gateway" {
  name            = "acctestbap-230616075211618987"
...
resource "azurerm_public_ip" "test" {
  name                = "acctestpip-230616075211618987"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  sku                 = "Standard"
...
resource "azurerm_network_interface" "test" {
  name                = "acctestnic-230616075211618987"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
