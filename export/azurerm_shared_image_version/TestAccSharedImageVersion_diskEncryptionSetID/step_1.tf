...
locals {
  number            = "221111020149332900"
  location          = "West Europe"
  domain_name_label = "acctestvm-oxbop"
  random_string     = "oxbop"
  admin_username    = "testadmin221111020149332900"
  admin_password    = "Password1234!221111020149332900"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221111020149332900"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221111020149332900"
  ...
  identifier {
    publisher = "AccTesPublisher221111020149332900"
    offer     = "AccTesOffer221111020149332900"
    sku       = "AccTesSku221111020149332900"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-221111020149332900"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
