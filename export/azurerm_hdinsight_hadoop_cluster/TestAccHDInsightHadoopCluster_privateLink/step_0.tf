...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-221021034152659366"
  location = "West Europe"
}

resource "azurerm_storage_account" "gen2test" {
  name                     = "accgen2test2rn9e"
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestvirtnet221021034152659366"
...
resource "azurerm_subnet" "test" {
  name                 = "acctestsubnet221021034152659366"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_public_ip" "test" {
  name                = "acctestpip221021034152659366"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_nat_gateway" "test" {
  name                    = "acctestnat221021034152659366"
  location                = azurerm_resource_group.test.location
  resource_group_name     = azurerm_resource_group.test.name
  sku_name                = "Standard"
...
resource "azurerm_hdinsight_hadoop_cluster" "test" {
  ...
  name                = "acctesthdi-221021034152659366"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  cluster_version     = "4.0"
  tier                = "Standard"
...
resource "azurerm_network_security_group" "test" {
  name                = "acctestnsg-221021034152659366"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
