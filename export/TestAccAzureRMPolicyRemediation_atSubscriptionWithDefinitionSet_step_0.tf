...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-m9ag6"
  policy_type  = "Custom"
  display_name = "testPolicySet-m9ag6"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-m9ag6"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-m9ag6"
