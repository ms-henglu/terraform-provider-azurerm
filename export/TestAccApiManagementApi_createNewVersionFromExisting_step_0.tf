...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-220204055629027024"
  location = "West Europe"
}

resource "azurerm_api_management" "test" {
  name                = "acctestAM-220204055629027024"
...
resource "azurerm_api_management_api" "test" {
  name                = "acctestapi-220204055629027024"
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_api_management_api_version_set" "test" {
  name                = "acctestAMAVS-220204055629027024"
  resource_group_name = azurerm_resource_group.test.name
  api_management_name = azurerm_api_management.test.name
...
resource "azurerm_api_management_api" "version" {
  name                = "acctestVersion-220204055629027024"
  resource_group_name = azurerm_resource_group.test.name
  api_management_name = azurerm_api_management.test.name
