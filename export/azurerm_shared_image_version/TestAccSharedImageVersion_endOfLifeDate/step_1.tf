...
locals {
  number            = "221216013235530121"
  location          = "West Europe"
  domain_name_label = "acctestvm-q93t2"
  random_string     = "q93t2"
  admin_username    = "testadmin221216013235530121"
  admin_password    = "Password1234!221216013235530121"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221216013235530121"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221216013235530121"
  ...
  identifier {
    publisher = "AccTesPublisher221216013235530121"
    offer     = "AccTesOffer221216013235530121"
    sku       = "AccTesSku221216013235530121"
  }
}
