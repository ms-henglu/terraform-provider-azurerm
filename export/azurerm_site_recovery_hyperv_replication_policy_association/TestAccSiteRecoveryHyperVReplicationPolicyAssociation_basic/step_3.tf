...
locals {
  rg_name              = "acctest-nested-rg-230512011252343946"
  location             = "West Europe"
  vn_name              = "acctest-nested-vn-230512011252343946"
  ip_name              = "acctest-nested-ip-230512011252343946"
  vm_name              = "acctest-nested-vm-230512011252343946"
  nic_name             = "acctest-nested-nic-230512011252343946"
  disk_name            = "acctest-nested-disk-230512011252343946"
  keyvault_name        = "acctkv230512011252343946"
  nsg_name             = "acctest-nested-nsg-230512011252343946"
  recovery_vault_name  = "acctest-nested-recovery-vault-230512011252343946"
  recovery_site_name   = "acctest-nested-recovery-site-230512011252343946"
  admin_name           = "acctestadmin"
  cert_name            = "acctestcert"
  storage_account_name = "acctestsazj11b"
}
...
resource "azurerm_windows_virtual_machine" "host" {
  ...
  additional_unattend_content {
    setting = "AutoLogon"
    content = "<AutoLogon><Password><Value>^($)##1Q)#</Value></Password><Enabled>true</Enabled><LogonCount>1</LogonCount><Username>${local.admin_name}</Username></AutoLogon>"
  }
...
resource "azurerm_site_recovery_hyperv_replication_policy" "test" {
  recovery_vault_id                                  = azurerm_recovery_services_vault.test.id
  name                                               = "acctest-policy-230512011252343946"
