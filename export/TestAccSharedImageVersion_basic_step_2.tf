...
locals {
  number            = "220422011655558084"
  location          = "West Europe"
  domain_name_label = "acctestvm-9nplg"
  random_string     = "9nplg"
  admin_username    = "testadmin220422011655558084"
  admin_password    = "Password1234!220422011655558084"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220422011655558084"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220422011655558084"
  ...
  identifier {
    publisher = "AccTesPublisher220422011655558084"
    offer     = "AccTesOffer220422011655558084"
    sku       = "AccTesSku220422011655558084"
  }
}
