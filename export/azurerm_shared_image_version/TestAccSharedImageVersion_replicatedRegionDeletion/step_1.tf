...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240112224137953277"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240112224137953277"
  ...
  identifier {
    publisher = "AccTesPublisher240112224137953277"
    offer     = "AccTesOffer240112224137953277"
    sku       = "AccTesSku240112224137953277"
  }
}
