...
resource "azurerm_resource_group" "test1" {
  name     = "acctestRG-api1-240311031231518895"
  location = "West Europe"
}

resource "azurerm_resource_group" "test2" {
  name     = "acctestRG-api2-240311031231518895"
  location = "West US 2"
}

resource "azurerm_resource_group" "test3" {
  name     = "acctestRG-api3-240311031231518895"
  location = "East US 2"
}

resource "azurerm_api_management" "test" {
  name                      = "acctestAM-240311031231518895"
  publisher_name            = "pub1"
  ...
  hostname_configuration {
    proxy {
      host_name                    = "acctestAM-240311031231518895.azure-api.net"
