...
locals {
  number            = "230915023108513953"
  location          = "West Europe"
  domain_name_label = "acctestvm-hg8g3"
  random_string     = "hg8g3"
  admin_username    = "testadmin230915023108513953"
  admin_password    = "Password1234!230915023108513953"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230915023108513953"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230915023108513953"
  ...
  identifier {
    publisher = "AccTesPublisher230915023108513953"
    offer     = "AccTesOffer230915023108513953"
    sku       = "AccTesSku230915023108513953"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230915023108513953"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
