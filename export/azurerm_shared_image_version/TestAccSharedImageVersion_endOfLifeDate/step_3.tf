...
locals {
  number            = "230613071532220060"
  location          = "West Europe"
  domain_name_label = "acctestvm-sbu28"
  random_string     = "sbu28"
  admin_username    = "testadmin230613071532220060"
  admin_password    = "Password1234!230613071532220060"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230613071532220060"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230613071532220060"
  ...
  identifier {
    publisher = "AccTesPublisher230613071532220060"
    offer     = "AccTesOffer230613071532220060"
    sku       = "AccTesSku230613071532220060"
  }
}
