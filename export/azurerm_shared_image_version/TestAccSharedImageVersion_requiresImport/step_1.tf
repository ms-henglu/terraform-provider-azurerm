...
locals {
  number            = "230316221218745268"
  location          = "West Europe"
  domain_name_label = "acctestvm-i2utu"
  random_string     = "i2utu"
  admin_username    = "testadmin230316221218745268"
  admin_password    = "Password1234!230316221218745268"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230316221218745268"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230316221218745268"
  ...
  identifier {
    publisher = "AccTesPublisher230316221218745268"
    offer     = "AccTesOffer230316221218745268"
    sku       = "AccTesSku230316221218745268"
  }
}
