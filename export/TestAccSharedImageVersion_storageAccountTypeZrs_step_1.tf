...
locals {
  number            = "211112020355812812"
  location          = "West Europe"
  domain_name_label = "acctestvm-ephad"
  random_string     = "ephad"
  admin_username    = "testadmin211112020355812812"
  admin_password    = "Password1234!211112020355812812"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211112020355812812"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211112020355812812"
  ...
  identifier {
    publisher = "AccTesPublisher211112020355812812"
    offer     = "AccTesOffer211112020355812812"
    sku       = "AccTesSku211112020355812812"
  }
}
