...
locals {
  number            = "220916011219832503"
  location          = "West Europe"
  domain_name_label = "acctestvm-ucibd"
  random_string     = "ucibd"
  admin_username    = "testadmin220916011219832503"
  admin_password    = "Password1234!220916011219832503"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220916011219832503"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220916011219832503"
  ...
  identifier {
    publisher = "AccTesPublisher220916011219832503"
    offer     = "AccTesOffer220916011219832503"
    sku       = "AccTesSku220916011219832503"
  }
}
