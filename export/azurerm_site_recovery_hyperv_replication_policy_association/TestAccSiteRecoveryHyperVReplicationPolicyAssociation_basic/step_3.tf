...
locals {
  rg_name              = "acctest-nested-rg-230616075323997372"
  location             = "West Europe"
  vn_name              = "acctest-nested-vn-230616075323997372"
  ip_name              = "acctest-nested-ip-230616075323997372"
  vm_name              = "acctest-nested-vm-230616075323997372"
  nic_name             = "acctest-nested-nic-230616075323997372"
  disk_name            = "acctest-nested-disk-230616075323997372"
  keyvault_name        = "acctkv230616075323997372"
  nsg_name             = "acctest-nested-nsg-230616075323997372"
  recovery_vault_name  = "acctest-nested-recovery-vault-230616075323997372"
  recovery_site_name   = "acctest-nested-recovery-site-230616075323997372"
  admin_name           = "acctestadmin"
  cert_name            = "acctestcert"
  storage_account_name = "acctestsa7o3zr"
}
...
resource "azurerm_windows_virtual_machine" "host" {
  ...
  additional_unattend_content {
    setting = "AutoLogon"
    content = "<AutoLogon><Password><Value>VNr4%HV$Mu</Value></Password><Enabled>true</Enabled><LogonCount>1</LogonCount><Username>${local.admin_name}</Username></AutoLogon>"
  }
...
resource "azurerm_site_recovery_hyperv_replication_policy" "test" {
  recovery_vault_id                                  = azurerm_recovery_services_vault.test.id
  name                                               = "acctest-policy-230616075323997372"
