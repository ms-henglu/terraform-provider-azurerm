...
locals {
  number            = "220630223513059568"
  location          = "West Europe"
  domain_name_label = "acctestvm-pwelm"
  random_string     = "pwelm"
  admin_username    = "testadmin220630223513059568"
  admin_password    = "Password1234!220630223513059568"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220630223513059568"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220630223513059568"
  ...
  identifier {
    publisher = "AccTesPublisher220630223513059568"
    offer     = "AccTesOffer220630223513059568"
    sku       = "AccTesSku220630223513059568"
  }
}
