...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231020040746255484"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231020040746255484"
  ...
  identifier {
    publisher = "AccTesPublisher231020040746255484"
    offer     = "AccTesOffer231020040746255484"
    sku       = "AccTesSku231020040746255484"
  }
}
