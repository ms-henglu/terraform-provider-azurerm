...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-DataCollectionRule-230127045758686287"
...
resource "azurerm_log_analytics_workspace" "test1" {
  name                = "acctest-law-230127045758686287"
...
resource "azurerm_log_analytics_workspace" "test2" {
  name                = "acctest-law2-230127045758686287"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
}
...
resource "azurerm_monitor_data_collection_rule" "test" {
  name                = "acctestmdcr-230127045758686287"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
