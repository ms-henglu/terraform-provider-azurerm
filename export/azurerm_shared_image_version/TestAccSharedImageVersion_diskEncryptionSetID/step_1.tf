...
locals {
  number            = "230818023718899059"
  location          = "West Europe"
  domain_name_label = "acctestvm-pf4wu"
  random_string     = "pf4wu"
  admin_username    = "testadmin230818023718899059"
  admin_password    = "Password1234!230818023718899059"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230818023718899059"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230818023718899059"
  ...
  identifier {
    publisher = "AccTesPublisher230818023718899059"
    offer     = "AccTesOffer230818023718899059"
    sku       = "AccTesSku230818023718899059"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230818023718899059"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
