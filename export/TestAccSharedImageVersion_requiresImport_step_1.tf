...
locals {
  number            = "211022001757135756"
  location          = "West Europe"
  domain_name_label = "acctestvm-zojg6"
  random_string     = "zojg6"
  admin_username    = "testadmin211022001757135756"
  admin_password    = "Password1234!211022001757135756"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211022001757135756"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211022001757135756"
  ...
  identifier {
    publisher = "AccTesPublisher211022001757135756"
    offer     = "AccTesOffer211022001757135756"
    sku       = "AccTesSku211022001757135756"
  }
}
