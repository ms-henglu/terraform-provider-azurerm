...
locals {
  number            = "220722035002620598"
  location          = "West Europe"
  domain_name_label = "acctestvm-gocal"
  random_string     = "gocal"
  admin_username    = "testadmin220722035002620598"
  admin_password    = "Password1234!220722035002620598"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220722035002620598"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220722035002620598"
  ...
  identifier {
    publisher = "AccTesPublisher220722035002620598"
    offer     = "AccTesOffer220722035002620598"
    sku       = "AccTesSku220722035002620598"
  }
}
