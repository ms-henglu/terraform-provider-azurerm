...
locals {
  number            = "221216013235531896"
  location          = "West Europe"
  domain_name_label = "acctestvm-nmtwj"
  random_string     = "nmtwj"
  admin_username    = "testadmin221216013235531896"
  admin_password    = "Password1234!221216013235531896"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221216013235531896"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221216013235531896"
  ...
  identifier {
    publisher = "AccTesPublisher221216013235531896"
    offer     = "AccTesOffer221216013235531896"
    sku       = "AccTesSku221216013235531896"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-221216013235531896"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
