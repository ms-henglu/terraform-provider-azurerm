...
locals {
  number            = "221021033910593843"
  location          = "West Europe"
  domain_name_label = "acctestvm-xeodw"
  random_string     = "xeodw"
  admin_username    = "testadmin221021033910593843"
  admin_password    = "Password1234!221021033910593843"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221021033910593843"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221021033910593843"
  ...
  identifier {
    publisher = "AccTesPublisher221021033910593843"
    offer     = "AccTesOffer221021033910593843"
    sku       = "AccTesSku221021033910593843"
  }
}
