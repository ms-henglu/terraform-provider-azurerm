...
locals {
  number            = "231013043133459467"
  location          = "West Europe"
  domain_name_label = "acctestvm-wd430"
  random_string     = "wd430"
  admin_username    = "testadmin231013043133459467"
  admin_password    = "Password1234!231013043133459467"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231013043133459467"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231013043133459467"
  ...
  identifier {
    publisher = "AccTesPublisher231013043133459467"
    offer     = "AccTesOffer231013043133459467"
    sku       = "AccTesSku231013043133459467"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-231013043133459467"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
