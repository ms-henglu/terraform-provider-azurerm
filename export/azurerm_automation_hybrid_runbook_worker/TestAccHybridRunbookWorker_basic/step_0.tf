...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-auto-230428045239840914"
  location = "West Europe"
}

resource "azurerm_automation_account" "test" {
  name                = "acctestAA-230428045239840914"
...
resource "azurerm_automation_credential" "test" {
  name                    = "acctest-230428045239840914"
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network" "test" {
  name                = "acctestnw-230428045239840914"
...
resource "azurerm_network_interface" "test" {
  name                = "acctni-230428045239840914"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "test" {
  name                = "acctestVM-230428045239840914"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_automation_hybrid_runbook_worker" "test" {
  ...
  worker_id               = "f5a9ddba-eea9-4b39-9356-2b663d68c4fa"
