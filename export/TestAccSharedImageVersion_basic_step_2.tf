...
locals {
  number            = "220726014613800438"
  location          = "West Europe"
  domain_name_label = "acctestvm-40873"
  random_string     = "40873"
  admin_username    = "testadmin220726014613800438"
  admin_password    = "Password1234!220726014613800438"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220726014613800438"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220726014613800438"
  ...
  identifier {
    publisher = "AccTesPublisher220726014613800438"
    offer     = "AccTesOffer220726014613800438"
    sku       = "AccTesSku220726014613800438"
  }
}
