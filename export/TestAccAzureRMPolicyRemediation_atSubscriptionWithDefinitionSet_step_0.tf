...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-2tfnv"
  policy_type  = "Custom"
  display_name = "testPolicySet-2tfnv"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-2tfnv"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-2tfnv"
