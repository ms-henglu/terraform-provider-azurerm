...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220623233411082495"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220623233411082495"
  ...
  identifier {
    publisher = "AccTesPublisher220623233411082495"
    offer     = "AccTesOffer220623233411082495"
    sku       = "AccTesSku220623233411082495"
  }
}
