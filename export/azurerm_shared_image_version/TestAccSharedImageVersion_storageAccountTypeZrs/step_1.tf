...
locals {
  number            = "230512003629461078"
  location          = "West Europe"
  domain_name_label = "acctestvm-mi6qc"
  random_string     = "mi6qc"
  admin_username    = "testadmin230512003629461078"
  admin_password    = "Password1234!230512003629461078"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230512003629461078"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230512003629461078"
  ...
  identifier {
    publisher = "AccTesPublisher230512003629461078"
    offer     = "AccTesOffer230512003629461078"
    sku       = "AccTesSku230512003629461078"
  }
}
