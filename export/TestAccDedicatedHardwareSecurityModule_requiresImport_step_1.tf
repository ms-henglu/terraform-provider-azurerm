...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-hsm-220422011937188493"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet-220422011937188493"
...
resource "azurerm_subnet" "test" {
  name                 = "acctest-computesubnet-220422011937188493"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_subnet" "test2" {
  name                 = "acctest-hsmsubnet-220422011937188493"
  resource_group_name  = azurerm_resource_group.test.name
  virtual_network_name = azurerm_virtual_network.test.name
...
resource "azurerm_public_ip" "test" {
  name                = "acctest-pip-220422011937188493"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network_gateway" "test" {
  name                = "acctest-vnetgateway-220422011937188493"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
