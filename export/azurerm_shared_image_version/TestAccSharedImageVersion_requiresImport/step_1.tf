...
locals {
  number            = "230113180850405129"
  location          = "West Europe"
  domain_name_label = "acctestvm-89cgu"
  random_string     = "89cgu"
  admin_username    = "testadmin230113180850405129"
  admin_password    = "Password1234!230113180850405129"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230113180850405129"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230113180850405129"
  ...
  identifier {
    publisher = "AccTesPublisher230113180850405129"
    offer     = "AccTesOffer230113180850405129"
    sku       = "AccTesSku230113180850405129"
  }
}
