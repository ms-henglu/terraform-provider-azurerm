...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-signalr-220630224156706950"
  location = "West Europe"
}

resource "azurerm_signalr_service" "test" {
  name                = "acctest-signalr-220630224156706950"
...
resource "azurerm_virtual_network" "test" {
  name                = "acctest-vnet-220630224156706950"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_subnet" "test" {
  name                 = "acctest-subnet-220630224156706950"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_private_endpoint" "test" {
  name                = "acctest-pe-220630224156706950"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
...
resource "azurerm_virtual_network" "test2" {
  name                = "acctest-vnet2-220630224156706950"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  address_space       = ["10.5.0.0/16"]
}
...
resource "azurerm_subnet" "test2" {
  name                 = "acctest-subnet2-220630224156706950"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_private_endpoint" "test2" {
  name                = "acctest-pe2-220630224156706950"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
