...
locals {
  number            = "230728025312716991"
  location          = "West Europe"
  domain_name_label = "acctestvm-m2wrh"
  random_string     = "m2wrh"
  admin_username    = "testadmin230728025312716991"
  admin_password    = "Password1234!230728025312716991"
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230728025312716991"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
