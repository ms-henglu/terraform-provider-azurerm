...
// ConfigType enumerates the values for config type.
type ConfigType string

const (
	// ConfigTypeAdminPolicy ...
	ConfigTypeAdminPolicy ConfigType = "AdminPolicy"
	// ConfigTypeConnectivity ...
	ConfigTypeConnectivity ConfigType = "Connectivity"
	// ConfigTypeUserPolicy ...
	ConfigTypeUserPolicy ConfigType = "UserPolicy"
)

// PossibleConfigTypeValues returns an array of possible values for the ConfigType const type.
func PossibleConfigTypeValues() []ConfigType {
	return []ConfigType{ConfigTypeAdminPolicy, ConfigTypeConnectivity, ConfigTypeUserPolicy}
}
...
func PossibleScopeAccessesValues() []ScopeAccesses {
	return []ScopeAccesses{ScopeAccessesConnectivity, ScopeAccessesRouting, ScopeAccessesSecurity}
}
