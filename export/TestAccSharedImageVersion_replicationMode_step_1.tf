...
locals {
  number            = "220726001659728504"
  location          = "West Europe"
  domain_name_label = "acctestvm-ld8ml"
  random_string     = "ld8ml"
  admin_username    = "testadmin220726001659728504"
  admin_password    = "Password1234!220726001659728504"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220726001659728504"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220726001659728504"
  ...
  identifier {
    publisher = "AccTesPublisher220726001659728504"
    offer     = "AccTesOffer220726001659728504"
    sku       = "AccTesSku220726001659728504"
  }
}
