...
locals {
  number            = "220324160038486774"
  location          = "West Europe"
  domain_name_label = "acctestvm-zq33h"
  random_string     = "zq33h"
  admin_username    = "testadmin220324160038486774"
  admin_password    = "Password1234!220324160038486774"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220324160038486774"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220324160038486774"
  ...
  identifier {
    publisher = "AccTesPublisher220324160038486774"
    offer     = "AccTesOffer220324160038486774"
    sku       = "AccTesSku220324160038486774"
  }
}
