...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-a0tn4"
  policy_type  = "Custom"
  display_name = "testPolicySet-a0tn4"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-a0tn4"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-a0tn4"
