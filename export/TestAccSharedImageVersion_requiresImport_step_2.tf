...
locals {
  number            = "210928075302205724"
  location          = "West Europe"
  domain_name_label = "acctestvm-6m7lb"
  random_string     = "6m7lb"
  admin_username    = "testadmin210928075302205724"
  admin_password    = "Password1234!210928075302205724"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig210928075302205724"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg210928075302205724"
  ...
  identifier {
    publisher = "AccTesPublisher210928075302205724"
    offer     = "AccTesOffer210928075302205724"
    sku       = "AccTesSku210928075302205724"
  }
}
