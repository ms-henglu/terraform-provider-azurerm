...
locals {
  number            = "230227175227917452"
  location          = "West Europe"
  domain_name_label = "acctestvm-q3zt7"
  random_string     = "q3zt7"
  admin_username    = "testadmin230227175227917452"
  admin_password    = "Password1234!230227175227917452"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230227175227917452"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230227175227917452"
  ...
  identifier {
    publisher = "AccTesPublisher230227175227917452"
    offer     = "AccTesOffer230227175227917452"
    sku       = "AccTesSku230227175227917452"
  }
}
