...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-netapp-240311032721754164"
...
resource "azurerm_user_assigned_identity" "test" {
  name                = "user-assigned-identity-240311032721754164"
...
resource "azurerm_key_vault_key" "test" {
  name         = "anfenckey240311032721754164"
...
resource "azurerm_netapp_account" "test" {
  name                = "acctest-NetAppAccount-240311032721754164"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_virtual_network" "test" {
  name                = "acctest-VirtualNetwork-240311032721754164"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_subnet" "test-delegated" {
  name                 = "acctest-Delegated-Subnet-240311032721754164"
  resource_group_name  = azurerm_resource_group.test.name
...
resource "azurerm_subnet" "test-non-delegated" {
  name                 = "acctest-Non-Delegated-Subnet-240311032721754164"
  resource_group_name  = azurerm_resource_group.test.name
  virtual_network_name = azurerm_virtual_network.test.name
...
resource "azurerm_private_endpoint" "test" {
  name                = "acctest-pe-akv-240311032721754164"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
  subnet_id           = azurerm_subnet.test-non-delegated.id

  private_service_connection {
    name                           = "acctest-pe-sc-akv-240311032721754164"
...
resource "azurerm_netapp_pool" "test" {
  name                = "acctest-NetAppPool-240311032721754164"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_netapp_volume" "test" {
  name                          = "acctest-NetAppVolume-240311032721754164"
  location                      = azurerm_resource_group.test.location
  resource_group_name           = azurerm_resource_group.test.name
  account_name                  = azurerm_netapp_account.test.name
  pool_name                     = azurerm_netapp_pool.test.name
  volume_path                   = "my-unique-file-path-240311032721754164"
  service_level                 = "Standard"
