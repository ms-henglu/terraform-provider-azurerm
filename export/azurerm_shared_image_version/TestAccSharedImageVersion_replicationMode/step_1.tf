...
locals {
  number            = "231016033604021328"
  location          = "West Europe"
  domain_name_label = "acctestvm-6jqee"
  random_string     = "6jqee"
  admin_username    = "testadmin231016033604021328"
  admin_password    = "Password1234!231016033604021328"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig231016033604021328"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg231016033604021328"
  ...
  identifier {
    publisher = "AccTesPublisher231016033604021328"
    offer     = "AccTesOffer231016033604021328"
    sku       = "AccTesSku231016033604021328"
  }
}
