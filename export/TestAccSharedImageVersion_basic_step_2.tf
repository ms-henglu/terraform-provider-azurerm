...
locals {
  number            = "221019054023438335"
  location          = "West Europe"
  domain_name_label = "acctestvm-wvx4n"
  random_string     = "wvx4n"
  admin_username    = "testadmin221019054023438335"
  admin_password    = "Password1234!221019054023438335"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221019054023438335"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221019054023438335"
  ...
  identifier {
    publisher = "AccTesPublisher221019054023438335"
    offer     = "AccTesOffer221019054023438335"
    sku       = "AccTesSku221019054023438335"
  }
}
