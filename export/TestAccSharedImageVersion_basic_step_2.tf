...
locals {
  number            = "220818234946129204"
  location          = "West Europe"
  domain_name_label = "acctestvm-gg6wg"
  random_string     = "gg6wg"
  admin_username    = "testadmin220818234946129204"
  admin_password    = "Password1234!220818234946129204"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220818234946129204"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220818234946129204"
  ...
  identifier {
    publisher = "AccTesPublisher220818234946129204"
    offer     = "AccTesOffer220818234946129204"
    sku       = "AccTesSku220818234946129204"
  }
}
