...
locals {
  number            = "230616074443135530"
  location          = "West Europe"
  domain_name_label = "acctestvm-6hwaq"
  random_string     = "6hwaq"
  admin_username    = "testadmin230616074443135530"
  admin_password    = "Password1234!230616074443135530"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230616074443135530"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230616074443135530"
  ...
  identifier {
    publisher = "AccTesPublisher230616074443135530"
    offer     = "AccTesOffer230616074443135530"
    sku       = "AccTesSku230616074443135530"
  }
}
