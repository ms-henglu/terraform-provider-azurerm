...
locals {
  number            = "211217035034683419"
  location          = "West Europe"
  domain_name_label = "acctestvm-lredd"
  random_string     = "lredd"
  admin_username    = "testadmin211217035034683419"
  admin_password    = "Password1234!211217035034683419"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig211217035034683419"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg211217035034683419"
  ...
  identifier {
    publisher = "AccTesPublisher211217035034683419"
    offer     = "AccTesOffer211217035034683419"
    sku       = "AccTesSku211217035034683419"
  }
}
