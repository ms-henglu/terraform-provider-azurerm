...
locals {
  number            = "221028164721120319"
  location          = "West Europe"
  domain_name_label = "acctestvm-llsj1"
  random_string     = "llsj1"
  admin_username    = "testadmin221028164721120319"
  admin_password    = "Password1234!221028164721120319"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221028164721120319"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221028164721120319"
  ...
  identifier {
    publisher = "AccTesPublisher221028164721120319"
    offer     = "AccTesOffer221028164721120319"
    sku       = "AccTesSku221028164721120319"
  }
}
