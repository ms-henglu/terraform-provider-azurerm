...
locals {
  number            = "230728025312844443"
  location          = "West Europe"
  domain_name_label = "acctestvm-mnbr6"
  random_string     = "mnbr6"
  admin_username    = "testadmin230728025312844443"
  admin_password    = "Password1234!230728025312844443"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230728025312844443"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230728025312844443"
  ...
  identifier {
    publisher = "AccTesPublisher230728025312844443"
    offer     = "AccTesOffer230728025312844443"
    sku       = "AccTesSku230728025312844443"
  }
}
