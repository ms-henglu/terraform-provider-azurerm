...
locals {
  ...
  vm_name           = "acctestsourcevm-231016033603940861"
  admin_username    = "testadmin231016033603940861"
  admin_password    = "Password1234!231016033603940861"
}

resource "azurerm_resource_group" "test" {
  name     = "acctestRG-231016033603940861"
  location = "West Europe"
}

resource "azurerm_virtual_network" "test" {
  name                = "acctestnw-231016033603940861"
...
resource "azurerm_public_ip" "test" {
  name                = "acctpip-231016033603940861"
  location            = "${azurerm_resource_group.test.location}"
  resource_group_name = "${azurerm_resource_group.test.name}"
...
resource "azurerm_network_interface" "public" {
  name                = "acctnicsource-231016033603940861"
  location            = "${azurerm_resource_group.test.location}"
  resource_group_name = "${azurerm_resource_group.test.name}"
...
resource "azurerm_network_interface" "test" {
  name                = "acctestnic-231016033603940861"
  location            = azurerm_resource_group.test.location
  resource_group_name = azurerm_resource_group.test.name
...
resource "azurerm_linux_virtual_machine" "source" {
  name                            = "acctestsourceVM-231016033603940861"
  resource_group_name             = azurerm_resource_group.test.name
  location                        = azurerm_resource_group.test.location
  size                            = "Standard_F2"
