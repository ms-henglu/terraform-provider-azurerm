...
locals {
  number            = "230127045135677880"
  location          = "West Europe"
  domain_name_label = "acctestvm-691kj"
  random_string     = "691kj"
  admin_username    = "testadmin230127045135677880"
  admin_password    = "Password1234!230127045135677880"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230127045135677880"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230127045135677880"
  ...
  identifier {
    publisher = "AccTesPublisher230127045135677880"
    offer     = "AccTesOffer230127045135677880"
    sku       = "AccTesSku230127045135677880"
  }
}
