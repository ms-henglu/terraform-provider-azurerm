...
locals {
  number            = "220520053718278530"
  location          = "West Europe"
  domain_name_label = "acctestvm-igp33"
  random_string     = "igp33"
  admin_username    = "testadmin220520053718278530"
  admin_password    = "Password1234!220520053718278530"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220520053718278530"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220520053718278530"
  ...
  identifier {
    publisher = "AccTesPublisher220520053718278530"
    offer     = "AccTesOffer220520053718278530"
    sku       = "AccTesSku220520053718278530"
  }
}
