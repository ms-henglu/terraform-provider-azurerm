...
locals {
  number            = "240119021734533204"
  location          = "West Europe"
  domain_name_label = "acctestvm-tr42p"
  random_string     = "tr42p"
  admin_username    = "testadmin240119021734533204"
  admin_password    = "Password1234!240119021734533204"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240119021734533204"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240119021734533204"
  ...
  identifier {
    publisher = "AccTesPublisher240119021734533204"
    offer     = "AccTesOffer240119021734533204"
    sku       = "AccTesSku240119021734533204"
  }
}
