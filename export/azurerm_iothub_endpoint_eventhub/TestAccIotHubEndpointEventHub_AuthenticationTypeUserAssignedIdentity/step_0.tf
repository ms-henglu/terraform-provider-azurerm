...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-iothub-221104005521047786"
  location = "West Europe"
}

resource "azurerm_eventhub_namespace" "test" {
  name                = "acctesteventhubnamespace-221104005521047786"
...
resource "azurerm_eventhub" "test" {
  name                = "acctesteventhub-221104005521047786"
...
resource "azurerm_eventhub_authorization_rule" "test" {
  name                = "acctest-221104005521047786"
  namespace_name      = azurerm_eventhub_namespace.test.name
...
resource "azurerm_user_assigned_identity" "test" {
  name                = "acctestuai-221104005521047786"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}
...
resource "azurerm_iothub" "test" {
  name                = "acctestIoTHub-221104005521047786"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
