...
locals {
  number            = "230707010127177182"
  location          = "West Europe"
  domain_name_label = "acctestvm-en1gk"
  random_string     = "en1gk"
  admin_username    = "testadmin230707010127177182"
  admin_password    = "Password1234!230707010127177182"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230707010127177182"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230707010127177182"
  ...
  identifier {
    publisher = "AccTesPublisher230707010127177182"
    offer     = "AccTesOffer230707010127177182"
    sku       = "AccTesSku230707010127177182"
  }
}
