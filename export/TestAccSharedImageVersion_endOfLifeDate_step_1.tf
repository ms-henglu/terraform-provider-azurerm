...
locals {
  number            = "220826002453900478"
  location          = "West Europe"
  domain_name_label = "acctestvm-6nf2d"
  random_string     = "6nf2d"
  admin_username    = "testadmin220826002453900478"
  admin_password    = "Password1234!220826002453900478"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220826002453900478"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220826002453900478"
  ...
  identifier {
    publisher = "AccTesPublisher220826002453900478"
    offer     = "AccTesOffer220826002453900478"
    sku       = "AccTesSku220826002453900478"
  }
}
...
resource "azurerm_shared_image_version" "test" {
  ...
  end_of_life_date    = "2022-08-26T10:24:53Z"
