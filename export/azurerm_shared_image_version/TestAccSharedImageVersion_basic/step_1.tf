...
locals {
  number            = "240112224137950526"
  location          = "West Europe"
  domain_name_label = "acctestvm-irgc0"
  random_string     = "irgc0"
  admin_username    = "testadmin240112224137950526"
  admin_password    = "Password1234!240112224137950526"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig240112224137950526"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg240112224137950526"
  ...
  identifier {
    publisher = "AccTesPublisher240112224137950526"
    offer     = "AccTesOffer240112224137950526"
    sku       = "AccTesSku240112224137950526"
  }
}
