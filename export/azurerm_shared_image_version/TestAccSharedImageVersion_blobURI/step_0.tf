...
locals {
  number            = "221111013238941719"
  location          = "West Europe"
  domain_name_label = "acctestvm-pz6hi"
  random_string     = "pz6hi"
  admin_username    = "testadmin221111013238941719"
  admin_password    = "Password1234!221111013238941719"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221111013238941719"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221111013238941719"
  ...
  identifier {
    publisher = "AccTesPublisher221111013238941719"
    offer     = "AccTesOffer221111013238941719"
    sku       = "AccTesSku221111013238941719"
  }
}
