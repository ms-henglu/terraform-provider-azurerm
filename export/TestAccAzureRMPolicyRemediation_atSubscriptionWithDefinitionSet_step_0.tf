...
resource "azurerm_policy_set_definition" "test" {
  name         = "testPolicySet-pujtv"
  policy_type  = "Custom"
  display_name = "testPolicySet-pujtv"
...
resource "azurerm_policy_definition" "test" {
  name         = "acctestDef-pujtv"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "acctestDef-pujtv"
