...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220726001659723917"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220726001659723917"
  ...
  identifier {
    publisher = "AccTesPublisher220726001659723917"
    offer     = "AccTesOffer220726001659723917"
    sku       = "AccTesSku220726001659723917"
  }
}
