...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-240119025218620812"
  location = "West Europe"
}

resource "azurerm_resource_group" "test2" {
  name     = "acctestSecRG-240119025218620812"
  location = "West Europe"
}
...
resource "azurerm_cosmosdb_account" "test" {
  name                = "acctest-ca-240119025218620812"
...
resource "azurerm_cosmosdb_sql_database" "test" {
  name                = "acctestcosmosdbsqldb-240119025218620812"
  resource_group_name = azurerm_cosmosdb_account.test.resource_group_name
  account_name        = azurerm_cosmosdb_account.test.name
}

resource "azurerm_cosmosdb_sql_container" "test" {
  name                = "acctestcosmosdbsqlcon-240119025218620812"
  resource_group_name = azurerm_cosmosdb_account.test.resource_group_name
  account_name        = azurerm_cosmosdb_account.test.name
...
resource "azurerm_kusto_database" "test" {
  name                = "acctestkd-240119025218620812"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
