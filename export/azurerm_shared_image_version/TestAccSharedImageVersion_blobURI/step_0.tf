...
locals {
  number            = "230512010404761218"
  location          = "West Europe"
  domain_name_label = "acctestvm-6k2ap"
  random_string     = "6k2ap"
  admin_username    = "testadmin230512010404761218"
  admin_password    = "Password1234!230512010404761218"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230512010404761218"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230512010404761218"
  ...
  identifier {
    publisher = "AccTesPublisher230512010404761218"
    offer     = "AccTesOffer230512010404761218"
    sku       = "AccTesSku230512010404761218"
  }
}
