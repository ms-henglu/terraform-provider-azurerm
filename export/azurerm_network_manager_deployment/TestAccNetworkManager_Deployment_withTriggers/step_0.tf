...
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-network-manager-230818024518133636"
...
resource "azurerm_network_manager" "test" {
  name                = "acctest-nm-230818024518133636"
...
resource "azurerm_network_manager_network_group" "test" {
  name               = "acctest-nmng-230818024518133636"
  network_manager_id = azurerm_network_manager.test.id
}

resource "azurerm_virtual_network" "test" {
  name                    = "acctest-vnet-230818024518133636"
  location                = azurerm_resource_group.test.location
  resource_group_name     = azurerm_resource_group.test.name
...
resource "azurerm_network_manager_connectivity_configuration" "test" {
  name                  = "acctest-nmcc-230818024518133636"
  network_manager_id    = azurerm_network_manager.test.id
...
resource "azurerm_network_manager_security_admin_configuration" "test" {
  name               = "acctest-nmsac-230818024518133636"
  network_manager_id = azurerm_network_manager.test.id
}

resource "azurerm_network_manager_admin_rule_collection" "test" {
  name                            = "acctest-nmarc-230818024518133636"
...
resource "azurerm_network_manager_admin_rule" "test" {
  name                     = "acctest-nmar-230818024518133636"
