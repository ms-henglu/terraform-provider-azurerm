...
locals {
  number            = "230313020903880233"
  location          = "West Europe"
  domain_name_label = "acctestvm-06v6o"
  random_string     = "06v6o"
  admin_username    = "testadmin230313020903880233"
  admin_password    = "Password1234!230313020903880233"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230313020903880233"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230313020903880233"
  ...
  identifier {
    publisher = "AccTesPublisher230313020903880233"
    offer     = "AccTesOffer230313020903880233"
    sku       = "AccTesSku230313020903880233"
  }
}
...
resource "azurerm_disk_encryption_set" "test" {
  name                = "acctestdes-230313020903880233"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
