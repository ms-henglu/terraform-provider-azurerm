...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig220627123942227546"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg220627123942227546"
  ...
  identifier {
    publisher = "AccTesPublisher220627123942227546"
    offer     = "AccTesOffer220627123942227546"
    sku       = "AccTesSku220627123942227546"
  }
}
