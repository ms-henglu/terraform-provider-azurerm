...
resource "azurerm_resource_group" "test" {
  name     = "acctest-mn-240105064218655669"
...
resource "azurerm_mobile_network_site" "test" {
  name              = "acctest-mns-240105064218655669"
...
resource "azurerm_mobile_network_packet_core_control_plane" "test" {
  name                              = "acctest-mnpccp-240105064218655669"
  resource_group_name               = azurerm_resource_group.test.name
  location                          = "West Europe"
  sku                               = "G0"
