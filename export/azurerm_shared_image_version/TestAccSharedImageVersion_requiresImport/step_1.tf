...
locals {
  number            = "221021033910595452"
  location          = "West Europe"
  domain_name_label = "acctestvm-om8qx"
  random_string     = "om8qx"
  admin_username    = "testadmin221021033910595452"
  admin_password    = "Password1234!221021033910595452"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221021033910595452"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221021033910595452"
  ...
  identifier {
    publisher = "AccTesPublisher221021033910595452"
    offer     = "AccTesOffer221021033910595452"
    sku       = "AccTesSku221021033910595452"
  }
}
