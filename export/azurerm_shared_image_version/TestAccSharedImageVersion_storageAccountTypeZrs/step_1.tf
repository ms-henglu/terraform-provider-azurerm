...
locals {
  number            = "230818023718891580"
  location          = "West Europe"
  domain_name_label = "acctestvm-pj3qj"
  random_string     = "pj3qj"
  admin_username    = "testadmin230818023718891580"
  admin_password    = "Password1234!230818023718891580"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig230818023718891580"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg230818023718891580"
  ...
  identifier {
    publisher = "AccTesPublisher230818023718891580"
    offer     = "AccTesOffer230818023718891580"
    sku       = "AccTesSku230818023718891580"
  }
}
