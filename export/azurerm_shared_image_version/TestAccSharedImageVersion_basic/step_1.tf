...
locals {
  number            = "221021030948780232"
  location          = "West Europe"
  domain_name_label = "acctestvm-csppe"
  random_string     = "csppe"
  admin_username    = "testadmin221021030948780232"
  admin_password    = "Password1234!221021030948780232"
}
...
resource "azurerm_shared_image_gallery" "test" {
  name                = "acctestsig221021030948780232"
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
}

resource "azurerm_shared_image" "test" {
  name                = "acctestimg221021030948780232"
  ...
  identifier {
    publisher = "AccTesPublisher221021030948780232"
    offer     = "AccTesOffer221021030948780232"
    sku       = "AccTesSku221021030948780232"
  }
}
